...
<Image src={import('./_assets/ipc-2152-copper-thickness-modifier-graph-with-trendlines.png')} width="500px">Copper-thickness modifier data from IPC-2152 with 5th-order polynomials fitted to each copper weight.</Image>
...
<Image src={import('./_assets/ipc-2152-copper-thickness-modifier-copper-weight-versus-c5-graph.png')} width="500px">Coefficient C5 of the fitted 5th-order polynomial plotted against copper weight, with its own third-degree polynomial fit.</Image>
