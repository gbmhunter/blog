...
<Image src={import('./0603-resistor-and-designator-2d-cad-birds-eye-high-zoom.png')} width="425px">A 0603 resistor and it's designator inside a CAD packages PCB design file.</Image>
...
<Image src={import('./close-up-of-0603-resistor-on-pcb.jpg')} width="800px">A close-up of a 0603 resistor and it's designator on a PCB.</Image>
...
<Image src={import('./designators-separated-from-dense-components-on-pcb.png')} width="800px">Designators can be separated from dense components, as long as they are grouped and are in the same orientation as the components.</Image>
