...
authors: [gbmhunter]
date: 2022-04-06
description: SOT-143 is a 4 gull-wing lead SMD package which is easily distinguishable by having one wider lead compared with the other 3.
...
<Image src={import('./_assets/sot-143-3d-model-digikey.png')} width="150px"></Image>
...
<Image src={import('./_assets/sot-143-3d-model-digikey.png')} width="300px">A 3D model of the SOT-143 component package[^bib-digikey-stm6315rbw13f]. On the upside down render, you can clearly see the 1 wider lead.</Image>
