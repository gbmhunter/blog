...
<Image src={import('./_assets/qfn-component-package-sawn-vs-punch-vs-col-singulation.png')} width="573px">Cross-sectional comparison of sawn and punch singulated QFN packages. Image from http://cache.freescale.com/files/analog/doc/app_note/AN1902.pdf.</Image>
...
<Image src={import('./_assets/qfn-24-component-package-with-unique-corner-pads-mpu-9250-dimensions.png')} width="306px">The corner pins on the QFN package used by the IvenSense MPU-9250 have a unique shape.</Image>

<Image src={import('./_assets/qfn-24-component-package-with-unique-corner-pads-mpu-9250-land-pattern.png')} width="260px">The footprint for the IvenSense MPU-9250 IMU which uses a QFN package with unique corner pin shapes (notice how they are smaller).</Image>
...
<Image src={import('./_assets/st-micro-pwd13f60-vfqfpn-3d-render.png')} width="500px">3D render of the VFQFPN 10x13x1.0mm package used for ST Microelectronic's PWD13F60 IC[^st-pwd13f60-ds].</Image>
