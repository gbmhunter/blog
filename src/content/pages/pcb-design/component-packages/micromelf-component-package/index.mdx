...
authors: [gbmhunter]
date: 2015-04-04
description: MicroMELF is a small 2-lead SMD component package. It is the smallest package in the family also containing the MELF and MiniMELF packages.
image: ./_assets/cover-image.webp
lastUpdated: 2024-12-13
tags: [component packages, PCB design, MicroMELF]
title: MicroMELF Component Package
type: page
---
...
<Image src={import('./_assets/micro-melf-component-package-photo.jpg')} width="300px">A photo of the Micro-MELF component package.</Image>
...
<Image src={import('./_assets/component-package-micro-melf-dimensions-and-land-pattern.png')} width="800px">The dimensions and recommended land pattern for the Vishay MicroMELF component package[^vishay-smm0102-thin-film-micromelf-resistors].</Image>
