...
<Image src={import('./confused-man-holding-ic-in-hand.webp')} width="250px" float="right"></Image>
...
<Image src={import('./package-size-comparison-chart.svg')} width="900px">A package size comparison chart. When printed on A4 paper is has a 1:1 scale.</Image>
...
<Image src={import('./sparkfun-break-out-board.jpg')} width="160px">A SOIC-8 to DIP break-out board made by SparkFun.</Image>
...
<Image src={import('./aries-correct-a-chip-sot-23-6.png')} width="250px">SOT-23-6 to DIP.</Image>

<Image src={import('./aries-correct-a-chip-soic-16.png')} width="250px">SOIC-16 to DIP. </Image>

<Image src={import('./aries-correct-a-chip-qfp-64.png')} width="250px">QFP-64 to PGA (dual-rowed DIP). </Image>
</div>
