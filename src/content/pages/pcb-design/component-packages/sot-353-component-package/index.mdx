...
authors: [gbmhunter]
date: 2023-07-14
description: SOT-353 is a 5 gull-wing lead SMD component package with a pitch of 0.65mm.
image: ./_assets/cover-image.webp
lastUpdated: 2024-12-15
tags: [component packages, PCB design, SOT-353]
title: SOT-353 Component Package
type: page
---

_SOT-353_ (Small-outline Transistor 353) is a 5-lead SMD component package with a pitch of 0.65mm[^nexperia-sot-353].
...
<Image src={import('./_assets/sot-353-package-dimensions-diodes-com.png')} width="700px">Mechanical outline and dimensions for the SOT-353 package[^diodes-incorp-sot-353-package-info].</Image>

## Recommended Land Pattern

The below image shows the recommended land pattern from Diodes Incorporated:

<Image src={import('./_assets/sot-353-recommended-land-pattern-diodes-inc.png')} width="700px">The recommended land pattern for the SOT-353 package from Diodes Incorporated[^diodes-incorp-sot-353-package-info].</Image>
