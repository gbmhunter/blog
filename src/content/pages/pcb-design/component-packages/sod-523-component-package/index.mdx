...
authors: [gbmhunter]
date: 2014-11-09
description: SOD-523 is a 2 lead SMD component package commonly used for diodes. It is related to the SOD-123, SOD-323, SOD-723 and SOD-923 packages.
...
<Image src={import('./_assets/sc-79-sod-523-component-package-3d-render.png')} width="300px"></Image>
...
<Image src={import('./_assets/sod-523-package-dimensions.png')} width="600px">Package dimensions for the SOD-523 package[^bib-nxp-sod523-package-info].</Image>

<Image src={import('./_assets/sod-523-land-pattern.png')} width="600px">Recommended land pattern for the SOD-523 package[^bib-nxp-sod523-package-info].</Image>
