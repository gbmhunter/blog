...
authors: [gbmhunter]
date: 2015-04-07
description: The TO-252 component package family is a family of SMD component packages commonly used for MOSFETs and linear power regulators. It includes the 3-lead variant (DPAK) and 2 less commonly used 5-lead variants.
...
<Image src={import('./_assets/to-252-component-package-3d-render.jpg')} width="150px">A 3D render of the TO-252-3 (DPACK) component package.</Image>
...
* [TO-220](/pcb-design/component-packages/to-220-component-package): The through-hole package that the TO-252-3 was designed to replace (obviously not pin compatible!).
...
<Image src={import('./_assets/to-252-component-package-3d-render.jpg')} width="300px">A 3D render of the TO-252-3 (DPACK) component package.</Image>
...
<Image src={import('./_assets/to-252-5-p1-3d-model-diodes-inc.png')} width="400px">3D model of the TO-252-5-P1 package[^diodes-inc-to-252-5-p1].</Image>
...
<Image src={import('./_assets/to-252-p1-package-dimensions-diode-inc.png')} width="600px">Dimensions of the TO-252-5-P1 package from Diodes Inc[^diodes-inc-to-252-5-p2-ds].</Image>

**Recommended Land Pattern**

The image below shows the recommended land pattern of the `TO-252-5-P1` package from Diodes Inc.

<Image src={import('./_assets/to-252-p1-recommended-land-pattern-diode-inc.png')} width="600px">The recommended land pattern for the TO-252-5-P1 package from Diodes Inc[^diodes-inc-to-252-5-p2-ds].</Image>
...
<Image src={import('./_assets/to-252-5-p2-3d-render-nisshinbo.png')} width="300px">A 3D render of the TO-252-5-P2 component package.[^nisshinbo-to-252-5-p2]</Image>

**Recommended Land Pattern**

The image below shows a recommended land pattern from Ricoh for the `TO-252-5-P2`.

<Image src={import('./_assets/component-package-to-252-5-recommended-land-pattern.png')} width="500px">The recommended PCB land pattern for the TO-252-5 component package. Image from Ricoh TO-252 Package Information (http://www.ricoh.com/LSI/product_power/pkg/to-252-5-p2.pdf).</Image>
