...
authors: [gbmhunter]
date: 2015-10-25
description: Chip (EIA xxxx) components are family of very popular rectangular SMD cuboid packages, commonly used for resistors and capacitors.
...
<Image src={import('./_assets/routing-between-0805-footprints.jpg')} width="500px">Routing between the pads of a 0805 footprint (in Altium).</Image>

The following image is of 0603 (imperial) SMD components inside a small container.

<Image src={import('./_assets/smd-container-open-and-closed.jpg')} width="800px">A container from DealExtreme used for holding SMD components (capacitors in this picture)</Image>
...
<Image src={import('./_assets/reverse-geometery-chip-capacitor-photo-tdk.png')} width="200px">A photo of a reverse geometry chip capacitor from TDKs C series[^tdk-reverse-geometry-mlcc-ds].</Image>
...
<Image src={import('./_assets/2012-smd-mems-oscillator-component-package.png')} width="300px">Photo of the underside of a MEMS oscillator in a modified (2 extra pins) 2012 (2.0x1.2mm) chip package. Image from https://www.mouser.com/ProductDetail/SiTime/SiT1533AI-H4-AA3-32768E/?qs=dMZC7um9hO9NUxlac12G7g%3D%3D.</Image>
