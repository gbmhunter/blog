...
JEDEC formalized the dimensions of the `SOT-23` package (and all it's variants) in the MO-178 document (with package designator `R-PDSO-G`). After registering, you can download this document for free from https://www.jedec.org/standards-documents/docs/mo-178-c.

The [SOT-23F package](/pcb-design/component-packages/sot-23f-component-package/) is closely related to the `SOT-23` put has flat leads instead of gull-wing leads.
...
<Image src={import('./_assets/component-package-sot-23-6-sc-74a-sot-457-3d-render.jpg')} width="200px">A 3D render of the SOT-23-6 (SOT-457) component package.</Image>
