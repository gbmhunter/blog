...
authors: [gbmhunter]
date: 2015-04-06
description: SOT-563 (SC-89-6) is a small 6 flat lead SMD component package.
...
<Image src={import('./_assets/sot-563-component-package-3d-render.jpg')} width="350px">A 3D render of the SOT-563 component package.</Image>
...
<Image src={import('./_assets/sot-563-component-package-dimensions-ti-drl-r-pdso-n6.png')} width="556px">Dimensions of the SOT-563 component package. Image from http://www.ti.com/.</Image>
...
<Image src={import('./_assets/sot-563-component-package-recommended-pcb-footprint-ti-drl-r-pdso-n6.png')} width="800px">A recommended PCB footprint for the SOT-563 (TI DRL) component package. Image from http://www.ti.com/.</Image>
