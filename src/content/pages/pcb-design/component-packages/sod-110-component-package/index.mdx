...
authors: [gbmhunter]
date: 2015-04-05
description: SOD-110 is a small 2-lead SMD package used for diodes.
...
<Image src={import('./_assets/sod-110-component-package-photo.png')} width="357px">A photo of the SOD-110 component package.</Image>
...
<Image src={import('./_assets/component-package-sod-110-2d-outline-with-dimensions.png')} width="800px">The dimensions of the SOD-110 component package. Image from NXP SOD-110 Package Outline (http://www.nxp.com/documents/outline_drawing/sod110_po.pdf)</Image>

## Recommended Land Pattern

Below is the recommended land pattern for the SOD-110 from NXP (for reflow soldering):

<Image src={import('./_assets/sod-110-recommended-land-pattern-nxp.png')} width="800px">The recommended land pattern for the SOD-110 component package[^nxp-sod110].</Image>
