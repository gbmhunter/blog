...
authors: [gbmhunter]
date: 2019-04-29
description: TO-273AA is is a through-hole component package which can be considered an upgrade of the TO-220 with a clip-mounted design.
...
<Image src={import('./_assets/to-273aa-super-to-220-component-package-3d-render.png')} width="200px">A 3D render of the TO-273AA (Super TO-220) component package. Image from http://www.irf.com/part/INTELLIGENT-POWER-SWITCH-1-CHANNEL-LOW-SIDE-DRIVER-IN-A-SUPER-220-TO-273AA-PACKAGE/_/A~IPS0551T.</Image>

## Dimensions

<Image src={import('./_assets/component-package-to-273aa-super-to-220-case-outline-dimensions.png')} width="700px">The case outline and dimensions of the TO-273AA component package (Super TO-220). Image from http://www.irf.com/product-info/datasheets/data/ips0551t.pdf.</Image>
