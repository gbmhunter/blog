...
authors: [gbmhunter]
date: 2020-07-30
description: DFN (a.k.a. SON) is a popular SMD component package with pins running down two of its sides. It is commonly used for MOSFETs, flash memory ICs and other devices.
...
[Texas Instruments AN-1187: Leadless Lead frame Package (LLP)](https://www.ti.com/lit/an/snoa401r/snoa401r.pdf) is a great PCB designers reference document when using DFN or QFN packages (the document calls them LLP, but it is the same thing as DFN/QFN).
...
* MFF2: Package name used for eSIM cards. Represents a DFN-8 package.[^st-st4sim-200m-esim-ds]
* MLP (micro lead frame package or moulded leaded package). This also can refer to variants with pins on all four sides of the package, which is also called a QFN package. This name is used by Linear Technologies, Carsem.
* MLPD (MLP dual).
...
MFF2 is a package that eSIM cards use. It is a DFN-8, that measures 5x6x1.27mm.[^velocity-iot-viot-flex-mff2-ds] The complete dimensions are shown in <IRef iref="fig-mff2-dfn-8-package-dimensions-stm" />.

<Image iref="fig-mff2-dfn-8-package-dimensions-stm" src={import('./_assets/mff2-dfn-8-package-dimensions-stm.webp')} width="700px">The dimensions of the MFF2 (DFN-8) component package that is commonly used for eSIM ICs, as per STMicroelectronics' ST4SIM-200M eSIM. This package has wettable flanks.[^st-st4sim-200m-esim-ds]</Image>
...
[^st-st4sim-200m-esim-ds]: STMicroelectronics (2021, Jan). _ST4SIM-200M - eSIM GSMA system-on-chip solution for secure M2M industrial applications_. Retrieved 2024-12-09, from https://www.st.com/resource/en/data_brief/st4sim-200m.pdf.
[^velocity-iot-viot-flex-mff2-ds]: Velocity IoT. _VIoT-Flex MFF2 - Multi-IMSI eUICC compliant eSIM card_ [datasheet]. Retrieved 2024-12-09, https://mm.digikey.com/Volume0/opasdata/d220001/medias/docus/4887/VIOT-1SIM-MFF2.pdf.
