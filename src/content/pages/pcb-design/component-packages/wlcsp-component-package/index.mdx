...
The pin numbering follows the standard [BGA](/pcb-design/component-packages/bga-component-package) convention, the columns are labelled with letters (A, B, C, ...) and the rows with numbers (1, 2, 3, ...). Thus pins are referred to as A1, C3, D11, etc.
...
<Image src={import('./_assets/paragraph-on-backside-laminate-for-wlcsp-package-farchild-an-5075.png')} width="517px">Paragraph on backside laminate (BSL) for WLCSP component packages. Image from https://www.fairchildsemi.com/application-notes/AN/AN-5075.pdf.</Image>
