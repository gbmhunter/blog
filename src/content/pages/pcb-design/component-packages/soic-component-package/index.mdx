...
authors: [gbmhunter]
date: 2015-01-21
description: SOIC is a family of larger pitch SMD component packages that have gull-wing leads on two sides. There are three different widths of SOIC packages.
