...
<Image src={import('./_assets/tsoc-6-component-package-photo.jpg')} width="360px">A photo of the TSOC-6 component package. Image from maximintegrated.com.</Image>
...
<Image src={import('./_assets/tsoc-6-component-package-dimensions.png')} width="900px">A photo of the TSOC-6 component package. Image from maximintegrated.com.</Image>
...
<Image src={import('./_assets/component-package-tsoc-6-d6-1-recommended-land-pattern.png')} width="900px">The recommended land pattern for the TSOC-6 D6+1/D6-1 component package. Image from maximintegrated.com.</Image>

D6N+1/D6N-1 Variants (Variant B):

<Image src={import('./_assets/component-package-tsoc-6-d6n-1-recommended-land-pattern.png')} width="900px">The recommended land pattern for the TSOC-6 D6N+1/D6N-1 component package. Image from maximintegrated.com.</Image>
