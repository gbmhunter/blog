...
authors: [gbmhunter]
date: 2015-04-04
description: DO-204AL (DO-41) is a component package commonly used for older through-hole medium current diodes such as the 1N400x series.
...
<Image src={import('./_assets/do-41-component-package-photo.jpg')} width="300px">A photo of the DO-204AL component package.</Image>
