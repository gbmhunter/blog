...
authors: [gbmhunter]
date: 2015-03-08
description: BGA is a high-density SMD component package which can have from 4 to 1700+ pins. The pins are solder balls which are arranged in a grid on the underside of the package.
...
<Image src={import('./_assets/bga-144-component-package-3d-render.jpg')} width="150px">A 3D render of the BGA-144 component package.</Image>
...
<Image src={import('./_assets/example-of-nsmd-pcb-pad-solder-joint-xilinx.png')} width="507px">Example of a NSMD (non-soldermask defined) solder joint on a BGA package. Image from http://www.xilinx.com/.</Image>
...
<Image src={import('./_assets/dsbga-component-package-4-25-bump-size-comparison-ti.png')} width="282px">A size comparison of the 4 to 25 bump DSBGA component packages. Image from http://www.ti.com/.</Image>
...
<Image src={import('./_assets/dsbga-8-component-package-2d-pcb-footprint-birds-eye.png')} width="236px">A 2D birds-eye view of the CAD model for the DSBGA-8 component package.</Image>
