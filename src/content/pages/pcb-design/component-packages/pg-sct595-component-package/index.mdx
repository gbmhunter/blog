...
authors: [gbmhunter]
date: 2023-08-29
description: PG-SCT595 is a 5-lead gull-wing SMD component package used by Infineon.
...
<Image src={import('./_assets/pg-sct595-3d-render.png')} width="300px">A 3D render of the PG-SCT595 package[^digikey-tls105b0mbhtsa1-product-page].</Image>
...
<Image src={import('./_assets/pg-sct595-package-dimensions.png')} width="800px">The dimensions for the PG-SCT595 package[^infineon-bts3800sl-gate-driver-ds].</Image>

## Recommended Land Pattern

The below image shows the recommended land pattern and solder paste apertures:

<Image src={import('./_assets/pg-sct595-recommended-land-pattern.png')} width="700px">The recommended land pattern and solder paste apertures for the PG-SCT595 package[^infineon-pg-sct595-5-1].</Image>
