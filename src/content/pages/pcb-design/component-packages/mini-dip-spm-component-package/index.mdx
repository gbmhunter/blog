...
<tr>
  <td>Similar To</td>
  <td>[DIP](/pcb-design/component-packages/dip-component-package)</td>
</tr>
<tr>
<td>Mounting</td>
<td>TH</td>
...
<Image src={import('./_assets/mini-dip-spm-component-package-3d-render.png')} width="412px">A 3D render of the Mini-DIP SPM component package.</Image>
