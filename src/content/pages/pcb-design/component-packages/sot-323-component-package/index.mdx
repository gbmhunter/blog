...
authors: [gbmhunter]
date: 2014-11-09
description: SOT-323 is a family of SMD component packages with gull-wing leads on two sides. The most popular variant is the SOT-323-3 (SC-70-3) which is commonly used for transistors.
...
<Image src={import('./_assets/component-package-sot-323-3-3d-model.jpg')} width="200px">3D model of the SOT-323-3 (SC-70-3) component package.</Image>
...
<Image src={import('./_assets/sot323-3-dimensions-nxp.png')} width="800px">Dimensions for the SOT-323-3 (SC-70-3) component package from NXP[^nxp-sot-323].</Image>

### Recommend Land Pattern

<Image src={import('./_assets/sot-323-recommended-land-pattern-reflow-nxp.png')} width="800px">Recommended reflow land pattern for the SOT-323-3 (SC-70-3) component package from NXP[^nxp-sot-323].</Image>
...
<Image src={import('./_assets/component-package-sot-323-5-3d-model.jpg')} width="200px">3D model of the SOT-323-5 (SC-70-5) component package.</Image>
...
<Image src={import('./_assets/component-package-sot-323-5-dimensions-and-land-pattern.png')} width="800px">Dimensions and recommended land pattern for the SOT-323-5 (SC-70-5) component package.</Image>
...
<Image src={import('./_assets/sot-323-6-dimensions-and-land-pattern-analog-devices.png')} width="800px">Dimensions and recommended land pattern for the SOT-323-6 (SC-70-6) component package from Analog Devices[^analog-devices-sc6-package].</Image>
...
<Image src={import('./_assets/sc8-sot-223-8-package-dimensions-analog-devices.png')} width="900px">Dimensions of the SC8 (SOT-223-8) package from Analog Devices[^analog-devices-sc8-package].</Image>
