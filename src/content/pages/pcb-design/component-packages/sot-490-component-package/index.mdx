...
authors: [gbmhunter]
date: 2021-09-02
description: SOT-490 is a 3-lead SMD component package primarily used for transistors. It is similar to the SOT-416FL.
...
<Image src={import('./_assets/sc-89-3-3d-model-digikey.png')} width="250px">3D model of the SOD-490 (SC-89-3) component package. Retrieved 2021-09-02, from https://www.digikey.co.nz/en/products/detail/onsemi/NTE4153NT1G/687079.</Image>
...
The image below shows the dimensions of the SOT-490 package from Vishay.

<Image src={import('./_assets/sot-490-dimensions-vishay.png')} width="600px">Dimensions of the SOT-490 package from Vishay[^vishay-sot-490].</Image>
