...
authors: [gbmhunter]
date: 2015-04-05
description: SIP is a older through-hole component package with a single row of 2.54mm pitch pins. It was/is commonly used for resistor networks and RAM chips.
...
<Image src={import('./_assets/sip-component-package-photo.jpg')} width="385px">A photo of the SIP component package.</Image>
...
<Image src={import('./_assets/bourns-4300r-series-resistor-network-configurations.png')} width="800px">The different configurations available for the Bourns 4300R series resistor networks available in the SIP package[^bourns-4300r-resistor-networks-ds].</Image>
