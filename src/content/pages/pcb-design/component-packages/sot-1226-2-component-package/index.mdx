...
authors: [gbmhunter]
date: 2015-03-26
description: SOT-1226-2 is a SMD component package used by NXP with 8 leads and a pitch of 0.5mm.
...
<Image src={import('./_assets/sot-1226-component-package-3d-render-top-bottom.gif')} width="500px">A 3D render of the SOD-1226 component package. Image from http://www.nxp.com/packages/sot1226.html.</Image>

## Dimensions

Dimensions are 0.80x0.80x0.35mm.

<Image src={import('./_assets/sot-1226-component-package-dimensions.png')} width="481px">The dimensions of the SOT-1226 component package. Image from http://www.nxp.com/documents/outline_drawing/sot1226_po.pdf.</Image>

## Recommended Land Pattern/Footprint

<Image src={import('./_assets/sot-1226-component-package-recommended-footprint.png')} width="443px">The recommended footprint (land pattern) for the SOT-1226 component package.</Image>
