...
authors: [gbmhunter]
date: 2015-03-09
description: SMC (DO-214AB) is a 2-lead SMD component package commonly used for diodes. It is the largest package in the family containing SMA, SMB and SMC.
