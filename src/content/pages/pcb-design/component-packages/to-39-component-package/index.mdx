...
authors: [gbmhunter]
date: 2015-04-07
description: TO-39 is a family of metallic can packages used for hermetically sealing semiconductor devices.
...
<Image src={import('./_assets/to-39-component-package-photo.jpg')} width="300px">A photo of the TO-39-3 component package.</Image>
...
<Image src={import('./_assets/component-package-to-39-2-photo-with-window.jpg')} width="400px">A photo of the TO-39-2 component package.</Image>

## TO-39-3

<Image src={import('./_assets/component-package-to-39-3-dimensions.png')} width="400px">Dimensions for the TO-39-3 component package.</Image>

<Image src={import('./_assets/component-package-to-39-3-photo-with-window.jpg')} width="400px">A photo of a windowed component in the TO-39-3 component package.</Image>

<Image src={import('./_assets/component-package-to-39-pcb-land-pattern.png')} width="400px">An example of a PCB land pattern for the TO-39-3 component package.</Image>

## TO-39-4

<Image src={import('./_assets/component-package-to-39-4-dimensions.png')} width="400px">Dimensions for the TO-39-4 component package.</Image>

<Image src={import('./_assets/component-package-to-39-4-photo-with-window.jpg')} width="400px">A photo of a TO-39-4 component package with window.</Image>

<Image src={import('./_assets/component-package-to-39-mlx90614xci-dimensions.png')} width="400px">Package dimensions for the MLX90614XCI infrared thermometer. Image from melexis.com.</Image>

## TO-39 Ball Lens

Optan produces components which come in a TO-39 "Ball Lens" package.

<Image src={import('./_assets/to-39-ball-lens-component-package-optan-3d-render.png')} width="400px">A 3D render of the TO-39 \"Ball Lens\" package by Optan[^bib-optan-products]. Image © 2021, Crystal IS, Inc.</Image>
