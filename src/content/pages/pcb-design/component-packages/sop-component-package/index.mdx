...
tags: [electronics, component packages, PCB design, SOP, SOP-4, relays, DUB, SOP-8, Texas Instruments, solid-state relays, optocouplers]
...
The `SOP-4` is an easy to solder, medium sized, 4-pin SMD package. Commonly used for small [solid-state relays](/electronics/components/relays/solid-state/) (Vishay makes quite a few of them) and [optocouplers](/electronics/components/optical-isolators/). Related to `SOP-4L`, which is the same width, but longer.
