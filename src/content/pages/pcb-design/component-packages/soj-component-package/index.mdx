...
authors: [gbmhunter]
date: 2015-04-06
description: SOJ is a family of SMD component packages with J-type leads on two sides. It is commonly used to house ICs. It is related to the PLCC package which has J-type leads on all four sides.
...
* [Chip Carrier](/pcb-design/component-packages/chip-carrier-packages/): Another SMD package with J-type leads, but with leads on all four sides.
