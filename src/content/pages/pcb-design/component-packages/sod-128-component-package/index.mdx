...
authors: [gbmhunter]
date: 2015-04-06
description: SOD-128 is a 2 flat lead SMD component package used by a few manufacturers for diodes.
...
<Image src={import('./_assets/sod-128-component-package-3d-render.jpg')} width="150px"></Image>
...
<Image src={import('./_assets/sod-128-component-package-3d-render.jpg')} width="300">A 3D render of the SOD-128 component package.</Image>
...
<Image src={import('./_assets/sod128-package-outline.jpg')} width="900">The package outline for the SOD-128 component package.</Image>

## Recommended Land Pattern

<Image src={import('./_assets/sod128-recommended-land-pattern.jpg')} width="900">The recommended land pattern for the SOD-128 component package.</Image>
