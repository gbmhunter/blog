...
The `TO-204 AA` component package is a variant of the `TO-3` component package (a `TO-3-2L` with 1.0mm pins). See the [TO-3 Component Package page](/pcb-design/component-packages/to-3-component-package) for more information.