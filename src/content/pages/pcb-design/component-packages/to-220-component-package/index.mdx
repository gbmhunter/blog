...
<Image src={import('./_assets/to-220-7-analog-devices-t7-package-dimensions.png')} width="700px">Dimensions of the TO-220-7 (T7) package from Analog Devices[^bib-analog-devices-to-220-7].</Image>
...
<Image src={import('./_assets/power-integrations-to-220-7c-package-dimensions.png')} width="700px">Dimensions of the TO-220-7C package from Power Integrations[^bib-power-int-top254-258-ds].</Image>
