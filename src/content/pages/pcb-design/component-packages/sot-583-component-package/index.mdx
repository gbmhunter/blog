...
authors: [gbmhunter]
date: 2015-10-06
description: SOT-583 is an 8 flat lead SMD component package with a pitch of 0.5mm.
...
<Image src={import('./_assets/sot-583-component-package-3d-render-ti.png')} width="200px">A 3D render of the SOT-583 component package from Texas Instruments[^ti-tps628512-product-page].</Image>
...
<Image src={import('./_assets/sot-583-component-package-dimensions-ti.png')} width="500px">The dimensions of the SOT-583 component package from TI. Image from https://www.ti.com/lit/ml/mpcs002/mpcs002.pdf.</Image>

## Recommended Footprint

<Image src={import('./_assets/sot-583-component-package-recommended-footprint.png')} width="500px">The recommended footprint for the SOT-583 component package by TI. Image from https://www.ti.com/lit/ml/mpcs002/mpcs002.pdf.</Image>
