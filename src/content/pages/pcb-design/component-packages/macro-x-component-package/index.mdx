...
<Image src={import('./_assets/mrf581.png')} width="200px"></Image>
...
<Image src={import('./_assets/mrf581.png')} width="350px">Photo of the MRF581 RF NPN transistor in the Macro X component package.</Image>
