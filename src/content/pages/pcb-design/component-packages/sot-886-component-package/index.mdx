...
authors: [gbmhunter]
date: 2015-04-06
description: SOT-886 is a small 6-lead SMD component package commonly used for RFID tag chips, logic gates, buffer/line drivers and linear voltage regulators.
...
<Image src={import('./_assets/sot-886-component-package-3d-render.jpg')} width="200px">A 3D render of the SOT-886 component package.</Image>
...
<Image src={import('./_assets/sot-886-package-dimensions-nxp.png')} width="800px">The dimensions of the SOT-886 component package from NXP[^nxp-sot-886].</Image>
...
<Image src={import('./_assets/component-footprint-sot-886-land-pattern.png')} width="800px">The PCB land pattern for the SOT-886 component package from NXP[^nxp-sot-886].</Image>
