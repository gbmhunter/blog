...
authors: [gbmhunter]
date: 2015-11-11
description: SOT-89 is a family to two small SMD component packages with gull-wing leads and a central tab-shaped lead. The SOT-89-3 and the SOT-89-5 are the two variants.
...
<Image src={import('./_assets/sot-89-sc62-to-243-component-package-3d-render.jpg')} width="200px"></Image>
...
<Image src={import('./_assets/sot-89-3-package-dimensions-diodes-inc.png')} width="300px">Dimensions of the SOT-89-3 component package[^bib-diodes-sot89].</Image>
...
<Image src={import('./_assets/sot-89-sc62-to-243-component-package-3d-render.jpg')} width="296px">A 3D render of the SOT-89 (SC-62, TO-243) component package. Image from http://www.digikey.com/.</Image>

### Dimensions

<Image src={import('./_assets/sot-89-sc62-to-243-component-package-dimensions.jpg.png')} width="937px">The dimensions for the SOT-89-5 (SC-62, TO-243) component package.</Image>
