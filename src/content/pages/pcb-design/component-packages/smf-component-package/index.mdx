...
authors: [gbmhunter]
date: 2024-04-17
description: SMF (DO-219AB) is a 2-lead SMD package commonly used for diodes.
...
<Image src={import('./_assets/smf-package-3d-render-digikey.png')} width="150px">3D render of the SMF (DO-219AB) package from DigiKey[^digikey-smf24a-e3-08].</Image>
...
<Image src={import('./_assets/smf-do-219ab-package-dimensions-vishay.png')} width="900px">SMF (DO-219AB) package dimensions from Vishay[^vishay-bzd17-zener-diodes].</Image>
...
<Image src={import('./_assets/smf-do-219ab-recommended-land-pattern-vishay.png')} width="600px">Recommended land pattern for the SMF (DO-219AB) package from Vishay[^vishay-bzd17-zener-diodes].</Image>
