...
<Image src={import('./ims-pcb-aluminium-side-on-photo.png')} width="346px">A side on photo of a IMS PCB with an aluminium base.</Image>
...
<Image src={import('./ims-pcb-copper-clad-top-down-photo.png')} width="281px">Top-down photo of a IMS PCB for high-power LEDs.</Image>
...
<Image src={import('./example-stack-up-of-single-sided-single-layered-ims-pcb.png')} width="407px">An example stack-up of a single-sided, single-layered IMS PCB.</Image>
...
<Image src={import('./example-stack-up-of-single-sided-double-layered-ims-pcb.png')} width="388px">An example stack-up of a single-sided, double-layered IMS PCB.</Image>
