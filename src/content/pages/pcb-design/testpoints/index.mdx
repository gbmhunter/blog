...
<Image src={import('./_assets/pcb-untented-vias-as-test-points.jpg')} width="500px">Notice the untented vias on a PCB. These can be used as test-points in space-constrained designs.</Image>
...
<table>
  <tbody>
    <tr>
      <td><Image src={import('./_assets/keystone-minature-smd-testpoint.jpg')} width="200px">A minature SMD testpoint made by Keystone.</Image></td>
      <td>Keystone Miniature SMT Test Point</td>
      <td>Element14 Number: 385-8030</td>
    </tr>
    <tr>
      <td><Image src={import('./_assets/harwin-smt-test-point.jpg')} width="160px">Harwin SMT Test Point</Image></td>
...
## Test Points For Timing

Test points that are connected to a MCU or other programmable device can be used to measure the timing of specific parts of the firmware.

<Image src={import('./_assets/real-life-example-of-using-test-point-pulses-to-indicate-firmware-events.webp')} width="500px">A real-life example of using test point pulses to indicate firmware events. 2 short pulses indicate the first event, 3 short pulses indicate the second event.</Image>
