...
<Image src={import('./pcb-untented-vias-as-test-points.jpg')} width="500px">Notice the untented vias on a PCB. These can be used as test-points in space-constrained designs.</Image>
...
<Image src={import('./keystone-minature-smd-testpoint.jpg')} width="200px">A minature SMD testpoint made by Keystone.</Image>
</td>
...
<Image src={import('./harwin-smt-test-point.jpg')} width="160px">Harwin SMT Test Point</Image>
</td>
