...
<Image src={import('./ninja-calc-via-current-ipc-2221a-calculator-screenshot.png')} width="890px">A screenshot of the via current calculator (based of the IPC-2221A standard) in NinjaCalc.</Image>
