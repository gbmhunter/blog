...
<Image src={import('./hasl-pcb-surface-finish-example.jpg')} width="463px">An example of a PCB with a HASL surface finish. Image from http://www.pcbsourcing.com/.</Image>
...
<Image src={import('./example-of-immersion-tin-surface-finish-on-pcb.jpg')} width="890px">Example of an immersion tin (ISn) PCB surface finish. Image from http://www.standardpcb.com/.</Image>
...
<Image src={import('./pcb-surface-finish-immersion-silver.jpg')} width="600px">Example of an immersion silver (IAg) PCB finish. Image from http://www.rlcinnovation.com/.</Image>
...
<Image src={import('./example-of-immersion-gold-pcb-surface-finish.jpg')} width="1557px">Example of an immersion gold PCB surface finish. Image from http://www.standardpcb.com/.</Image>
