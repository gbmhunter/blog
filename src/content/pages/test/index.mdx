...
This should be a link to the second line: <IRef iref="eq-w-eq-y" />
...
<Image iref="wikipedia-colour-test-image" src={import('./_assets/wikipedia-colour-test-image.webp')} width="500"></Image>
