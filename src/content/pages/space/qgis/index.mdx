...
<Image src={import('./qgis-logo.png')} width="200px">The QGIS logo.</Image>
...
<Image src={import('./qgis-xyz-tiles-new-connection.png')} width="500px">Right-click on 'XYZ tiles' and then click on 'New Connection'.</Image>

Then add your desired XYZ tile server information:

<Image src={import('./qgis-xyz-tiles-google-tile-server.png')} width="500px">Adding the Google tile map service to QGIS.</Image>

To use this tile server, click on the newly added tile server and drag in down into the _Layers_ pane:

<Image src={import('./qgis-xyz-tiles-dragging-server-into-layers.png')} width="500px">Dragging the tile server into the Layers pane to display the basemap imagery.</Image>
