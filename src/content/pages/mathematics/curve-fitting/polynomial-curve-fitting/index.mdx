...
<Image src={import('./_assets/2-degree-poly-best-fit-graph.png')} width="600px">Four data points and a 2 degree polynomial of best fit (using the least squares method).</Image>
