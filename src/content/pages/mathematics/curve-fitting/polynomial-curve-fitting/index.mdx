...
<Image src={import('./many-polynomial-best-fits-on-graph.png')} width="605px">A graph showing how different degree polynomials can be fitted to data.</Image>
...
<Image src={import('./2-degree-poly-best-fit-graph.png')} width="600px">Four data points and a 2 degree polynomial of best fit (using the least squares method).</Image>
