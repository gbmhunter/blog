...
<Image src={import('./linear_curve_fitting_graph_of_points_and_line.png')} width="600px">The linear curve fitting (using the least squares approach) to four data points.</Image>
...
<Aside type="example" title="EXAMPLE: Find a line of best fit">
...
<Image src={import('./linear_curve_fitting_graph_of_points_and_line.png')} width="587px">The linear curve fitting (using the least squares approach) to four data points.</Image>
