...
<Image src={import('./_assets/normal-distribution-pdf-examples.png')} width="500px">A few example probability density functions (PDFs) for the normal distribution.</Image>
