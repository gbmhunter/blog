...
date: 2011-09-06
description: The wireless comms format, speed control, programming and more info on the electric skateboard firmware.
...
<Image src={import('./_assets/bit-bucket-logo.png')} width="320px">The BitBucket logo. Image from https://bitbucket.org/.</Image>
...
<Image src={"/images/electronics-electricskateboard/electric-skateboard-c-code-screenshot.png"} width="600px">Screenshot of the electric skateboard firmware, showing main.c.</Image>
