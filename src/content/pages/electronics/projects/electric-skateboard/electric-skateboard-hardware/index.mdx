...
I had a sneak peak around in the guts of this thing, and I discovered that it had four n-channel MOSFETs (STP75NF75x4) and four schottky diodes (NFA19) to make up the half-bridge. Both components were in the [TO-220AB](/pcb-design/component-packages/to-220-component-package/) package, and each all four of each were in series to increase the current capabilities.
