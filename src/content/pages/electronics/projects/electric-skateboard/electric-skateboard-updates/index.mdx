...
authors: [gbmhunter]
date: 2011-09-06
description: Updates on the electric skateboard project.
...
<Image src="/images/electronics-electricskateboard/skateboard-pcb-routing-almost-complete.jpg" width="500px">Screenshot of the nearly finished skateboard PCB routing (1 of 2 boards...).</Image>
...
<Image src={import('./_assets/psoc-5-cy8c5246ax1-054-microcontroller.png')} width="320px">A schematic drawing of the PSoC 5 CY8C5246AX1-054 microcontroller.</Image>
...
Fixed the Li-Po battery. Removed the dead cell and reconnected the remaining cells and terminals to make a 7 cell battery pack. It was quite hard to solder a bridge on the terminals, they are huge pieces of metal and solder which make good heatsinks, my soldering iron and mini blow torch had a hard time melting the solder.

**11/03/2011**

Nivens engineering is kindly cutting a 'D' into my motor shaft, so the cog can slide on, as well as drilling a hole for a grub screw to keep the cog in place (their idea, I was just going to rely on friction, but the experts said that's bad!)
...
<tbody >
<tr >
<td ><Image src="/images/electronics-electricskateboard-firstprototype/img_6210.jpg" width="160px">A supposedly '3kW' BLDC motor I got from Hobby King.</Image></td>
<td ><Image src="/images/electronics-electricskateboard-firstprototype/img_6216.jpg" width="160px">The BLDC motor mount, that attaches to only one end of the motor, since it is an outrunner.</Image></td>
<td ><Image src="/images/electronics-electricskateboard-firstprototype/img_6221.jpg" width="160px">A lithium-ion polymer battery from Hobby King.</Image></td>
</tr>
</tbody>
</table>
...
<Image src="/images/electronics-electricskateboard-firstprototype/sam_0125.jpg" width="320px">I made two Xbee breakout boards for prototyping, since they use the non-prototype friendly 2mm pitch connectors.</Image>
