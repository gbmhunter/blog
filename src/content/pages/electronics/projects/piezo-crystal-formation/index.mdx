...
tags: [electronics, project, piezo crystal]
...
<Image src={import('./_assets/2012-07-16-22-21-30.jpg')} width="500px">A large homemade piezo crystal.</Image>
...
<Image src={import('./_assets/2012-07-21-19-43-19.jpg')} width="500px">The simple setup to generate a measurable voltage from the piezo. The two tin pieces of tin foil where connected up to an oscilloscope.</Image>
...
<Image src={import('./_assets/2012-07-21-19-42-13.jpg')} width="500px">The voltage when giving the piezo a small whack from the end of a screw driver.</Image>
...
<Image src={import('./_assets/2012-07-21-19-42-57.jpg')} width="500px">The voltage created when giving the piezo a large whack from the back-end of the screw driver.</Image>
...
<Image src={import('./_assets/2012-07-21-19-50-19.jpg')} width="500px">The piezo crystal broke in two after one too many hits with the screw driver.</Image>

If you want more information about piezos and their use in electronics, see the [Piezo Speaker page](/electronics/components/piezoelectric-speakers/).
