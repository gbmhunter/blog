...
<Image src={import('./basic-switched-capacitor-circuit.png')} width="400">A basic switched-capacitor circuit.</Image>
...
<Image src={import('./phase-graph.png')} width="600">Plot showing the on/off sequencing for the switches in the above schematic.</Image>
