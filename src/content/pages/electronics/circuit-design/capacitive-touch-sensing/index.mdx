...
<Image src={import('./_assets/cap-sense-button-diagram-cypress.jpg')} width="395">How simple cap sense buttons work.</Image>
...
<Image src={import('./_assets/atmel-recommended-cap-button-shape.jpg')} width="430">A recommended cap button shape by Atmel. Image from atmel.com.</Image>
