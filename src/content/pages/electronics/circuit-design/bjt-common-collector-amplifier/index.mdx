...
<Image src={import('./common-collector-bjt-amplifier-basic-schematic.png')} width="400">The basic schematic of a common-collector BJT amplifier.</Image>
...
<Image src={import('./basic-common-collector-amplifier/plot-annotated.png')} width="800">$V_{out}$ vs. $V_{in}$ for a basic common-collector BJT amplifier.</Image>
...
<Image src={import('./common-collector-bjt-amplifier-ac-coupled-schematic.png')} width="600">Schematic of an AC-coupled common-collector NPN BJT amplifier.</Image>

The small-signal AC model for this circuit is shown below. DC voltage rails and capacitors are shorted.

<Image src={import('./common-collector-bjt-amplifier-ac-coupled-ac-equivalent-schematic.png')} width="600">Small-signal AC model for the AC-coupled common-collector BJT amplifier.</Image>
...
<Image src={import('./graph-from-kenneth-kuhn-cc-amplifier-design.png')} width="400">Just one example of a graph from Kenneth Kuhn's excellent Common-Collector Amplifier Design[^bib-kenneth-kuhn-common-collector-amp-design].</Image>
