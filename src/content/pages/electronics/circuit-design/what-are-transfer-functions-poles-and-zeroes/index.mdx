...
import PoleZeroExplorer from 'src/components/tools/pole-zero-explorer/PoleZeroExplorer.jsx';
...
The tool below lets you build a transfer function by dragging poles and zeroes around the s-plane, and see the resulting Bode plot (magnitude and phase) and time-domain response (step and impulse) update live. Try dragging the complex pole pair towards the imaginary axis to make the system more oscillatory, or into the right-half plane to make it unstable.

<PoleZeroExplorer client:load />
