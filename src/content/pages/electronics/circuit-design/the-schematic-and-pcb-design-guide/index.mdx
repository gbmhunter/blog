...
<Image src={import('./_assets/ray-gun-example-st-nucleo-l073rz.png')} width="500px">Example of 'ray guns'. Screenshot of the ST NUCLEO-L073RZ dev. board schematics[^st-nucleo-l073rz-sch].</Image>

### Add Decoupling Capacitors

As a rule-of-thumb, add 100nF [decoupling capacitors](/electronics/components/capacitors/#decoupling) to all IC power rails. If the IC's datasheet has specific decoupling advice, follow that instead.
...
The copper to copper and copper width clearance are usually the same value. This is commonly called the 'Track and Gap' clearance. **Typical Values:**
...
Typical copper to board-edge clearance : 0.3048mm (12 mil) This is the closest you can put copper to the board edge. This usually accommodates for slight board-misalignment and tool inaccuracies when routing the board into shape so that the router will not cut into the copper and leave 'exposed copper' ( a big no-no, usually). However, there are cases in which this rule is ignored, for example when you a making an RF shield or box from pieces of PCB, and need the copper to go right to the edge so that they can be soldered together into a box shape. This clearance is usually larger than the 'track and gap' clearance.
...
- Checking the PCB for any manufacturing problems and adjusting as necessary (e.g. removing soldermask slivers)
...
<Image src={import('./_assets/spherical-rubber-pcb-feet.jpg')} width="160px">A stick-on spherical rubber PCB foot.</Image>

Below is an example of an SMD standoff from [PEM Engineering](http://www.pemnet.com/).

<Image src={import('./_assets/reelfast-smd-standoff-example.jpg')} width="500px">An SMD standoff from PEM Engineering. Image from http://catalog.pemnet.com/viewitems/uts-and-spacers-standoffs-surface-mount-type-smtso/t-nuts-and-spacers-standoffs-br-type-smtso-unified.</Image>

### Desiccant

Desiccant (a moisture absorbing compound), can be a good thing to use if your PCB is at risk of condensation.

<Image src={import('./_assets/dessicant-on-oven-tray.jpg')} width="400px">Desiccant about to be dried on an oven tray.</Image>
...
This is an example of a PCB which I really like. It is called "[The Mojo](http://embeddedmicro.com/products/the-mojo)", and it is an Arduino-like FPGA development board. I love the black and green colour combination of the soldermask and silkscreen respectively.

<Image src={import('./_assets/the-mojo-fpga-pcb.jpg')} width="800px">'The Mojo', an Arduino-like FPGA development board that looks really nice. Image from http://embeddedmicro.com/products/the-mojo.</Image>

### Late Cycle Rework

"Late cycle rework" is the term given to PCB reworking done at the late stages, just before being sent off to the PCB manufacturer. Late cycle work is normally a bad thing, it is estimated that work done in this stage costs 10x as much as it does in the earlier stage.
...
<Image src={import('./_assets/qfn-footprint-failure-after-too-much-resoldering.jpg')} width="600px">The PCB was wrecked after doing too much re-soldering on a 0.5mm pitch QFN footprint.</Image>

### PCB Design Checklist

See the [PCB Design Checklist](/pcb-design/pcb-design-checklist/).

{/* =========================================================================================== */}
{/* REFERENCES */}
{/* =========================================================================================== */}

[^st-nucleo-l073rz-sch]: STMicroelectronics. _MB1136: NUCLEO-L073RZ Schematics_. Retrieved 2022-09-23, from https://www.st.com/resource/en/schematic_pack/mb1136-default-c03_schematic.pdf.
