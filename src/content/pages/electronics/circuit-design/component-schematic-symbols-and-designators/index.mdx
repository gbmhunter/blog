...
<Image src={import('./_assets/battery-symbol.svg')} width="200">The schematic symbol for a battery.</Image>
...
<div  style={symbolStyle}>
<Image src={import('./_assets/capacitor-symbol-unpolarized.svg')} width="200">The schematic symbol for a non-polarised capacitor.</Image>
<Image src={import('./_assets/capacitor-symbol-polarized.svg')} width="200">The schematic symbol for a polarised capacitor.</Image>
<Image src={import('./_assets/capacitor-symbol-variable.svg')} width="200">The schematic symbol for a variable capacitor.</Image>
</div>
...
<div  style={symbolStyle}>
<Image src={import('./_assets/diode-symbol-general-purpose.svg')} width="200">The recommended schematic symbol for an general purpose diode.</Image>
<Image src={import('./_assets/diode-symbol-zener.svg')} width="200">The recommended schematic symbol for an Zener diode.</Image>
<Image src={import('./_assets/diode-symbol-tvs-avalanche.svg')} width="200">The recommended schematic symbol for a unidirectional avalanche diode (including TVS diodes).</Image>
<Image src={import('./_assets/diode-symbol-led.svg')} width="200">The recommended schematic symbol for an LED.</Image>
</div>
...
<Image src={import('./_assets/fuse-symbol.svg')} width="200">Schematic symbol for a fuse.</Image>
...
<Image src={import('./_assets/ferrite-bead-symbol.svg')} width="200">The schematic symbol for a ferrite bead.</Image>
...
<Image src={import('./_assets/fiducial-symbol.svg')} width="200">The schematic symbol for a fiducial.</Image>
...
<div  style={symbolStyle}>
<Image src={import('./_assets/gdt-schematic-symbol-2-electrode.svg')} width="250">Schematic symbol and designator for a 2-electrode gas discharge tube (GDT).</Image>
<Image src={import('./_assets/gdt-schematic-symbol-3-electrode.svg')} width="250">Schematic symbol and designator for a 3-electrode gas discharge tube (GDT).</Image>
</div>
...
<div  style={symbolStyle}>
<Image src={import('./_assets/ground-symbol-signal.svg')} width="250">The schematic symbol for a signal (general) ground.</Image>
<Image src={import('./_assets/ground-symbol-earth.svg')} width="250">The schematic symbol for a earth ground.</Image>
<Image src={import('./_assets/ground-symbol-chassis.svg')} width="250">The schematic symbol for a chassis ground.</Image>
</div>

### Integrated Circuits (U)

`U` is the designator for integrated circuits. ICs include microcontrollers, liner voltage regulators, op-amps, etc.
...
<Image src={import('./_assets/integrated-circuit-schematic-symbol-u1.png')} width="200">Recommended schematic symbol for an integrated circuit (IC).</Image>
...
<div style={symbolStyle}>
<Image src={import('./_assets/resistor-schematic-symbol-r1.png')} width="250">The schematic symbol for a standard resistor.</Image>
<Image src={import('./_assets/variable-resistor-potentiometer-schematic-symbol.png')} width="250">The schematic symbol for a variable resistor (potentiometer).</Image>
</div>
...
<Image src={import('./_assets/spark-gap-schematic-symbol-triangular-200um-no-bom.png')} width="200">A schematic symbol for a spark gap. This spark gap is created with two triangles of copper on the PCB, with a gap of 200um between them. As this is made purely from the PCB, there is no BOM component needed.</Image>
...
Typically, `Q` is used for all transistors, no matter if they are BJTs, MOSFETs, JFETs, etc.
...
<Image src={import('./_assets/transistor-symbols.svg')} width="700">Schematic symbols for a variety of different transistor types. Showing the circle around the BJT or the body diode of the MOSFET is personal choice, however I do recommend showing the MOSFET body diode so you don't forget it's there when designing a circuit!</Image>
...
<Image src={import('./_assets/crystal-schematic-symbol.png')} width="200">The schematic symbol for a crystal.</Image>
...
<Image src={import('./_assets/varistor-symbol-mov.svg')} width="200">Schematic symbol for a varistor (e.g. MOV) (recommended).</Image>
