...
<Image src={import('./_assets/rc-low-pass-filter-frequency-response.png')} width="700">The frequency response (magnitude and phase) of a low-pass RC filter.</Image>
...
### Building A VDAC From An PWM Signal And Low-pass RC Filter
...
<Image src={import('./_assets/low-pass-lc-filter-schematic.svg')} width="550">A basic schematic of a low-pass LC filter.</Image>
...
<Image src={import('./_assets/low-pass-lc-filter-with-parasitics-schematic.png')} width="550">A schematic of a LC low-pass filter with parasitic inductor resistance included.</Image>
...
$f_c$ = -3dB cut-off frequency, in $Hz$<br/></p>
...
<Image src={import('./_assets/low-pass-vcvs-generic/low-pass-vcvs-generic.svg')} width="700">Schematic of a generic VCVS filter. Note how it is very similar to the Sallen-Key filter, except with the additional resistors R3 and R4 to set a voltage gain other than unity.</Image>
...
<Image src={import('./_assets/okawa-filter-design-and-analysis-homepage-screenshot.png')} width="700">Screenshot of the homepage for the OKAWA Filter Design and Analysis website. Image from [http://sim.okawa-denshi.jp/en/Fkeisan.htm](http://sim.okawa-denshi.jp/en/Fkeisan.htm), retrieved 2021-03-27.</Image>
