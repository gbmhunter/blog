...
1. Done! The finished schematic ready for simulating is shown in <IRef iref="fig-high-pass-sallen-key-fc2khz-q0.8-k4-schematic" />.

    <Image iref="fig-high-pass-sallen-key-fc2khz-q0.8-k4-schematic" src={import('./_assets/high-pass-sallen-key-fc2khz-q0.8-k4/schematic.png')} width="600">The simulation-ready schematic of our 2kHz high-pass Sallen-Key filter.</Image>
