...
<Image src={import('./_assets/edge-coupled-stripline-impedance-controlled-routing-diagram-with-dimensions.png')} width="800px">A cross-sectional diagram of a edge-coupled stripline, showing the common names for the dimensions.</Image>
