...
Use the calculator below to apply these equations directly. Enter the track width, copper thickness, substrate height and substrate dielectric constant — dimensions accept metric prefixes (e.g. `0.2mm`, `35um`, `1.6mm`).
