...
import MicrostripImpedance from 'src/components/calculators/microstrip-impedance/MicrostripImpedance.jsx';
...
Use the calculator below to apply these equations directly. Enter the track width, copper thickness, substrate height and substrate dielectric constant, picking the units for each dimension from the dropdowns.

<MicrostripImpedance client:load />
