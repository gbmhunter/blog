...
<Image iref="fig-propagation-of-electrical-signal-down-wire" src={import('./_assets/propagation-of-electrical-signal-down-wire.webp')} width="400px">The propagation of an electrical signal down a wire.</Image>
