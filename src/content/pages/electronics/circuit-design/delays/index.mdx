...
BBDs usually have quite a number of buckets in them! Common sizes include 256, 512, 1024, 2048, and 4096 buckets per chip[^gerlt-technologies-bbds]. Because they were designed for audio, delays ranged from about 5 ms to 200 ms. Delays longer than this can be achieved by chaining multiple BBDs together.
