...
* Version: `12.2.0.5`
* Full CD: [mc12cd.zip (58MB)](https://files.mbedded.ninja/misc/how-to-use-micro-cap/micro-cap-12-installer/mc12cd.zip)
* Executable only: [mc12.zip (16MB)](https://files.mbedded.ninja/misc/how-to-use-micro-cap/micro-cap-12-installer/mc12.zip)
* Date: 2021-06-17
* User's Guide: [ug12.pdf (15MB)](https://files.mbedded.ninja/misc/how-to-use-micro-cap/micro-cap-12-installer/ug12.pdf)
* Reference Guide: [rm12.pdf (15MB)](https://files.mbedded.ninja/misc/how-to-use-micro-cap/micro-cap-12-installer/rm12.pdf)
* Brochure: [mc12_brochure.pdf (6.2MB)](/misc/how-to-use-micro-cap/micro-cap-12-installer/mc12_brochure.pdf)
...
<Image src={import('./1-bit-digital-stimulus-sim/1-bit-digital-stimulus-config.png')} width="800px">Screenshot showing how to configure a 1-bit digital stimulus.</Image>

The above settings gives the following waveform if we perform a transient analysis:

<Image src={import('./1-bit-digital-stimulus-sim/transient-analysis.png')} width="900px">Transient analysis for the 1-bit digital stimulus.</Image>
...
<Image src={import('./jk-flipflop-nand-sim/schematic.png')} width="600px">The simulation schematic for the JK flip-flop.</Image>
...
<Image src={import('./jk-flipflop-nand-sim/transient-analysis-without-initial-conditions.png')} width="900px">Simulation results without specifying initial conditions. The outputs get stuck in an indeterminate state forever.</Image>
...
<Image src={import('./jk-flipflop-nand-sim/initial-conditions.png')} width="400px">The initial conditions specified for the JK flip-flop simulation.</Image>

Now the outputs start in a determinate state, and the simulation works as expected:

<Image src={import('./jk-flipflop-nand-sim/transient-analysis-with-initial-conditions.png')} width="900px">Simulation with initial conditions.</Image>
