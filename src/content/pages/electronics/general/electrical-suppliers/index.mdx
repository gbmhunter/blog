...
<Image src={import('./avnet-logo.gif')} width="100px"></Image>
...
<Image src={import('./digi-key-logo.jpg')} width="100">The Digi-Key logo.</Image>
...
<Image src={import('./digi-key-automatic-bom-uploading-please-wait.png')} width="320px"></Image>

<Image src={import('./digi-key-automatic-bom-uploading-selecting-excel-columns.png')} width="700px"></Image>
...
<Image src={import('./element-14-logo.jpg')} width="100px"></Image>
...
<Image src={import('./lcsc-logo.png')} width="200px">The LCSC logo.</Image>
...
<Image src={import('./mouser-logo.jpg')} width="100">The Mouser logo.</Image>
...
<Image src={import('./rs-components-logo.jpg')} width="100">The RS Components logo.</Image>
...
<Image src={import('./alibaba-logo.jpg')} width="100px">The Alibaba logo.</Image>
...
<Image src={import('./aliexpress-logo.jpg')} width="100px">The AliExpress logo.</Image>
...
<Image src={import('./st-estore-free-samples.png')} width="500">The ST eStore provides free samples for some of their parts, for example, the A6986ITR isolated buck converter[^bib-st-estore-free-samples].</Image>
...
<Image src={import('./microchip-direct-logo.png')} width="300px">Microchip Direct's logo.[^bib-microchip-direct-home-page]</Image>
...
<Image src={import('./pcb-cart-logo.jpg')} width="100">The PCB Cart logo.</Image>
...
<Image src={import('./jlc-pcb-logo.png')} width="400">The logo for JLC PCB. Image from https://www.crunchbase.com/organization/jlcpcb, retrieved 2021-03-03.</Image>
...
<Image src={import('./pcb-zone-logo.jpg')} width="100">The PCB Zone logo.</Image>
...
<Image src={import('./imp-logo.gif')} width="100">The IMP logo.</Image>
