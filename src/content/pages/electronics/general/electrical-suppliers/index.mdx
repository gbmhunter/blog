...
<Image src={import('./_assets/avnet-logo.gif')} width="100px" />
...
<Image src={import('./_assets/digi-key-logo.jpg')} width="100px">The Digi-Key logo.</Image>
...
Their pricing is usually a little expensive for one-off components, but they are by far the cheapest if you buy in large quantities. I definitely recommend using Digi-Key if you are taking a circuit into production.
...
<Image src={import('./_assets/digi-key-automatic-bom-uploading-please-wait.png')} width="320px" />

<Image src={import('./_assets/digi-key-automatic-bom-uploading-selecting-excel-columns.png')} width="700px" />
...
<Image src={import('./_assets/element-14-logo.jpg')} width="100px" />
...
International online component store that stocks most electrical components. In my opinion they have a nicer online layout than RS, and an easier to use search engine. Formerly called Farnell. Element14 had free shipping (in New Zealand) for while in 2010-2011, and offered over-night delivery speeds from Sydney! As of 2022 this delivery time is now many days, and free shipping is only offered on orders of NZ\$45 or more.

### LCSC

<Image src={import('./_assets/lcsc-logo.png')} width="200px">The LCSC logo.</Image>
...
<Image src={import('./_assets/mouser-logo.jpg')} width="100px">The Mouser logo.</Image>
...
<Image src={import('./_assets/rs-components-logo.jpg')} width="100px">The RS Components logo.</Image>
...
<Image src={import('./_assets/alibaba-logo.jpg')} width="100px">The Alibaba logo.</Image>
...
Alibaba is a huge international trading site that offers goods at wholesale prices (if you're prepared to buy in quantity). Prices are sometimes listed, but it is normally up to you to contact the seller and organise prices/quantities. Normally you can buy direct from manufacturers, offering very good deals!

### AliExpress

<Image src={import('./_assets/aliexpress-logo.jpg')} width="100px">The AliExpress logo.</Image>
...
<Image src={import('./_assets/st-estore-free-samples.png')} width="500px">The ST eStore provides free samples for some of their parts, for example, the A6986ITR isolated buck converter[^bib-st-estore-free-samples].</Image>
...
<Image src={import('./_assets/microchip-direct-logo.png')} width="300px">Microchip Direct's logo.[^bib-microchip-direct-home-page]</Image>
...
<Aside type="caution">
The displayed available stock of a part on Microchip Direct does not drop as orders are made, and nor is the shown lead time that accurate. Instead, a manual review process is done in the 24-48 hours after an order is made, and someone decides if they can fulfil your order. At that point you are sent another email with a confirmed dispatch date. It feels like a poor way to do business!
</Aside>
...
<Image src={import('./_assets/deal-extreme-logo.png')} width="100px">The Deal Extreme logo.</Image>
...
<Image src={import('./_assets/mind-kits-logo.png')} width="100px">The Mind Kits logo.</Image>
...
<Image src={import('./_assets/jaycar-logo.jpg')} width="100px">The Jaycar logo.</Image>
...
<Image src={import('./_assets/pcb-cart-logo.jpg')} width="100px">The PCB Cart logo.</Image>
...
* Based In: China
* Supplied Locations: International
* Notes: Cheap supplier for boards, but they do take a while to manufacture. Offers extensive features and a nice web ordering interface with on-the-spot quotes.

**Stack-ups:** Here is one of their default 4-layer, 2-core, 1.6mm thick stack-ups.

<Image src={import('./_assets/pcb-cart-4-layer-1-6mm-layer-stackup.jpg')} width="400px">A PCB Cart default 4-layer, 2-core, 1.6mm thick stack-up.</Image>

Here is a similar 4-layer, 1.6mm thick PCB stack-up, except with only one core.

<Image src={import('./_assets/pcb-cart-4-layer-1-core-1-6mm-layer-stackup.jpg')} width="400px">A PCB Cart 4-layer, 1-core, 1.6mm thick stack-up.</Image>

### JLC PCB

<Image src={import('./_assets/jlc-pcb-logo.png')} width="400px">The logo for JLC PCB. Image from https://www.crunchbase.com/organization/jlcpcb, retrieved 2021-03-03.</Image>

* Website: https://jlcpcb.com/
* Instant Quote: Yes
* Based In: China

JLC PCB is (and I quote from their website) "China's Largest PCB Prototype Manufacturer". I believe them on this, they are an absolutely huge PCB fabrication house in China, and offer a very streamlined, fast and cheap PCB manufacturing service for "standard" PCB designs. Pricing can be laughably cheap for 2-layer/4-layer boards (e.g. only US\$5 for a 4-layer PCB!), as long as you don't have any non-standard manufacturing requirements.

JLC PCB supports a single sign-on/account across JLC PCB, EasyEDA and LCSC.

They also offer an assembly service backed by a large amount of component stock. They primarily get these components from their sister compancy LCSC.

<Image src={import('./_assets/jlc-pcb-component-stock-screenshot.webp')} width="700px">A screenshot of the JLC PCB component stock page, showing the large amount of components they have in stock for assembly services.</Image>
...
<Image src={import('./_assets/pcb-zone-logo.jpg')} width="100px">The PCB Zone logo.</Image>
...
<Image src={import('./_assets/imp-logo.gif')} width="100px">The IMP logo.</Image>
...
<Image src={import('./_assets/circuit-labs-logo.jpg')} width="100px">The Circuit Labs logo.</Image>
...
See the [OLED Screens page](/electronics/components/displays/oled-screens/).
