...
<Image src={import('./_assets/altium-library-search-with-asterisk.jpg')} width="800px">Searching an Alitum component library with an asterisk.</Image>
...
<Image src={import('./_assets/altium-polygon-clearance-rule.jpg')} width="970px">The 'Polygon Clearance' rule in Alitum. Make sure you use 'InPolygon' and not 'IsPolygon'.</Image>
...
<Image src={import('./_assets/altium-schematic-symbol-pin-properties-highlighting-hidden-pin-connect-to.png')} width="486px">The 'Pin Properties' window in the Altium schematic symbol library editor. The 'Hide' and 'Connect To' fields give the allusion you can hide a pin and connect it to another, visible pin.</Image>
