...
<Image src={import('./altium-selecting-bom-configure-in-outjob.png')} width="449px">Getting to the BOM configuration window from an Outjob in Altium.</Image>

...there is an option to provide an Excel template file.

<Image src={import('./altium-bom-configure-excel-template-field.png')} width="459px">The field in the BOM configuration window that allows you to specify a Excel template file.</Image>
