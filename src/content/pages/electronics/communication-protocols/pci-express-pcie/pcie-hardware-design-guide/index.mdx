...
<Image src={import('./pcie-edge-connector-schematic-symbol-and-example-design.png')} width="997">A PCIe card-edge connector schematic symbol and associated components.</Image>
