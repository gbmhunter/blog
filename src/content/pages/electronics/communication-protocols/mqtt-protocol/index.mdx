...
<Image src={import('./_assets/mqtt-logo.png')} width="500">The MQTT logo. Image from https://www.eclipse.org/paho/, acquired 2021-03-30.</Image>
...
MQTT uses a topic-based system for sending and receiving messages. A topic is a string that clients and publish on and subscribe to. Topics are hierarchical and can contain multiple levels separated by forward slashes. For example, `home/bedroom/temperature` is a topic with three levels.
...
<Image src={import('./_assets/mqtt-sn-architecture.png')} width="600">High-level diagram of the MQTT-SN architecture[^bib-oasis-open-mqtt-protocol-spec-v1.2].</Image>
