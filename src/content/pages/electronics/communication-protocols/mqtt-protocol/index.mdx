...
<IRef ref="mqtt-sn-architecture" /> shows the high-level MQTT-SN architecture, and how MQTT-SN clients talk to a standard MQTT broker.

<Image ref="mqtt-sn-architecture" src={import('./_assets/mqtt-sn-architecture.png')} width="600">High-level diagram of the MQTT-SN architecture[^bib-oasis-open-mqtt-protocol-spec-v1.2].</Image>
