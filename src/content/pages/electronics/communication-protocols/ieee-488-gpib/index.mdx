...
488.2 standardised the syntax and a set of common commands, but not the commands that actually drive a measurement — those were still manufacturer-specific. [SCPI](/electronics/communication-protocols/scpi/) was released in 1990 to close that gap, layering a standard instrument-class command tree on top of 488.2. Unlike 488.2, SCPI does not mandate a transport, and today it is used over USB, Ethernet and RS-232 far more often than over GPIB itself.
