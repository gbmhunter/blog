...
The WCH CH340 is a family of popular USB to UART ICs. It supports USB 2.0 and serial baud rates from 50 bps to 2 Mbps.[^wch-usb-to-serial-port-chip-ch340-ds]
