...
<tbody>
  <tr>
    <td>Logo</td>
    <td><Image src={import('./_assets/lonmark-international-logo-certified.jpg')} width="200"></Image></td>
  </tr>
  <tr>
    <td>Speed</td>
    <td>
...
<Image src={import('./_assets/ft-5000-smart-transceiver-cip-block-diagram.png')} width="392">The block diagram for the FT5000 'Smart Transceiver' IC which can be used as part of a LON node.</Image>
...
<Image src={import('./_assets/ft500-ft-x3-connection-diagram.png')} width="518">A connection diagram between the FT5000 processor and the FT-X3 transformer.</Image>
...
<Image src={import('./_assets/ft5000-typical-operating-conditions.png')} width="325">The typical operating conditions of the FT5000 processor.</Image>
...
<Image src={import('./_assets/ft5000-allowed-external-memory-configurations.png')} width="270">The permitted external memory configurations for the FT5000 processor.</Image>
...
BROKEN: On http://localhost:3000/electronics/communication-protocols/lon-ansi709-2-communication-protocol/, url: http://localhost:3000/electronics/communication-protocols/lon-ansi709-2-communication-protocol/_assets/LonWorks-Host-Application-Programmers-Guide-Revision-2.pdf, reason: Not Found (404)
