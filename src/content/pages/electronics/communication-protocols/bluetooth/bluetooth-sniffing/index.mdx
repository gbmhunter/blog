...
<Image src={import('./_assets/nrf52840-dongle-photo-of-device-and-bag.webp')} width="600px">A photo of the Nordic Semiconductor nRF52840 Dongle and its packaging. The nRF52840 Dongle is a small USB device that can be used for Bluetooth sniffing when programmed with the appropriate firmware.</Image>
