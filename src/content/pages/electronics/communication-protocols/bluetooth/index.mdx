...
tags: [communication protocol, Bluetooth, mesh, network, Bluetooth 4.0, hops, flooding, packets, messages, encryption, latencies, Silicon Labs, nodes, routing, Bluetooth SIG, Coded PHY, long range, 1M PHY, 2M PHY, frequency shift keying, FSK, GFSK]
title: Bluetooth
type: page
---
...
LE Coded PHY support is optional, and as of August 2025 support on smartphones is limited.[^novel-bits-coded-phy-bluetooths-long-range-feature]
