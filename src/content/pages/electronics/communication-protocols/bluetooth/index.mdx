...
<Aside type="note">
Nordic's RX and TX characteristics are labelled with respect to the Bluetooth peripheral. In other words, the RX characteristic is the characteristic that peripheral receives data from (i.e. and so the central device writes to this).
</Aside>
...
- Service UUID: `2456e1b926e28f83e744f34f01e9d701`
- Data Characteristic (FIFO) UUID: `2456e1b926e28f83e744f34f01e9d703` (properties: "indicate", "notify", "write", "write without response")
- Credits Characteristic UUID: `2456e1b926e28f83e744f34f01e9d704` (properties: "indicate", "notify", "write", "write without response")
...
- Data Characteristic UUID: `fec26ec4-6d71-4442-9f81-55bc21d658d6` (properties: "notify", "write no response")
