...
tags: [electronics, communication protocols, SPI, bit-banging, MOSI, MISO, peripherals, microcontrollers, MCP4131, Arduino, controller, peripheral, master, slave, OSHWA, execute-in-place, XIP, WS2812, RGB, low power]
...
<Image src={import('./_assets/spi-basic-master-slave-diagram.webp')} width="600">The basic connections needed between an SPI master and a single SPI slave.</Image>
...
<Image src={import('./_assets/microchip-sam-d21-spi-transfer-modes-table.png')} width="800">Screenshot of the SPI modes table from the Microchip SAM D21 datasheet.[^microchip-samd21-datasheet]</Image>
...
<Image src={import('./_assets/fxos8700cq-freescale-magnetometer-note-supports-only-point-to-point-spi-protocol.png')} width="745">The note from the Freescale FXOS8700CQ magnetometer stating that it only supports the 'point-to-point' SPI protocol.[^nxp-fxos8700cq-ds]</Image>
...
<Image src={import('./_assets/microchip-mcp41x1-dpot-spi-connections.png')} width="600">Schematics from the MCP4XXX DPOT datasheet showing to connect the shared MOSI/MISO pin (called SDI/SDO) to a SPI bus and SPI host.[^microchip-mcp4xxxx-dpot-ds]</Image>
...
<Image src={import('./_assets/infineon-s25fs128s-qspi-flash-connection-diagram.png')} width="500">Wiring diagram for the Infineon S25FS128S QSPI flash IC.[^infineon-s25fs128s-ds]</Image>
...
<Image src={import('./_assets/ws2812b-comms-protocol-info.webp')} width="900">Data showing how the WS2812 RGB LED communication protocol relies of the timings of HIGH and LOW parts of a bit to determine a 0 or 1.[^worldsemi-ws2812b-rgb-led-ds]</Image>
