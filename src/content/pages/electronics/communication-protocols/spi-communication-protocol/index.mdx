...
<Image src={import('./_assets/microchip-sam-d21-spi-transfer-modes-table.png')} width="800">Screenshot of the SPI modes table from the Microchip SAM D21 datasheet[^bib-microchip-samd21-datasheet].</Image>
...
<Image src={import('./_assets/fxos8700cq-freescale-magnetometer-note-supports-only-point-to-point-spi-protocol.png')} width="745">The note from the Freescale FXOS8700CQ magnetometer stating that it only supports the 'point-to-point' SPI protocol[^bib-nxp-fxos8700cq-ds].</Image>
...
<Image src={import('./_assets/microchip-mcp41x1-dpot-spi-connections.png')} width="600">Schematics from the MCP4XXX DPOT datasheet showing to connect the shared MOSI/MISO pin (called SDI/SDO) to a SPI bus and SPI host[^bib-microchip-mcp4xxxx-dpot-ds].</Image>
...
<Image src={import('./_assets/infineon-s25fs128s-qspi-flash-connection-diagram.png')} width="500">Wiring diagram for the Infineon S25FS128S QSPI flash IC[^bib-infineon-s25fs128s-ds].</Image>
