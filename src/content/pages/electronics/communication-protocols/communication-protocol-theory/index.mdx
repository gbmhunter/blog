...
authors: [gbmhunter]
date: 2017-08-30
description: Bus topologies, point-to-point, multi-drop, multipoint, and more about communication bus topologies.
...
A multi-drop communication bus has **one driver, many receivers**. RS-485 is an example of a communication protocol which supports a multi-drop topology.
