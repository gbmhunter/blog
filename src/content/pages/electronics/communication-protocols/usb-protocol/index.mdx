...
<Image src={import('./_assets/usb-adp-architecture-vbus-and-current-sources.png')} width="786px">The ADP architecture, showing Vbus, current sources, and the snesing logic. Image from On-The-Go and Embedded Host Supplement to the USB Revision 2.0 Specification: Revision 2.0 version 1.1a.</Image>
