...
<Image src={import('./_assets/1-wire-ic-schematic-ds18b20-high-zoom-logo.png')} width="181">A high-zoom schematic screenshot of the DS18B20, a Maxim 1-wire temperature sensor.</Image>
...
<Image src={import('./_assets/ds18b20-temp-sensor-functional-block-diagram-showing-one-wire-interface.png')} width="475">The functional block diagram of the DS18B20 temperature sensor, showing the 1-wire interface circuitry. Image from www.maximintegrated.com.</Image>
...
<Image src={import('./_assets/1-wire-bus-example-showing-sequence-detection-with-ds28ea00.png')} width="702">An example of a 1-wire bus with the DS28EA00 ICs, which support sequence detection. Image from www.maximintegrated.com.</Image>
