...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td rowspan="2">802.3cg</td> {/* Standard */}
            <td>10BASE-T1S</td> 
        ...
        <tr>
            ...
            <td rowspan="2">802.3bw</td> {/* Standard */}
        ...
        <tr>
          ...
          <td rowspan="2">802.3bp</td> {/* Standard (1)*/}
        ...
        <tr>
          ...
          <td rowspan="3">802.3ch</ td> {/* Standard (1) */}
...
For convenience, the standard allows the DC voltage to applied in either direction by the power source. This means that the receiver requires a rectifier (or similar) to support reverse polarity.[^electric-ui-deep-dive-single-pair-ethernet]
