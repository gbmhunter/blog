...
<table iref="lpwan-standards-comparison">
<thead>
<tr>
<th>Parameter</th>
<th>LTE Cat M1</th>
...
<tbody> 
<tr>
<td>Device Receive Bandwidth</td> {/* Parameter */}
<td>1.4 MHz</td> {/* LTE Cat M1 */}
<td>5 MHz</td> {/* LTE Cat M2 */}
<td>180 kHz</td> {/* LTE Cat NB1 */}
<td>180 kHz</td> {/* LTE Cat NB2 */}
</tr>
<tr>
<td>Peak downlink data rate</td> {/* Parameter */}
<td>1 Mbps</td> {/* LTE Cat M1 */}
<td>4 Mbps</td> {/* LTE Cat M2 */}
<td>26 kbps</td> {/* LTE Cat NB1 */}
<td>127 kbps</td> {/* LTE Cat NB2 */}
</tr>
<tr>
<td>Peak uplink data rate</td> {/* Parameter */}
<td>1 Mbps</td> {/* LTE Cat M1 */}
<td>7 Mbps</td> {/* LTE Cat M2 */}
<td>62 kbps</td> {/* LTE Cat NB1 */}
<td>159 kbps</td> {/* LTE Cat NB2 */}
</tr>
<tr>
<td>Latency</td> {/* Parameter */}
<td>10-15 ms</td> {/* LTE Cat M1 */}
<td>10-15 ms</td> {/* LTE Cat M2 */}
<td>1.6-10 s</td> {/* LTE Cat NB1 */}
<td>1.6-10 s</td> {/* LTE Cat NB2 */}
</tr>
<tr>
<td>Device transmit power</td> {/* Parameter */}
<td>20, 23 dBm</td> {/* LTE Cat M1 */}
<td>20, 23 dBm</td> {/* LTE Cat M2 */}
<td>20, 23 dBm</td> {/* LTE Cat NB1 */}
<td>14, 20, 23 dBm</td> {/* LTE Cat NB2 */}
</tr>
</tbody>
<caption>
...
**ldldld**
Comparison of LTE Cat-M1/M2 and Cat NB1/NB2 (NB-IoT) features[^wikipedia-narrowband-iot].
...
<Table data={
  ...
  transpose={{
    'enable': false,
    'headerKey': 'Standard',
    'topLeftCellText': 'Parameter',
  }}
>
  <p slot="caption">Comparison of LTE Cat-M1/M2 and Cat NB1/NB2 (NB-IoT) features[^wikipedia-narrowband-iot].</p>
</Table>
...
eDRX also allows for further power savings.
