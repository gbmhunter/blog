...
LTE (Long Term Evolution) is a term used to describe the fourth generation (4G) cellular networks designed to replace 3G. LTE Cat-M1 and NB-IoT are two variants of LTE designed for IoT devices. Even though they were introduced as part of 4G, both LTE Cat-M and NB-IoT will continue to evolve with newer 5G standards.

The table below compares some of the key metrics across many of the popular LPWAN standards.
...
A typical LTE cell site can support 10x as many Cat-M1 devices compared to regular LTE devices[^twilio-lte-cat-m-for-iot-devices]. This makes it ideal from the cellular provider's perspective for IoT devices that are densely deployed.

### Coverage

Cat-M1 is not as widely deployed as regular LTE. However, as of 2024 it has good coverage in many countries. The map below shows the coverage of LTE-M and NB-IoT across the globe.

<Image src={import('./_assets/gsma-mobile-iot-deployment-map.webp')} width="800px">A world map showing where LTE-M and NB-IoT networks have been deployed[^gsma-mobile-iot-deployment-map].</Image>
...
- eDRX cycle (amount of time the device is unreachable for in each cycle) up to ~44 mins
...
<Image src={import('./_assets/nrf9160-sip-photo.webp')} width="300px">A close-up photo of the nRF9160 SiP from Nordic Semiconductor[^nordic-nrf9160].</Image>
...
The table below compares some of the key metrics of the two NB-IoT standards.
...
<Table
  data={
    [
      ...
      {
        "Feature": "Max. downlink data rate",
        "LTE Cat NB1": "26 kbps",
        "LTE Cat NB2": "80/127 kbps (1HARQ/2HARQ)",
      },
      {
        "Feature": "Max. uplink data rate",
        "LTE Cat NB1": "62 kbps",
        "LTE Cat NB2": "105/159 kbps (1HARQ/2HARQ)",
      },
      {
        "Feature": "Positioning",
        "LTE Cat NB1": "Cell ID",
        "LTE Cat NB2": "OTDOA, E-CID",
      },
      {
        "Feature": "Max. transmission power",
        "LTE Cat NB1": "20, 23 dBm",
        "LTE Cat NB2": "14, 20, 23 dBm",
      }
    ]
  }
>
  <caption slot="caption">Comparison of LTE Cat NB1 and LTE Cat NB2 features.</caption>
</Table>
...
Wide band cellular [antennas](/electronics/components/antennas/) are designed to work with the wide range of frequencies used by cellular networks. A common range supported is from about 600-800MHz up to 5G (5GHz).
...
- LTE-M
- NB-IoT
- 433 MHz, 868 MHz, and 915 MHz [LPWA](/electronics/communication-protocols/sub-ghz-ism-bands/)

It is a ground-plane independent dipole antenna so it can be mounted on metallic and non-metallic surfaces.

<Image src={import('./_assets/linx-technologies-ant-5gw-sps1-series-panel-mount-cellular-antenna.webp')} width="300px">A panel mount antenna from Linx Technologies.[^linx-technologies-ant-5gw-sps1-series-ds]</Image>

The image below shows the band (frequency) specifications for the Linx Technologies ANT-5GW-SPS1 Series antenna.

<Image src={import('./_assets/linx-technologies-ant-5gw-sps1-series-band-specs.webp')} width="1000px">The band specifications for the Linx Technologies ANT-5GW-SPS1 Series antenna.[^linx-technologies-ant-5gw-sps1-series-ds]</Image>
...
[^linx-technologies-ant-5gw-sps1-series-ds]: Linx Technologies. _ANT-5GW-SPS1 SERIES - Panel Mount 5G/LTE Antenna_ [datasheet]. Retrieved 2025-06-09, from https://www.te.com/commerce/DocumentDelivery/DDEController?Action=srchrtrv&DocNm=ANT-5GW-SPS1_SERIES&DocType=Data+Sheet&DocLang=English&DocFormat=pdf&PartCntxt=ANT-5GW-SPS1-1.