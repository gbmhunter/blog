...
<Image src={import('./_assets/op-amp-basic-schematic-symbol.svg')} width="500px">The basic schematic symbol for an op-amp.</Image>
...
<Image src={import('./_assets/op-amp-schematic-voltage-follower-buffer.svg')} width="500px">An op-amp configured as a voltage follower (aka buffer).</Image>
...
<Image src={import('./_assets/op-amp-current-sink-schematic.png')} width="500px">Schematic of an op-amp based current sink. See [Current Sources And Sinks: Op-amp Current Sink](/docs/electronics/components/current-sources-and-sinks/index.mdx#op-amp-current-sink) for more info.</Image>
...
<Image src={import('./_assets/summing-amplifier-non-inverting.svg')} width="500px">A non-inverting summing amplifier with three inputs.</Image>
...
<Image src={import('./_assets/ideal-diode-basic.svg')} width="600px">A basic ideal diode circuit.</Image>
...
<Image src={import('./_assets/ideal-diode-improved-inverting.svg')} width="700px">An improved ideal diode/half-wave rectifier.</Image>
...
<Image src={import('./_assets/sample-and-hold.svg')} width="600px">Basic op-amp based sample-and-hold circuit.</Image>
...
<Image src={import('./_assets/standard-8-pin-dual-op-amp-pinout.svg')} width="400px">The standard pinout for two op-amps in an 8-pin package. This includes the DIP-8, TSSOP-8, SOIC-8 and MSOP-8 component packages.</Image>
