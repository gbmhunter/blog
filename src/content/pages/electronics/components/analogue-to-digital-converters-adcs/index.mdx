...
<Image src={import('./_assets/adc-symbol-analogue-to-digital.webp')} width="500">A symbol representing a analogue-to-digital converter (ADC).</Image>
