...
\begin{align}
V_{GS} &= V_{GS(off)} \left[ 1 - (\frac{I_D}{I_{DSS}})^{1/k} \right] \nonumber \\
       &= -6.0\unit{V} \left[ 1 - (\frac{1.0\unit{mA}}{3.0\unit{mA}})^{1/2} \right] \nonumber \\
       &= -2.54\unit{V}
\end{align}
$$
...
1. As the op-amp raises the voltage on its output, this is connected to the gate of the MOSFET, which will begin to turn it on.
...
<Image src={import('./_assets/lt1492-voltage-controlled-current-sink.png')} width="500">A schematic showing gate capacitance compensation circuitry on a op-amp based current sink using the LT1492[^linear-lt1492-ds].</Image>
...
[^vishay-an103-jfet-constant-current-source]:  Siliconix (now Vishay) (1997, Mar 10). _AN103: The FET Constant-Current Source/Limiter_. Retrieved 2021-04-29, from https://www.vishay.com/docs/70596/70596.pdf.
...
[^onsemi-2n5457-ds]:  On Semiconductor (now On Semi) (2010, Feb). _2N5457, 2N5458 JFETs: General Purpose N−Channel − Depletion (datasheet)_. Retrieved 2022-01-11, from https://www.onsemi.com/pdf/datasheet/2n5457-d.pdf.
[^linear-lt1492-ds]:  Linear Technology. _LT1492/LT1493: 5MHz, 3V/µs, Low Power Single Supply, Dual and Quad Precision Op Amps (datasheet)_. Retrieved 2020-12-25 from https://www.analog.com/media/en/technical-documentation/data-sheets/14923f.pdf.
