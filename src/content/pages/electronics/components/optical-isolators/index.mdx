...
Optical isolators (a.k.a. opto-isolators or optocouplers) are used to isolate two circuits electrically while allowing data to pass between them. They are used to prevent high voltages from damaging sensitive electronics, and to prevent noise from one part of a circuit from affecting another part.

Types:

* BJT output optocouplers.
...
A commonly used schematic symbol for a basic [BJT](/electronics/components/transistors/bipolar-junction-transistors-bjts/)-based optocoupler is shown below:

<Image src={import('./_assets/basic-optocoupler-schematic-symbol.webp')} width="500px">A commonly used symbol for a basic BJT-based optocoupler.</Image>
...
AC capable optocouplers usually have two LEDs in anti-parallel (e.g. the HCPL-354 by Avago).
