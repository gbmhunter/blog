...
- Differential [pressure](/electronics/components/sensors/pressure/) flow sensors: These utilize the Bernoulli principle to measure the pressure drop across an obstruction as the fluid flows through it.
...
$$
\begin{align*}
Q &= \frac{N}{6.6 \cdot \frac{t_{total}}{N}} \\
...
Sensirion makes small 10x10mm liquid flow sensors (the LPP10 and LPG10). They are based on thermal MEMs elements. They can measure between 0 and 1000uL/min (1mL/min), with a resolution that can be as low as 0.5nL/min. It has a response time 40ms/sample. It is compatible with H2O, methanol, ethanol, and blood.
