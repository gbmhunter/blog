...
The table below shows the different types of thermocouples and their material composition. Sorted alphabetically by type.
...
<th width="15%">+ Lead</th>
<th width="15%">- Lead</th>
<th>ANSI MC 96.1 Color</th>
<th>IEC 584-3 Color</th>
...
<tr>
<td>Type B</td> {/* Type */}
<td>Pt 30%, Rh</td> {/* Material, + Lead */}
<td>Pt</td> {/* Material, - Lead */}
<td>n/a[^blaze-thermocouple-types]</td> {/* ANSI MC 96.1 Color */}
<td>Grey (+), White (-)[^blaze-thermocouple-types]</td> {/* IEC 584-3 Color */}
<td>0°C to +1820°C[^blaze-thermocouple-types]</td> {/* Temperature Range */}
</tr>
<tr>
<td>Type E</td> {/* Type */}
<td>NiCr</td> {/* Material, + Lead */}
<td>CuNi</td> {/* Material, - Lead */}
<td>Purple (+), Red (-)[^blaze-thermocouple-types]</td> {/* ANSI MC 96.1 Color */}
<td>Purple (+), White (-)[^blaze-thermocouple-types]</td> {/* IEC 584-3 Color */}
<td>-270°C to +1000°C[^blaze-thermocouple-types]</td> {/* Temperature Range */}
</tr>
<tr>
<td>Type K</td> {/* Type */}
<td>NiCr</td> {/* Material, + Lead */}
<td>NiAl</td> {/* Material, - Lead */}
<td>Yellow (+), Red (-)[^blaze-thermocouple-types]</td> {/* ANSI MC 96.1 Color */}
<td>Green (+), White (-)[^blaze-thermocouple-types]</td> {/* IEC 584-3 Color */}
<td>-270°C to +1372°C[^blaze-thermocouple-types]</td> {/* Temperature Range */}
</tr>
<tr>
<td>Type J</td> {/* Type */}
<td>Fe</td> {/* Material, + Lead */}
<td>CuNi</td> {/* Material, - Lead */}
<td>White (+), Red (-)[^blaze-thermocouple-types]</td> {/* ANSI MC 96.1 Color */}
<td>Black (+), White (-)[^blaze-thermocouple-types]</td> {/* IEC 584-3 Color */}
<td>-210°C to +1200°C[^blaze-thermocouple-types]</td> {/* Temperature Range */}
</tr>
<tr>
<td>Type N</td> {/* Type */}
<td>NiCrSi</td> {/* Material, + Lead */}
<td>NiSiMg</td> {/* Material, - Lead */}
<td>Orange (+), Red (-)[^blaze-thermocouple-types]</td> {/* ANSI MC 96.1 Color */}
<td>Pink (+), White (-)[^blaze-thermocouple-types]</td> {/* IEC 584-3 Color */}
<td>-270°C to +1300°C[^blaze-thermocouple-types]</td> {/* Temperature Range */}
</tr>
<tr>
<td>Type R</td> {/* Type */}
<td>Pt 13%, Rh</td> {/* Material, + Lead */}
<td>Pt</td> {/* Material, - Lead */}
<td>n/a[^blaze-thermocouple-types]</td> {/* ANSI MC 96.1 Color */}
<td>Orange (+), White (-)[^blaze-thermocouple-types]</td> {/* IEC 584-3 Color */}
<td>-50°C to +1768°C[^blaze-thermocouple-types]</td> {/* Temperature Range */}
</tr>
<tr>
<td>Type S</td> {/* Type */}
<td>Pt 10%, Rh</td> {/* Material, + Lead */}
<td>Pt</td> {/* Material, - Lead */}
<td>n/a[^blaze-thermocouple-types]</td> {/* ANSI MC 96.1 Color */}
<td>Orange (+), White (-)[^blaze-thermocouple-types]</td> {/* IEC 584-3 Color */}
<td>-50°C to +1768°C[^blaze-thermocouple-types]</td> {/* Temperature Range */}
