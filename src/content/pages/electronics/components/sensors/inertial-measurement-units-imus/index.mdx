...
<Image src={import('./screenshot-playing-around-with-rthostimugl.png')} width="782px">Playing around with RTHostIMUGL and a connected IMU through an Arduino.</Image>
