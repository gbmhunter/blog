...
<Image src={import('./_assets/555-timer-schematic-for-monostable-operation-ti.png')} width="600px">Schematic for putting the 555 timer into monostable mode. Image from https://www.ti.com/lit/ds/symlink/sa555.pdf?HQS=TI-null-null-digikeymode-df-pf-null-wwe.</Image>
