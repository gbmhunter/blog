...
An easy and loud way to drive a 2-lead (or pin) piezoelectric speaker is with an [inductor](/electronics/components/inductors/) in parallel with the piezo and a NPN [BJT](/electronics/components/transistors/bipolar-junction-transistors/) acting as a switch, as shown in <IRef iref="piezo-drive-circuit-parallel-inductor" />.
