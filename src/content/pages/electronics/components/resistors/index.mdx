...
$V$ is the voltage across the resistor, in $V$<br/>
$I$ is the current through the resistor, in $A$<br/>
...
This relationship is shown in in the below image.
...
[^ohmcraft-hvr-series-high-voltage-leaded-resistor-series-datasheet]: Ohmcraft. _HVR Series - High Voltage Leaded Resistors_. Retrieved 2025-10-08, from https://ohmcraft.com/wp-content/uploads/2022/02/HVR-datasheet.pdf.
