...
<Image src={import('./_assets/schematic-symbols-amer-euro-resistors.png')} width="500">The \"American\" and \"European\" schematic symbols for a resistor. I prefer the American-style because it's easiest to distinguish from other box-like symbols.</Image>
...
<Image src={import('./_assets/resistor-divider-schematic.webp')} width="350">A basic schematic of a simple resistor divider. You will see these used everywhere in circuits!</Image>
...
<Image src={import('./_assets/resistor-divider-charging-a-capacitor-example-2.webp')} width="400">The Thevenin equivalent circuit.</Image>
...
<Image src={import('./_assets/parasitic-model-of-resistor-series-rl-parallel-c.svg')} width="600">Parasitic model of a resistor modelling the resistance in parallel with an inductor which is then in series with a capacitor.</Image>
...
<Image src={import('./_assets/parasitic-model-of-resistor-parallel-rc-series-l.svg')} width="600">Parasitic model of a resistor modelling the resistance in parallel with the end cap capacitance and that in series with the lead inductance.</Image>
...
<Image src={import('./_assets/reel-0603-resistor-leftovers-best.jpg')} width="900">This was me trying to be creative with the left-overs from putting about 30,000 reeled 0603 resistors into containers for prototyping with.</Image>
