...
High voltage resistors are resistors that are rated for high voltages, typically 1000 V or more. They are used in high voltage applications, such as in power supplies.

<Image src={import('./_assets/ohmcraft-hvrw42k1009j4-1414-resistor-photo.webp')} width="900px">A photo of an Ohmcraft (Exxelia) HVRW42K1009J4-1414 high voltage radial resistor (the large blue rectangle) on a PCB inside the Fluke 5322A "Electrical Safety Tester Calibrator" (test equipment). This particular resistor is 100 GΩ, and can handle 2 kV.[^ohmcraft-hvr-series-high-voltage-leaded-resistor-series-datasheet]</Image>
