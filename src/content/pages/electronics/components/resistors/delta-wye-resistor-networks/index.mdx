...
<Image ref="delta-wye-pi-t-networks" src={import('./delta-wye-pi-t-networks.png')} width="800px">Schematic showing the four common resistor network arrangements: Wye, Delta, Pi and Tee.</Image>
