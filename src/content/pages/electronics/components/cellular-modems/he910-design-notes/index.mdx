...
date: 2013-10-16
draft: false
lastUpdated: 2013-10-16
tags: [HE910, cellular modem, Telit, modem, GSM, GPS, 3G, 4G, LTE, antenna, soldering, power supply, UART, power supply filter]
...
The HE910 family of modems come in a [LGA component package](/pcb-design/component-packages/lga-component-package/). It has selectively depopulated pads. As far as I know, you cannot create one of these packages using the Automatic footprint creator in Altium (the closest you can get is a BGA).
...
<Image src={import('./_assets/he910-component-footprint-with-keepouts.png')} width="700">The Telit HE-910 cellular modem component footprint (a LGA-style footprint) with keep-outs around three EMI-sensitive pads.</Image>
...
<Image src={import('./_assets/recommended-power-supply-filter-for-he910.png')} width="700">The recommended power supply filter for the Telit HE910 cellular modem.</Image>
