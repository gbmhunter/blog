...
<Image src={import('./he910-component-footprint-with-keepouts.png')} width="700">The Telit HE-910 cellular modem component footprint (a LGA-style footprint) with keepouts around three EMI-sensitive pads.</Image>
...
<Image src={import('./recommended-power-supply-filter-for-he910.png')} width="700">The recommended power supply filter for the Telit HE910 cellular modem.</Image>
