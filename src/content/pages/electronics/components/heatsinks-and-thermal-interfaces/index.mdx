...
Typical components that require heatsinking are high current [linear regulators](/electronics/components/power-regulators), MOSFETs on [H-bridges](/electronics/components/h-bridges/), power amplifier BJTs and [MOSFETs](/electronics/components/transistors/mosfets), and power limiting resistors. Most heatsinks are made from black anodized aluminium.
...
There is no standard package for heatsinks and the pitch for their support pins, although some more common pin spacings exist (such as 25.4mm (1inch) etc.).
