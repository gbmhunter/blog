...
<Video src="/videos/heat-set-insert-installation.webm" width="500px" autoplay loop>
  A heat set insert being pushed into a 3D-printed plastic part using a soldering iron.
</Video>
