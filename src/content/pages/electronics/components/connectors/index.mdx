...
<Image src={import('./jst-ph-connector-photo.png')} width="400">Photo of the W2B (wire-to-board) PH 2.0mm pitch connector from JST[^bib-jst-ph-conn].</Image>
...
<Image src={import('./gold-and-tin-plated-contacts.jpg')} width="500">You can see the difference between the gold and tin plated header connectors. Image from http://www.fischerelektronik.de/en/latest-news/press-releases/releases/smd-high-precision-male-header-with-2point54mm-grid-spacing-horizontal-design/</Image>
...
<Image src={import('./te-connectivity-ariso-m30-contactless-connector-pair-photo.png')} width="640">A photo of TE Connectivity's ARISO M30 contactless connectors. Image from www.te.com.</Image>
...
<Image src={import('./arduino-relay-shields-and-relays.jpg')} width="1200">Many push-in terminal blocks (items in green) I used as part of the [Luxcity Tonic project](/electronics/projects/luxcity-uv-tonic-control-system).</Image>
...
<Image src={import('./wire-ferrules-used-in-terminal-block.jpg')} width="500">Wire ferrule are crimped onto wires before they are inserted into a terminal block, preventing fraying and solder creep.</Image>
...
<Image src={import('./terminal-block-screw-style.jpg')} width="181">A terminal block with a screw-style connection method.</Image>
...
<Image src={import('./terminal-block-rising-cage-close-up.jpg')} width="148">A terminal block with a rising-cage style connection method.</Image>
...
<Image src={import('./terminal-block-cover-beside-block1.jpg')} width="400">A terminal block cover beside the terminal block.</Image>

<Image src={import('./terminal-block-cover-mounted-on-block.jpg')} width="400">A terminal block cover mounted onto a terminal block.</Image>
...
<Image src={import('./20150109-ceramic-terminal-block.jpg')} width="400">A ceramic terminal block.</Image>
...
<Image src={import('./molex-0387700104-barrier-strip-photo.png')} width="400">Photo of a 4 circuit 9.53mm (0.375") pitch barrier strip by Molex (part number: 0387700104). Image retrieved 2021-10-07, from https://www.digikey.com/en/products/detail/molex/0387700104/362488.</Image>
...
<Image src={import('./barrier-strips-forks-coloured-glarks.png')} width="400">Photo of covered barrier strips, combs and wire forks. Image retrieved 2021-10-07, from https://www.amazon.com/Glarks-Positions-Terminals-Pre-Insulated-Insulated/dp/B07Y217129/.</Image>
...
<Image src={import('./jst-sh-conn-adafruit-stemma-qt-sparkfun-qwiic.png')} width="400">A photo of a Adafruit "STEMMA QT" or SparkFun "Qwiic" connector + cable. Both use the JST SH 1.0mm pitch W2B connector family[^bib-adafruit-jst-sh-conn]. Image (C) 2021, Adafruit.</Image>
...
<Image src={import('./molex-picoblade-connector-photo.gif')} width="300">A photo showing a few of the connectors from the Molex PicoBlade families. Image from www.molex.com.</Image>
...
<Image src={import('./bnc-connectors-on-oscilloscope.jpg')} width="700">Four BNC connectors on the front of a Keysight InfiniiVision DSOX2024A oscilloscope to connect the probes to.</Image>
...
<Image src={import('./bnc-adapter-edited.jpg')} width="300">Photo of a BNC adapter, showing the male BNC connector.</Image>
...
<Image src={import('./ufl-connector-photo.png')} width="350">A photo of a male, SMD mount UFL connector. Image from www.digikey.com.</Image>
...
<Image src={import('./ufl-umc-umcc-rf-connector-schematic-symbol.png')} width="510">A schematic symbol for the male, SMD, UFL (a.k.a. UMC, UMCC) style RF connector.</Image>
...
<Image src={import('./sma-male-and-female-next-to-each-other-edited.jpg')} width="700">One male and one female inline (connector to cable) SMA connector next to each other.</Image>
...
<Image src={import('./sma-cable-edited.jpg')} width="700">A coaxial cable with SMA connectors at both ends.</Image>
...
<Image src={import('./n-connector-close-up-edited.jpg')} width="300">Close-up of a N Connector.</Image>
...
<Image src={import('./stacked-board-to-board-connector-photo.png')} width="500px">An example of a 'mezzanine' or 'stacked' style of board-to-board connector.</Image>
...
<Image src={import('./df59-hirose-board-to-board-connector-with-special-floating-feature.pdf.png')} width="400px">Diagram of the Hirose DF-59 family of board-to-board connectors, showing their special 'floating' feature.</Image>
...
<Image src={import('./iec-60320-c13-male-and-female-mains-power-connector-photo.jpg')} width="500px">A photo of both the male and female C13/C14 style connectors from the IEC 60320 standard. Also known as 'kettle' or 'jug' plugs. Image from www.amazon.com.</Image>
...
<Image src={import('./edge-connector-gold-fingers-and-bevel.png')} width="445px">Edge connector fingers which have been gold plated and the PCB bevelled. Image from http://www.eurocircuits.com/index.php/eurocircuits-printed-circuits-blog/gold-plating-for-edge-connectors.</Image>
...
<Image src={import('./pcb-card-edge-connector-example-from-cavro-xl-3000.jpg')} width="1200px">An example of a PCB card edge connector. This is a photo of the Cavro XL-3000 syringe pump.</Image>
...
<Image src={import('./pcb-edge-connector-pci-hockey-stick.png')} width="412px">Male pcb-card edge connectors can have 'hockey-stick' latches as indicated (the female connector also has to support this).</Image>

This is a screenshot from a PCB design for the male part of a card-edge connector in Altium.

<Image src={import('./altium-card-edge-male-connector-on-pcb.png')} width="1502px">An Altium PCB design of a male card-edge connector. This is for the 20-pin connector in the Molex SPD08 series.</Image>

This is a female latching card-edge connector.

<Image src={import('./pcb-connector-with-latches-3m-spd08.png')} width="1265px">A 20-pin card-edge female connector from the Molex SPD08 series.</Image>
...
<Image src={import('./identifying-a-w2b-connector-on-connector-book.png')} width="700px">Identifying a W2B (wire-to-board) connector with the help connectorbook.com[^bib-connector-book].</Image>
