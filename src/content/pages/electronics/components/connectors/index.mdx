...
<Image src={import('./_assets/jst-sh-conn-adafruit-stemma-qt-sparkfun-qwiic.png')} width="400">A photo of a Adafruit "STEMMA QT" or SparkFun "Qwiic" connector + cable. Both use the JST SH 1.0mm pitch W2B connector family[^bib-adafruit-jst-sh-conn]. Image (C) 2021, Adafruit.</Image>
...
<Image src={import('./_assets/molex-picoblade-connector-photo.gif')} width="300">A photo showing a few of the connectors from the Molex PicoBlade families. Image from www.molex.com.</Image>
...
<Image src={import('./_assets/bnc-connectors-on-oscilloscope.jpg')} width="700">Four BNC connectors on the front of a Keysight InfiniiVision DSOX2024A oscilloscope to connect the probes to.</Image>
...
<Image src={import('./_assets/bnc-adapter-edited.jpg')} width="300">Photo of a BNC adapter, showing the male BNC connector.</Image>
...
<Image src={import('./_assets/ufl-umc-umcc-rf-connector-schematic-symbol.png')} width="510">A schematic symbol for the male, SMD, UFL (a.k.a. UMC, UMCC) style RF connector.</Image>
...
<Image src={import('./_assets/sma-male-and-female-next-to-each-other-edited.jpg')} width="700">One male and one female inline (connector to cable) SMA connector next to each other.</Image>
...
<Image src={import('./_assets/sma-cable-edited.jpg')} width="700">A coaxial cable with SMA connectors at both ends.</Image>
...
<Image src={import('./_assets/n-connector-close-up-edited.jpg')} width="300">Close-up of a N Connector.</Image>
