...
<Image src={import('./zebra-connector-photo.png')} width="400">Photo of the ZEBRA branded elastomeric connector from Fujipoly[^bib-fujipoly-zebra-elastomeric-conn].</Image>
...
<Image src={import('./zebra-connector-interface.png')} width="500">Drawing from Fujipoly showing how a fine-pitch elastomeric connector can connect larger pitched components without precise alignment[^bib-fujipoly-zebra-elastomeric-conn].</Image>
