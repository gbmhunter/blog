...
<Image src={import('./header-schematic-symbol.svg')} width="200">The commonly-used schematic symbol for a header. This shows a 1x2 (1 row of 2 pins) male header.</Image>
...
<Image src={import('./typical-numbering-order-for-header-connectors.png')} width="500">This image show the typical way in which headers are numbered, with male headers (plugs) being numbered left-to-right and female headers (jacks) being numbered from right-to-left.</Image>
...
<Image src={import('./2-54mm-smd-right-angle-header-plug-and-jack-mosaic.jpg')} width="1200">Header plugs and jacks (male and female parts) are a good way of connecting PCBs together.</Image>
