...
authors: [gbmhunter]
date: 2021-01-28
description: Multiplexers select one of many input signals and connect it to a single output signal. Demultiplexers do the reverse. This page covers analgoue devices and datasheet parameters.
