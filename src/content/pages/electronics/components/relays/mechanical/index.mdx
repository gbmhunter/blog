...
Reed relays are a type of relay that used an electromagnet to move a reed switch. The contacts in the reed switch are magnetic and the magnetic field directly moves the contacts. This is what distinguishes them from armature relays, which require a armature to move non-magnetic contacts.[^wikipedia-reed-relay]
...
<Image src={import('./_assets/photo-of-2x-meder-mre12-18a5-reed-relays-on-pcb.webp')} width="900px">A photo of two Meder MRE12-18A5 reed relays on a PCB. These relays are quite "beautiful" in the sense that they are not in-cased in a square enclosure and you can see the insides! This PCB was inside a Fluke 5322A "Electrical Safety Tester Calibrator" (test equipment).</Image>
