...
Armature relays are the most common type of mechanical relay. They have a magnetized armature which is moved by the magnetic field of the coil (electromagnet). The contacts are connected to the armature and make or break the output circuit.
...
Reed relays typically cannot handle as high a current as armature relays, but can typically handle higher voltages (e.g. 1000-10,000 V) due to the glass sealed environment the contacts operate in.
