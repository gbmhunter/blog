...
Peltiers are used in things such as:
...
Most Peltiers consist of many small semiconductor junctions, joined together in an array, and connected between two thermally conductive, white ceramic plates.
...
If you want simple on/off control and the hot/cold sides don't need to switch, then you can control a peltier with a single mechanical [switch](/electronics/components/switches/), [relay](/electronics/components/relays/), or [transistor](/electronics/components/transistors/) (e.g. [MOSFET](/electronics/components/transistors/mosfets/)).

If you want tighter control over the power, you can [PWM](/electronics/circuit-design/pulse-width-modulation-pwm/) a transistor to provide varying power from a constant DC source.
