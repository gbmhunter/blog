...
authors: [gbmhunter]
date: 2011-09-05
description: PIN diodes are semiconductor diodes with a wide un-doped intrinsic region between the typical p-type an n-type regions.
...
<Image src={import('./_assets/pin-diode-photo-small.jpg')} width="200">A photo of a small, through-hole PIN diode.</Image>
