...
authors: [gbmhunter]
date: 2011-09-05
description: Signal diodes are semiconductor diodes designed for rectification of low power signals rather than the higher power electronics that general purpose diodes are designed to rectify.
...
<Image src={import('./_assets/1n4148-small-signal-diode-photo-on-semi.png')} width="200">Photo of the small signal 1N41488 diode by onsemi in the DO-35 component package. Image (C) onsemi.</Image>
