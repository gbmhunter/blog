...
<Image src={import('./_assets/led-diode-schematic-symbol.webp')} width="300">Schematic symbol for an LED (light emitting diode).</Image>
...
<Image src={import('./osram-ls-p47k-reverse-mount-led-photo.png')} width="450">An Osram reverse-mount LED (P47K series).</Image>
...
<Image src={import('./led-connected-to-micro-for-light-detection-schematic.png')} width="500">Schematic showing how to connect an LED to a general microcontroller for light detection. The LED and resistor are connected to GPIO pins.</Image>
...
<Image src={import('./ws2811-rgb-led-front-and-back-photo.png')} width="500">The WS2811, a popular RGD LED, with integrated controller and drive circuitry (constant current supply). Communicates via a custom 800kHz protocol to a microcontroller.</Image>
...
<Image src={import('./_assets/ws2812b-typical-application-schematic.webp')} width="900px">Typical application schematic of the WS2812B RGB LED, showing how they can be daisy-chained together.</Image>
...
<Image src={import('./laser-diode-with-integrated-fet-and-cap.png')} width="500">A laser diode with an integrated FET and capacitor for high-seed, high-power switching.</Image>
...
<Image src={import('./led-pulse-extending-circuit-schematic-annotated-rc-mosfet.png')} width="650">The schematic for a LED pulse width extending circuit. It converts a short pulse that would not be seen into a longer pulse which is visible.</Image>
...
<Image src={import('./green-led-relative-intensity-vs-wavelength-ltst-c190kgkt.png')} width="650">A graph of the relative intensity vs. wavelength for a 0603 green LED (LTST-C190KGKT). It has a peak wavelength of 574nm and a dominant wavelength of 571nm.</Image>
...
<Image src={import('./0603-led-up-close.jpg')} width="700">A picture of a 0603 LED up close on a PCB. You can see the filament running into the middle of the pad (the part which emits the light).</Image>
