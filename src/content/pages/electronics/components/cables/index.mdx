...
<Image src={import('./nec-2005-cable-standards-reference-cable-type-and-fire-resistance-summary.png')} width="790">A summary of the cable types and flame tests from NEC. Image from http://www.associatedtelephone.com/.</Image>
...
<Image src={import('./cable-glands-three-sizes.jpg')} width="500">Three sizes of cable gland.</Image>
...
<Image src={import('./cable-gland-multi-cable-edited.jpg')} width="300">A single large cable gland which contains a grommet which allows 8 cables to pass through.</Image>
...
<Image src={import('./metal-cable-gland.jpg')} width="200">Metal cable glands are available if you need stronger support. Note however metal is not strictly better...plastic is better for chemical/corrosion resistance!</Image>
