...
<Image src={import('./coax-cable-cut-away-annotated.png')} width="700">The make-up of a standard coaxial cable. Relative dimensions accurate for RG-6 (dimensions taken from http://www.farnell.com/datasheets/1697593.pdf).</Image>
