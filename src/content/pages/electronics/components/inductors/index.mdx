...
<Image src={import('./_assets/inductors-in-parallel-with-equation.png')} width="608px">Two inductors in parallel is the equivalent of one inductor whose inductance is given by the reciprocal equation in this image.</Image>
...
<Image src={import('./_assets/inductor-in-series-with-equation.png')} width="609px">Two inductors in series are the equivalent of one inductor whose inductance is the sum of the individual inductances.</Image>
...
<Image src={import('./_assets/ipc-sm-782-component-dimensions-for-smd-inductors.png')} width="709px">Standard dimensions for three different types of SMD inductor packages. Image from the IPC-SM-782 standard.</Image>
