...
date: 2014-06-24
description: Comparators vs. op-amps, types, gain, hyteresis, push-pull and open-drain output comparators, non-inverting and inverting configurations, PCB surface leakage and more info about the comparators.
...
<Image src={import('./_assets/comparator-hystersis-graph.png')} width="334">A graph showing how comparator hystersis works.</Image>
