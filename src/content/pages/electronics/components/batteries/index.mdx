...
date: 2011-09-05
description: Chemistries (lead acide, lithium-ion, lithium thionyl chloride, zinc-air), voltage, current draw, leakage current, discharge characteristics, energy density, temperature range, and chemical reactions of batteries.
...
<Image src={import('./zinc-air-battery-cut-away-annotated.jpg')} width="450">A cut-away of a zinc-air button cell with annotations. Image from http://hear-better.com/.</Image>
