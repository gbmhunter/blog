...
authors: [gbmhunter]
date: 2023-07-31
description: Lithium-ion (or li-ion) is a popular chemistry for a rechargeable battery that uses the recombination of Lithium ions with their missing electrons to generate electricity.
...
A lithium-ion (or li-ion) battery is a rechargeable battery that uses the recombination of Lithium ions with their missing electrons to generate electricity, and the reverse of this process to recharge.[^wikipedia-lithium-ion-battery]
...
Lithium-ion batteries experience about 1-5% of self-discharge per month. This means that they loose 1-5% of their remaining energy each month, even when there is no external power draw. Note that it is a percentage of their **remaining** energy, not a percentage of their maximum energy. This means the energy loss follows an exponential decay.
...
Lithium-ion batteries have a better self-discharge rather than other common rechargeable chemistries. NiMH has a self-discharge rate about ten times higher than Lithium-ion.[^ti-li-ion-battery-charger-jeita-compliance]
