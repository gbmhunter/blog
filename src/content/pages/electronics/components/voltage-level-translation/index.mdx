...
<Image src={import('./_assets/schematic-of-voltage-level-translation-with-a-mosfet.png')} width="600">An example schematic of bi-directional voltage-level translation using a MOSFET.</Image>
