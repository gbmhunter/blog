...
{/* <Image src={import('./_assets/mems-vs-crystal-oscillator-package-size.png')} width="700px">A comparison between MEMS and crystal-based oscillators in CSP and larger 2012 SMD packages. Note how the MEMS oscillator sneaks in two extra pins between the standard 2012 pads for power and ground.</Image> */}
