...
authors: [gbmhunter]
date: 2024-04-03
description: Info on system basis chips (SBCs).
...
<Image src={import('./_assets/nxp-fs26-architecture-block-diagram.png')} width="700px">Architecture block diagram of the NXP FS26 SBC[^nxp-fs26-product-page].</Image>
