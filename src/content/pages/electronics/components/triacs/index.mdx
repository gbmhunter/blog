...
authors: [gbmhunter]
date: 2015-11-02
description: A TRIAC (TRIode for Alternating Current) is a 4-layer semiconductor device that conducts current in either direction when given a signal.
...
<Image src={import('./_assets/triac-schematic-symbol-with-pin-names.png')} width="255px">The schematic symbol for the TRIAC, with pin names.</Image>
