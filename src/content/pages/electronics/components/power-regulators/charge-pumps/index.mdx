...
<Image src={import('./_assets/charge-pump-inverter/charge-pump-inverter-simulation-results.png')} width="600px">A schematic for a voltage-inverting charge pump.</Image>
