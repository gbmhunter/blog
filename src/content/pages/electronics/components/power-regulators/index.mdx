...
<Image src={import('./recom-acdc-converter.jpg')} width="200px">A Recom AC/DC converter module that can take 100-240VAC as it's input and outputs 12V at up to 83mA.</Image>
...
<Image src={import('./ul60950-limited-power-circuits-graph.png')} width="400px">A graph of voltage vs. current for a LPS (limited power supply).</Image>
