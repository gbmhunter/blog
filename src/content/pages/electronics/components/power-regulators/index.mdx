...
<Image src={import('./_assets/recom-acdc-converter.jpg')} width="200px">A Recom AC/DC converter module that can take 100-240VAC as it's input and outputs 12V at up to 83mA.</Image>
