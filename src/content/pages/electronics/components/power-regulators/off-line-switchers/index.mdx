...
<Image src={import('./_assets/innoswitch3-pro-insop-24d-package-3d-render.png')} width="300px">3D render of the InnoSwitch3-Pro off-line regulator in a InSOP-24D package[^bib-innoswitchpro-3-ds].</Image>
