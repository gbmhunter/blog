...
<Image src={import('./_assets/floating-buck-boost-converter-basic-schematic.svg')} width="500">Schematic of a floating buck-boost converter. Note that $V_{IN}$ is referenced to ground, but $V_{OUT}$ is not (measured across $R_{LOAD}$ as shown).</Image>
...
<Image src={import('./_assets/floating-buck-boost-converter-current-when-switch-closed.svg')} width="500">Current paths through the floating buck-boost converter when the switch is **closed** (during $t_{on}$).</Image>
...
<Image src={import('./_assets/floating-buck-boost-converter-current-when-switch-open.svg')} width="500">Current paths through the floating buck-boost converter when the switch is **open** (during $t_{off}$).</Image>
