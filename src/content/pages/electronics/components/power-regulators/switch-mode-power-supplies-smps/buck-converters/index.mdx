...
$T$ is the switching frequency, in seconds ($t_{on} + t_{off}$)<br/></p>
...
<Image src={import('./_assets/buck-converter-schematic-current-path-ton.svg')} width="500">Current path when the switch is **closed** (during $t_{on}$ ).</Image>
...
<Image src={import('./_assets/buck-converter-schematic-current-path-toff.svg')} width="500">Current path when the switch is **open** (during $t_{off}$).</Image>
...
$\eta$ is the efficiency, typically $0.9$ (i.e. 90%)[^ti-slva477b-basic-calc-buck-power-stage]<br/></p>
...
and everything else as mentioned previously<br/></p>
...
<Image src={import('./_assets/photo-of-lmz20502-buck-converter.jpg')} width="306">A photo of the LMZ20502 buck converter. Image from http://www.digikey.co.nz/product-detail/en/LMZ20502SILT/296-38656-1-ND/.</Image>
...
<Image src={import('./_assets/microsip-component-package-dimensions.png')} width="500">The dimensions of the MicroSIP component package, used by the Texas Instruments 'Nano' buck converters. Image from http://www.ti.com/lit/ds/symlink/lmz20502.pdf.</Image>
