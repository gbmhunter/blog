...
<Image src={import('./_assets/ninja-calc-buck-converter-calculator-screenshot.png')} width="950">A screenshot of the buck converter calculator in NinjaCalc (as of v2.2.0).</Image>
