...
authors: [gbmhunter]
date: 2015-03-24
description: "Switch-mode power supplies are power regulators that use electronic switching to convert voltages and currents. Topologies include buck, boost, buck-boost, SEPIC and Cuk."
lastUpdated: 2024-08-23
tags: [electronics, components, power regulators, SMPS, buck converter, power electronics, inductor, capacitor, regulation, control methods, constant frequency, current-mode, SNVA555, PCM, peak current mode, CCM, constant current mode, SEPIC, Cuk]
...
[^microsemi-v-i-mode]:  Maniktala, Sanjaya (2012). _Voltage-Mode, Current-Mode (and Hysteretic Control)_. Microsemi. Retrieved 2021-08-22, from https://www.microsemi.com/document-portal/doc_view/124786-voltage-mode-current-mode-and-hysteretic-control.
[^onsemi-floating-buck-boost]:  OnSemi (2011, May). _Design Note DN05002/D: Buck-Boost Converter for 3A LEDs_. Retrieved 2021-09-16, from https://www.onsemi.com/pub/Collateral/DN05002-D.PDF.
