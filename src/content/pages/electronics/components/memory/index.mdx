...
<Image src={import('./_assets/m25p128-flash-ic-that-uses-flip-flop-style-naming-for-spi-pins.png')} width="420px">The M25P128 flash IC which uses flip-flop style pin naming conventions.</Image>
