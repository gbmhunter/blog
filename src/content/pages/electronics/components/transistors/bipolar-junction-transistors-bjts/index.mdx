...
[Phototransistors](/electronics/components/phototransistors/) are very similar to a standard NPN BJT, but use light to drive the base rather than an electrical signal.
