...
<Image src={import('./_assets/bjt-schematic-symbols-npn-pnp.png')} width="600px">Schematics symbols for NPN and PNP transistors. Note that the collector and emitter have flipped positions for the PNP, as commonly drawn on schematics.</Image>
...
<Image src={import('./_assets/bc548-transistor-to92-photo.png')} width="300px">A photo of the ubiquitous BC548 BJT transistor in to TO-92 package. Image from https://www.dnatechindia.com/bc-548-npn-transistor-buy-online-india.html.</Image>
...
The you are looking for a slice of history and some informative transistor information, check out the [1964 edition of the GE Transistor Manual](/pdfs/ge-transistor-manual-1964.pdf).
