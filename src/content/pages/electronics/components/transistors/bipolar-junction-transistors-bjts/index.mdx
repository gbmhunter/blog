...
<Image src={import('./bjt-schematic-symbols-npn-pnp.png')} width="600px">Schematics symbols for NPN and PNP transistors. Note that the collector and emitter have flipped positions for the PNP, as commonly drawn on schematics.</Image>
...
<Image src={import('./output-transfer-characteristics-microcap-sim/plot.png')} width="600px">The output transfer characteristics (simulated) for the 2N2222 BJT.</Image>
...
<Image src={import('./early-voltage-microcap-sim/vce-vs-ic-with-early-voltage.png')} width="700px">Graph of Vce vs. Ic showing how the Early voltage is the extrapolation of the curves (in the active region) back to the x-axis intersection.</Image>
...
<Image src={import('./hybrid-pi-model-simplified.png')} width="600px">A simplified Hybrid-Pi model of a BJT transistor.</Image>
...
<Image src={import('./common-base-amplifier.png')} width="400px">Basic schematic of a NPN BJT common-base amplifier. DC biasing componentry is not shown.</Image>
...
<Image src={import('./common-base-amplifier-dc-bias.png')} width="700px">Schematic of a NPN BJT common-base amplifier with DC biasing componentry shown.</Image>
...
<Image src={import('./constant-current-bjt-based-led-driver.png')} width="300px">The simulation schematic for a constant-current BJT-based LED driver.</Image>
...
<Image src={import('./constant-current-bjt-based-led-driver-simulation-results.png')} width="800px">The simulation results of a constant-current BJT-based LED driver.</Image>
...
<Image src={import('./current-source-npn-voltage-divider-base.png')} width="500px">A NPN BJT current-sink using a resistor divider to drive the base.</Image>
...
<Image src={import('./current-mirror-pnp.png')} width="400px">A basic PNP-based current mirror programmed to source 1mA into the load. Q1 and Q2 should be a matched transistor pair to achieve good mirroring of the current.</Image>
...
<Image src={import('./bc548-transistor-to92-photo.png')} width="300px">A photo of the ubiquitous BC548 BJT transistor in to TO-92 package. Image from https://www.dnatechindia.com/bc-548-npn-transistor-buy-online-india.html.</Image>
...
<Image src={import('./multiple-emitter-bjt-schematic-symbol-u1.png')} width="300px">The schematic symbol for a multiple-emitter BJT.</Image>
...
<Image src={import('./basic-two-input-tll-nand-gate-schematic.png')} width="600px">The schematic of a basic two-input TTL NAND gate.</Image>
...
<Image src={import('./bjt-safe-operating-area.png')} width="500px">A typical representation of the safe operating area (SOA) of a BJT. Normally multiple curves are drawn, one for DC and a number for pulses of various lengths. Both $V_{CE}$ and $I_C$ are on logarithmic axes.</Image>
...
<Image src={import('./leakage-current-diagrams.png')} width="800px">Circuits showing how each 1 of the three BJT leakage currents is measured.</Image>
