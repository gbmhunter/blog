...
They are used for making things such as amplifiers, switches, [linear regulators](/electronics/components/power-regulators/linear-regulators/), [current mirrors](/electronics/components/current-mirrors/) and digital logic.
