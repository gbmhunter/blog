...
date: 2015-03-25
description: How they work, crosstalk, switching speeds, power consumtion, examples and more info on analogue switches (tranmission gates).
...
<Image src={import('./_assets/transmission-gate-symbols.png')} width="900">Various schematic symbols used for transmission gates (the same thing as an analogue switch but used for digital signals).</Image>
