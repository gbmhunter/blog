...
<Image src={import('./_assets/nexperia-74hc74-d-flip-flop-logic-diagram.png')} width="700">Logic diagram for 1 of the positive-edge triggered D-type flip-flops in the Nexperia 74HC74 IC. Note the complexity![^bib-nexperia-74hc74-ds]</Image>
...
<Image src={import('./_assets/intersil-isl43l410-analogue-switch-functional-diagram.png')} width="250">Functional diagram of the Intersil ISL43L410 analogue switch. Image from http://www.intersil.com/content/dam/Intersil/documents/isl4/isl43l410.pdf.</Image>
...
<Image src={import('./_assets/maxim-ds3690-26-channel-transmission-gate-functional-diagram.png')} width="300">The functional diagram for the Maxim DS3690 26-channel transmission gate[^bib-maxim-ds3690-ds].</Image>
