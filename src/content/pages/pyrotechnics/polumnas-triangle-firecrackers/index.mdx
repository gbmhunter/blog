...
tags: [pyrotechnics, firecrackers]
...
<Image src={import('./_assets/polumna_construction.jpg')} width="320px">Diagram with instructions on showing how to make a polumna.</Image>
...
<Image src={import('./_assets/polumna_01.jpg')} width="320px">The layers of newspaper used to make a polumna.</Image>
...
<Image src={import('./_assets/polumna_02.jpg')} width="320px">Wrapping the newspaper into a triangle, filling it with blackpower, and then adding a fuse.</Image>
...
<Image src={import('./_assets/polumna_03.jpg')} width="320px">The finished polumna.</Image>

1. Light fuse and get to a safe distance!

<Image src={import('./_assets/polumna_04.jpg')} width="320px">The remains of a polumna.</Image>
