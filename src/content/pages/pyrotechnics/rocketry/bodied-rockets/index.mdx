...
authors: [gbmhunter]
date: 2004-10-03
lastUpdated: 2004-10-03
tags: [pyrotechnics, rocketry, rockets]
...
<Image src={import('./_assets/5min_rocket.jpg')} width="320px">The 5min rocket. Visual appearance came second to construction speed.</Image>
...
<Image src={import('./_assets/tiger_rocket_01.jpg')} width="320px">The 'Tiger' rocket. Painted with fluro colours so it was easy to find in a paddock.</Image>

<Image src={import('./_assets/tiger_rocket_02.jpg')} width="320px">The rocket motors that went in the 'Tiger' rocket.</Image>