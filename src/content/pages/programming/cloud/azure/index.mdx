...
Azure Functions are a way to run small pieces of code, in which you are only billed for compute time when the code is running (i.e. serverless). They are similar to [AWS Lambda functions](/programming/cloud/aws/lambda).
