...
<Image src={import('./the-yocto-project-logo.png')} width="404px">The logo for the Yocto project.</Image>
...
<Image src={import('./yocto-linux-build-in-progress-showing-cpu-usage.png')} width="1491px">An embedded Linux build in progress (using Yocto), note the CPU usage!</Image>
...
<Image src={import('./yocto-running-qemu-after-building-default-linux-image.png')} width="1327px">Running the finished Yocto build in QEMU (an emulator).</Image>
