...
In particular, zynq7-base.dtsi located at `meta-xilinx/recipes-bsp/device-tree/files/common/` could be of particular interest because it defines hardware such as the ethernet, UART, I2C, CAN, USB, ADC etc.
