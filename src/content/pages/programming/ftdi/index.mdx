...
tags: [FTDI, Python, firmware, pyftdi, programming, CBUS, GPIO]
...
self.eeprom.open(self.device_url)
...
self.ftdi.set_cbus_direction(0b0011, 0b0001) # 0b0011 selects the GPIO pins we want to change, 0b0001 sets 0 as output, 1 as input
```
