...
<Image src={import('./ema-bode-plot.png')} width="800px">Bode plot showing the magnitude and phase of an EMA filter with $ \alpha=0.25 $.</Image>
...
<Image src={import('./ema-impulse-response.png')} width="800px">Impulse response for an EMA filter with different $\alpha$ values.</Image>
