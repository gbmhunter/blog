...
date: 2018-06-05
description: Convolution is a mathematical operation that operates on two functions and produces a third output function. 1D convolution is commonly used in digital signal processing (DSP) algorithms, while 2D convolution is commonly used in image processing to perform edge detection and blurring. Conversely, deconvolution is commonly used to sharpen images.
