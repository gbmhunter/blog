...
<Image src={import('./_assets/sinusoidal.gif')} width="850px">A sinusoidal image in the spatial domain and it's corresponding Fourier magnitude and phase images. The wavelength is varied from 2 to 64px.</Image>

<Image src={import('./_assets/square_wave.gif')} width="850px">A square-waved (striped) image in the spatial domain and it's corresponding Fourier magnitude and phase images. The wavelength is varied from 2 to 64px.</Image>
