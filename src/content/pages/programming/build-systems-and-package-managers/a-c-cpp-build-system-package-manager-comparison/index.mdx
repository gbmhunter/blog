...
- Slogan: *\{Fast, Correct\} - Choose two*
...
<table>
    <tbody>
        <tr>
            ...
            <td>9/10</td>
            <td>Bazel is great at building C/C++ packages.</td>
        </tr>
        <tr>
...
As far as I'm aware, Bazel does not have the install functionality that build systems such as make and CMake have. There is no way to "install" the build executables, libraries and header files onto the system, be it the typical install locations (such as `/usr/local/bin`, `/usr/local/lib`, etc. on Linux) or a custom install directory.
...
See the dedicated [Buck page](/programming/build-systems-and-package-managers/buck/) for more information.
...
<table>
    <tbody>
        ...
        <tr>
            <td>Community</td>
            <td>6/10</td>
            <td><a href="https://buckbuild.com/setup/getting_started.html">Although the documentation is quite comprehensive</a>, Buck is still young and it can be difficult to find solutions to problems on places such as StackOverflow. It does have over 5.5k stars on GitHub!</td>
        </tr>
        <tr>
            <td><b>TOTAL</b></td>
            <td><b>7/10</b></td>
...
Unfortunately, I do not believe that Buckaroo supports local dependencies. All dependencies have to come from remote repositories.

See the dedicated [Buckaroo page](/programming/build-systems-and-package-managers/buckaroo/) for more information.
...
<table>
    <tbody>
        ...
        <tr>
            <td>Usability</td>
            <td>5/10</td>
            <td>CMake can be somewhat easy to use for a self-contained build, but can get rather complex when dealing with dependencies (exporting, supporting find_package, .cmake.in files, etc.), see <a href="https://cmake.org/cmake/help/git-master/manual/cmake-packages.7.html#creating-packages">here</a>.</td>
        </tr>
        <tr>
            <td>Scalability/Speed</td>
            <td>7/10</td>
...
Conan is solely a C/C++ package manager, although it provides interfaces to common build tools such as CMake (this seems to be a popular pairing). Installation can be as simple as `pip install conan`.
...
See the dedicated [Conan page](/programming/build-systems-and-package-managers/conan/) for more information.
...
See the dedicated [SCons page](/programming/build-systems-and-package-managers/scons/) for more information.
