...
The Zephyr Project provides a Docker container that is suitable for CI pipelines. The images can be found on Docker Hub [here](https://hub.docker.com/r/zephyrprojectrtos/ci). Note the images are quite large, with the current ones as of November 2024 being around 4GB in size!
