...
Zephyr has built-in support for the MCUboot [bootloader](/programming/bootloaders/), a popular bootloader that also is supported by a number of other platforms/manufacturers such as Apache Mynewt, RIOT, Mbed OS, Espressif, and Cypress/Infineon.[^mcuboot-doc]
