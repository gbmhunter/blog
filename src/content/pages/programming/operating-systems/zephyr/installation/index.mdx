...
Now we can run `west update` to pull down all the required dependencies. This command will take some time (5-15mins) to complete. It will populate the `external` directory.
