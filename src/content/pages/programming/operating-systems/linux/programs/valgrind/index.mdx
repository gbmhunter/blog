...
<Image src={import('./valgrind-logo.jpg')} width="316px">The Valgrind logo.</Image>
...
<Image src={import('./callgrind-profiling-output-displayed-in-kcachegrind.png')} width="1310px">The callgrind profiling output data being displayed in kcachegrind for a simple test application (with Fibonacci calculation and looping).</Image>
