...
authors: [gbmhunter]
date: 2014-07-07
description: minicom is a Linux terminal program that can be used to connect to a serial device. It calls itself a "friendly serial communications program". It is also available for the RaspberryPi.
lastUpdated: 2025-05-21
tags: [Linux, programs, minicom, serial, terminals, RaspberryPi, embedded, microcontrollers, programming, electronics]
title: minicom
type: page
---
