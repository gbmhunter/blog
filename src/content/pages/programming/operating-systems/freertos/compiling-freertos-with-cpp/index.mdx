...
FreeRTOS primitives, such as mutexes, semaphores, queues, delays etc. **can be called directly from C++ code**. However, you may decide that more OO-friendly primitives are required.
