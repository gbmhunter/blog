...
This page details one way of serializing messages for embedded systems. The method described here is based on Google's [protobuf](/programming/serialization-formats/protobuf/) serialization format.
