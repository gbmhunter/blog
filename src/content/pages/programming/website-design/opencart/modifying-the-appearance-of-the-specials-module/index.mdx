...
<Image src={import('./_assets/open-cart-unmodified-specials-module-appearance.jpg')} width="800px">The default appearance of the specials module.</Image>
...
<Image src={import('./_assets/open-cart-adding-box-specials-css-class.jpg')} width="800px">Modifying the CSS to change the appearance of the OpenCart specials module.</Image>
...
<Image src={import('./_assets/open-cart-creating-title-background-with-gimp.jpg')} width="600px">Creating a title background for the OpenCart specials module with GIMP.</Image>
