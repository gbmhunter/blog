...
<Image src={import('./_assets/wordpress-plugin-broken-link-checker-edit-url.png')} width="650px">You only have to edit a broken hyperlink once for all ocurrances of it on your site.</Image>
