...
**Connect via your Lightsail instance via ssh.** You can use the in-browser terminal if you want, but I much prefer a proper terminal-based session (e.g. from Windows Terminal, bash on Linux, etc.) for better responsiveness and copy/paste support.
