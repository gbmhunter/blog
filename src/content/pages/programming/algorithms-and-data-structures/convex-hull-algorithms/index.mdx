...
<Image src={import('./convex_hull.png')} width="700px">The 2D convex hull for a set of points.</Image>
...
The Shapely library for Python has built-in support for finding the minimum bounded rectangle for a generic geometry type. Shapely can find the minimum bouded rectangle for polygons, point sequences, etc.
...
[https://www.geometrictools.com/Documentation/MinimumAreaRectangle.pdf](https://www.geometrictools.com/Documentation/MinimumAreaRectangle.pdf) is a very detailed and precies explanation on how the minimum bounded rectangle algorithm works. See [here](/misc/convex-hull-algorithms/2015-05-17-DavidEberly-MinimumAreaRectangle.pdf) for a cached copy.
