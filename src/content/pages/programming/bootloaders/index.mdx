...
date: 2015-01-09
description: Bootloaders are specific bits of code that are capable of updating the main application (or the bootloader) running on a machine. They can either be their own application or integrated into the main application. 
...
The BootROM expects the boot images to be in a specific format as defined by AMD. Each boot image can contains:
