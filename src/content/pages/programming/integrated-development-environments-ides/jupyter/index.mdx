...
This can be used to create very configurable and flexible cell outputs, as you can output anything that HTML supports: tables, images, headings, etc. and any combination of these! Style is also easily supplied with inline CSS.
