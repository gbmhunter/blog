...
authors: [gbmhunter]
date: 2013-05-28
description: Makefiles are a way of describing the build process for source code. They are used by the GNU make tool. This page cov
...
[^stack-overflow-cd-cmd-in-makefile]: StackOverflow. _How do I write the 'cd' command in a makefile?_. Retrieved 2024-10-03, from https://stackoverflow.com/questions/1789594/how-do-i-write-the-cd-command-in-a-makefile.
