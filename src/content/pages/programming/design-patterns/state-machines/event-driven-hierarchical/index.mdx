...
Sometimes you are left with no choice --- you have to call code outside of your control that will block (be it a peripheral driver function, OS call, library call etc.). In this case, you are left with a few options:
