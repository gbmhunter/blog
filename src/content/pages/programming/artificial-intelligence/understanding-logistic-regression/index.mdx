...
<Image src={import('./logistic-function-changing-b1.gif')} width="800px">Animated graph showing the effect of changing $\beta_1$ in the logistic function.</Image>
...
<Image src={import('./logistic-function-changing-b0.gif')} width="800px">Animated graph showing the effect of changing $\beta_0$ in the logistic function.</Image>
