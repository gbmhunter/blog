...
<Image src={import('./core-sight-debug-and-trace-overview-diagram-for-arm-cortex-m3.png')} width="600px">The ARM Cortex-M3 Coresight debug and trace overview diagram. Image from http://www.keil.com/support/man/docs/ulink2/ulink2_cs_core_sight.htm.</Image>
