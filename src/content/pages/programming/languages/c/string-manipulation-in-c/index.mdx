...
`getopt()` is a standard function for finding command-line arguments passed into `main()` as an array of strings. It is included in the [GCC glibc library](http://www.gnu.org/software/libc/). The files are also downloadable locally [here](/misc/string-manipulation-in-c/getopt.zip) (taken from GCC gLibC v2.17).
