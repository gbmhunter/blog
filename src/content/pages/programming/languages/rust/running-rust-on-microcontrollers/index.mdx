...
<Image src={import('./_assets/ewg-logo-blue-white-on-transparent.png')} width="200px">The logo of Rust's Embedded Devices Working Group[^bib-rust-embedded-working-group-repo].</Image>
...
<Image src={import('./_assets/tock-architecture-diagram.png')} width="700px">Architecture block diagram for the Tock RTOS. Image from the Tock documentation[^bib-tock-tock-design].</Image>
