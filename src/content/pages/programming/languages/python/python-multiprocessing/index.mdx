...
* Child processes do not crash the main process if they throw an exception/seg fault etc., resulting in a more resiliant application than when using multithreading.
