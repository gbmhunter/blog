...
<Image iref="fig-dataframe-file-format-size-comparison" src={import('./_assets/dataframe-file-format-size-comparison.webp')} width="700px">A comparison of the file size of the dataframe file formats with a test dataset.</Image>
