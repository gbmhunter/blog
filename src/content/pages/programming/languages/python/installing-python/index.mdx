...
<Image src={import('./_assets/windows-manage-app-execution-aliases-python.png')} width="400px">Deselect all flavours of python.exe from the App Execution Aliases settings dialogue in Windows to prevent the Windows Store from opening when you try and invoke a non-existent python.exe.</Image>
