...
You can put namespaces inside other namespaces for even finer organisation:
...
<Aside type="caution">
Do NOT define unnamed namespaces in header files. Due to default internal linkage, each translation unit that includes that header file will define its own unique instance of members in the unnamed namespace that are ODR-used. This can trigger undefined behaviour due to ODR violations.
</Aside>
