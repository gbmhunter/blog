...
Another neat property of function-local static variables is that they continue to exist after the function returns. This is not the case for normal local variables, which are destroyed when the function returns. This means you can return a reference to a function-local static variable to the caller. For example:
