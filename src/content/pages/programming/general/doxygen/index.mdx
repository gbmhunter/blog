...
<Image src={import('./doxygen-logo.png')} width="300px"></Image>
...
<Image src={import('./doxygen-html-documentation-screenshot.png')} width="1900px">Screenshot of the html documentation that Doxygen generates with properly commented code.</Image>
...
<Image src={import('./doxygen-gui-extract-private-and-static-selected.png')} width="829px">Selecting 'EXTRACT_PRIVATE' and 'EXTRACT STATIC' in the Doxygen GUI.</Image>
