...
<Image src={import('./_assets/msd-simulation/manual-tuning-02-increasing-kp-round-1.png')} width="900px">2st step of tuning, increasing $K_p$ until system continuously oscillates.</Image>
...
<Image src={import('./_assets/msd-simulation/msd-response-plot-p300-i300-d0.png')} width="800px">The response of the mass-spring-damper system with more proportional gain.</Image>
