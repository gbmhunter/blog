...
<Image src={import('./_assets/embedded-vendor-which-has-the-best-ecosystem.png')} width="650px">Results from a embedded design survey, showing what microcontroller users thought has the best ecosystem.</Image>
...
<td >Supported Programming/Debugging Methods:</td>
...
<td >SiLabs USB Debug Adapters</td>
		</tr>
		<tr >
