...
<Image src={import('./_assets/01-opening-up-the-pic-kit-3-edit.jpg')} width="494px">Opening up the bricked PICkit3. The programming header we are interested in (J2) is circled in yellow.</Image>  
...
<Image src={import('./_assets/02-soldering-on-a-6-pin-header.jpg')} width="591px">Soldering on a 6-pin 2.54mm header to J2 on the bricked PICkit3. If you make the wires short enough, you can leave this header on and fit it back into the enclosure without any problems.</Image>  
...
<Image src={import('./_assets/03-connecting-up-another-working-pic-kit-3-programmer.jpg')} width="1000px">Connecting up a working PICkit3 to the bricked PICkit3. Notice the polarity of the white arrow on the working PICkit 3 with the notch on J2.</Image>  
...
<Image src={import('./_assets/04-select-pic-24-from-device.jpg')} width="429px">Selecting 'PIC24' from the 'Device Family' menu in the PICkit 3 v3.01 standalone programmer.</Image>  
  
    Once connected, you should see something like this...  
  
<Image src={import('./_assets/05-isp-prog-the-pic-kit3-pic24-device-found.png')} width="445px">Bricked programmer microcontroller has been detected.</Image>  
...
<Image src={import('./_assets/06-select-the-pic-kit-3-os-image.png')} width="985px">Select the PICkit3 hex file 'PK3IMG0200005.hex' from 'C:/Program Files (x86)/Microchip/PICkit 3 v3' or similar.</Image>
...
<Image src={import('./_assets/07-programming-successful.png')} width="412px">Programming was successful!</Image>  
  
7. The PICkit 3 should now be unbricked!  
  
<Image src={import('./_assets/08-led-on-its-now-fixed.jpg')} width="455px">The bricked PICkit3 is now fixed, the LED's come on correctly!</Image>  
...
<Image src={import('./_assets/10-taping-up-the-header-to-prevent-shorts.jpg')} width="1000px">Taping up the header to prevent shorts. I decided to keep this attached just in case it happens again...</Image>  
  
9. The unbricked PICkit3 can now be put back in its case!
  
<Image src={import('./_assets/09-putting-the-pic-kit-3-back-in-its-enclosure.jpg')} width="449px">Putting the now un-bricked PICkit3 back into it's enclosure, with the programming header still attached (it fits quite nicely).</Image>
