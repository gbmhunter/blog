...
To add a post-build command to a CMake-based ESP-IDF project, you can use the `add_custom_command` function, targeting the `gen_project_binary` target. This function allows you to specify a shell command that should be executed after the build process has completed.
