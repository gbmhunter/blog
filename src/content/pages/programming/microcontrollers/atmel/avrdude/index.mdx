...
<Image src={import('./_assets/avr-dude-windows-command-line-default-usage-info.png')} width="486px">The default information printed by avrdude from the Windows command line.</Image>

It supports a wide-range of programmers and microcontrollers.

<Image src={import('./_assets/example-cmd-screenshot-of-avrdude-programming-atmega-microcontroller.png')} width="452px">A Windows command-line screenshot of AVRDUDE programming an Atmel ATmega microcontroller.</Image>
