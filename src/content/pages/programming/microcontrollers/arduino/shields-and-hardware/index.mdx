...
<Image src={import('./_assets/arduino-infrared-sensors.jpg')} width="400px">Arduino-compatible infrared sensors.</Image>
...
<Image src={import('./_assets/arduino-4wd-robot-motor-controller.jpg')} width="400px">The controller for a Arduino 4WD robot.</Image>

## Sensor Shield

<Image src={import('./_assets/arduino-sensor-shield.jpg')} width="400px">An Arduino sensor shield.</Image>
...
<Image src={import('./_assets/arduino-ultrasound-module.jpg')} width="600px">An Arduino compatible ultrasound module.</Image>

## The DealExtreme Robotic Platform

<Image src={import('./_assets/bottom-side-of-arduino-4wd-robot.jpg')} width="200px">The bottom side of the 4WD Arduino robot.</Image>
...
<Image src={import('./_assets/arduino-4wd-robot-base-wheels-motor-driver.jpg')} width="600px">A Arduino robot base.</Image>
