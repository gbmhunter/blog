...
<Image src={import('./arduino-uno-r3-photo.jpg')} width="425px">A photo of the Arduino Uno (revision r3). Image from https://www.wikimedia.org/.</Image>
...
<Image src={import('./arduino-logo.svg')} width="300px">The Arduino logo.</Image>
...
<Image src={import('./windows-8-start-screen.jpg')} width="272px">The Windows 8 start screen.</Image>

## NetDuino

An embedded platform that runs the .NET Micro framework.

<Image src={import('./netduino-plus-photo.jpg')} width="470px">The Netduino, an embedded platform that runs the .NET Micro framework. Image from http://netduino.com/.</Image>
...
Most importantly, the Arduino IDE is free and open-source. The complete tool-chain (compilers/linkers/assemblers/programmers etc.) is free to use.
...
<Image src={import('./mariamole-screenshot-from-website.jpg')} width="402px">Screenshot of the MariaMole IDE. Image from http://dalpix.com/mariamole.</Image>
