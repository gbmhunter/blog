...
<Image src={import('./arduino-uno-pcb.jpg')} width="200px">The Arduino UNO, the first ever Arduino PCB.</Image>
...
<Image src={import('./arduino-yun-pcb.jpg')} width="200px">The Arduino Yun, a PCB with both a real-time Arduino microcontroller and Linux-based microprocessor.</Image>
