...
tags: [programming, microcontrollers, Arduino]
...
<Image src={import('./_assets/arduino-uno-pcb.jpg')} width="200px">The Arduino UNO, the first ever Arduino PCB.</Image>
...
Legitimate versions: DigiKey, Element14, Mouser, etc.  
...
<Image src={import('./_assets/arduino-yun-pcb.jpg')} width="200px">The Arduino Yun, a PCB with both a real-time Arduino microcontroller and Linux-based microprocessor.</Image>
