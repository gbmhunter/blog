...
The Hailo-8 uses HEF files (`.hef` -- Hailo Executable Format) to run inference. They contain optimized layers and weights for run efficient inference on the Hailo-8. Hailo provides a [Model Zoo](https://github.com/hailo-ai/hailo_model_zoo) with pre-trained models.
