...
* Act as analogue I/O. This means you cannot connect them up things like the ADC, VDAC, IDAC, etc.
...
<Image src={import('./_assets/additional-features-only-provided-on-sio-pins.png')} width="631px">Information on the SIO pins from a PSoC datasheet.</Image>
