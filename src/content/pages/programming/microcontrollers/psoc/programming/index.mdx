...
<Image src={import('./_assets/swd-programming-interface-for-psoc-5.png')} width="250px">The pinout for the PSoC programming interface.</Image>
...
<Image src={import('./_assets/mini-prog-3-insides-top.jpg')} width="400px">The top view of the MiniProg3 PCB with the cover removed.</Image>

<Image src={import('./_assets/mini-prog-3-insides-bottom_0.jpg')} width="400px">The bottom view of the MiniProg3 PCB with the cover removed.</Image>
