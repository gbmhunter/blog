...
import mercurial_error_msg_abandoned_transaction_found from './_assets/mercurial-error-msg-abandoned-transaction-found.png'

<Image src={mercurial_error_msg_abandoned_transaction_found} width="300px">The 'abandoned transaction found' Mercurial error message.</Image>
