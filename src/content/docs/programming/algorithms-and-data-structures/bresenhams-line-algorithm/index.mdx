...
import bresenham_selecting_next_pixel from './bresenham-selecting-next-pixel.png'

<Image src={bresenham_selecting_next_pixel} width="700px">Choosing the next pixel when drawing a line. Each grid point is the center of a pixel. The blue dot is the previously selected pixel that has been drawn. We have to choose the next pixel from the two possible orange options.</Image>
...
import bresenham_pixels_shaded from './bresenham-pixels-shaded.png'

<Image src={bresenham_pixels_shaded} width="700px">A line drawn using Bresenham's line algorithm.</Image>

It also helps to see Bresenham's line algorithm in action on a larger line:

import bresenham_large_line from './bresenham-large-line.png'

<Image src={bresenham_large_line} width="700px">A line drawn using Bresenham's line algorithm.</Image>
