...
import nz_nat_yearly_temp_plot from './nz-nat-yearly-temp-plot.png'

<Image src={nz_nat_yearly_temp_plot} width="600px">The effect of SMAs on data. New Zealand's national average yearly temperatures, overlaid with a 5-wide and 20-wide left-handed SMA.</Image>
...
import sine_wave_with_noise from './sine-wave-with-noise.png'

<Image src={sine_wave_with_noise} width="600px">Plot showing a noisy sine wave (random, normally distributed noise) and then the application of a SMA filter (symmetric, window size = 50) which recovers the original signal really well!</Image>
...
import frequency_response_of_sma_magnitude from './frequency-response-of-sma-magnitude.png'

<Image src={frequency_response_of_sma_magnitude} width="700px">The magnitude response of a SMA filter with fs=1kHz and a window size of 10. Frequency range is from 0Hz up to Nyquist (fs/2).</Image>
...
import frequency_response_of_sma_phase from './frequency-response-of-sma-phase.png'

<Image src={frequency_response_of_sma_phase} width="700px">The phase response of a SMA filter with fs=1kHz and a window size of 10. Frequency range is from 0Hz up to Nyquist (fs/2).</Image>

For interest, let's have a look at how increasing the window size effects the frequency response:

import sma_freq_response_various_window_sizes from './sma-freq-response-various-window-sizes.png'

<Image src={sma_freq_response_various_window_sizes} width="500px">Plot showing what effect an increasing window size has on the frequency response (magnitude) of a SMA filter.</Image>
...
import windowed_moving_average_accumulated_error from './windowed-moving-average-accumulated-error.png'

<Image src={windowed_moving_average_accumulated_error} width="700px">Plot showing the error that slowly accumulates when using the recursive SMA method with floating points.</Image>
...
import window_comparison_shapes from './window-comparison-shapes.png'

<Image src={window_comparison_shapes} width="600px">A comparison of the popular window shapes for moving average filters.</Image>

And a comparison of the frequency responses of these windows is shown below: 

import window_comparison_frequency_response from './window-comparison-frequency-response.png'

<Image src={window_comparison_frequency_response} width="600px">The frequency responses of the popular window shapes shown above, normalized w.r.t to the sampling frequency fs.</Image>
