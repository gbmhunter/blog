...
import psoc_programmer_screenshot_01 from './_assets/psoc-programmer-screenshot-01.png'

<Image src={psoc_programmer_screenshot_01} width="600px">Screenshot of the PSoC programmer application in Windows.</Image>
...
import psoc_programmer_chip_lock_enabled from './_assets/psoc-programmer-chip-lock-enabled.png'

<Image src={psoc_programmer_chip_lock_enabled} width="600px">The 'Chip Lock Enabled' option in PSoC programmer.</Image>
