...
import swd_programming_interface_for_psoc_5 from './_assets/swd-programming-interface-for-psoc-5.png'

<Image src={swd_programming_interface_for_psoc_5} width="250px">The pinout for the PSoC programming interface.</Image>
...
import mini_prog_3_insides_top from './_assets/mini-prog-3-insides-top.jpg'

<Image src={mini_prog_3_insides_top} width="400px">The top view of the MiniProg3 PCB with the cover removed.</Image>

import mini_prog_3_insides_bottom_0 from './_assets/mini-prog-3-insides-bottom_0.jpg'

<Image src={mini_prog_3_insides_bottom_0} width="400px">The bottom view of the MiniProg3 PCB with the cover removed.</Image>
