...
import freertos_logo_large from './_assets/freertos-logo-large.jpg'

<Image src={freertos_logo_large} width="320px">The FreeRTOS logo. Image from http://www.arm.com/community/partners/display_product/rw/ProductId/4028/.</Image>
