...
import psoc_creator_verilog_report_file_technology_mapping_summary_hardware_utilisation from './_assets/psoc-creator-verilog-report-file-technology-mapping-summary-hardware-utilisation.png'

<Image src={psoc_creator_verilog_report_file_technology_mapping_summary_hardware_utilisation} width="800px">The PSoC Creator 'Technology Mapping Table' in the .rpt file, showing a breakdown of the hardware utilisation.</Image>
