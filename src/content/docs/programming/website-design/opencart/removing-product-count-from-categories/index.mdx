...
import open_cart_product_count_next_to_categories_before_and_after from './_assets/open-cart-product-count-next-to-categories-before-and-after.jpg'

<Image src={open_cart_product_count_next_to_categories_before_and_after} width="600px">Removing the product count from the categories in OpenCart. This uses the free VSmod extension 'Simple Remove Product Count From Categories'.</Image>
