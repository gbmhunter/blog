...
import docusaurus_deployed_successfully_on_vercel from './_assets/docusaurus-deployed-successfully-on-vercel.webp'

<Image src={docusaurus_deployed_successfully_on_vercel} width="900">A screenshowing showing this blog being built and deployed successfully on Vercel.</Image>
