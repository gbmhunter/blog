...
import embedded_vendor_which_has_the_best_ecosystem from './_assets/embedded-vendor-which-has-the-best-ecosystem.png'

<Image src={embedded_vendor_which_has_the_best_ecosystem} width="650px">Results from a embedded design survey, showing what microcontroller users thought has the best ecosystem.</Image>
