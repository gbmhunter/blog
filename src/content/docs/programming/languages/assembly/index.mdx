...
import assembly_code_example from './_assets/assembly-code-example.png'

<Image src={assembly_code_example} width="481px">An example of assembly code from the glibc library (an optimised memcpy() function).</Image>
