...
<Image src={magic_statics_icon_bunny_hat_code} width="300px"></Image>
...
This is sometimes called the _Meyers' Singleton_ after Scott Meyers publication "[_C++ and the Perils of Double-Checked Locking_](./_assets/Scott-Meyers-Cpp-and-the-Perils-of-Double-Checked-Locking.pdf)".
...
import visual_studio_support_for_cpp_magic_statics from './_assets/visual-studio-support-for-cpp-magic-statics.png'

<Image src={visual_studio_support_for_cpp_magic_statics} width="622px">Table showing Visual Studio's support for magic statics. Image from https://msdn.microsoft.com/en-us/library/hh567368.aspx.</Image>
