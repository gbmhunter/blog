...
import rust_programming_language_logo_white_background from './_assets/rust-programming-language-logo-white-background.png'

<Image src={rust_programming_language_logo_white_background} width="300px">The logo of the Rust programming language. Image from http://www.rust-lang.org/.</Image>
