...
import elf_section_bss_will_not_fit_in_region_ram from './_assets/elf-section-bss-will-not-fit-in-region-ram.png'

<Image src={elf_section_bss_will_not_fit_in_region_ram} width="700px">C build error 'elf section '.bss' will not fit in region 'ram'</Image>
...
import c_warning_suggesed_parentheses_around_assignment_used_as_truth_value from './_assets/c-warning-suggesed-parentheses-around-assignment-used-as-truth-value.png'

<Image src={c_warning_suggesed_parentheses_around_assignment_used_as_truth_value} width="500px">A warning message from the C compiler.</Image>
...
import c_build_error_subscripted_value_is_neither_array_nor_pointer from './_assets/c-build-error-subscripted-value-is-neither-array-nor-pointer.png'

<Image src={c_build_error_subscripted_value_is_neither_array_nor_pointer} width="500px">The C build error 'subscripted value is neither array nor pointer'.</Image>
...
import c_build_warning_pragma_once_in_main_file from './_assets/c-build-warning-pragma-once-in-main-file.png'

<Image src={c_build_warning_pragma_once_in_main_file} width="500px">The C compiler warning '#pragma once in main file' which occurs when the directive '#pragma once' is incorrectly placed in a .c file.</Image>
...
import c_build_error_variable_or_field_declared_void from './_assets/c-build-error-variable-or-field-declared-void.png'

<Image src={c_build_error_variable_or_field_declared_void} width="500px">The C build error 'Variable or field declared void'.</Image>
...
import keil_c51_build_error_not_in_formal_parameter_list from './_assets/keil-c51-build-error-not-in-formal-parameter-list.png'

<Image src={keil_c51_build_error_not_in_formal_parameter_list} width="500px">The 'not in formal parameter list' build error is most likely to occur when you have forgotten to add the semi-colon at the end of a function declaration.</Image>
