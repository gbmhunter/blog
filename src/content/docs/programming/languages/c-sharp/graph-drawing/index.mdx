...
import nplot_screenshot from './_assets/nplot-screenshot.png'

<Image src={nplot_screenshot} width="300px">Screenshot of the NPlot charting library for .NET. Features a 2D candleplot, filled region, line plot and datetime axis.</Image>
...
import telerik_radchart_screenshot from './_assets/telerik-radchart-screenshot.png'

<Image src={telerik_radchart_screenshot} width="300px">Screenshot of the Telerik charting library for .NET applications. Comes with some very nice skins and tutorials.</Image>
...
import zedgraph_screenshot from './_assets/zedgraph-screenshot.png'

<Image src={zedgraph_screenshot} width="300px">Screenshot of the ZedGraph charting library for .NET. One of the most powerful and widely used free charting libraries.</Image>
