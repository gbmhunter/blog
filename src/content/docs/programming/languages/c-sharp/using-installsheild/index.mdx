...
import visual_studio_config_manager_window_single_image from './_assets/visual-studio-config-manager-window-single-image.png'

<Image src={visual_studio_config_manager_window_single_image} width="600px">Making InstallShield produce a single file output install (e.g. setup.exe) in the Visual Studio configuration manager.</Image>
...
import another_version_is_installed_error_from_install_shield from './_assets/another-version-is-installed-error-from-install-shield.png'

<Image src={another_version_is_installed_error_from_install_shield} width="450px">The 'Another version is installed' error that InstallShield gives you if you haven't set the updates up correctly.</Image>
...
import install_shield_adding_new_upgrade_path from './_assets/install-shield-adding-new-upgrade-path.png'

<Image src={install_shield_adding_new_upgrade_path} width="800px">Adding a new update path, so newer versions of the program will install over older versions.</Image>
...
import change_product_code_not_upgrade_code_install_shield from './_assets/change-product-code-not-upgrade-code-install-shield.png'

<Image src={change_product_code_not_upgrade_code_install_shield} width="700px">If you want a install to replace/upgrade and older one, make sure to re-generate a different product code (the circled number).</Image>
...
import install_shield_launch_this_program_end_of_installation from './_assets/install-shield-launch-this-program-end-of-installation.png'

<Image src={install_shield_launch_this_program_end_of_installation} width="500px">The option to allow the user to launch the program once the installation has finished. This normally doesn't work without tweaking a few settings.</Image>
