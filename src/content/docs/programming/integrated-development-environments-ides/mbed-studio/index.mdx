...
import arm_mbed_studio_getting_started from './arm-mbed-studio-getting-started.png'

<Image src={arm_mbed_studio_getting_started} width="600px">A screenshot of the 'Getting Started' welcome screen in Mbed Studio.</Image>

Mbed Studio uses ARM Compiler 6 (as of June 2020).

import mbed_studio_os_blinky_example from './mbed-studio-os-blinky-example.png'

<Image src={mbed_studio_os_blinky_example} width="600px">A screenshot of the 'OS blinky' example project in Mbed Studio.</Image>
