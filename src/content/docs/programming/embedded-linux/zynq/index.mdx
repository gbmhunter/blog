...
import xilinx_zynq_7000_ZC720_evaluation_kit_photo from './xilinx-zynq-7000-ZC720-evaluation-kit-photo.png'

<Image src={xilinx_zynq_7000_ZC720_evaluation_kit_photo} width="773px">The Xilinx ZC720 Evaluation Kit featuring the Zynq-7000 SoC.</Image>
