...
import polumna_construction from './_assets/polumna_construction.jpg'

<Image src={polumna_construction} width="320px">Diagram with instructions on showing how to make a polumna.</Image>
...
import polumna_01 from './_assets/polumna_01.jpg'

<Image src={polumna_01} width="320px">The layers of newspaper used to make a polumna.</Image>
...
1. This will form and pocket inside the triangle. This is where you pour in about 2 grams of BP or flash powder. Fill the pocket so it is 3/4 full, then place the end of the fuse in the mix.

import polumna_02 from './_assets/polumna_02.jpg'

<Image src={polumna_02} width="320px">Wrapping the newspaper into a triangle, filling it with blackpower, and then adding a fuse.</Image>
...
import polumna_03 from './_assets/polumna_03.jpg'

<Image src={polumna_03} width="320px">The finished polumna.</Image>

1. Light fuse and get to a safe distance!

import polumna_04 from './_assets/polumna_04.jpg'

<Image src={polumna_04} width="320px">The remains of a polumna.</Image>
