...
import lvds_multipoint_configuration_example_schematic_ti from './lvds-multipoint-configuration-example-schematic-ti.png'

<Image src={lvds_multipoint_configuration_example_schematic_ti} width="676">Example schematics showing LVDS devices in a multipoint configuration. Image from www.ti.com.</Image>
