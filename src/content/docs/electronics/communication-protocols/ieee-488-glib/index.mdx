...
draft: false
image: /images/page-images/ieee-488-glib.jpg
last_update:
  date: 2020-07-13
...
import gpib_ieee_488_keithley_daq from './_assets/gpib-ieee-488-keithley-daq.jpg'

<Image src={gpib_ieee_488_keithley_daq} width="400">Photo of the Keithley DAQ6510 Data Acquisition And Logging module which uses the IEEE-488 (GPIB) bus.</Image>
