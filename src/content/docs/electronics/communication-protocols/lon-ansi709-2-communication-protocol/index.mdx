...
import lonmark_international_logo_certified from './_assets/lonmark-international-logo-certified.jpg'

<table>
    <tbody>
        <tr>
            <td>Logo</td>
            <td><Image src={lonmark_international_logo_certified} width="200"></Image></td>
        </tr>
        <tr>
            <td>Speed</td>
...
import ft_5000_smart_transceiver_cip_block_diagram from './_assets/ft-5000-smart-transceiver-cip-block-diagram.png'

<Image src={ft_5000_smart_transceiver_cip_block_diagram} width="392">The block diagram for the FT5000 'Smart Transceiver' IC which can be used as part of a LON node.</Image>
...
import ft500_ft_x3_connection_diagram from './_assets/ft500-ft-x3-connection-diagram.png'

<Image src={ft500_ft_x3_connection_diagram} width="518">A connection diagram between the FT5000 processor and the FT-X3 transformer.</Image>
...
import ft5000_typical_operating_conditions from './_assets/ft5000-typical-operating-conditions.png'

<Image src={ft5000_typical_operating_conditions} width="325">The typical operating conditions of the FT5000 processor.</Image>
...
import ft5000_allowed_external_memory_configurations from './_assets/ft5000-allowed-external-memory-configurations.png'

<Image src={ft5000_allowed_external_memory_configurations} width="270">The permitted external memory configurations for the FT5000 processor.</Image>
