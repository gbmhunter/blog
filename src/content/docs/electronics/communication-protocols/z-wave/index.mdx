...
import z_wave_logo_large from './z-wave-logo-large.png'

<Image src={z_wave_logo_large} width="447">The Z-Wave logo. Image from [http://www.z-wave.com/](http://www.z-wave.com/).</Image>
