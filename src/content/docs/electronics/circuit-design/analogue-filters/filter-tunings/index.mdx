...
import cover_photo from './_assets/cover-photo.png'

<Image src={cover_photo} width="500">Schematic of a simple low-pass RC filter.</Image>
...
import butterworth_bode_plot_for_various_n from './_assets/butterworth-bode-plot-for-various-n.png'

<Image src={butterworth_bode_plot_for_various_n} width="900">Magnitude and phase bode plots for normalized Butterworth filters of orders 1, 2, 4 and 8.</Image>
...
import chebyshev_poly_graph from './_assets/chebyshev-poly-graph.png'

<Image src={chebyshev_poly_graph} width="600">The first 6 Chebyshev polynomials (of the first kind) from $T_0$ to $T_5$.</Image>
...
import tuning_comparison_group_delay from './_assets/tuning-comparison-group-delay.png'

<Image src={tuning_comparison_group_delay} width="700">The group delay for various 4th-order filter tunings. The Bessel-tuned filter has the flattest group delay in the passband.</Image>
...
import tuning_comparison_step_response from './_assets/tuning-comparison-step-response.png'

<Image src={tuning_comparison_step_response} width="600">Step response comparison of different filter tunings. The Bessel-tuned filter has the least ringing.</Image>
...
import bessel_2nd_order_bode_plot from './_assets/bessel-2nd-order-bode-plot.png'

<Image src={bessel_2nd_order_bode_plot} width="600">Bode plots for the 2nd-order Bessel low-pass filter.</Image>
...
import tuning_comparison_gain_db from './_assets/tuning-comparison-gain-db.png'

<Image src={tuning_comparison_gain_db} width="600">Gain comparison of different filter tunings.</Image>
...
import tuning_comparison_gain_linear from './_assets/tuning-comparison-gain-linear.png'

<Image src={tuning_comparison_gain_linear} width="600">Gain comparison of different filter tunings, now with linear x and y axes.</Image>
...
import tuning_comparison_phase_log from './_assets/tuning-comparison-phase-log.png'

<Image src={tuning_comparison_phase_log} width="600">Phase comparison of different filter tunings.</Image>
...
import tuning_comparison_phase_linear from './_assets/tuning-comparison-phase-linear.png'

<Image src={tuning_comparison_phase_linear} width="600">Phase comparison of different filter tunings, with a linear x-axis (frequency) which makes it easy to see how linear the phase response is.</Image>
...
<Image src={tuning_comparison_group_delay} width="600">Group delay comparison of different filter tunings.</Image>
...
<Image src={tuning_comparison_step_response} width="600">Step response comparison of different filter tunings.</Image>
