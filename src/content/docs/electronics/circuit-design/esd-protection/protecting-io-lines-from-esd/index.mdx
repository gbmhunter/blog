...
import io_protection_with_resistor from './io-protection-with-resistor.png'

<Image src={io_protection_with_resistor} width="600">Simple IO protection with a series resistor.</Image>
...
import io_protection_with_resistor_capacitor from './io-protection-with-resistor-capacitor.png'

<Image src={io_protection_with_resistor_capacitor} width="600">Simple IO protection with a series resistor and capacitor.</Image>
...
import io_protection_with_tvs_diode from './io-protection-with-tvs-diode.png'

<Image src={io_protection_with_tvs_diode} width="600">ESD protection with a TVS diode. The standoff voltage is normally set to the maximum working voltage (i.e. +3.3V in this case) and will begin to conduct significantly as the voltage rises above this level.</Image>
...
import io_protection_with_steering_diodes_to_rail from './io-protection-with-steering-diodes-to-rail.png'

<Image src={io_protection_with_steering_diodes_to_rail} width="600">Using steering diodes (Schottky diodes connected as shown) to protect an IO line from ESD.</Image>
...
import io_protection_with_steering_diodes_to_rail_and_tvs from './io-protection-with-steering-diodes-to-rail-and-tvs.png'

<Image src={io_protection_with_steering_diodes_to_rail_and_tvs} width="700">Protecting an IO line from ESD with both steering diodes and a TVS diode.</Image>
...
import littelfuse_sp3012_06utg_esd_array_functional_block_diagram from './littelfuse-sp3012-06utg-esd-array-functional-block-diagram.png'

<Image src={littelfuse_sp3012_06utg_esd_array_functional_block_diagram} width="300">Functional block diagram for the Littelfuse SP3012-06UTG ESD diode array[^bib-littelfuse-sp3012-ds].</Image>

import littelfuse_sp3012_06utg_esd_array_usb30_application_example from './littelfuse-sp3012-06utg-esd-array-usb30-application-example.png'

<Image src={littelfuse_sp3012_06utg_esd_array_usb30_application_example} width="300">Using the Littelfuse SP3012-06UTG to protect data lines on USB3.0[^bib-littelfuse-sp3012-ds].</Image>
</div>
...
import littelfuse_srda33_functional_block_diagram from './littelfuse-srda33-functional-block-diagram.png'

<Image src={littelfuse_srda33_functional_block_diagram} width="300">The functional block diagram of the Littelfuse SRDA3.3 steering diode array[^bib-littelfuse-srda33-ds].</Image>
