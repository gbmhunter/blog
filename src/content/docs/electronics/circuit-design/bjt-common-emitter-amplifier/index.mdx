...
import common_emitter_amplifier_schematic from './_assets/common-emitter-amplifier-schematic.png'

<Image src={common_emitter_amplifier_schematic} width="600">Schematic for a common emitter amplifier with DC bias and AC coupling.</Image>
...
import common_emitter_amplifier_gain_equation_diagram from './_assets/common-emitter-amplifier-gain-equation-diagram.png'

<Image src={common_emitter_amplifier_gain_equation_diagram} width="300">Diagram showing how the gain equation for a common emitter amplifier is found.</Image>
...
import common_emitter_amplifier_design_process_schematic from './_assets/common-emitter-amplifier-design-process-schematic.png'

<Image src={common_emitter_amplifier_design_process_schematic} width="800">The finished schematic of our common emitter amplifier, ready for simulation.</Image>
...
import common_emitter_amplifier_simulation_vin_vout_plot from './_assets/common-emitter-amplifier-simulation-vin-vout-plot.png'

<Image src={common_emitter_amplifier_simulation_vin_vout_plot} width="600">Simulation results showing $V_{OUT}$ vs. $V_{IN}$.</Image>
...
import common_emitter_amplifier_simulation_freq_response_plot from './_assets/common-emitter-amplifier-simulation-freq-response-plot.png'

<Image src={common_emitter_amplifier_simulation_freq_response_plot} width="600">The simulated frequency response of our common emitter amplifier.</Image>
