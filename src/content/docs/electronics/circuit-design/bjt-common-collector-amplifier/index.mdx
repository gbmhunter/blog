...
import common_collector_bjt_amplifier_basic_schematic from './common-collector-bjt-amplifier-basic-schematic.png'

<Image src={common_collector_bjt_amplifier_basic_schematic} width="400">The basic schematic of a common-collector BJT amplifier.</Image>
...
import basic_common_collector_amplifier_plot_annotated from './basic-common-collector-amplifier/plot-annotated.png'

<Image src={basic_common_collector_amplifier_plot_annotated} width="800">$V_{out}$ vs. $V_{in}$ for a basic common-collector BJT amplifier.</Image>
...
import common_collector_bjt_amplifier_ac_coupled_schematic from './common-collector-bjt-amplifier-ac-coupled-schematic.png'

<Image src={common_collector_bjt_amplifier_ac_coupled_schematic} width="600">Schematic of an AC-coupled common-collector NPN BJT amplifier.</Image>

The small-signal AC model for this circuit is shown below. DC voltage rails and capacitors are shorted.


import common_collector_bjt_amplifier_ac_coupled_ac_equivalent_schematic from './common-collector-bjt-amplifier-ac-coupled-ac-equivalent-schematic.png'

<Image src={common_collector_bjt_amplifier_ac_coupled_ac_equivalent_schematic} width="600">Small-signal AC model for the AC-coupled common-collector BJT amplifier.</Image>
...
import graph_from_kenneth_kuhn_cc_amplifier_design from './graph-from-kenneth-kuhn-cc-amplifier-design.png'

<Image src={graph_from_kenneth_kuhn_cc_amplifier_design} width="400">Just one example of a graph from Kenneth Kuhn's excellent Common-Collector Amplifier Design[^bib-kenneth-kuhn-common-collector-amp-design].</Image>
