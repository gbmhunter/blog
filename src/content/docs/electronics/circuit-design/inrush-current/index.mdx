...
import inrush_current_limiting_with_thermistor from './inrush-current-limiting-with-thermistor.jpg'

<Image src={inrush_current_limiting_with_thermistor} width="475">A graph showing the effect of a NTC thermistor limiting the inrush current to a circuit.</Image>
