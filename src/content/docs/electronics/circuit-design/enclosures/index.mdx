...
import extruded_aluminium_enclosures_eurocard_pcb from './extruded-aluminium-enclosures-eurocard-pcb.jpg'

<Image src={extruded_aluminium_enclosures_eurocard_pcb} width="300">Examples of extruded aluminium enclosures by Vero Technologies.</Image>
