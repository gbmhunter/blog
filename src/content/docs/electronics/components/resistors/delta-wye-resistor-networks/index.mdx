...
import delta_wye_pi_t_networks from './delta-wye-pi-t-networks.png'

<Image src={delta_wye_pi_t_networks} width="800px">Schematic showing the four common resistor network arrangements: Wye, Delta, Pi and Tee.</Image>
...
import wheatstone_resistor_network_worked_example_01 from './wheatstone-resistor-network-worked-example-01.png'

<Image src={wheatstone_resistor_network_worked_example_01} width="300px">What is the current I drawn from the +12V for this resistor network? This can't be solved purely with resistors-in-series and resistors-in-parallel equations, but can be done with the help of a Delta To Wye transformation.</Image>

Let's treat the top three resistors as a Delta network:

import wheatstone_resistor_network_worked_example_02 from './wheatstone-resistor-network-worked-example-02.png'

<Image src={wheatstone_resistor_network_worked_example_02} width="300px">We can treat the top three resistors as a Delta network.</Image>
...
import wheatstone_resistor_network_worked_example_03 from './wheatstone-resistor-network-worked-example-03.png'

<Image src={wheatstone_resistor_network_worked_example_03} width="300px">The same circuit, but now transformed to a Wye network.</Image>
...
import wheatstone_resistor_network_worked_example_04 from './wheatstone-resistor-network-worked-example-04.png'

<Image src={wheatstone_resistor_network_worked_example_04} width="300px">The two bottom legs simplified.</Image>
...
import wheatstone_resistor_network_worked_example_05 from './wheatstone-resistor-network-worked-example-05.png'

<Image src={wheatstone_resistor_network_worked_example_05} width="200px">Simplifying the two bottom resistors in parallel into this one resistor.</Image>
...
import wheatstone_resistor_network_worked_example_06 from './wheatstone-resistor-network-worked-example-06.png'

<Image src={wheatstone_resistor_network_worked_example_06} width="200px">Simplifying the two remaining resistors in series into just the one resistor.</Image>
...
import circuitjs_sim_of_wheatstone_resistor_network from './circuitjs-sim-of-wheatstone-resistor-network.png'

<Image src={circuitjs_sim_of_wheatstone_resistor_network} width="200px">Screenshot of this Wheatstone bridge resistor network in a circuitjs simulation.</Image>
