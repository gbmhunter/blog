...
import classic_bjt_astable_multivibrator from './classic-bjt-astable-multivibrator.svg'

<Image src={classic_bjt_astable_multivibrator} width="600px">A basic (and somewhat of a classic) BJT astable multivibrator.</Image>
...
import flasher_schematics_dick_smiths_funway_into_electronics from './flasher-schematics-dick-smiths-funway-into-electronics.png'

<Image src={flasher_schematics_dick_smiths_funway_into_electronics} width="600px">'The flasher' circuit here is a BJT astable multivibrator. Diode and 390R resistor are just for protection in-case the 9V battery gets hooked up the wrong way. Image from Dick Smith's Fun Way Into Electronics, Eighth Printing, page 24.</Image>
...
import n_555_timer_simplified_internal_schematic_ti from './555-timer-simplified-internal-schematic-ti.png'

<Image src={n_555_timer_simplified_internal_schematic_ti} width="600px">A simplified internal schematic of a 555 timer IC. Image from https://www.ti.com/lit/ds/symlink/sa555.pdf?HQS=TI-null-null-digikeymode-df-pf-null-wwe.</Image>
...
import n_555_timer_schematic_for_monostable_operation_ti from './555-timer-schematic-for-monostable-operation-ti.png'

<Image src={n_555_timer_schematic_for_monostable_operation_ti} width="600px">Schematic for putting the 555 timer into monostable mode. Image from https://www.ti.com/lit/ds/symlink/sa555.pdf?HQS=TI-null-null-digikeymode-df-pf-null-wwe.</Image>
...
import n_555_timer_schematic_for_astable_operation_ti from './555-timer-schematic-for-astable-operation-ti.png'

<Image src={n_555_timer_schematic_for_astable_operation_ti} width="600px">Schematic for putting the 555 timer into astable mode. Image from https://www.ti.com/lit/ds/symlink/sa555.pdf?HQS=TI-null-null-digikeymode-df-pf-null-wwe.</Image>
