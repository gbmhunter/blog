...
import lm7805_voltage_regulator from './lm7805-voltage-regulator.jpg'
import ptma401120_dcdc_converter_module_from_ti from './ptma401120-dcdc-converter-module-from-ti.png'
import joule_thief from './joule-thief.jpg'
...
<tr>
  ...
  <td><Image src={lm7805_voltage_regulator} width="160px">The LM7805 5V linear voltage regulator in a TO-220 package.</Image></td>
</tr>
<tr>
<td>Buck Converter</td>
<td>
...
<td><Image src={ptma401120_dcdc_converter_module_from_ti} width="160px">The PTMA401120 DC/DC converter module from Texas Instruments. This can convert anything from 36 to 72V down to 12V with a 1A output.</Image></td>
</tr>
<tr>
  <td>Boost Converter</td>
  <td>
...
<tr>
  ...
  <td><Image src={joule_thief} width="160px">A tiny Joule Thief made for a single coin battery that can power an LED.</Image></td>
</tr>
</tbody>
</table>
...
import recom_acdc_converter from './recom-acdc-converter.jpg'

<Image src={recom_acdc_converter} width="200px">A Recom AC/DC converter module that can take 100-240VAC as it's input and outputs 12V at up to 83mA.</Image>
...
import ul60950_limited_power_circuits_graph from './ul60950-limited-power-circuits-graph.png'

<Image src={ul60950_limited_power_circuits_graph} width="400px">A graph of voltage vs. current for a LPS (limited power supply).</Image>
