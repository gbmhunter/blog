...
import scr_pn_junction_diagram from './scr-pn-junction-diagram.svg'

<Image src={scr_pn_junction_diagram} width="400px">The construction of a SCR showing the P and N semiconductor regions.</Image>
...
import two_scrs_on_heatsinks from './two-scrs-on-heatsinks.jpg'

<Image src={two_scrs_on_heatsinks} width="600px">Two high-power SCRs in TO-93 packages that are mounted to heatsinks (the International Rectifier 151RB60 and an unknown SCR).</Image>

## Schematic Symbol

The schematic symbol for an SCR is shown below:

import scr_schematic_symbol from './scr-schematic-symbol.svg'

<Image src={scr_schematic_symbol} width="400px">The schematic symbol for a silicon controlled rectifier (SCR).</Image>
...
import m54123l_circuit_breaker_typical_application_with_scr from './m54123l-circuit-breaker-typical-application-with-scr.png'

<Image src={m54123l_circuit_breaker_typical_application_with_scr} width="600px">Typical application diagram for the M54123L circuit breaker IC, showing the use of an external SCR.</Image>
