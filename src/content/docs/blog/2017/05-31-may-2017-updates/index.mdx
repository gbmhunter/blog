...
import clion_logo from './_assets/clion-logo.png'

<Image src={clion_logo} width="261px">The CLion logo.</Image>

* New [Space sub-site](/space) added to www.mbedded.ninja.  

import planet_icon_space from './_assets/planet-icon-space.png'

<Image src={planet_icon_space} width="200px"></Image>
...
import tle_two_line_element_example_first_quarter from './_assets/tle-two-line-element-example-first-quarter.png'

<Image src={tle_two_line_element_example_first_quarter} width="575px">A partial screenshot of a TLE (two-line element) for the NOAA 14 satellite.</Image>
...
import yocto_device_tree_conversion_from_blob_to_source from './_assets/yocto-device-tree-conversion-from-blob-to-source.png'

<Image src={yocto_device_tree_conversion_from_blob_to_source} width="1159px">A comparison between the Yocto generated binary Device Tree Blob (.dtb) file and the human-readable Device Tree Source (.dts) file that can be created from the .dtb file using the program dtc.</Image>