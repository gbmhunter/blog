...
<Image src={ninja_calc_crc_calculator_example} width="1094px">Example usage of the CRC Calculator within NinjaCalc (http://gbmhunter.github.io/NinjaCalc/).</Image>
...
import ninja_calc_logo_v2_no_transparency from './_assets/ninja-calc-logo-v2-no-transparency.png'

<Image src={ninja_calc_logo_v2_no_transparency} width="308px">The NinjaCalc logo (with no transparency).</Image>
