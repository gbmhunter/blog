...
import half_bridge_schematic_for_eda_forums from './half-bridge-schematic-for-eda-forums.jpg'

<Image src={half_bridge_schematic_for_eda_forums} width="320px"></Image>

Testing it with a motor. I was able to stand on it for short times! (last time the MOSFETs blew).

import n_2012_02_18_17_08_37 from './2012-02-18-17-08-37.jpg'

<Image src={n_2012_02_18_17_08_37} width="320px"></Image>
...
import n_2012_02_18_16_17_26 from './2012-02-18-16-17-26.jpg'

<Image src={n_2012_02_18_16_17_26} width="320px">The oscillating gate drive to the MOSFETs.</Image>
