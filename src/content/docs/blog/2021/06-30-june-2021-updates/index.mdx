...
import pink_noise_screenshot from './pink-noise-screenshot.png'

<Image src={pink_noise_screenshot} width="500px"></Image>

* Added info on [Hakko soldering tweezers](/electronics/tools/#soldering-irons-and-stations).

import hakko_screenshot from './hakko-screenshot.png'

<Image src={hakko_screenshot} width="300px"></Image>
...
import capacitance_multiplier_screenshot from './capacitance-multiplier-screenshot.png'

<Image src={capacitance_multiplier_screenshot} width="500px"></Image>
