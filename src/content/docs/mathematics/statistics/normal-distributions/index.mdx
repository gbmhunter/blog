...
import normal_distribution_pdf_examples from './normal-distribution-pdf-examples.png'

<Image src={normal_distribution_pdf_examples} width="500px">A few example probability density functions (PDFs) for the normal distribution.</Image>
