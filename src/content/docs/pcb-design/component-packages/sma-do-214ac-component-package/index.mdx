...
import sma_do_214ac_component_package_3d_render from './_assets/sma-do-214ac-component-package-3d-render.jpg'

<Image src={sma_do_214ac_component_package_3d_render} width="200px">A 3D render of the SMA (DO-214AC) component package.</Image>
...
import package_do_214ac_2d_dimensions from './_assets/package-do-214ac-2d-dimensions.png'

<Image src={package_do_214ac_2d_dimensions} width="500px">The dimensions for the DO-214AC component package.</Image>

Pitch is 6.8mm from pad center to pad center.

## Recommended Land Pattern

import package_do_214ac_recommended_land_pattern from './_assets/package-do-214ac-recommended-land-pattern.png'

<Image src={package_do_214ac_recommended_land_pattern} width="500px">The recommended PCB land pattern for the DO-214AC component package.</Image>
