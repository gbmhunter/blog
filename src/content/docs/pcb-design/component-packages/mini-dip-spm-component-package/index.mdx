...
import mini_dip_spm_component_package_3d_render from './mini-dip-spm-component-package-3d-render.png'

<Image src={mini_dip_spm_component_package_3d_render} width="412px">A 3D render of the Mini-DIP SPM component package.</Image>