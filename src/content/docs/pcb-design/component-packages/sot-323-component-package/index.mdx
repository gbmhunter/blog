...
import component_package_sot_323_3_3d_model from './_assets/component-package-sot-323-3-3d-model.jpg'

<Image src={component_package_sot_323_3_3d_model} width="200px">3D model of the SOT-323-3 (SC-70-3) component package.</Image>
...
import sot323_3_dimensions_nxp from './_assets/sot323-3-dimensions-nxp.png'

<Image src={sot323_3_dimensions_nxp} width="800px">Dimensions for the SOT-323-3 (SC-70-3) component package from NXP[^nxp-sot-323].</Image>

### Recommend Land Pattern

import sot_323_recommended_land_pattern_reflow_nxp from './_assets/sot-323-recommended-land-pattern-reflow-nxp.png'

<Image src={sot_323_recommended_land_pattern_reflow_nxp} width="800px">Recommended reflow land pattern for the SOT-323-3 (SC-70-3) component package from NXP[^nxp-sot-323].</Image>
...
import component_package_sot_323_5_3d_model from './_assets/component-package-sot-323-5-3d-model.jpg'

<Image src={component_package_sot_323_5_3d_model} width="200px">3D model of the SOT-323-5 (SC-70-5) component package.</Image>
...
import component_package_sot_323_5_dimensions_and_land_pattern from './_assets/component-package-sot-323-5-dimensions-and-land-pattern.png'

<Image src={component_package_sot_323_5_dimensions_and_land_pattern} width="800px">Dimensions and recommended land pattern for the SOT-323-5 (SC-70-5) component package.</Image>
...
import sot_323_6_dimensions_and_land_pattern_analog_devices from './_assets/sot-323-6-dimensions-and-land-pattern-analog-devices.png'

<Image src={sot_323_6_dimensions_and_land_pattern_analog_devices} width="800px">Dimensions and recommended land pattern for the SOT-323-6 (SC-70-6) component package from Analog Devices[^analog-devices-sc6-package].</Image>
...
import sc8_sot_223_8_package_dimensions_analog_devices from './_assets/sc8-sot-223-8-package-dimensions-analog-devices.png'

<Image src={sc8_sot_223_8_package_dimensions_analog_devices} width="900px">Dimensions of the SC8 (SOT-223-8) package from Analog Devices[^analog-devices-sc8-package].</Image>
