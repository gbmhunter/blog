...
import sot_665_component_package_3d_render from './_assets/sot-665-component-package-3d-render.jpg'

<Image src={sot_665_component_package_3d_render} width="200px">A 3D render of the SOT-665 component package. Image from http://www.digikey.com/.</Image>
...
import sot_665_component_package_dimensions from './_assets/sot-665-component-package-dimensions.png'

<Image src={sot_665_component_package_dimensions} width="836px">The dimensions for the SOT-665 component package from NXP[^nxp-sot-665].</Image>
...
import sot_665_component_package_footprint_land_pattern from './_assets/sot-665-component-package-footprint-land-pattern.png'

<Image src={sot_665_component_package_footprint_land_pattern} width="736px">A recommended footprint (land pattern) for the SOT-665 component package. Image from http://www.st.com/.</Image>
...
import sot_665_recommended_land_pattern from './_assets/sot-665-recommended-land-pattern.png'

<Image src={sot_665_recommended_land_pattern} width="800px">The recommended land pattern for the SOT-665 component package from NXP[^nxp-sot-665].</Image>
