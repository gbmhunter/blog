...
import sot_353_package_dimensions_diodes_com from './_assets/sot-353-package-dimensions-diodes-com.png'

<Image src={sot_353_package_dimensions_diodes_com} width="700px">Mechanical outline and dimensions for the SOT-353 package[^diodes-incorp-sot-353-package-info].</Image>

## Recommended Land Pattern

The below image shows the recommended land pattern from Diodes Incorporated:

import sot_353_recommended_land_pattern_diodes_inc from './_assets/sot-353-recommended-land-pattern-diodes-inc.png'

<Image src={sot_353_recommended_land_pattern_diodes_inc} width="700px">The recommended land pattern for the SOT-353 package from Diodes Incorporated[^diodes-incorp-sot-353-package-info].</Image>
