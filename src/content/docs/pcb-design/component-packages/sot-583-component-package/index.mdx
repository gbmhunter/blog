...
import sot_583_component_package_3d_render_ti from './_assets/sot-583-component-package-3d-render-ti.png'

<Image src={sot_583_component_package_3d_render_ti} width="200px">A 3D render of the SOT-583 component package from Texas Instruments[^ti-tps628512-product-page].</Image>
...
import sot_583_component_package_dimensions_ti from './_assets/sot-583-component-package-dimensions-ti.png'

<Image src={sot_583_component_package_dimensions_ti} width="500px">The dimensions of the SOT-583 component package from TI. Image from https://www.ti.com/lit/ml/mpcs002/mpcs002.pdf.</Image>

## Recommended Footprint

import sot_583_component_package_recommended_footprint from './_assets/sot-583-component-package-recommended-footprint.png'

<Image src={sot_583_component_package_recommended_footprint} width="500px">The recommended footprint for the SOT-583 component package by TI. Image from https://www.ti.com/lit/ml/mpcs002/mpcs002.pdf.</Image>
