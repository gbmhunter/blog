...
import sot_723_component_package_3d_render from './_assets/sot-723-component-package-3d-render.jpg'

<Image src={sot_723_component_package_3d_render} width="200px">A 3D render of the SOT-723 component package.</Image>
...
import sot_723_component_package_dimensions_and_footprint from './_assets/sot-723-component-package-dimensions-and-footprint.png'

<Image src={sot_723_component_package_dimensions_and_footprint} width="686px">Dimensions and a recommended footprint for the SOT-723 component package. Image from http://www.onsemi.com/pub_link/Collateral/ESD7C3.3D-D.PDF.</Image>
...
import sot_723_recommended_land_pattern_onsemi from './_assets/sot-723-recommended-land-pattern-onsemi.png'

<Image src={sot_723_recommended_land_pattern_onsemi} width="800px">The recommended land pattern for the SOT-723 component package from onsemi[^onsemi-esd7c-szesd7c-series-esd-diode].</Image>
