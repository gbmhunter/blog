...
import wog_component_package_photo from './_assets/wog-component-package-photo.jpg'

<Image src={wog_component_package_photo} width="342px">A photo of the WOG component package.</Image>
