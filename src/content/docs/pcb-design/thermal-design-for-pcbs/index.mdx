...
import basic_thermal_resistance_principle from './basic-thermal-resistance-principle.svg'

<Image src={basic_thermal_resistance_principle} width="300px">The basic principle behind thermal resistance. Note the similarity to Ohm's law.</Image>
...
import ic_temperature_diagram_with_junction_case_ambient from './ic-temperature-diagram-with-junction-case-ambient.svg'

<Image src={ic_temperature_diagram_with_junction_case_ambient} width="800px">A diagram of the different temperature points used when defining thermal resistances for ICs mounted on PCBs.</Image>
...
import thermal_resistance_vs_pressure_tim_t_global_tg_a1250 from './thermal-resistance-vs-pressure-tim-t-global-tg-a1250.png'

<Image src={thermal_resistance_vs_pressure_tim_t_global_tg_a1250} width="600px">The relationship between pressure and thermal resistance for a silicon TIM from T-Global Technology (TG-A1250). Image acquired 2020-08-14 from http://www.tglobaltechnology.com/uploads/files/tds/TG-A1250.pdf.</Image>
