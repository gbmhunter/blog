...
import smd_components_in_reflow from './smd-components-in-reflow.gif'

<Image src={smd_components_in_reflow} width="240px">SMD components during a reflow soldering process.</Image>
