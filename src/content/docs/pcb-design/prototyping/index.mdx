...
import first_electric_skateboard_prototype_circuit from './_assets/first-electric-skateboard-prototype-circuit.jpg'

<Image src={first_electric_skateboard_prototype_circuit} width="504px">The first prototype circuit for the electric skateboard.</Image>
