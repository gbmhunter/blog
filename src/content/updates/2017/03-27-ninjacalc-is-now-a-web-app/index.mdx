...
tags: [calculators, embedded, engineering, git, GitHub, Heroku, Java, NinjaCalc, porting, server, vue.js, web app, website]
...
<Image src={import('./_assets/ninja-calc-v2.2.0-screenshot-calc-selection-page.png')} width="1920px">NinjaCalc is now a web app! A screenshot while selecting a calculator using the new web app at https://ninjacalc.mbedded.ninja/calculators/electronics/cabling/wire-gauge-calculator.</Image>
