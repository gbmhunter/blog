...
tags: [assembly, bugs, C, concurrency, coordinate conversion, GCC, geometry, memory
    barriers, Perlin noise, priority, space, thread, threading, virtual methods]
...
<Image src={import('./_assets/gcc-compiler-logo.png')} width="151px">The GCC logo.</Image>
...
<Image src={import('./_assets/satellite-orbit-on-2d-map-propagator.png')} width="500px"></Image>

* Updates to the [Assembly page](/programming/languages/assembly).  


<Image src={import('./_assets/assembly-programming-language-icon.png')} width="500px"></Image>

* New [Perlin Noise page](/mathematics/perlin-noise) under Mathematics.  


<Image src={import('./_assets/perlin-noise-cloud-example.png')} width="374px">Rendered Perlin noise that has been configured to make realistic looking clouds.</Image>
