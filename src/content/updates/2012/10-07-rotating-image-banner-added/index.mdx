...
tags: [banner, cimy, cladlabs, drupal, header, image, rotating]
...
<Image src={import('./screenshot-of-banner-added-to-cladlabs.jpg')} width="600px">Screenshot of the rotating banner added to the CladLabs website.</Image>
