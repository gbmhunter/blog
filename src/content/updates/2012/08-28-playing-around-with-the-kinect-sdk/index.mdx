...
tags: [3D, C, drivers, embedded, Kinect, mapping, Microsoft, modelling, open, PC, problems, SDK, source, visual, Xbox]
...
<Image src={import('./first-try-with-kinect.png')} width="600px"></Image>
