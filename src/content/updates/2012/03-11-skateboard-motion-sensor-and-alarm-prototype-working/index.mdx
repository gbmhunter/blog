...
authors: [gbmhunter]
date: 2012-03-11
lastUpdated: 2012-03-11
tags: [alarms, BJTs, electric skateboards, full-bridges, motion sensors, PSoC]
title: Skateboard Motion Sensor And Alarm Prototype Working
type: updates
---

<Image src={import('./2012-03-04-21-17-27.jpg')} width="250px">The MS24 motion sensor (works in any direction, unlike most tilt sensors).</Image>
...
<Image src={import('./2012-03-08-21-36-21.jpg')} width="250px"></Image>
...
<Image src={import('./2012-03-08-21-37-14.jpg')} width="250px">The BJT full-bridge used to drive the alarm speaker.</Image>
