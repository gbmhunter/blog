...
tags: [capacitance calculator, capacitor energy calculator, online calculator]
...
<Image src={import('./two-new-capacitor-charge-and-energy-calculators.jpg')} width="600px">Two new electrical-engineering-themed calculators. One calculator is for the capacitor charge equation, Q = CV, which involves charge, capacitance and voltage. The other is for the capacitor energy equation, E = 1/2CV^2 which involves energy, capacitance and voltage.</Image>

Also, updates were made to the [RFID page](/electronics/circuit-design/rfid) (regarding 13.56MHz RFID standards and transceivers) and also the [OLED page](/electronics/components/displays/oled-screens) (regarding the SSD1306 driver IC and manufacturers/distributors).
