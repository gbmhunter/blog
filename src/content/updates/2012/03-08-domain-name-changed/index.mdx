...
authors: [gbmhunter]
date: 2012-03-08
lastUpdated: 2012-03-08
tags: [domain, interconnectit, mbedded.ninja, migration, PHP, script, server down]
title: Domain Name Changed!
type: updates
---

<Image src={import('./domain-registration-www.jpg')} width="320px"></Image>
...
<Image src={import('./interconnect-it-logo.jpg')} width="320px"></Image>
