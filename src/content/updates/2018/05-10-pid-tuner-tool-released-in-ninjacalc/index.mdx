...
tags: [controller, jet engine, mass/spring/damper, NinjaCalc, PID, process, simulation, system, tool, tune]
...
<div style={{ width: '100%', height: 0, paddingBottom: '66%', position: 'relative' }}><iframe src="https://giphy.com/embed/kv7upS6SsijqjoX5F4" width="100%" height="100%" style={{ position: 'absolute', 'frameBorder': "0", class: 'giphy-embed', allowFullScreen: 'true'}}></iframe></div><p><a href="https://giphy.com/gifs/kv7upS6SsijqjoX5F4">via GIPHY</a></p>
