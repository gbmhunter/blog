...
tags: [blog, hugo, wordpress, migration, cms, static site generation, gatsby, export,
  menu, partials, layout, disqus, vglnk, page speed, seo]
...
<Image src={import('./_assets/wordpress-to-hugo.png')} width="500px"></Image>
...
<Image src={import('./_assets/wordpress-users-per-day-last-two-months.png')} width="800px"></Image>
...
<Image src={import('./_assets/wordpress-homepage-page-speed.png')} width="500px"></Image>

_Hugo Page Speed_

<Image src={import('./_assets/hugo-homepage-page-speed.png')} width="500px"></Image>
...
<Image src={import('./_assets/disqus-admin-vglnk-url-corruption.png')} width="500px">The two checkboxes I had to disable in my Disqus settings to prevent Disqus from corrupting URLs on the rest of the page, and adding vglnk classes.</Image>
...
<Image src={import('./_assets/mbedded-ninja-homepage-mobile-device.png')} width="400px">This is what the blog.mbedded.ninja homepage currently looks like when rendered on a cellphone. Urgh...</Image>
