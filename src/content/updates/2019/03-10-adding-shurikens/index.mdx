...
authors: [gbmhunter]
date: 2019-03-10
description: Shurikens were added to this blog as a simple upvoting and reader interaction
  mechanism.
draft: false
lastUpdated: 2019-03-10
tags: [shuriken, AWS, Amazon Web Services, DynamoDB, CloudWatch, Lambda functions,
  upvote, clap, API, rest]
...
<Image src={import('./shuriken.gif')} width="700px">Demo of the shurikens.</Image>
...
<Image src={import('./travis-ci-secret-environment-variables.png')} width="700px">The settings page for the CICD setup on TravisCI.</Image>
...
<Image src={import('./removing-disqus-reactions.png')} width="700px">Saying goodbye to the Disqus reactions.</Image>
