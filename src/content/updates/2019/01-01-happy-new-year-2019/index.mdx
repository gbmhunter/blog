...
tags: [new year, '2019', statistics, Google Analytics, page view, user, referral,
  acquisition, Wordpress, Hugo, GitHub, blog]
title: Happy New Year 2019
type: post
---

<Image src={import('./colorful-happy-new-year-2019-vector.jpg')} width="800px">Happy new year! Image from www.vecteezy.com.</Image>
...
<Image src={import('./google-analytics-2018-mbedded-ninja-users.png')} width="800px">Number of users per week for the 2018 year. Image from Google Analytics.</Image>
