...
<Image src={import('./screenshot-columbus-radio-directory.png')} width="500px">A screenshot showing the number of image resources in the `columbus-radio` page.</Image>
