...
Added info on [phototransistors](/electronics/components/phototransistors/), including the schematic symbol and a basic circuit.

## Added Figure Numbering and References
