...
tags: [apertures, AVR Studio, C, code, component packages, C++, dependency injection,
  FreeRTOS, GitHub, IDEs, inversion of control, IOC, microcontrollers, PCBs, programming,
  PSoC Creator, stencils, updates]
