...
tags: [Latex, op-amp, jumpers, resistors, capacitors, connectors, component packages,
  circuitikz, tikz]
...
<Image src={import('./example-of-an-op-amp-circuit-drawn-with-circuitikz.png')} width="600px">An op-amp circuit drawn with Circuitikz/Latex.</Image>
