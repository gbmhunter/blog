...
tags: [accelerometer, Bluetooth, ' C', charge pump, IGBT, IMU, linkage, Linux, magnetometer,
  transistor]
...
<Image src={import('./bluetooth-4-0-icon.jpg')} width="379px">The Bluetooth icon/logo.</Image>
...
<Image src={import('./screenshot-playing-around-with-rthostimugl.png')} width="657px">Playing around with RTHostIMUGL and a connected IMU through an Arduino.</Image>
