...
<Image src={import('./bug-asterisk-appearing-after-page-headings.png')} width="452px">Weird asterisks appearing after the page headings!</Image>
...
<Image src={import('./bug-quick-latex-not-rendering-resistor-symbols.png')} width="569px">The resistor symbols on the Resistors page are not being rendered.</Image>
