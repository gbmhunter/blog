...
tags: [Altium, bss, candy-calc, canvas, castellation, desmear, etchback, gerber, HTML,
  IMS, IPC-2581b, odb++, resistors, RF design, rotation, scripts, SEPIC, temperature
    sensors, updates]
...
<Image src={import('./etchback-after-plating.png')} width="219px">A via which has been plated after etchback was done, notice the 'three-point connection'.</Image>
...
<Image src={import('./ims-pcb-aluminium-side-on-photo.png')} width="653px">A side on photo of a IMS PCB with an aluminium base.</Image>
...
<Image src={import('./2d-co-ordinate-rotation-equations.png')} width="375px">2D co-ordinate rotation equations.</Image>
