...
<Image src={import('./two-mosfet-gate-drives-with-deadtime-graph-screenshot.png')} width="500px">Screenshot of the MOSFET gate drive graph on the MOSFETs page.</Image>
