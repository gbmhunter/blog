...
<Image src={import('./psoc-creator-build-settings-command-line-custom-flags.png')} width="500px">Adding custom command line flags in PSoC Creator to force GCC to use the C++ compiler.</Image>
...
<Image src={import('./cplusplus-linker-error-undefined-reference-to-gxx-personality.png')} width="600px">Add the custom compile flag '-fno-exceptions' to every .cpp file you want to compile in PSoC Creator to prevent the 'undefined reference to __gxx_personality_v0' linker error.</Image>
