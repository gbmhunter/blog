...
<Image src={import('./new-image-layout-for-component-packages-screenshot.jpg')} width="500px">A new image layout for images of component packages.</Image>
...
<Image src={import('./to-leadless-package-screenshot.jpg')} width="500px">TO-Leadless is one new package that has been added to the Component Packages page.</Image>
...
<Image src={import('./headers-on-connectors-page-screenshot.jpg')} width="500px">The Connectors page has been updated with the new sections 'Headers' and 'Circular Connectors'.</Image>

* The is a new page on [Memory](/electronics/components/memory) under Components.

* There are new pages under Web Design on [node.js](/programming/website-design/nodejs) (or just called node) and [JSON](/programming/serialization-formats/json/).
...
<Image src={import('./standard-resistance-value-calculator-screenshot.jpg')} width="500px">The new standard resistance calculator.</Image>
