...
tags: [BJTs, constant-current, I2C, LED drivers, low-pass RC, Microblaze, multiple-collector,
  multiple-emitter, NinjaCalc, NTC, PWM, sensors, temperature, thermistors, track
    current, VDAC, ' z-wave']
