...
tags: [circuit protection, component packages, connectors, current loop, ' D-subminiature',
  D2PAK, TO-263, mains power, SPI, thermistor]
...
<Image src={import('./_assets/typical-spi-connections.jpg')} width="200px">The typical SPI connections that an IC will have.</Image>
...
<Image src={import('./_assets/d2pak-to-263-component-package-3d-render.jpg')} width="300px">A 3D render of the D2PAK (TO-263) component package.</Image>
...
<Image src={import('./_assets/4-20ma-current-loop-interface-to-micro-schematic-with-filter-and-buffer.png')} width="800px">An schematic showing how to interface a 4-20mA current loop signal to the ADC on a microcontroller. The circuit also has a low-pass filter and a buffer.</Image>
