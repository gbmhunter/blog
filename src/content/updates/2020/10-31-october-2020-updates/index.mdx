...
<Image src={import('./_assets/sot-883-component-package-3d-render.png')} width="400px"></Image>
...
<Image src={import('./_assets/mosfet-soa-diagram-with-annotations.png')} width="700px"></Image>
