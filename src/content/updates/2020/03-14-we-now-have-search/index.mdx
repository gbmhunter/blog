...
authors: [gbmhunter]
date: 2020-03-14
description: How a search feature was added to the statically built blog.mbedded.ninja
  website running Hugo.
draft: false
lastUpdated: 2020-03-14
tags: [search, fuse, flexsearch, Javascript, Hugo, client, browser, indexing, blog,
  JSON, dictionary]
...
<Image src={import('./example-of-search-in-blog.gif')} width="800px">A demo of the new search functionality added for blog.mbedded.ninja.</Image>
...
<Image src={import('./search-dictionary-download-speed.png')} width="700px">The Network panel of the Chrome Developer Tools showing the time it takes to download the site's search dictionary (index.json) to the clients browser.</Image>
