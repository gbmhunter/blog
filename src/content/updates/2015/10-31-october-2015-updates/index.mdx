...
tags: [Atmel, avrdude, fans, gcc, I2C addressing, LC filters, MTA-100, noise, PCBs,
  PSoC, RMS, RS-232, RS-485, SOD-923, SOT-23-8, SOT-346, surface finish, tests, test
    points, TO-5, USB]
...
<Image src={import('./_assets/atmel-avr-at32-3d-render-of-ic-www-teckhat-com.gif')} width="259px">A 3D render of the AT32UC3L, an Atmel AVR AT32 microcontroller. Image from http://teckhat.com/.</Image>  
...
<Image src={import('./_assets/pcb-surface-finish-immersion-silver.jpg')} width="355px">Example of an immersion silver (IAg) PCB finish. Image from http://www.rlcinnovation.com/.</Image>  
...
<Image src={import('./_assets/sot-346-sc-59a-component-package-3d-render.jpg')} width="354px">A 3D render of the SOT-346 (SC-59A) component package.</Image>  
...
<Image src={import('./_assets/keystone-minature-smd-testpoint.jpg')} width="275px">A miniature SMD testpoint made by Keystone.</Image>  
