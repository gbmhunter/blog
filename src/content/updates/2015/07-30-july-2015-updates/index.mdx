...
* Added information on [adding comments (well, pseudo comments) to JSON files on the JSON page](/programming/serialization-formats/json/).
...
<Image src={import('./_assets/op-amp-schematic-differential-amplifier.png')} width="436px">An op-amp configured as a differential amplifier.</Image>
...
<Image src={import('./_assets/aspect-ratio-page-screenshot.png')} width="312px">A screenshot of the aspect ratio information added the 'Pads, Vias And Holes' page as part of the PCB design section.</Image>  
...
<Image src={import('./_assets/fpga-schematic-just-the-ic-no-routing.png')} width="590px">An A3 schematic sheet with just one 236-pin FPGA IC added to it (no routing).</Image>  
