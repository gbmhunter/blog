...
tags: [Avada, caching, CMS, CPanel, cron, CSS, fast, file manager, FTP, GoDaddy, HTML,
  Linux, managed, performance, PHP, slow, speed, ssh, theme, website, Wordpress]
...
<Image src={import('./screenshot-godaddy-managed-wordpress-plans.png')} width="692px">Screenshot of GoDaddy's managed Wordpress plans as of 2015-04-03.</Image>
...
<Image src={import('./web-page-test-on-mbedded-ninja-after-moving-to-managed-wordpress-service.png')} width="1032px">A webpage speed test run on blog.mbedded.ninja after the site was moved to a GoDaddy managed wordpress service.</Image>
...
<Image src={import('./screenshot-avada-wordpress-theme-homepage.png')} width="716px">A screenshot of the Avada Wordpress theme homepage as of 2015-04-03. Image from http://theme-fusion.com/avada/.</Image>
