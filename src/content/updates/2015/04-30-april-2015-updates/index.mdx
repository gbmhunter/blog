...
tags: [component packages, DPAK, futures and promises, inductors, inverting buck-boost, io-link, layer stackup, Mercurial, protocol bridges, saturation, SDQ, SMPS, watermarks]
...
<Image src={import('./_assets/mercurial-hg-scm-logo.jpg')} width="225px">The Mercurial (Hg) SCM logo.</Image>
...
<Image src={import('./_assets/inductance-vs-current-graph-wurth-7447789003-3.3uh.png')} width="317px">Inductance vs. current graph of the Wurth 7447789003, a 3.3uH ferrite SMD inductor with a specified saturation current of 4.2A.</Image>
...
<Image src={import('./_assets/smps-buck-boost-inverting-basic-components.png')} width="683px">The basic components of an inverting buck-boost converter.</Image>
