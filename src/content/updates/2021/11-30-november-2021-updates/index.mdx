...
<Image src={import('./arm-programming-header-pinout-screenshot.png')} width="500px"></Image>
...
<Image src={import('./to-39-ball-lens-screenshot.png')} width="500px"></Image>

* Added info on the [JTAG and SWD programming/debug interfaces](/programming/programming-microcontrollers-an-overview/).

* Added info on [RF attenuators, transient limiters and EMC software](/electronics/compliance/electromagnetic-compatibility-emc/).
...
<Image src={import('./sma-connector-screenshot.png')} width="500px"></Image>
