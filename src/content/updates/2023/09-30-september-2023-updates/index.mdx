...
<Image src={import('./ninjaterm-homepage-old-new-comparison.webp')} width="900px"></Image>
...
<Image src={import('./stuck-i2c-buses-screenshot.png')} width="600px"></Image>
...
<Image src={import('./i2c-protocol-format-screenshot.png')} width="600px"></Image>
...
* Added new page on [hall effect sensors](/electronics/components/sensors/hall-effect/).
