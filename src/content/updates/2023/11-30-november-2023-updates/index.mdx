...
<Image src={import('./control-char-and-hex-code-glyphs.gif')} width="700px"></Image>

* Added logging functionality.

<Image src={import('./logging.gif')} width="700px"></Image>
...
<Image src={import('./filtering.gif')} width="700px"></Image>
...
<Image src={import('./google-adsense.png')} width="700px"></Image>
