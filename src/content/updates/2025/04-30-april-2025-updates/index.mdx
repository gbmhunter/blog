...
<Image src={import('./_assets/influx-db-screenshot.webp')} width="800px" userClass="red-glow"/>

## Added Info on Azure Functions

Added info on [Azure Functions](/programming/cloud/azure/).

<Image src={import('./_assets/azure-cloud-functions-screenshot.webp')} width="800px" userClass="red-glow"/>
...
<Image src={import('./_assets/pandas-serialization-screenshot.webp')} width="800px" userClass="red-glow"/>
...
<Image src={import('./_assets/x86-register-names-screenshot.webp')} width="800px" userClass="red-glow"/>
...
Added info on [creating a Zephyr login shell](/programming/operating-systems/zephyr/#login-shell).

<Image src={import('./_assets/zephyr-shell-login-screenshot.webp')} width="800px" userClass="red-glow"/>
