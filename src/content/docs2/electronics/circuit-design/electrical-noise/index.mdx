...
import noise_from_3_smps from './_assets/noise-from-3-smps.png'

<Image src={noise_from_3_smps} width="700">Noise on a power rail that was feeding 3 SMPS that hadn't been compensated correctly. Kept this image because I thought the waveform was interesting!</Image>
...
import noise_white_time_domain from './_assets/noise-white-time-domain.png'

<Image src={noise_white_time_domain} width="700">What white noise looks like in the time domain.</Image>

And this is what it looks like in the frequency domain (the discrete FFT of the above signal):

import noise_white_freq_domain from './_assets/noise-white-freq-domain.png'

<Image src={noise_white_freq_domain} width="700">What white noise looks like in the frequency domain.</Image>
...
import noise_pink_time_domain from './_assets/noise-pink-time-domain.png'

<Image src={noise_pink_time_domain} width="700">What pink noise looks like in the time domain.</Image>

And this is what it looks like in the frequency domain (the discrete FFT of the above signal):

import noise_pink_freq_domain from './_assets/noise-pink-freq-domain.png'

<Image src={noise_pink_freq_domain} width="700">What pink noise looks like in the frequency domain.</Image>
...
import noise_red_time_domain from './_assets/noise-red-time-domain.png'

<Image src={noise_red_time_domain} width="700">What red noise looks like in the time domain.</Image>

And this is what it looks like in the frequency domain (the discrete FFT of the above signal):

import noise_red_freq_domain from './_assets/noise-red-freq-domain.png'

<Image src={noise_red_freq_domain} width="700">What red noise looks like in the frequency domain.</Image>
...
import noise_blue_time_domain from './_assets/noise-blue-time-domain.png'

<Image src={noise_blue_time_domain} width="700">What blue noise looks like in the time domain.</Image>

And this is what it looks like in the frequency domain (the discrete FFT of the above signal):

import noise_blue_freq_domain from './_assets/noise-blue-freq-domain.png'

<Image src={noise_blue_freq_domain} width="700">What blue noise looks like in the frequency domain.</Image>
