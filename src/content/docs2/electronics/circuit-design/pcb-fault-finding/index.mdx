...
<Image src={import('./pcb-fault-micro-pin-short-close-up-02.jpg')} width="800">A solder fleck between two microcontroller pins, causing a short.</Image>

{/* {{% figure src="pcb-fault-micro-pin-short-close-up-01.jpg" caption="Flux residue ontop of some microcontroller pins."  width="800px" %}} */}
<Image src={import('./pcb-fault-micro-pin-short-close-up-01.jpg')} width="800">Flux residue ontop of some microcontroller pins.</Image>
...
<Image src={import('./flux-residue-on-pcb-close-up-01.jpg')} width="800">Flux residue ontop of some microcontroller pins.</Image>
...
<Image src={import('./flux-residue-on-pcb-close-up-02.jpg')} width="800">A solder fleck between two microcontroller pins, causing a short.</Image>
