...
<Image src={import('./inrush-current-limiting-with-thermistor.jpg')} width="475">A graph showing the effect of a NTC thermistor limiting the inrush current to a circuit.</Image>
