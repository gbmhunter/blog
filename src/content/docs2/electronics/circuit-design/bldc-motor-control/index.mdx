...
draft: false
image: /images/page-images/rp17-bldc-motor-nema-17.jpg
last_update:
  date: 2020-05-12
...
import rp17_bldc_motor_nema_17 from './_assets/rp17-bldc-motor-nema-17.jpg'

<Image src={rp17_bldc_motor_nema_17} width="258">A standard-looking BLDC motor in a NEMA-17 enclosure.</Image>
...
import hall_effect_interrupts_from_bldc_motor_for_both_rise_and_fall from './_assets/hall-effect-interrupts-from-bldc-motor-for-both-rise-and-fall.png'

<Image src={hall_effect_interrupts_from_bldc_motor_for_both_rise_and_fall} width="550">6 PSoC interrupts to service the three hall-effect inputs from a BLDC motor. Six interrupts are required because the PSoC interrupt component only supports rising-edge triggering, and so a inverting gate and second interrupt per sensor is required to trigger on falling-edge.</Image>
...
import psoc_bldc_schematic_luts_and_multiplexors_for_phase_drive from './_assets/psoc-bldc-schematic-luts-and-multiplexors-for-phase-drive.png'

<Image src={psoc_bldc_schematic_luts_and_multiplexors_for_phase_drive} width="1000">A PSoC schematic containing LUTs and multiplexors for trapezoidal-control of a BLDC motor.</Image>
...
import n_16_bit_500_count_sine_wave_lut_data_graph_1 from './_assets/16-bit-500-count-sine-wave-lut-data-graph-1.png'

<Image src={n_16_bit_500_count_sine_wave_lut_data_graph_1} width="1069">Data extracted from a 16-bit sine wave LUT designed for use with sinusoidal BLDC motor control.</Image>
...
$I_{\alpha\beta\gamma}$ = the Clark transformed currents<br/></p>
...
import clark_transformation_alpha_beta_geometric_interpretation from './_assets/clark-transformation-alpha-beta-geometric-interpretation.gif'

<Image src={clark_transformation_alpha_beta_geometric_interpretation} width="516">A geometric interpretation of the Clark (alpha-beta) transformation. Image from http://en.wikipedia.org/wiki/%CE%91%CE%B2%CE%B3_transform.</Image>
...
import park_transformation_d_q_geometric_interpretation from './_assets/park-transformation-d-q-geometric-interpretation.jpg'

<Image src={park_transformation_d_q_geometric_interpretation} width="976">A geometric interpretation of the Park (dq) transformation. Image from http://en.wikipedia.org/wiki/Dqo_transformation.</Image>
...
import pmsm_motor_control_architecture_with_psoc_micro from './_assets/pmsm-motor-control-architecture-with-psoc-micro.png'

<Image src={pmsm_motor_control_architecture_with_psoc_micro} width="1000">The FOC control architecture for a PMSM motor with a PSoC microcontroller.</Image>
...
import nema_17_motor_mounting_dimensions from './_assets/nema-17-motor-mounting-dimensions.jpg'

<Image src={nema_17_motor_mounting_dimensions} width="497">The NEMA17 mounting hole dimensions .The dimensions are in millimeters. Image from http://www.xylotex.com/FAQ.htm.</Image>

The NEMA23 mounting hole dimensions are shown below. The dimensions are in inches.

import nema_23_motor_mounting_dimensions from './_assets/nema-23-motor-mounting-dimensions.jpg'

<Image src={nema_23_motor_mounting_dimensions} width="595">The NEMA23 mounting hole dimensions .The dimensions are in inches. Image from http://www.xylotex.com/FAQ.htm.</Image>
