...
import n_165um_dielectric_3m_467mp_half_peeled_off_backing from './165um-dielectric-3m-467mp-half-peeled-off-backing.jpg'

<Image src={n_165um_dielectric_3m_467mp_half_peeled_off_backing} width="400">165um plastic dielectric (3M 467MP).</Image>
...
import cap_encoder_individual_cdc_waveform_graphs_for_both_tracks from './cap-encoder-individual-cdc-waveform-graphs-for-both-tracks.jpg'

<Image src={cap_encoder_individual_cdc_waveform_graphs_for_both_tracks} width="800">The individual waveforms for each CDC channel on both the N and N-1 tracks (for use with an absolute algorithm).</Image>
...
import cap_encoder_grouped_cdc_waveform_graphs_for_both_tracks from './cap-encoder-grouped-cdc-waveform-graphs-for-both-tracks.jpg'

<Image src={cap_encoder_grouped_cdc_waveform_graphs_for_both_tracks} width="800">The grouped waveforms (all 6 channels) for both the N and N-1 tracks (for use with an absolute algorithm).</Image>
...
import cdc_vs_time_graph_showing_different_offsets_of_each_channel from './cdc-vs-time-graph-showing-different-offsets-of-each-channel.jpg'

<Image src={cdc_vs_time_graph_showing_different_offsets_of_each_channel} width="800">CDC values vs. time graph showing the different offsets each channel can have.</Image>
...
import cdc_phase_difference_graph_showing_noisy_stepwise_increments from './cdc-phase-difference-graph-showing-noisy-stepwise-increments.jpg'

<Image src={cdc_phase_difference_graph_showing_noisy_stepwise_increments} width="800">Graph showing the stepwise incrementing of the phase difference between the two calculated positions of the CDC tracks.</Image>
