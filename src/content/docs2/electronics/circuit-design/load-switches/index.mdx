...
<Image src={import('./high-side-mosfet-load-switch-schematic.png')} width="700">A high-side load switch made from a N-Channel and P-Channel MOSFET.</Image>
...
<Image src={import('./high-side-load-switch-with-tps27082lddcr-ic-schematic.png')} width="692">The TPS27082LDDCR, a high-side load switch IC.</Image>
...
<Image src={import('./ncp380-ncv-380-load-switch-internal-block-diagram-with-reverse-current-protection.png')} width="516">A functional diagram of the NCP380 high-side load switch. Note the switches connected to the MOSFET substrate which show how reverse-current protection is performed.</Image>
...
<Image src={import('./max15162-simplified-block-diagram.png')} width="800">The simplified block diagram of the MAX15162 circuit breaker IC[^bib-maxim-max15162-ds].</Image>
...
<Image src={import('./max15162-startup-paragraph-screenshot-annotated.png')} width="800">Screenshot from the MAX15162's datasheet highlighting it's averaged 28mA start-up current[^bib-maxim-max15162-ds].</Image>
