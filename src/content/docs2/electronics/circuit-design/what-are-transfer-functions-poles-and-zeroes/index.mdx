...
import diagram_of_hs_in_complex_plane from './diagram-of-hs-in-complex-plane.png'

<Image src={diagram_of_hs_in_complex_plane} width="600">Graphical representation of $H(s)$ on the complex plane and how the magnitude and phase are encoded into this.</Image>
...
import poles_graph from './poles-graph.png'

<Image src={poles_graph} width="900">Argand diagram showing how the location of poles (no zeroes shown) on a pole zero plots shows how components of the system respond to transients (i.e. impulses).</Image>
...
import tuning_comparison_group_delay from './tuning-comparison-group-delay.png'

<Image src={tuning_comparison_group_delay} width="600">Group delay plotted for a number of different 4-order filter tunings.</Image>
...
import low_pass_rc_filter_mag from './low-pass-rc-filter-mag.png'

<Image src={low_pass_rc_filter_mag} width="600">The magnitude response of the the low-pass RC filter, found by plotting $Eq.\ \ref{eq:mag-response-lp-rc-filter}$. Note that the magnitude has been converted into decibels with $dB = 20log10(mag)$.</Image>
...
import low_pass_rc_filter_phase from './low-pass-rc-filter-phase.png'

<Image src={low_pass_rc_filter_phase} width="600">The phase response of the the low-pass RC filter, found by plotting $Eq.\ \ref{eq:phase-response-lp-rc-filter}$</Image>
...
import wolfram_alpha_transfer_function_analysis_screenshot from './wolfram-alpha-transfer-function-analysis-screenshot.png'

<Image src={wolfram_alpha_transfer_function_analysis_screenshot} width="600">Screenshot of Wolfram Alpha's results when you provide it a transfer function[^bib-wolfram-alpha-transfer-function-2nd-order-bessel].</Image>
