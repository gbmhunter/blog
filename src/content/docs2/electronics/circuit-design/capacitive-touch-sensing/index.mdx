...
import cap_sense_button_diagram_cypress from './cap-sense-button-diagram-cypress.jpg'

<Image src={cap_sense_button_diagram_cypress} width="395">How simple cap sense buttons work.</Image>
...
import atmel_recommended_cap_button_shape from './atmel-recommended-cap-button-shape.jpg'

<Image src={atmel_recommended_cap_button_shape} width="430">A recommended cap button shape by Atmel. Image from atmel.com.</Image>
