...
<Image src={import('./ray-gun-example-st-nucleo-l073rz.png')} width="500">Example of 'ray guns'. Screenshot of the ST NUCLEO-L073RZ dev. board schematics[^bib-st-nucleo-l073rz-sch].</Image>
...
<Image src={import('./pcb-showing-mounting-holes.png')} width="800">A PCB, showing the four mounting holes. Note that one is underneath a component (the Xbee module).</Image>

{/* {{% figure src="m3-12mm-pcb-standoff.jpg" caption="A M3 PCB standoff. Image from http://www.electronicparts.net.au/."  width="200px" %}} */}
<Image src={import('./m3-12mm-pcb-standoff.jpg')} width="200">A M3 PCB standoff. Image from http://www.electronicparts.net.au/.</Image>
...
<Image src={import('./spherical-rubber-pcb-feet.jpg')} width="160">A stick-on spherical rubber PCB foot.</Image>
...
<Image src={import('./reelfast-smd-standoff-example.jpg')} width="500">An SMD standoff from Pen Engineering. Image from http://catalog.pemnet.com/viewitems/uts-and-spacers-standoffs-surface-mount-type-smtso/t-nuts-and-spacers-standoffs-br-type-smtso-unified.</Image>
...
<Image src={import('./dessicant-on-oven-tray.jpg')} width="400">Desiccant about to be dried on an oven tray.</Image>
...
<Image src={import('./the-mojo-fpga-pcb.jpg')} width="800">'The Mojo', a Arduino-like FPGA development that looks really nice. Image from http://embeddedmicro.com/products/the-mojo.</Image>
...
<Image src={import('./qfn-footprint-failure-after-too-much-resoldering.jpg')} width="600">The PCB was wrecked after doing too much re-soldering on a 0.5mm pitch QFN footprint.</Image>
