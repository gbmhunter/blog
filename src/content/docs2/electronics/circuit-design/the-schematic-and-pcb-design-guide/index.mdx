...
import ray_gun_example_st_nucleo_l073rz from './ray-gun-example-st-nucleo-l073rz.png'

<Image src={ray_gun_example_st_nucleo_l073rz} width="500">Example of 'ray guns'. Screenshot of the ST NUCLEO-L073RZ dev. board schematics[^bib-st-nucleo-l073rz-sch].</Image>
...
import pcb_showing_mounting_holes from './pcb-showing-mounting-holes.png'

<Image src={pcb_showing_mounting_holes} width="800">A PCB, showing the four mounting holes. Note that one is underneath a component (the Xbee module).</Image>

{/* {{% figure src="m3-12mm-pcb-standoff.jpg" caption="A M3 PCB standoff. Image from http://www.electronicparts.net.au/."  width="200px" %}} */}
import m3_12mm_pcb_standoff from './m3-12mm-pcb-standoff.jpg'

<Image src={m3_12mm_pcb_standoff} width="200">A M3 PCB standoff. Image from http://www.electronicparts.net.au/.</Image>
...
import spherical_rubber_pcb_feet from './spherical-rubber-pcb-feet.jpg'

<Image src={spherical_rubber_pcb_feet} width="160">A stick-on spherical rubber PCB foot.</Image>
...
import reelfast_smd_standoff_example from './reelfast-smd-standoff-example.jpg'

<Image src={reelfast_smd_standoff_example} width="500">An SMD standoff from Pen Engineering. Image from http://catalog.pemnet.com/viewitems/uts-and-spacers-standoffs-surface-mount-type-smtso/t-nuts-and-spacers-standoffs-br-type-smtso-unified.</Image>
...
<Image src={dessicant_on_oven_tray} width="400">Desiccant about to be dried on an oven tray.</Image>
...
import the_mojo_fpga_pcb from './the-mojo-fpga-pcb.jpg'

<Image src={the_mojo_fpga_pcb} width="800">'The Mojo', a Arduino-like FPGA development that looks really nice. Image from http://embeddedmicro.com/products/the-mojo.</Image>
...
import qfn_footprint_failure_after_too_much_resoldering from './qfn-footprint-failure-after-too-much-resoldering.jpg'

<Image src={qfn_footprint_failure_after_too_much_resoldering} width="600">The PCB was wrecked after doing too much re-soldering on a 0.5mm pitch QFN footprint.</Image>
