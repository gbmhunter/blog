...
import circuit_schematic_suicide_switch_with_usb_powered_lipo_charger from './_assets/circuit-schematic-suicide-switch-with-usb-powered-lipo-charger.png'

<Image src={circuit_schematic_suicide_switch_with_usb_powered_lipo_charger} width="700">A circuit schematic of a 'suicide switch' powered from a USB port.</Image>
...
import power_mgmt_ic_switching_on_48v_scope_trace from './_assets/power-mgmt-ic-switching-on-48v-scope-trace.png'

<Image src={power_mgmt_ic_switching_on_48v_scope_trace} width="700">A scope trace of a power management IC switching on the output once the UVLO threshold is exceeded.</Image>
...
import ina226_power_monitor_ic_internal_diagram_with_external_filtering from './_assets/ina226-power-monitor-ic-internal-diagram-with-external-filtering.png'

<Image src={ina226_power_monitor_ic_internal_diagram_with_external_filtering} width="878">The internal diagram (with some external filtering circuitry) of the INA226 voltage/current/power monitoring IC. Image from http://www.ti.com/.</Image>
