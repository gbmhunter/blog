...
import not_gate_symbol from './_assets/not-gate-symbol.svg'

<Image src={not_gate_symbol} width="800">The symbols for a NOT gate (inverter).</Image>
...
import and_gate_symbol from './_assets/and-gate-symbol.svg'

<Image src={and_gate_symbol} width="800">The symbols for an AND gate.</Image>
...
import and_gate_from_diodes_and_resistors from './_assets/and-gate-from-diodes-and-resistors.svg'

<Image src={and_gate_from_diodes_and_resistors} width="300">An AND gate made from basic diode logic.</Image>
...
import nand_gate_symbol from './_assets/nand-gate-symbol.svg'

<Image src={nand_gate_symbol} width="800">The symbol for an NAND gate.</Image>
...
import or_gate_symbol from './_assets/or-gate-symbol.svg'

<Image src={or_gate_symbol} width="800">The symbol for an OR gate.</Image>
...
import how_to_draw_the_or_gate from './_assets/how-to-draw-the-or-gate.png'

<Image src={how_to_draw_the_or_gate} width="600">Diagram showing how to draw an OR gate from the segments of three equal diameter circles placed on a grid[^bib-spin-num-logic-gates].</Image>
...
import nor_gate_symbol from './_assets/nor-gate-symbol.svg'

<Image src={nor_gate_symbol} width="800">The symbols for a NOR gate.</Image>
...
import xor_gate_symbol from './_assets/xor-gate-symbol.svg'

<Image src={xor_gate_symbol} width="800">The symbols for a 2-input XOR (exclusive-or) gate.</Image>
...
import xor_gate_made_from_ands_and_or from './_assets/xor-gate-made-from-ands-and-or.png'

<Image src={xor_gate_made_from_ands_and_or} width="500">A XOR gate made from AND and OR gates, with some of the inputs inverted into the front-end of the AND gates.</Image>
...
import xor_gate_made_from_and_nand_or from './_assets/xor-gate-made-from-and-nand-or.svg'

<Image src={xor_gate_made_from_and_nand_or} width="500">A XOR gate made from 1 AND, NAND and OR gate.</Image>
...
import xor_gate_made_from_nands from './_assets/xor-gate-made-from-nands.svg'

<Image src={xor_gate_made_from_nands} width="600">A XOR gate made exclusively from NAND gates.</Image>
...
import xor_gate_made_from_nors from './_assets/xor-gate-made-from-nors.svg'

<Image src={xor_gate_made_from_nors} width="600">A XOR gate made exclusively from NOR gates.</Image>
...
import xnor_gate_symbol from './_assets/xnor-gate-symbol.svg'

<Image src={xnor_gate_symbol} width="800">The symbols for a XNOR gate.</Image>
...
import rtl_logic_inverter from './_assets/rtl-logic-inverter.svg'

<Image src={rtl_logic_inverter} width="400">A very basic logic "inverter" made from RTL.</Image>
...
import rtl_logic_nor_gate from './_assets/rtl-logic-nor-gate.svg'

<Image src={rtl_logic_nor_gate} width="400">Schematic of a RTL NOR gate. When both inputs are `LOW`, neither transistor is on and the output is pulled `HIGH` by $R_C$. Any `HIGH` input will turn on a transistor, which will drive the output `LOW`.</Image>
...
<div className="flex-row-wrap">
import nmos_inverter_gate from './_assets/nmos-inverter-gate.png'

<Image src={nmos_inverter_gate} width="200">The simple inverter made using NMOS technology.</Image>
...
<div className="flex-row-wrap">
import nmos_nor_gate from './_assets/nmos-nor-gate.png'

<Image src={nmos_nor_gate} width="300">A NOR gate made using NMOS technology.</Image>
...
<div className="flex-row-wrap">
import cmos_inverter_gate from './_assets/cmos-inverter-gate.png'

<Image src={cmos_inverter_gate} width="200">A CMOS inverter gate.</Image>
...
import cmos_inverter_from_discrete_mosfets_animation from './_assets/cmos-inverter-from-discrete-mosfets-animation.gif'

<Image src={cmos_inverter_from_discrete_mosfets_animation} width="400">Video of a basic CMOS inverter made from a discrete P-channel and N-channel MOSFET. The inverter is fed a 0.5Hz clock signal into it's input from a function generator. 1 LED is connected to the inverters input, the other connected to it's output.</Image>
...
<div className="flex-row-wrap">
import cmos_nand_gate from './_assets/cmos-nand-gate.png'

<Image src={cmos_nand_gate} width="400">A 2-input CMOS NAND gate, built from two P-channel and two N-channel MOSFETs.</Image>
...
import cmos_nand_gate_3_input from './_assets/cmos-nand-gate-3-input.png'

<Image src={cmos_nand_gate_3_input} width="500">A schematic for a 3-input CMOS NAND gate.</Image>
...
<div className="flex-row-wrap">
import cmos_nor_gate from './_assets/cmos-nor-gate.png'

<Image src={cmos_nor_gate} width="400">A CMOS NOR gate.</Image>
...
<div className="flex-row-wrap">
import cmos_and_gate from './_assets/cmos-and-gate.png'

<Image src={cmos_and_gate} width="400">The schematic for building a 2-input CMOS AND gate. Notice how it's just a NAND gate with an inverter attached to the output.</Image>
...
<div className="flex-row-wrap">
import cmos_or_gate from './_assets/cmos-or-gate.png'

<Image src={cmos_or_gate} width="400">The schematic for building a 2-input CMOS OR gate. Notice how it's just a NOR gate with an inverter attached to the output.</Image>
...
import cmos_xor_gate from './_assets/cmos-xor-gate.png'

<Image src={cmos_xor_gate} width="600">A XOR gate built from CMOS logic.</Image>
...
import tristate_inverter from './_assets/tristate-inverter.png'

<Image src={tristate_inverter} width="900">Diagram showing how a tri-state converter can be made by combining the MOSFETs from a inverter and transmission gate into a single \"totem pole\" arrangement.</Image>
...
import ptl_and_gate from './_assets/ptl-and-gate.png'

<Image src={ptl_and_gate} width="500">An AND gate made from PTL logic.</Image>
...
import ptl_xor_gate_8_tran from './_assets/ptl-xor-gate-8-tran.png'

<Image src={ptl_xor_gate_8_tran} width="400">A XOR gate made from PTL logic. This XOR circuit uses a total of 8 transistors, less than the CMOS implementation that uses 12. But we can still do better!</Image>
...
import ptl_xor_gate_6_tran from './_assets/ptl-xor-gate-6-tran.png'

<Image src={ptl_xor_gate_6_tran} width="600">A XOR gate made in PTL logic with only 6 transistors[^bib-uni-waterloo-ptl].</Image>
...
import digital_logic_counter_six_state_binary from './_assets/digital-logic-counter-six-state-binary.png'

<Image src={digital_logic_counter_six_state_binary} width="700">Schematic of a six state binary counter.</Image>
...
import digital_logic_counter_three_bit_grey_encoded_binary from './_assets/digital-logic-counter-three-bit-grey-encoded-binary.png'

<Image src={digital_logic_counter_three_bit_grey_encoded_binary} width="700">Schematic of a three-bit Grey encoded binary counter.</Image>
