...
import basic_rc_schematic from './_assets/basic-rc-schematic.webp'

<Image src={basic_rc_schematic} width="500">A basic RC charging circuit.</Image>
...
import rc_charging_plot from './_assets/rc-charging-plot.png'

<Image src={rc_charging_plot} width="700">A basic RC charging circuit.</Image>
