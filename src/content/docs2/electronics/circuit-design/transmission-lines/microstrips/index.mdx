...
import single_ended_basic_microstrip_diagram_annotated from './_assets/single-ended-basic-microstrip-diagram-annotated.png'

<Image src={single_ended_basic_microstrip_diagram_annotated} width="760">A diagram of a single-ended microstrip, with standard names for the various dimensions added.</Image>
...
import screenshot_microstrip_impedance_calculator_ninjacalc from './_assets/screenshot-microstrip-impedance-calculator-ninjacalc.png'

<Image src={screenshot_microstrip_impedance_calculator_ninjacalc} width="945">A screenshot of the 'Microstrip Impedance' calculator in the NinjaCalc web app.</Image>
