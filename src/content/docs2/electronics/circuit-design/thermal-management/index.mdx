...
<Image src={import('./thermal-resistance-diagram-with-semiconductor.png')} width="800">A diagram showing how thermal resistance works. Image from http://www.aavid.com/sites/default/files/products/boardlevel/aavid-standard-heatsinks.pdf</Image>
...
<Image src={import('./analogy-of-thermal-resistance-to-electrical-resistance.png')} width="800">The analogy of thermal resistance to electrical resistance. Image from http://www.vishay.com/docs/28705/mc_pro.pdf</Image>
...
<Image src={import('./experimentally-determined-internal-thermal-resistances-for-smd-resistors.png')} width="500">Experimentally determined values for the internal thermal resistance (junction-to-case) for various sized SMD resistors. Image from http://www.vishay.com/docs/28705/mc_pro.pdf</Image>
