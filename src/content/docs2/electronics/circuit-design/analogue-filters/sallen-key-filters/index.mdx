...
<Image src={import('./_assets/low-pass-variable-gain-sallen-key-filter-schematic.png')} width="700">The schematic for a variable-gain low-pass Sallen-Key filter.</Image>
