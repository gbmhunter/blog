...
<Image src={import('./two-resistor-one-micro-very-simple-zero-cross-detector-atmel.png')} width="333">A very simple two-component mains zero-cross detection circuit. Image from http://www.atmel.com/.</Image>
