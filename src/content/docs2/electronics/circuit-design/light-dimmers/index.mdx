...
import two_resistor_one_micro_very_simple_zero_cross_detector_atmel from './two-resistor-one-micro-very-simple-zero-cross-detector-atmel.png'

<Image src={two_resistor_one_micro_very_simple_zero_cross_detector_atmel} width="333">A very simple two-component mains zero-cross detection circuit. Image from http://www.atmel.com/.</Image>
