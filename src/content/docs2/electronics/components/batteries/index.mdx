...
import zinc_air_battery_cut_away_annotated from './zinc-air-battery-cut-away-annotated.jpg'

<Image src={zinc_air_battery_cut_away_annotated} width="450">A cut-away of a zinc-air button cell with annotations. Image from http://hear-better.com/.</Image>
