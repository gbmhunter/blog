...
<Image src={import('./_assets/lead-acid-charging-showing-voltage-and-current.jpg')} width="600">Monitoring the voltage and current is important while charging a lead-acid battery.</Image>
