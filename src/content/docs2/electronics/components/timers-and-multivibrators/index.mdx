...
<Image src={import('./classic-bjt-astable-multivibrator.svg')} width="600px">A basic (and somewhat of a classic) BJT astable multivibrator.</Image>
...
<Image src={import('./555-timer-simplified-internal-schematic-ti.png')} width="600px">A simplified internal schematic of a 555 timer IC. Image from https://www.ti.com/lit/ds/symlink/sa555.pdf?HQS=TI-null-null-digikeymode-df-pf-null-wwe.</Image>
...
<Image src={import('./555-timer-schematic-for-monostable-operation-ti.png')} width="600px">Schematic for putting the 555 timer into monostable mode. Image from https://www.ti.com/lit/ds/symlink/sa555.pdf?HQS=TI-null-null-digikeymode-df-pf-null-wwe.</Image>
...
<Image src={import('./555-timer-schematic-for-astable-operation-ti.png')} width="600px">Schematic for putting the 555 timer into astable mode. Image from https://www.ti.com/lit/ds/symlink/sa555.pdf?HQS=TI-null-null-digikeymode-df-pf-null-wwe.</Image>
