...
date: 2012-10-25
description: Terminology, parameters, solid state relays, contact arrangements, inductive kickback, flyback diodes, latching, common relay packages, supplier links and more on relays.
...
<Image src={import('./_assets/solid-state-relay-in-schematic-with-input-resistor.png')} width="600px">This is the typical schematic symbol for a solid-state relay, along with a resistor connected to the input to limit the current through the internal LED.</Image>
