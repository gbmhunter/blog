...
import charge_pump_voltage_doubler_schematic from './charge-pump-voltage-doubler-schematic.png'

<Image src={charge_pump_voltage_doubler_schematic} width="700px">The basic schematic for a voltage doubling charge pump circuit.</Image>
...
import charge_pump_voltage_doubler_simulation_charge_pump_voltage_doubler_simulation_schematics from './charge-pump-voltage-doubler-simulation/charge-pump-voltage-doubler-simulation-schematics.png'

<Image src={charge_pump_voltage_doubler_simulation_charge_pump_voltage_doubler_simulation_schematics} width="800px">The schematics for the voltage-doubling charge pump simulation.</Image>
...
import charge_pump_voltage_doubler_simulation_charge_pump_voltage_doubler_simulation_plot from './charge-pump-voltage-doubler-simulation/charge-pump-voltage-doubler-simulation-plot.png'

<Image src={charge_pump_voltage_doubler_simulation_charge_pump_voltage_doubler_simulation_plot} width="600px">A plot of the simulation results for the above voltage doubling charge pump circuit.</Image>
...
import charge_pump_voltage_doubler_sim_microcap_schematics from './charge-pump-voltage-doubler-sim-microcap/schematics.png'

<Image src={charge_pump_voltage_doubler_sim_microcap_schematics} width="800px">Micro-Cap simulation schematic of a +3.3V voltage-doubling charge pump.</Image>
...
import charge_pump_inverter_charge_pump_inverter_schematic from './charge-pump-inverter/charge-pump-inverter-schematic.png'

<Image src={charge_pump_inverter_charge_pump_inverter_schematic} width="600px">A schematic for a voltage-inverting charge pump.</Image>

The simulation results:

import charge_pump_inverter_charge_pump_inverter_simulation_results from './charge-pump-inverter/charge-pump-inverter-simulation-results.png'

<Image src={charge_pump_inverter_charge_pump_inverter_simulation_results} width="600px">A schematic for a voltage-inverting charge pump.</Image>
...
import john_f_dickson_patent_charge_pump_schematic from './john-f-dickson-patent-charge-pump-schematic.png'

<Image src={john_f_dickson_patent_charge_pump_schematic} width="600px">A schematic from John F. Dickson's 1978 charge pump patent. Image from https://patentimages.storage.googleapis.com/d5/27/b7/321211f48454c8/US4214174.pdf, retrieved 2020-12-14.</Image>
...
<Image src={lm7705_low_noise_negative_bias_voltage_generator_for_op_amp_application_schematic} width="409px">The typical application schematic for the Texas Instruments LM7705, a 'Low-Noise Negative Bias Generator' for the negative supply of an op-amp. This allows the op-amp to output true 0V. Image from http://www.ti.com/.</Image>
