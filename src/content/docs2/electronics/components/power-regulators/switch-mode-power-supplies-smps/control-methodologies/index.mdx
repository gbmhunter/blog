...
draft: false
image: /images/page-images/smps-control-methodologies.webp
...
import voltage_mode_control_diagram from './_assets/voltage-mode-control-diagram.webp'

<Image src={voltage_mode_control_diagram} width="700px">Diagram showing the basic (simplified) feedback circuitry that makes up voltage mode control. No gain resistors or compensation shown.</Image>
...
import peak_current_mode_control_waveforms from './_assets/peak-current-mode-control-waveforms.webp'

<Image src={peak_current_mode_control_waveforms} width="600px"></Image>

The following diagram shows the basic components of peak current mode control for a buck converter:

import peak_current_mode_control_diagram from './_assets/peak-current-mode-control-diagram.webp'

<Image src={peak_current_mode_control_diagram} width="900px">Block diagram showing the basics of peak current mode control for a buck converter.</Image>
...
import peak_current_mode_control_noise from './_assets/peak-current-mode-control-noise.webp'

<Image src={peak_current_mode_control_noise} width="500px">Diagram showing how switching noise can prematurely turn the switch OFF, and how a blanking interval can be used to improve the noise immunity.</Image>
...
import university_of_colorado_boulder_peak_current_mode_control_screenshot from './_assets/university-of-colorado-boulder-peak-current-mode-control-screenshot.png'

<Image src={university_of_colorado_boulder_peak_current_mode_control_screenshot} width="600px">Screenshot of the YouTube video \"Introduction to Peak Current Mode Control\" by the University of Colorado Bolder[^university-of-colorado-bolder-intro-to-peak-current-mode-control].</Image>
...
import average_current_mode_control_screenshot from './_assets/average-current-mode-control-screenshot.png'

<Image src={average_current_mode_control_screenshot} width="500px">Screenshot from Unitrode's Application Note \"Average Current Mode Control of Switching Power Supplies\" by Lloyd Dixon[^unitrode-average-current-mode-control-of-smps].</Image>
