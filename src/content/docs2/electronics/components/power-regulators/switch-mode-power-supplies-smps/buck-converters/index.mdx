...
import buck_converter_basic_schematic from './_assets/buck-converter-basic-schematic.svg'

<Image src={buck_converter_basic_schematic} width="600">The basic schematic of a buck converter. SW1 is typically a MOSFET switched by control logic (not shown).</Image>
...
import buck_converter_schematic_current_path_ton from './_assets/buck-converter-schematic-current-path-ton.svg'

<Image src={buck_converter_schematic_current_path_ton} width="500">Current path when the switch is **closed** (during $t_{on}$ ).</Image>
...
import buck_converter_schematic_current_path_toff from './_assets/buck-converter-schematic-current-path-toff.svg'

<Image src={buck_converter_schematic_current_path_toff} width="500">Current path when the switch is **open** (during $t_{off}$).</Image>
...
import voltage_mode_control_diagram from './_assets/voltage-mode-control-diagram.svg'

<Image src={voltage_mode_control_diagram} width="800">The basic logical components used for voltage-mode control.</Image>
...
import ninja_calc_buck_converter_calculator_screenshot from './_assets/ninja-calc-buck-converter-calculator-screenshot.png'

<Image src={ninja_calc_buck_converter_calculator_screenshot} width="950">A screenshot of the buck converter calculator in NinjaCalc (as of v2.2.0).</Image>
...
import photo_of_lmz20502_buck_converter from './_assets/photo-of-lmz20502-buck-converter.jpg'

<Image src={photo_of_lmz20502_buck_converter} width="306">A photo of the LMZ20502 buck converter. Image from http://www.digikey.co.nz/product-detail/en/LMZ20502SILT/296-38656-1-ND/.</Image>
...
import microsip_component_package_dimensions from './_assets/microsip-component-package-dimensions.png'

<Image src={microsip_component_package_dimensions} width="500">The dimensions of the MicroSIP component package, used by the Texas Instruments 'Nano' buck converters. Image from http://www.ti.com/lit/ds/symlink/lmz20502.pdf.</Image>
