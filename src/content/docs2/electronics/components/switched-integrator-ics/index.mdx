...
<Image src={import('./ivc102-switched-integrator-ic-functional-diagram.png')} width="500px">Functional diagram of the IVC102 switched integrator IC from Burr-Brown (now Texas Instruments)[^burr-brown-ivc102-ds].</Image>
