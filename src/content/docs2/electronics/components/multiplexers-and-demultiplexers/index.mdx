...
<Image src={import('./cd4051b-functional-diagram-ti.png')} width="400px">The functional diagram of the CD4051B 8:1 analogue multiplexer by Texas Instruments. Image retrieved from https://www.ti.com/lit/ds/symlink/cd4052b.pdf on 2021-01-30.</Image>
...
<Image src={import('./intech-2100-m-analogue-input-multiplexer.png')} width="400px">16-channel analog input multiplexer by Intech.</Image>
