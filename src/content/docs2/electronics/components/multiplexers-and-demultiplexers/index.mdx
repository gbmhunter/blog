...
import cd4051b_functional_diagram_ti from './cd4051b-functional-diagram-ti.png'

<Image src={cd4051b_functional_diagram_ti} width="400px">The functional diagram of the CD4051B 8:1 analogue multiplexer by Texas Instruments. Image retrieved from https://www.ti.com/lit/ds/symlink/cd4052b.pdf on 2021-01-30.</Image>
...
import intech_2100_m_analogue_input_multiplexer from './intech-2100-m-analogue-input-multiplexer.png'

<Image src={intech_2100_m_analogue_input_multiplexer} width="400px">16-channel analog input multiplexer by Intech.</Image>
