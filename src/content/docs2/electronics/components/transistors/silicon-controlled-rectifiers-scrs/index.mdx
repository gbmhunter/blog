...
<Image src={import('./scr-pn-junction-diagram.svg')} width="400px">The construction of a SCR showing the P and N semiconductor regions.</Image>
...
<Image src={import('./two-scrs-on-heatsinks.jpg')} width="600px">Two high-power SCRs in TO-93 packages that are mounted to heatsinks (the International Rectifier 151RB60 and an unknown SCR).</Image>

## Schematic Symbol

The schematic symbol for an SCR is shown below:

<Image src={import('./scr-schematic-symbol.svg')} width="400px">The schematic symbol for a silicon controlled rectifier (SCR).</Image>
...
<Image src={import('./m54123l-circuit-breaker-typical-application-with-scr.png')} width="600px">Typical application diagram for the M54123L circuit breaker IC, showing the use of an external SCR.</Image>
