...
import bjt_schematic_symbols_npn_pnp from './bjt-schematic-symbols-npn-pnp.png'

<Image src={bjt_schematic_symbols_npn_pnp} width="600px">Schematics symbols for NPN and PNP transistors. Note that the collector and emitter have flipped positions for the PNP, as commonly drawn on schematics.</Image>
...
import output_transfer_characteristics_microcap_sim_plot from './output-transfer-characteristics-microcap-sim/plot.png'

<Image src={output_transfer_characteristics_microcap_sim_plot} width="600px">The output transfer characteristics (simulated) for the 2N2222 BJT.</Image>
...
import early_voltage_microcap_sim_vce_vs_ic_with_early_voltage from './early-voltage-microcap-sim/vce-vs-ic-with-early-voltage.png'

<Image src={early_voltage_microcap_sim_vce_vs_ic_with_early_voltage} width="700px">Graph of Vce vs. Ic showing how the Early voltage is the extrapolation of the curves (in the active region) back to the x-axis intersection.</Image>
...
import hybrid_pi_model_simplified from './hybrid-pi-model-simplified.png'

<Image src={hybrid_pi_model_simplified} width="600px">A simplified Hybrid-Pi model of a BJT transistor.</Image>
...
import common_base_amplifier from './common-base-amplifier.png'

<Image src={common_base_amplifier} width="400px">Basic schematic of a NPN BJT common-base amplifier. DC biasing componentry is not shown.</Image>
...
import common_base_amplifier_dc_bias from './common-base-amplifier-dc-bias.png'

<Image src={common_base_amplifier_dc_bias} width="700px">Schematic of a NPN BJT common-base amplifier with DC biasing componentry shown.</Image>
...
import constant_current_bjt_based_led_driver from './constant-current-bjt-based-led-driver.png'

<Image src={constant_current_bjt_based_led_driver} width="300px">The simulation schematic for a constant-current BJT-based LED driver.</Image>
...
import constant_current_bjt_based_led_driver_simulation_results from './constant-current-bjt-based-led-driver-simulation-results.png'

<Image src={constant_current_bjt_based_led_driver_simulation_results} width="800px">The simulation results of a constant-current BJT-based LED driver.</Image>
...
import current_source_npn_voltage_divider_base from './current-source-npn-voltage-divider-base.png'

<Image src={current_source_npn_voltage_divider_base} width="500px">A NPN BJT current-sink using a resistor divider to drive the base.</Image>
...
import current_mirror_pnp from './current-mirror-pnp.png'

<Image src={current_mirror_pnp} width="400px">A basic PNP-based current mirror programmed to source 1mA into the load. Q1 and Q2 should be a matched transistor pair to achieve good mirroring of the current.</Image>
...
import bc548_transistor_to92_photo from './bc548-transistor-to92-photo.png'

<Image src={bc548_transistor_to92_photo} width="300px">A photo of the ubiquitous BC548 BJT transistor in to TO-92 package. Image from https://www.dnatechindia.com/bc-548-npn-transistor-buy-online-india.html.</Image>
...
import multiple_emitter_bjt_schematic_symbol_u1 from './multiple-emitter-bjt-schematic-symbol-u1.png'

<Image src={multiple_emitter_bjt_schematic_symbol_u1} width="300px">The schematic symbol for a multiple-emitter BJT.</Image>
...
import basic_two_input_tll_nand_gate_schematic from './basic-two-input-tll-nand-gate-schematic.png'

<Image src={basic_two_input_tll_nand_gate_schematic} width="600px">The schematic of a basic two-input TTL NAND gate.</Image>
...
import bjt_safe_operating_area from './bjt-safe-operating-area.png'

<Image src={bjt_safe_operating_area} width="500px">A typical representation of the safe operating area (SOA) of a BJT. Normally multiple curves are drawn, one for DC and a number for pulses of various lengths. Both $V_{CE}$ and $I_C$ are on logarithmic axes.</Image>
...
import leakage_current_diagrams from './leakage-current-diagrams.png'

<Image src={leakage_current_diagrams} width="800px">Circuits showing how each 1 of the three BJT leakage currents is measured.</Image>
...
import micronta_transistor_tester_box from './micronta-transistor-tester-box.jpg'
import micronta_transistor_tester_front_panel from './micronta-transistor-tester-front-panel.jpg'
import micronta_transistor_tester_internals from './micronta-transistor-tester-internals.jpg'

<div style={{ display: 'grid' }}>
<div style={{ gridRow: 1, gridColumn: '1/3' }}><Image src={micronta_transistor_tester_box} width="600px">The front box.</Image></div>
<div style={{ gridRow: 2, gridColumn: '1' }}><Image src={micronta_transistor_tester_front_panel} width="300px">The front panel.</Image></div>
<div style={{ gridRow: 2, gridColumn: '2' }}><Image src={micronta_transistor_tester_internals} width="300px">The internal circuitry.</Image></div>
</div>
