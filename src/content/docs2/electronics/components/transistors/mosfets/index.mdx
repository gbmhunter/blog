...
<Image src={import('./_assets/dmn61d8l-7-mosfet-internal-schematic.png')} width="600">Internal schematics of the DMN61D8L-7 MOSFET from Diodes Incorporated[^bib-dinc-dmn61d8l-ds].</Image>
...
<Image src={import('./_assets/common-source-amplifier.webp')} width="500">Schematic of a basic common-mode N-channel MOSFET amplifier.</Image>
