...
import zener_diode_schematic_symbol from './zener-diode-schematic-symbol.svg'

<Image src={zener_diode_schematic_symbol} width="300">The schematic symbol for a Zener diode.</Image>
...
import zener_and_npn_bjt_voltage_limiter_adp8140 from './zener-and-npn-bjt-voltage-limiter-adp8140.png'

<Image src={zener_and_npn_bjt_voltage_limiter_adp8140} width="600">A simple Zener/NPN based voltage limiter circuit for the input to the ADP8140 LED driver IC. Image from https://www.analog.com/media/en/technical-documentation/data-sheets/ADP8140.pdf.</Image>
