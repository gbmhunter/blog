...
<Image src={import('./1n4148-small-signal-diode-photo-on-semi.png')} width="200">Photo of the small signal 1N41488 diode by onsemi in the DO-35 component package. Image (C) onsemi.</Image>
