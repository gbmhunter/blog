...
import schottky_diode_schematic_symbol from './schottky-diode-schematic-symbol.svg'

<Image src={schottky_diode_schematic_symbol} width="300px">The schematic symbol and designator for the Schottky diode. Note the curls on the bar, which differs from the general-purpose diode symbol. The anode is the left pin and the cathode is the right pin.</Image>
