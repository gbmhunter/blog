...
import lt_3745_led_driver_typical_application_circuit from './lt-3745-led-driver-typical-application-circuit.png'

<Image src={lt_3745_led_driver_typical_application_circuit} width="800px">The LT3745 LED driver by Linear Technology is a advanced driver which can individually control the current for up to 16 LED circuits. Image from http://cds.linear.com/docs/en/datasheet/3745f.pdf.</Image>
...
import lt3745_resistance_vs_switching_frequency_graph from './lt3745-resistance-vs-switching-frequency-graph.png'

<Image src={lt3745_resistance_vs_switching_frequency_graph} width="800px">A graph of the resistance of RT, versus the switching frequency for the LT3745 LED driver IC. The power-based equation fits the data well! Note that Excel rounded the co-efficient shown by too great an amount!</Image>
