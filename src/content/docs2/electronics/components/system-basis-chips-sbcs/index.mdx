...
import nxp_fs26_architecture_block_diagram from './_assets/nxp-fs26-architecture-block-diagram.png'

<Image src={nxp_fs26_architecture_block_diagram} width="700px">Architecture block diagram of the NXP FS26 SBC[^nxp-fs26-product-page].</Image>
