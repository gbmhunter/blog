...
<Image src={import('./vishay-thermawick-construction-thjp.png')} width="400px">Basic construction of a thermal jumper chip from the Vishay ThermaWick family[^bib-vishay-thermawick-series-ds].</Image>
...
<Image src={import('./tjc-application-example-tt-electronics.png')} width="300px">Typical application example for a thermal jumper chip.[^bib-tt-elec-tjc-series-ds]</Image>
