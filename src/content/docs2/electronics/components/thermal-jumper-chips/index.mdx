...
date: 2020-07-29
description: Thermal jumper chips are PCB components whose sole purpose is to provide good thermal conductivity between two pads on a PCB.
...
<Image src={import('./_assets/vishay-thermawick-construction-thjp.png')} width="400px">Basic construction of a thermal jumper chip from the Vishay ThermaWick family[^bib-vishay-thermawick-series-ds].</Image>
...
<Image src={import('./_assets/tjc-application-example-tt-electronics.png')} width="300px">Typical application example for a thermal jumper chip.[^bib-tt-elec-tjc-series-ds]</Image>
