...
import fpga_schematic_just_the_ic_no_routing from './fpga-schematic-just-the-ic-no-routing.png'

<Image src={fpga_schematic_just_the_ic_no_routing} width="1245px">An A3 schematic sheet with just one 236-pin FPGA IC added to it (no routing).</Image>
