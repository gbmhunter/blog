...
<Image src={gdt_schematic_symbol_2_electrode} width="250px">Schematic symbol and designator for a 2-electrode gas discharge tube (GDT). </Image>
<Image src={gdt_schematic_symbol_3_electrode} width="250px">Schematic symbol and designator for a 3-electrode gas discharge tube (GDT). </Image>
</div>
...
import bourns_2031_xxt_gdt_3d_model from './_assets/bourns-2031-xxt-gdt-3d-model.png'

<Image src={bourns_2031_xxt_gdt_3d_model} width="250px">3D model of the Bourns 2031-xxT-SM range of GDTs. Image from https://www.bourns.com/docs/Product-Datasheets/2031-xxT.pdf.</Image>
