...
import piezo_photo from './piezo-photo.jpg'

<Image src={piezo_photo} width="400px">Photo of an externally driven piezo. They tend to be smaller than their internally driven cousins.</Image>
...
import piezoelectric_speaker_schematic_symbol from './piezoelectric-speaker-schematic-symbol.png'

<Image src={piezoelectric_speaker_schematic_symbol} width="400px">The schematic symbol for a 2-pin piezoelectric speaker.</Image>
...
import piezo_4khz_resonant_frequency_response from './piezo-4khz-resonant-frequency-response.jpg'

<Image src={piezo_4khz_resonant_frequency_response} width="500px">The frequency response of a piezo speaker with a resonant frequency of 4kHz.</Image>
...
import piezo_drive_circuit_parallel_inductor from './piezo-drive-circuit-parallel-inductor.jpg'

<Image src={piezo_drive_circuit_parallel_inductor} width="500px">An easy and loud way to drive a piezo speaker using an inductor in parallel with the piezo and a NPN BJT.</Image>

A non-standard and slightly convoluted method for driving a piezo speaker using a half-bridge driver IC:

import piezo_drive_circuit_half_bridge_ic from './piezo-drive-circuit-half-bridge-ic.jpg'

<Image src={piezo_drive_circuit_half_bridge_ic} width="500px">A non-standard and slightly convoluted method for driving a Piezo speaker using a half-bridge driver IC.</Image>
...
import piezo_int_drive_volume_control_circuit from './piezo-int-drive-volume-control-circuit.jpg'

<Image src={piezo_int_drive_volume_control_circuit} width="500px">The schematic of an internally driven piezo volume control circuit.</Image>
...
import piezoelectric_speaker_in_aura_br_au_109b_smoke_alarm from './piezoelectric-speaker-in-aura-br-au-109b-smoke-alarm.png'

<Image src={piezoelectric_speaker_in_aura_br_au_109b_smoke_alarm} width="800px">A piezoelectric \"bender\" style speaker mounted in a Aura BR-AU-109B smoke alarm. You can also see the third feedback lead (yellow wire connecting to \"broom\" shape on piezo).</Image>
...
import pieoelectric_speaker_with_nodal_mounting from './pieoelectric-speaker-with-nodal-mounting.jpg'

<Image src={pieoelectric_speaker_with_nodal_mounting} width="800px">The piezoelectric speaker in the Aura BR-AU-109B smoke alarm appears to be nodally mounted, as you can see the silicone and mounting point radius is about 0.65 times the piezoelectric speaker radius.</Image>
...
import home_made_piezo_crystal from './home-made-piezo-crystal.jpg'

<Image src={home_made_piezo_crystal} width="600px">A large home-made piezo crystal. Photo from 2012.</Image>
