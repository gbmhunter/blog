...
<Image src={import('./ssd1306-gddram-page-structure.png')} width="550px">The GDDRAM structure (the RAM inside the IC which holds information on the colour of each pixel) of the Solomon SSD1306 IC.</Image>
...
<Image src={import('./oled-display-brightness-vs-vddb.gif')} width="320px">Graph of OLED brightness vs. VDDB.</Image>
