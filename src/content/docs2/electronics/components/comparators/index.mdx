...
<Image src={import('./basic-op-amp-schematic-symbol.png')} width="350">The basic schematic symbol for a comparator (it is the same for an op-amp).</Image>
...
<Image src={import('./comparator-hystersis-graph.png')} width="334">A graph showing how comparator hystersis works.</Image>
...
<Image src={import('./comparator-push-pull-out-non-inverting-configuration.png')} width="535">A schematic of a comparator in the non-inverting configuration.</Image>
