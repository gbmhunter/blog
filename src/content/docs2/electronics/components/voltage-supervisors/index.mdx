...
<Image src={import('./apx803l-voltage-supervisor-functional-block-diagram.png')} width="600px">The functional block diagram for the Diodes Inc. APX803L voltage supervisor IC[^diodes-inc-apx803l-voltage-supervisor-ds].</Image>
