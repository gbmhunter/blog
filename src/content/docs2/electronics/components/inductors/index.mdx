...
import n_3_35uh_20a_large_inductor from './_assets/3-35uh-20a-large-inductor.jpg'

<Image src={n_3_35uh_20a_large_inductor} width="400px">A 3.35uH 20A large inductor.</Image>
...
import schematic_symbols_of_inductors from './_assets/schematic-symbols-of-inductors.png'

<Image src={schematic_symbols_of_inductors} width="500px">Schematic symbols for a range of the basic inductor sub-families.</Image>
...
import inductance_vs_dc_current_vishay_ihlp1212bzer1r0m11 from './_assets/inductance-vs-dc-current-vishay-ihlp1212bzer1r0m11.png'

<Image src={inductance_vs_dc_current_vishay_ihlp1212bzer1r0m11} width="500px">Plot of inductance vs. DC current for the Vishay Dale IHLP1212BZER1R0M11 inductor[^bib-vishay-ihlp1212bz11-ds].</Image>
...
import self_resonant_frequency from './_assets/self-resonant-frequency.png'

<Image src={self_resonant_frequency} width="600px">Plot of inductance vs. frequency for the Vishay Dale IHLP1212BZER1R0M11 inductor[^bib-vishay-ihlp1212bz11-ds], highlighting the self-resonant frequency (SRF).</Image>
...
import metal_composite_inductor_construction_kemet_mpx from './_assets/metal-composite-inductor-construction-kemet-mpx.png'

<Image src={metal_composite_inductor_construction_kemet_mpx} width="300px">Internal construction of a metal composite inductor. Image by Kemet, retrieved from https://media.digikey.com/pdf/Data%20Sheets/Kemet%20PDFs/MPXV_Series_DS.pdf on 2020-11-30.</Image>
...
import inductors_in_parallel_with_equation from './_assets/inductors-in-parallel-with-equation.png'

<Image src={inductors_in_parallel_with_equation} width="608px">Two inductors in parallel is the equivalent of one inductor whose inductance is given by the reciprocal equation in this image.</Image>
...
import inductor_in_series_with_equation from './_assets/inductor-in-series-with-equation.png'

<Image src={inductor_in_series_with_equation} width="609px">Two inductors in series are the equivalent of one inductor whose inductance is the sum of the individual inductances.</Image>
...
<Image src={inductance_vs_current_graph_wurth_7447789003_3_3uh} width="502px">Inductance vs. current graph of the Wurth 7447789003, a 3.3uH ferrite SMD inductor with a specified saturation current of 4.2A.</Image>
...
import inductor_measurement_with_sig_gen_and_oscilloscope_01 from './_assets/inductor-measurement-with-sig-gen-and-oscilloscope-01.png'

    <Image src={inductor_measurement_with_sig_gen_and_oscilloscope_01} width="500px"></Image>
...
import inductor_measurement_with_sig_gen_and_oscilloscope_02 from './_assets/inductor-measurement-with-sig-gen-and-oscilloscope-02.png'

    <Image src={inductor_measurement_with_sig_gen_and_oscilloscope_02} width="600px"></Image>
...
import ipc_sm_782_component_dimensions_for_smd_inductors from './_assets/ipc-sm-782-component-dimensions-for-smd-inductors.png'

<Image src={ipc_sm_782_component_dimensions_for_smd_inductors} width="709px">Standard dimensions for three different types of SMD inductor packages. Image from the IPC-SM-782 standard.</Image>
