...
import macronix_mx25v5126f_block_diagram from './_assets/macronix-mx25v5126f-block-diagram.png'

<Image src={macronix_mx25v5126f_block_diagram} width="700px">The internal block diagram showing the architecture of the MX25V5126F NOR flash IC from Macronix[^macronix-mx25v5126f-nor-flash-ds].</Image>
