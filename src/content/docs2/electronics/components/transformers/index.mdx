...
<Image src={import('./transformer-graph-explaining-hysteresis-losses.jpg')} width="609px">Graph explaining the hysteresis losses in a transformer. Image from http://ecetutorials.com/.</Image>
...
<Image src={import('./typical-flyback-schematic.png')} width="600px">Schematic of a boost converter using a flyback transformer. Image from https://www.coilcraft.com/edu/flyback_transformer.cfm.</Image>
