...
<Image src={import('./idc-connector-plug-and-socket-photo.png')} width="400">A photo of a IDC plug and socket. The top piece of black plastic squashes the ribbon cable into the sharp blades and keeps the cable clamped.</Image>
