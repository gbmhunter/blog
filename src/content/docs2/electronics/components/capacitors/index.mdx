...
<Image src={import('./_assets/capacitor-with-parasitic-series-resistance-leakage-current.png')} width="300">A capacitor showing the parasitic series resistance present in all real capacitors, which creates a leakage current.</Image>
