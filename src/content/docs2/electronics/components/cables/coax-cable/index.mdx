...
import coax_cable_cut_away_annotated from './coax-cable-cut-away-annotated.png'

<Image src={coax_cable_cut_away_annotated} width="700">The make-up of a standard coaxial cable. Relative dimensions accurate for RG-6 (dimensions taken from http://www.farnell.com/datasheets/1697593.pdf).</Image>
...
<p className="centered">where $c=3e8ms^{-1}$ is the speed of light in a vacuum.</p>
