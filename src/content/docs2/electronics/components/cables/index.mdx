...
import nec_2005_cable_standards_reference_cable_type_and_fire_resistance_summary from './nec-2005-cable-standards-reference-cable-type-and-fire-resistance-summary.png'

<Image src={nec_2005_cable_standards_reference_cable_type_and_fire_resistance_summary} width="790">A summary of the cable types and flame tests from NEC. Image from http://www.associatedtelephone.com/.</Image>
...
import cable_glands_three_sizes from './cable-glands-three-sizes.jpg'

<Image src={cable_glands_three_sizes} width="500">Three sizes of cable gland.</Image>
...
import cable_gland_multi_cable_edited from './cable-gland-multi-cable-edited.jpg'

<Image src={cable_gland_multi_cable_edited} width="300">A single large cable gland which contains a grommet which allows 8 cables to pass through.</Image>
...
import metal_cable_gland from './metal-cable-gland.jpg'

<Image src={metal_cable_gland} width="200">Metal cable glands are available if you need stronger support. Note however metal is not strictly better...plastic is better for chemical/corrosion resistance!</Image>
