...
<Image src={import('./curr-source-symbols.svg')} width="400">Popular schematics symbols to represent current sources.</Image>
...
<Image src={import('./zener-diode-bjt-current-source-schematic.png')} width="400">Schematic of a Zener diode + BJT current source.</Image>
...
<Image src={import('./current-sink/op-amp-current-sink-schematic.png')} width="700">Schematic of a basic op-amp based current sink.</Image>
...
<Image src={import('./lt1492-voltage-controlled-current-sink.png')} width="500">A schematic showing gate capacitance compensation circuitry on a op-amp based current sink using the LT1492[^bib-linear-lt1492-ds].</Image>
