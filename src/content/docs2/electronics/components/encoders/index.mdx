...
<Image src={import('./quadrature-phase-detection-circuit.png')} width="600px">A simple quadrature phase detection circuit using a D flip-flop.</Image>
...
<Image src={import('./incorrect-pinout-on-baumer-bhk-05a-encoder.png')} width="400px">The incorrect pinout on a Baumer BHK-05A encoder datasheet.</Image>
