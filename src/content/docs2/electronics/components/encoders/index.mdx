...
import quadrature_phase_detection_circuit from './quadrature-phase-detection-circuit.png'
...
import incorrect_pinout_on_baumer_bhk_05a_encoder from './incorrect-pinout-on-baumer-bhk-05a-encoder.png'

<Image src={incorrect_pinout_on_baumer_bhk_05a_encoder} width="400px">The incorrect pinout on a Baumer BHK-05A encoder datasheet.</Image>
