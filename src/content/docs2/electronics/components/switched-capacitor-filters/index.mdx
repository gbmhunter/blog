...
import ltc1068_switched_capacitor_filter_typical_application from './ltc1068-switched-capacitor-filter-typical-application.png'

<Image src={ltc1068_switched_capacitor_filter_typical_application} width="500px">A dual 4th order butterworth lowpass filter made from the Analog Devices LTC1068 switched-capacitor filter IC[^bib-analog-devices-ltc-1068-ds].</Image>
...
import maxim_mf10_switched_capacitor_filter_4th_order_lowpass_butterworth from './maxim-mf10-switched-capacitor-filter-4th-order-lowpass-butterworth.png'

<Image src={maxim_mf10_switched_capacitor_filter_4th_order_lowpass_butterworth} width="700px">Schematic using the Maxim MF10 to create a 4th order lowpass 2kHz butterworth filter[^bib-maxim-mf10-ds]. The clock is 100x the cutoff frequency.</Image>
