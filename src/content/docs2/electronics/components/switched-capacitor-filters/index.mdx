...
<Image src={import('./ltc1068-switched-capacitor-filter-typical-application.png')} width="500px">A dual 4th order butterworth lowpass filter made from the Analog Devices LTC1068 switched-capacitor filter IC[^bib-analog-devices-ltc-1068-ds].</Image>
...
<Image src={import('./maxim-mf10-switched-capacitor-filter-4th-order-lowpass-butterworth.png')} width="700px">Schematic using the Maxim MF10 to create a 4th order lowpass 2kHz butterworth filter[^bib-maxim-mf10-ds]. The clock is 100x the cutoff frequency.</Image>
