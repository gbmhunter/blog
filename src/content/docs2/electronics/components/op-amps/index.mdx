...
<Image src={import('./op-amp-basic-schematic-symbol.svg')} width="500px">The basic schematic symbol for an op-amp.</Image>
...
<Image src={import('./op-amp-schematic-voltage-follower-buffer.svg')} width="500px">An op-amp configured as a voltage follower (aka buffer).</Image>
...
<Image src={import('./simulation-schematic-for-op-amp-voltage-follower-buffer.png')} width="400px">A simulation schematic for an op-amp configured as a voltage-follower (buffer).</Image>

The results of the simulation:

<Image src={import('./output-voltage-vs-input-voltage-op-amp-voltage-follower.png')} width="600px">The simulation results for an op-amp configured as a voltage-follower (buffer). Note how the output voltage mirrors the input voltage exactly.</Image>
...
<Image src={import('./non-inverting-amplifier-schematic.svg')} width="500px">An op-amp configured as a non-inverting amplifier.</Image>
...
<Image src={import('./non-inverting-op-amp-amplifier-simulation-schematic.png')} width="450px">The simulation schematic for a non-inverting op-amp amplifier.</Image>
...
<Image src={import('./vout-vs-vin-non-inverting-op-amp-amplifier-gain-of-2.png')} width="700px">A graph of $v_{out}$ vs. $v_{in}$ for a non-inverting op-amp amplifier circuit.</Image>
...
<Image src={import('./inverting-amplifier-schematic.svg')} width="500px">An op-amp configured as an inverting amplifier.</Image>
...
<Image src={import('./inverting-op-amp-simulation-schematic.png')} width="600px">A schematic for simulating the behaviour of an inverting op-amp.</Image>

And below are the simulation results for the above schematic:

<Image src={import('./vout-vs-vin-inverting-op-amp-gain-neg-1.png')} width="700px">$v_{out}$ vs. $v_{in}$ for an inverting op-amp with a gain of -1.</Image>
...
<Image src={import('./differential-amplifier-schematic.svg')} width="700px">An op-amp configured as a differential amplifier.</Image>
...
<Image src={import('./differential-op-amp-simulation-schematic.png')} width="800px">A schematic for simulating the behaviour of a differential op-amp.</Image>

This schematic produces the following results:

<Image src={import('./differential-op-amp-simulation-graph-vin1-vin2-vout.png')} width="700px">A graph Vout vs. Vin1 and Vin2 for a op-amp configured as a differential amplifier.</Image>
...
<Image src={import('./integration-amplifier-schematic-ideal.svg')} width="500px">An op-amp configured as an ideal integrator.</Image>
...
<Image src={import('./integration-amplifier-schematic-non-ideal.svg')} width="430px">An op-amp configured as a non-ideal (real world) integrator, with feedback resistor $R_f$ to slowly remove DC offset and $R_{bias}$ to compensate for input bias current.</Image>
...
<Image src={import('./op-amp-current-sink-schematic.png')} width="500px">Schematic of an op-amp based current sink. See [Current Sources And Sinks: Op-amp Current Sink](/docs/electronics/components/current-sources-and-sinks/index.mdx#op-amp-current-sink) for more info.</Image>
...
<Image src={import('./summing-amplifier-inverting.svg')} width="500px">A summing amplifier with three inputs.</Image>
...
<Image src={import('./summing-amplifier-non-inverting.svg')} width="500px">A non-inverting summing amplifier with three inputs.</Image>
...
<Image src={import('./ideal-diode-basic.svg')} width="600px">A basic ideal diode circuit.</Image>

The below graph shows the response of the basic ideal diode circuit.

<Image src={import('./ideal-diode-basic-response.png')} width="500px">The response of the basic ideal diode circuit.</Image>
...
<Image src={import('./ideal-diode-improved-inverting.svg')} width="700px">An improved ideal diode/half-wave rectifier.</Image>
...
<Image src={import('./sample-and-hold.svg')} width="600px">Basic op-amp based sample-and-hold circuit.</Image>
...
<Image src={import('./input-offset-voltage-model.svg')} width="600px">The input offset voltage is modelled as a voltage source in series with one of the inputs of an ideal op-amp (it doesn't matter which input, as the input offset voltage can be positive or negative).</Image>
...
<Image src={import('./input-offset-voltage-trimming-inverting.svg')} width="700px">A popular way of performing external input offset voltage trimming with a inverting op-amp.</Image>
...
<Image src={import('./slew-rate-distortion-diagram-square-wave.png')} width="500px">Plot showing the effect an op-amps slew rate on a input square wave. Slew rate was chosen to be equal to the LM324's of 0.4V/us[^bib-ti-lm324-datasheet].</Image>
...
<Image src={import('./slew-rate-distortion-diagram-sine-wave.png')} width="600px">Plots showing the distortion of a 10V (peak) 20kHz sine wave when subjected to different op-amp slew rates.</Image>
...
<Image src={import('./lm7705-low-noise-negative-bias-voltage-generator-for-op-amp-application-schematic.png')} width="688px">The typical application schematic for the Texas Instruments LM7705, a 'Low-Noise Negative Bias Generator' for the negative supply of an op-amp. This allows the op-amp to output true 0V. Image from http://www.ti.com/.</Image>
...
<Image src={import('./open-loop-vs-closed-loop-op-amp-gain-bode-plot.svg')} width="500px">How the open-loop and closed-loop gain of an op-amp changes with increasing frequency.</Image>

We can generalize the circuit of an op-amp with negative feedback to the block diagram shown below. 

<Image src={import('./generalized-negative-feedback-block-diagram.svg')} width="700px">A block diagram showing a generalized op-amp configuration with negative feedback.</Image>
...
<Image src={import('./fully-differential-isolation-amplfier-ti-amc1200-simplified-schematic.pdf.png')} width="700px">A simplified schematic of the Texas Instruments AMC1200, a fully-differential isolated amplifier. Image from http://www.ti.com/.</Image>
...
<Image src={import('./op-amp-input-pin-resistors.png')} width="500px">Schematic showing a resistor on the positive input to a op-amp.</Image>
...
<Image src={import('./op07-op-amp-offset-nulling-circuit.png')} width="500px">Image from https://www.analog.com/media/en/technical-documentation/data-sheets/OP07.pdf.</Image>
...
<Image src={import('./negative-impedance-converter-nic.svg')} width="500px">Schematic of a negative impedance converter (NIC) created from an op-amp and a few passive components.</Image>
...
<Image src={import('./standard-8-pin-dual-op-amp-pinout.svg')} width="400px">The standard pinout for two op-amps in an 8-pin package. This includes the DIP-8, TSSOP-8, SOIC-8 and MSOP-8 component packages.</Image>
