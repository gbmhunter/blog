...
import op_amp_basic_schematic_symbol from './op-amp-basic-schematic-symbol.svg'

<Image src={op_amp_basic_schematic_symbol} width="500px">The basic schematic symbol for an op-amp.</Image>
...
import op_amp_schematic_voltage_follower_buffer from './op-amp-schematic-voltage-follower-buffer.svg'

<Image src={op_amp_schematic_voltage_follower_buffer} width="500px">An op-amp configured as a voltage follower (aka buffer).</Image>
...
import simulation_schematic_for_op_amp_voltage_follower_buffer from './simulation-schematic-for-op-amp-voltage-follower-buffer.png'

<Image src={simulation_schematic_for_op_amp_voltage_follower_buffer} width="400px">A simulation schematic for an op-amp configured as a voltage-follower (buffer).</Image>

The results of the simulation:

import output_voltage_vs_input_voltage_op_amp_voltage_follower from './output-voltage-vs-input-voltage-op-amp-voltage-follower.png'

<Image src={output_voltage_vs_input_voltage_op_amp_voltage_follower} width="600px">The simulation results for an op-amp configured as a voltage-follower (buffer). Note how the output voltage mirrors the input voltage exactly.</Image>
...
import non_inverting_amplifier_schematic from './non-inverting-amplifier-schematic.svg'

<Image src={non_inverting_amplifier_schematic} width="500px">An op-amp configured as a non-inverting amplifier.</Image>
...
import non_inverting_op_amp_amplifier_simulation_schematic from './non-inverting-op-amp-amplifier-simulation-schematic.png'

<Image src={non_inverting_op_amp_amplifier_simulation_schematic} width="450px">The simulation schematic for a non-inverting op-amp amplifier.</Image>
...
import vout_vs_vin_non_inverting_op_amp_amplifier_gain_of_2 from './vout-vs-vin-non-inverting-op-amp-amplifier-gain-of-2.png'

<Image src={vout_vs_vin_non_inverting_op_amp_amplifier_gain_of_2} width="700px">A graph of $v_{out}$ vs. $v_{in}$ for a non-inverting op-amp amplifier circuit.</Image>
...
import inverting_amplifier_schematic from './inverting-amplifier-schematic.svg'

<Image src={inverting_amplifier_schematic} width="500px">An op-amp configured as an inverting amplifier.</Image>
...
import inverting_op_amp_simulation_schematic from './inverting-op-amp-simulation-schematic.png'

<Image src={inverting_op_amp_simulation_schematic} width="600px">A schematic for simulating the behaviour of an inverting op-amp.</Image>

And below are the simulation results for the above schematic:

import vout_vs_vin_inverting_op_amp_gain_neg_1 from './vout-vs-vin-inverting-op-amp-gain-neg-1.png'

<Image src={vout_vs_vin_inverting_op_amp_gain_neg_1} width="700px">$v_{out}$ vs. $v_{in}$ for an inverting op-amp with a gain of -1.</Image>
...
import differential_amplifier_schematic from './differential-amplifier-schematic.svg'

<Image src={differential_amplifier_schematic} width="700px">An op-amp configured as a differential amplifier.</Image>
...
import differential_op_amp_simulation_schematic from './differential-op-amp-simulation-schematic.png'

<Image src={differential_op_amp_simulation_schematic} width="800px">A schematic for simulating the behaviour of a differential op-amp.</Image>

This schematic produces the following results:

import differential_op_amp_simulation_graph_vin1_vin2_vout from './differential-op-amp-simulation-graph-vin1-vin2-vout.png'

<Image src={differential_op_amp_simulation_graph_vin1_vin2_vout} width="700px">A graph Vout vs. Vin1 and Vin2 for a op-amp configured as a differential amplifier.</Image>
...
import integration_amplifier_schematic_ideal from './integration-amplifier-schematic-ideal.svg'

<Image src={integration_amplifier_schematic_ideal} width="500px">An op-amp configured as an ideal integrator.</Image>
...
import integration_amplifier_schematic_non_ideal from './integration-amplifier-schematic-non-ideal.svg'

<Image src={integration_amplifier_schematic_non_ideal} width="430px">An op-amp configured as a non-ideal (real world) integrator, with feedback resistor $R_f$ to slowly remove DC offset and $R_{bias}$ to compensate for input bias current.</Image>
...
An **op-amp can be easily wired up with a MOSFET and sense resistor to make a _voltage controlled current source_**. See [Current Sources And Sinks: Op-amp Current Sink](/docs/electronics/components/current-sources-and-sinks/index.mdx#op-amp-current-sink) for info on how to make an op-amp current source, including schematics, equations and worked examples.

import _docs_electronics_components_current_sources_and_sinks_current_sink_op_amp_current_sink_schematic from './op-amp-current-sink-schematic.png'

<Image src={_docs_electronics_components_current_sources_and_sinks_current_sink_op_amp_current_sink_schematic} width="500px">Schematic of an op-amp based current sink. See [Current Sources And Sinks: Op-amp Current Sink](/docs/electronics/components/current-sources-and-sinks/index.mdx#op-amp-current-sink) for more info.</Image>
...
import summing_amplifier_inverting from './summing-amplifier-inverting.svg'

<Image src={summing_amplifier_inverting} width="500px">A summing amplifier with three inputs.</Image>
...
import summing_amplifier_non_inverting from './summing-amplifier-non-inverting.svg'

<Image src={summing_amplifier_non_inverting} width="500px">A non-inverting summing amplifier with three inputs.</Image>
...
import level_shifter_sim_schematic from './level-shifter-sim/schematic.png'

<Image src={level_shifter_sim_schematic} width="700px">Schematic of a level-shifting circuit that converts a $\pm 5.0V$ signal into a $0-3.3V$ signal.</Image>

import level_shifter_sim_out from './level-shifter-sim/out.png'

<Image src={level_shifter_sim_out} width="700px">Simulation results of the level-shifting circuit shown in [^level-shifter-sim-schematic]. You can clearly see that the $\pm 5.0V$ signal has been level-shifted to the range $0-3.3V$. Because the input is connected to the non-inverting input of the op-amp, the output is in phase with the input signal (i.e. not inverted).</Image>
...
import ideal_diode_basic from './ideal-diode-basic.svg'

<Image src={ideal_diode_basic} width="600px">A basic ideal diode circuit.</Image>

The below graph shows the response of the basic ideal diode circuit.

import ideal_diode_basic_response from './ideal-diode-basic-response.png'

<Image src={ideal_diode_basic_response} width="500px">The response of the basic ideal diode circuit.</Image>
...
import ideal_diode_improved_inverting from './ideal-diode-improved-inverting.svg'

<Image src={ideal_diode_improved_inverting} width="700px">An improved ideal diode/half-wave rectifier.</Image>
...
import sample_and_hold from './sample-and-hold.svg'

<Image src={sample_and_hold} width="600px">Basic op-amp based sample-and-hold circuit.</Image>
...
import input_offset_voltage_model from './input-offset-voltage-model.svg'

<Image src={input_offset_voltage_model} width="600px">The input offset voltage is modelled as a voltage source in series with one of the inputs of an ideal op-amp (it doesn't matter which input, as the input offset voltage can be positive or negative).</Image>
...
import input_offset_voltage_trimming_inverting from './input-offset-voltage-trimming-inverting.svg'

<Image src={input_offset_voltage_trimming_inverting} width="700px">A popular way of performing external input offset voltage trimming with a inverting op-amp.</Image>
...
import slew_rate_distortion_diagram_square_wave from './slew-rate-distortion-diagram-square-wave.png'

<Image src={slew_rate_distortion_diagram_square_wave} width="500px">Plot showing the effect an op-amps slew rate on a input square wave. Slew rate was chosen to be equal to the LM324's of 0.4V/us[^bib-ti-lm324-datasheet].</Image>
...
import slew_rate_distortion_diagram_sine_wave from './slew-rate-distortion-diagram-sine-wave.png'

<Image src={slew_rate_distortion_diagram_sine_wave} width="600px">Plots showing the distortion of a 10V (peak) 20kHz sine wave when subjected to different op-amp slew rates.</Image>
...
import lm7705_low_noise_negative_bias_voltage_generator_for_op_amp_application_schematic from './lm7705-low-noise-negative-bias-voltage-generator-for-op-amp-application-schematic.png'

<Image src={lm7705_low_noise_negative_bias_voltage_generator_for_op_amp_application_schematic} width="688px">The typical application schematic for the Texas Instruments LM7705, a 'Low-Noise Negative Bias Generator' for the negative supply of an op-amp. This allows the op-amp to output true 0V. Image from http://www.ti.com/.</Image>
...
import open_loop_vs_closed_loop_op_amp_gain_bode_plot from './open-loop-vs-closed-loop-op-amp-gain-bode-plot.svg'

<Image src={open_loop_vs_closed_loop_op_amp_gain_bode_plot} width="500px">How the open-loop and closed-loop gain of an op-amp changes with increasing frequency.</Image>

We can generalize the circuit of an op-amp with negative feedback to the block diagram shown below. 

import generalized_negative_feedback_block_diagram from './generalized-negative-feedback-block-diagram.svg'

<Image src={generalized_negative_feedback_block_diagram} width="700px">A block diagram showing a generalized op-amp configuration with negative feedback.</Image>
...
import fully_differential_isolation_amplfier_ti_amc1200_simplified_schematic_pdf from './fully-differential-isolation-amplfier-ti-amc1200-simplified-schematic.pdf.png'

<Image src={fully_differential_isolation_amplfier_ti_amc1200_simplified_schematic_pdf} width="700px">A simplified schematic of the Texas Instruments AMC1200, a fully-differential isolated amplifier. Image from http://www.ti.com/.</Image>
...
import op_amp_input_pin_resistors from './op-amp-input-pin-resistors.png'

<Image src={op_amp_input_pin_resistors} width="500px">Schematic showing a resistor on the positive input to a op-amp.</Image>
...
import op07_op_amp_offset_nulling_circuit from './op07-op-amp-offset-nulling-circuit.png'

<Image src={op07_op_amp_offset_nulling_circuit} width="500px">Image from https://www.analog.com/media/en/technical-documentation/data-sheets/OP07.pdf.</Image>
...
import negative_impedance_converter_nic from './negative-impedance-converter-nic.svg'

<Image src={negative_impedance_converter_nic} width="500px">Schematic of a negative impedance converter (NIC) created from an op-amp and a few passive components.</Image>
...
import standard_8_pin_dual_op_amp_pinout from './standard-8-pin-dual-op-amp-pinout.svg'

<Image src={standard_8_pin_dual_op_amp_pinout} width="400px">The standard pinout for two op-amps in an 8-pin package. This includes the DIP-8, TSSOP-8, SOIC-8 and MSOP-8 component packages.</Image>
