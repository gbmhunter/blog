...
date: 2015-11-02
description: Transistor output optocouplers, schematic symbols, phototraic output optocouplers, component packages and more info on optical isolators.
...
<Image src={import('./opto-isolator-schematic-symbol.png')} width="200px">A commonly used symbol for a standard optical isolator.</Image>
...
<Image src={import('./phototriac-based-optical-isolator-internal-schematic.png')} width="400px">The internal schematic of an optical isolator with a phototriac output driver rather than a phototransistor. Image from http://www.ti.com/.</Image>
