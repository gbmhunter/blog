...
import schematic_of_voltage_level_translation_with_a_mosfet from './schematic-of-voltage-level-translation-with-a-mosfet.png'

<Image src={schematic_of_voltage_level_translation_with_a_mosfet} width="600">An example schematic of bi-directional voltage-level translation using a MOSFET.</Image>
...
import basic_use_of_74lvc1t45 from './basic-use-of-74lvc1t45.png'

<Image src={basic_use_of_74lvc1t45} width="500">A 74LVC1T45 voltage-level translator IC being used to voltage translate a 3.3V logic-level signal to a 5.0V voltage domain.</Image>
...
import ti_txb0104_auto_direction_sensing_architecture from './ti-txb0104-auto-direction-sensing-architecture.png'

<Image src={ti_txb0104_auto_direction_sensing_architecture} width="400">Architecture of a single cell inside the TXB0104 IC, showing how the auto-direction sensing circuitry works[^bib-ti-txb0104-ds].</Image>
...
import cmos_powered_off_protection_circuit_ioff_ti from './cmos-powered-off-protection-circuit-ioff-ti.png'

<Image src={cmos_powered_off_protection_circuit_ioff_ti} width="700">Circuit showing how a CMOS \"totem-pole\" driver is modified to provide \"powered off protection\". Addition diode added between the substrate and the source of the P-channel MOSFET as circled, which prevents current from the output flowing back to $V_{CC}$ in the case that the power rail is at $0V$[^bib-ti-powered-off-protection][^bib-ti-logic-in-live-insertion-apps].</Image>
...
import lsf_family_level_translator_bias_circuit from './lsf-family-level-translator-bias-circuit.png'

<Image src={lsf_family_level_translator_bias_circuit} width="500px">Internal schematic for the LSF family of translators[^bib-ti-bias-circuit-lsf-family].</Image>
...
import n_74lvc1t45_diodes_inc_voltage_translator_pinout from './74lvc1t45-diodes-inc-voltage-translator-pinout.png'

<Image src={n_74lvc1t45_diodes_inc_voltage_translator_pinout} width="300">The pinout for the single bit Diodes Inc 74LVC1T45Z6-7 voltage translator in the SOT-563 package[^bib-diodes-inc-74lvc1t45z6-7-ds].</Image>
...
import sparkfun_txb0104_voltage_level_translator_breakout from './sparkfun-txb0104-voltage-level-translator-breakout.png'

<Image src={sparkfun_txb0104_voltage_level_translator_breakout} width="250">The SparkFun breakout board for the TXB0104[^bib-sparkfun-txb0104-breakout].</Image>
