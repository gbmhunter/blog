...
<Image src={import('./schematic-of-voltage-level-translation-with-a-mosfet.png')} width="600">An example schematic of bi-directional voltage-level translation using a MOSFET.</Image>
...
<Image src={import('./basic-use-of-74lvc1t45.png')} width="500">A 74LVC1T45 voltage-level translator IC being used to voltage translate a 3.3V logic-level signal to a 5.0V voltage domain.</Image>
...
<Image src={import('./ti-txb0104-auto-direction-sensing-architecture.png')} width="400">Architecture of a single cell inside the TXB0104 IC, showing how the auto-direction sensing circuitry works[^bib-ti-txb0104-ds].</Image>
...
<Image src={import('./lsf-family-level-translator-bias-circuit.png')} width="500px">Internal schematic for the LSF family of translators[^bib-ti-bias-circuit-lsf-family].</Image>
...
<Image src={import('./74lvc1t45-diodes-inc-voltage-translator-pinout.png')} width="300">The pinout for the single bit Diodes Inc 74LVC1T45Z6-7 voltage translator in the SOT-563 package[^bib-diodes-inc-74lvc1t45z6-7-ds].</Image>
...
<Image src={import('./sparkfun-txb0104-voltage-level-translator-breakout.png')} width="250">The SparkFun breakout board for the TXB0104[^bib-sparkfun-txb0104-breakout].</Image>
