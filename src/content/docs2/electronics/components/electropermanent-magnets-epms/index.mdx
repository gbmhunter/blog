...
<Image src={import('./diagram-of-electropermanent-magnet-fields-and-hystersis.png')} width="600px">Diagram showing the how electropermanent magnets work. Image from Electropermanent Magnetic Connectors and Actuators: Devices and Their Application in Programmable Matter by Ara Nerses Knaian.</Image>
...
<Image src={import('./opengrab-epm-688-v2.0-electropermanent-magnet-module.jpg')} width="600px">The OpenGrab Electropermanent Magnet (EPM) module. Image from http://nicadrone.com/index.php?id_product=13&controller=product.</Image>
