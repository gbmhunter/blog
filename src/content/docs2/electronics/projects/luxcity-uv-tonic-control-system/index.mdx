...
<Image src={import('./luxcity-tonic-logo-small.png')} width="320px">The Luxcity Tonic logo.</Image>
...
<Image src={import('./luxcity-event-october-2012-christchurch.jpg')} width="600px">Luxcity event poster for Christchurch 2012.</Image>
...
<Image src={import('./arduino-8-ch-relay-channel-02.jpg')} width="250px">The Freetronics 8-channel relay driver shield for the Arduino.</Image>
...
<Image src={import('./freetronics-relay-driver-schematic-snapshot-of-1-channel.png')} width="500px">Part of the schematics for the Freetronics 8-channel relay driver shield showing one channel.</Image>

## 64x SPDT 12V Relays

<Image src={import('./64-12v-relays.jpg')} width="500px">64 12V relays.</Image>
...
<Image src={import('./12v-solenoid-valve-02.jpg')} width="320px">A 12V solenoid valve. 62 of these were used to control the flow of UV-reactive tonic water or air through the pipes.</Image>
...
<Image src={import('./solenoid-minimum-operating-pressure.png')} width="500px"></Image>
...
<Image src={import('./twin-power-supplies.jpg')} width="320px">Twin 500W power supplies to turn on up to half of the relays and solenoids all at once.</Image>
...
<Image src={import('./arduino-lcd-shield-02.jpg')} width="320px">The Freetronics LCD shield for the Arduino. This was used to display running information to the user.</Image>
...
<Image src={import('./vixen-software-logo.jpg')} width="300px">The Vixen software logo. Image from http://www.vixenlights.com.</Image>
...
<Image src={import('./vixen-screenshot-tonic-test-sequence.png')} width="600px"></Image>

## Construction

The hardware! (just after arrival).

<Image src={import('./luxcity-tonic-hardware.jpg')} width="600px">The hardware for the Luxcity Tonic project (just after it arrived).</Image>

The relay boards and LCD were stacked ontop of each other.

<Image src={import('./arduino-and-relay-shield-stack-vertical.jpg')} width="600px">A Ardunio stack with the Uno (at bottom), 8 relay shields, and an LCD shield on-top.</Image>

Wiring up the relay boards.

<Image src={import('./relay-shiled-wiring-02.jpg')} width="600px">More wires!</Image>

Placement of the relays onto strip board (they JUST managed to fit all on one board).

<Image src={import('./relay-shield-wiring-and-relays-01.jpg')} width="600px">Wiring up the relay shields, with the relays next door.</Image>

A quick way of breaking tracks on prototype board.

<Image src={import('./quick-way-of-breaking-tracks-on-prototype-board.jpg')} width="600px">The quick way to break tracks on a prototype board.</Image>

Soldering the relays, relay coil inputs, and power connectors to the board.

<Image src={import('./soldering-prototype-board.jpg')} width="600px">Soldering up the prototype board.</Image>

The 62 solenoid valves.

<Image src={import('./solenoids-in-a-box.jpg')} width="600px">All of the 62 solenoids, in a box.</Image>
...
<Image src={import('./string-of-diodes.jpg')} width="600px">String of diodes for quenching the inductive kick of the solenoids.</Image>

The Arduino, relay control boards, and the relay board, semi-assembled.

<Image src={import('./arduino-and-relays-semi-assembled.jpg')} width="600px">The Arduino and relays semi-assembled.</Image>
...
<Image src={import('./finished-soldering-the-prototype-board.jpg')} width="600px">The bottom-side of the prototype board, fully soldered. Notice the heavy duty rails that deliver the power to the relays/solenoids. Even with these thick lines of solder, when half (31) of the solenoids where turned on, the board got considerably warm around the PSU entry point.</Image>

Wiring up the solenoids, as they need to have a 2m cable reach. I'm going through 100m cable rolls like it's Christmas.

<Image src={import('./lots-of-twisted-wire.jpg')} width="600px">Lots of twisted wire for the solenoids.</Image>

The pile of wired solenoids. It took a good 8+ hours to wire these up!

<Image src={import('./pile-of-wired-solenoids.jpg')} width="600px">The pile of wired solenoids. It took a good 8+ hours to wire these up!</Image>

Shorting out the green wire to ground on the PSU to get it to turn on.

<Image src={import('./grounding-the-green-wire-on-psu.jpg')} width="600px">Grounding the green wire on the PSU to get it to turn on.</Image>

Adding small-valued power resistors in series with the PSU outputs to make them share the current equally.

<Image src={import('./current-sharing-power-resistors.jpg')} width="600px">Adding small-valued power resistors in series with the PSU outputs to make them share the current equally.</Image>
...
<Image src={import('./heavy-duty-fuses.jpg')} width="600px">The heavy duty fuses used to protect the +12V rails of the power supply. The two in use are 30A 5AG fuses, and the two spares are 40A.</Image>
...
<Image src={import('./solenoid-number-3.jpg')} width="600px">Numbering the solenoids...</Image>
...
<Image src={import('./vixen-tonic-generic-serial-output-plugin-settings.png')} width="600px"></Image>

## Onsite

The manifold with the solenoids in place, being assembled on-site.

<Image src={import('./manifold-with-solenoids-in-place.jpg')} width="600px">The manifold with the solenoids in place, being assembled on-site.</Image>

Carrying the water tank for the gin and tonic drinks down the road to the the construction site.


<Image src={import('./carrying-tank-down-road.jpg')} width="600px">Carrying the water tank for the gin and tonic drinks down the road to the the construction site.</Image>

The tensioned cable structure being hoisted into the air by the crane.

<Image src={import('./structure-half-up-in-air.jpg')} width="600px">The tensioned cable structure being hoisted into the air by the crane.</Image>

The annoying street-light which dampened the fluorescent effect.

<Image src={import('./bright-light-in-the-way.jpg')} width="600px">A bright light that we couldn't turn off. This reduced the fluorescent effect of the tonic.</Image>
...
<Image src={import('./gin-and-tonic-uv.jpg')} width="600px">Gin and tonic glowing under UV light!</Image>

Some of the other structures at the Luxcity event.

<Image src={import('./altitude-02.jpg')} width="600px">A view of Altitude from the centre.</Image>

<Image src={import('./scary-tree.jpg')} width="600px"></Image>
