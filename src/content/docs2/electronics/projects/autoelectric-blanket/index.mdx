...
<Image src={import('./raspberry-pi-with-lots-of-cables-filtered.jpg')} width="800px">The RaspberryPi while testing.</Image>
...
<Image src={import('./simple-led-connected-to-raspberry-pi-gpio.jpg')} width="800px">I used a single LED connected up to one of the RaspberryPi's GPIO pins for basic testing.</Image>
...
<Image src={import('./node-js-server-running-on-raspberry-pi-terminal-output-filtered.jpg')} width="600px">The terminal output when a client visits the node.js server running on the RaspberryPi.</Image>

The express extension serves up a web page.

<Image src={import('./basic-web-page-served-by-node-js.jpg')} width="800px">The basic web page served with node.js running on the RaspberryPi (viewed in Chrome).</Image>
...
<Image src={import('./sending-files-via-rsync-between-pc-and-raspberry-pi.png')} width="800px">Sending code files using rsync from the PC to the RaspberryPi.</Image>
...
<Image src={import('./camerazoom-20131009175933171.jpg')} width="800px">The circuit inside the electric blanket controls (for one side of the bed).</Image>
