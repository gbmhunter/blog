...
import avnet_logo from './avnet-logo.gif'

<Image src={avnet_logo} width="100px"></Image>
...
import digi_key_logo from './digi-key-logo.jpg'

<Image src={digi_key_logo} width="100">The Digi-Key logo.</Image>
...
import digi_key_automatic_bom_uploading_please_wait from './digi-key-automatic-bom-uploading-please-wait.png'

<Image src={digi_key_automatic_bom_uploading_please_wait} width="320px"></Image>

import digi_key_automatic_bom_uploading_selecting_excel_columns from './digi-key-automatic-bom-uploading-selecting-excel-columns.png'

<Image src={digi_key_automatic_bom_uploading_selecting_excel_columns} width="700px"></Image>
...
import element_14_logo from './element-14-logo.jpg'

<Image src={element_14_logo} width="100px"></Image>
...
import lcsc_logo from './lcsc-logo.png'

<Image src={lcsc_logo} width="200px">The LCSC logo.</Image>
...
import mouser_logo from './mouser-logo.jpg'

<Image src={mouser_logo} width="100">The Mouser logo.</Image>
...
import rs_components_logo from './rs-components-logo.jpg'

<Image src={rs_components_logo} width="100">The RS Components logo.</Image>
...
import alibaba_logo from './alibaba-logo.jpg'

<Image src={alibaba_logo} width="100px">The Alibaba logo.</Image>
...
import aliexpress_logo from './aliexpress-logo.jpg'

<Image src={aliexpress_logo} width="100px">The AliExpress logo.</Image>
...
import st_estore_free_samples from './st-estore-free-samples.png'

<Image src={st_estore_free_samples} width="500">The ST eStore provides free samples for some of their parts, for example, the A6986ITR isolated buck converter[^bib-st-estore-free-samples].</Image>
...
import microchip_direct_logo from './microchip-direct-logo.png'

<Image src={microchip_direct_logo} width="300px">Microchip Direct's logo.[^bib-microchip-direct-home-page]</Image>
...
import pcb_cart_logo from './pcb-cart-logo.jpg'

<Image src={pcb_cart_logo} width="100">The PCB Cart logo.</Image>
...
import jlc_pcb_logo from './jlc-pcb-logo.png'

<Image src={jlc_pcb_logo} width="400">The logo for JLC PCB. Image from https://www.crunchbase.com/organization/jlcpcb, retrieved 2021-03-03.</Image>
...
import pcb_zone_logo from './pcb-zone-logo.jpg'

<Image src={pcb_zone_logo} width="100">The PCB Zone logo.</Image>
...
import imp_logo from './imp-logo.gif'

<Image src={imp_logo} width="100">The IMP logo.</Image>
