...
import n_1_bit_digital_stimulus_sim_1_bit_digital_stimulus_config from './1-bit-digital-stimulus-sim/1-bit-digital-stimulus-config.png'

<Image src={n_1_bit_digital_stimulus_sim_1_bit_digital_stimulus_config} width="800px">Screenshot showing how to configure a 1-bit digital stimulus.</Image>

The above settings gives the following waveform if we perform a transient analysis:

import n_1_bit_digital_stimulus_sim_transient_analysis from './1-bit-digital-stimulus-sim/transient-analysis.png'

<Image src={n_1_bit_digital_stimulus_sim_transient_analysis} width="900px">Transient analysis for the 1-bit digital stimulus.</Image>
...
import jk_flipflop_nand_sim_schematic from './jk-flipflop-nand-sim/schematic.png'

<Image src={jk_flipflop_nand_sim_schematic} width="600px">The simulation schematic for the JK flip-flop.</Image>
...
import jk_flipflop_nand_sim_transient_analysis_without_initial_conditions from './jk-flipflop-nand-sim/transient-analysis-without-initial-conditions.png'

<Image src={jk_flipflop_nand_sim_transient_analysis_without_initial_conditions} width="900px">Simulation results without specifying initial conditions. The outputs get stuck in an indeterminate state forever.</Image>
...
import jk_flipflop_nand_sim_initial_conditions from './jk-flipflop-nand-sim/initial-conditions.png'

<Image src={jk_flipflop_nand_sim_initial_conditions} width="400px">The initial conditions specified for the JK flip-flop simulation.</Image>

Now the outputs start in a determinate state, and the simulation works as expected:

import jk_flipflop_nand_sim_transient_analysis_with_initial_conditions from './jk-flipflop-nand-sim/transient-analysis-with-initial-conditions.png'

<Image src={jk_flipflop_nand_sim_transient_analysis_with_initial_conditions} width="900px">Simulation with initial conditions.</Image>
