...
import ngspice_main_window_windows_screenshot from './ngspice-main-window-windows-screenshot.png'

<Image src={ngspice_main_window_windows_screenshot} width="600px">Screenshot of the main window of ngspice v34.0 when running on Windows.</Image>
