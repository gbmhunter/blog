...
<Image src={import('./buck-converter-hot-loop.png')} width="700px">Schematic showing the \"Hot Loop\" of a standard buck converter.</Image>
...
<Image src={import('./boost-converter-hot-loop.png')} width="700px">Schematic showing the \"Hot Loop\" of a boost converter.</Image>
...
<Image src={import('./coilcraft-xal7050-showing-polarity-indicator-and-emi-note.png')} width="500px">Top view of the Coilcraft XAL7050 inductor, showing the polarity mark.</Image>
...
<Image src={import('./inductor-polarity-radiated-emissions-improvement-analog-devices.png')} width="600px">Graphs from Analog Devices showing the improvement in radiated emissions when the shortest inductor lead is connected to the switching node[^analog-devices-assembly-orientation-inductor-affect-emissions]. Orientation 1 is with the short lead connected to the switching node, orientation 2 is the opposite.</Image>
...
<Image src={import('./current-following-trace-at-high-frequencies.webp')} width="1000px">Diagram illustrating how current in the reference plane follows directly underneath the trace at high frequencies, rather than taking the shortest path back to the source.</Image>
...
<Image src={import('./gap-in-reference-plane.webp')} width="500px">A gap in the reference plane forces high frequency signals</Image>
