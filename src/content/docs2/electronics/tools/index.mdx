...
<Image src={import('./_assets/dsview-v1.1.2-screenshot.png')} width="700">A screenshot of the DSView v1.1.2 software.</Image>
...
<Image src={import('./_assets/digilent-analog-discovery-pro-adp3450-photo.png')} width="400px">A photo of the Analog Discovery Pro ADP3450[^bib-digilent-adp3450-ref-manual].</Image>

<Image src={import('./_assets/digilent-analog-discovery-pro-adp5250-photo.png')} width="400px">A photo of the Analog Discovery Pro ADP5250[^bib-digilent-adp5250-ref-manual].</Image>
</div>
