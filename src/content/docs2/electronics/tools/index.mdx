...
import wanptek_wps3010h_benchtop_psu_30v_10a from './_assets/wanptek-wps3010h-benchtop-psu-30v-10a.png'

<Image src={wanptek_wps3010h_benchtop_psu_30v_10a} width="200px">A photo of the Wanptek 30V 10A PSU.[^aliexpress-wanptek-30v-10a-psu]</Image>
...
import tenma_72_2925_30v_10a_benchtop_psu from './_assets/tenma-72-2925-30v-10a-benchtop-psu.png'

<Image src={tenma_72_2925_30v_10a_benchtop_psu} width="200px">A photo of the TENMA 72-2925 benchtop PSU[^element14-tenma-72-2925].</Image>
...
import dsview_v1_1_2_screenshot from './_assets/dsview-v1.1.2-screenshot.png'

<Image src={dsview_v1_1_2_screenshot} width="700">A screenshot of the DSView v1.1.2 software.</Image>
...
import digilent_analog_discovery_pro_adp3450_photo from './_assets/digilent-analog-discovery-pro-adp3450-photo.png'

<Image src={digilent_analog_discovery_pro_adp3450_photo} width="400px">A photo of the Analog Discovery Pro ADP3450[^bib-digilent-adp3450-ref-manual].</Image>

import digilent_analog_discovery_pro_adp5250_photo from './_assets/digilent-analog-discovery-pro-adp5250-photo.png'

<Image src={digilent_analog_discovery_pro_adp5250_photo} width="400px">A photo of the Analog Discovery Pro ADP5250[^bib-digilent-adp5250-ref-manual].</Image>
</div>
...
import tekbox_tboh02_active_dc_load_photo from './_assets/tekbox-tboh02-active-dc-load-photo.jpg'

<Image src={tekbox_tboh02_active_dc_load_photo} width="300">The TekBox TBOH02 Self-Powered Active Load. Image from https://www.tekbox.com/product/tboh02-self-powered-active-load/.</Image>
...
import ftdi_ic_send_serial_data_conditions_annotated from './_assets/ftdi-ic-send-serial-data-conditions-annotated.png'

<Image src={ftdi_ic_send_serial_data_conditions_annotated} width="500">The conditions which will cause an FTDI IC to send received serial data to the computer. Especially notice the 16ms 'latency timer'. Image from 'FTDI – AN232B-04 – Data Throughput. Latency and Handshaking'.</Image>
...
import screenshot_fast_computer_response_ftdi_java_set_latency_timer from './_assets/screenshot-fast-computer-response-ftdi-java-set-latency-timer.png'

<Image src={screenshot_fast_computer_response_ftdi_java_set_latency_timer} width="700">FTDI RX and TX data captured by a logic analyser, with the computer running Java code which responds to 0x01 with 0x02. The 'latency timer' on the FTDI IC has been reduced to 1ms, which gives a much faster response time from the computer (about 1.5ms delay).</Image>
...
import usb_light_with_magnifier_mighty_ape from './_assets/usb-light-with-magnifier-mighty-ape.png'

<Image src={usb_light_with_magnifier_mighty_ape} width="700">A USB desk lamp with magnifier from Mighty Ape[^mighty-ape-usb-magnifier].</Image>
...
<table>
  ...
  <tbody>
    <tr><td>T-962</td>          <td>800W</td>         <td>180x235mm</td>    <td>US$200</td><td><Image src={t_962_smd_reflow_oven_photo} width="200px"></Image></td></tr>
    <tr><td>T-962A</td>         <td>1500W</td>        <td>300x320mm</td>    <td></td>                   <td></td></tr>
    <tr><td>T-962C</td>        <td>2900W</td>         <td>585x400mm</td>    <td>US$750</td>             <td><Image src={t_962c_smd_reflow_oven_photo} width="200px"></Image></td></tr>
  </tbody>
</table>
...
* Calculate [thermal resistances](/docs/pcb-design/thermal-design-for-pcbs/index.mdx).
* Find short-circuits
...
import keysight_u5856a_marketing_photo from './_assets/keysight-u5856a-marketing-photo.jpg'

<Image src={keysight_u5856a_marketing_photo} width="300">A marketing photo for the Keysight U5856A thermal camera.</Image>
...
import keysight_trueir_analysis_reporting_tool_screenshot from './_assets/keysight-trueir-analysis-reporting-tool-screenshot.png'

<Image src={keysight_trueir_analysis_reporting_tool_screenshot} width="600">A screenshot of the Keysight TrueIR software tool.</Image>
...
import optris_xi_400_spot_finder_ir_camera_photo from './_assets/optris-xi-400-spot-finder-ir-camera-photo.jpg'

<Image src={optris_xi_400_spot_finder_ir_camera_photo} width="500">A photo of the Optris Xi 400 spot finder IR camera.</Image>
...
import hakko_soldering_pencil_sleeve_green from './_assets/hakko-soldering-pencil-sleeve-green.png'

<Image src={hakko_soldering_pencil_sleeve_green} width="300">A green soldering pencil sleeve from Hakko. You have to purchase one of these per tip before your soldering iron truly becomes 'quick change'. Image from https://nz.element14.com/hakko/b3219/soldering-pencil-sleeve-green/dp/1676853.</Image>
...
import hm_2023_hakko_mini_hot_tweezers_with_t9_l1_tips from './_assets/hm-2023-hakko-mini-hot-tweezers-with-t9-l1-tips.jpg'

<Image src={hm_2023_hakko_mini_hot_tweezers_with_t9_l1_tips} width="400">Close up of the T9-1L tips on the Hakko FM-2023 Mini SMD Hot Tweezers. Great for popping on and off small 0402/0603/0805 chip resistors and capacitors.</Image>
...
import aim_i_prober_520_fluxgate_magnetometer_current_probe_with_scope from './_assets/aim-i-prober-520-fluxgate-magnetometer-current-probe-with-scope.jpg'

<Image src={aim_i_prober_520_fluxgate_magnetometer_current_probe_with_scope} width="400">The AIM I-Prober 520 current probe based on fluxgate magnetometer technology. Image from http://www.tti-test.com/.</Image>
...
import beehive_electronics_non_contact_em_probes_100_a_b_c_d from './_assets/beehive-electronics-non-contact-em-probes-100-a-b-c-d.jpg'

<Image src={beehive_electronics_non_contact_em_probes_100_a_b_c_d} width="700">The four non-contact EM probes made by Beehive Electronics. Three are for magnetic field measurement and one is for electric field measurement.</Image>

The magnetic flux density can be calculated for the H-field probes using the equation below:

import beehive_magnetic_em_probes_flux_density_equation from './_assets/beehive-magnetic-em-probes-flux-density-equation.png'

<Image src={beehive_magnetic_em_probes_flux_density_equation} width="400">The equation to work out the magnetic flux density as measured by any of the three magnetic EM probes made by Beehive Electronics.</Image>

The scale factors for each of the magnetic probes is given below:

import beehive_magnetic_em_probes_scale_factors_and_resonance from './_assets/beehive-magnetic-em-probes-scale-factors-and-resonance.png'

<Image src={beehive_magnetic_em_probes_scale_factors_and_resonance} width="600">The scale factors and resonances for each of the three magnetic field probes made by Beehive Electronics.</Image>
...
import rosin_flux_tin_kolophonium_loeten_photo from './_assets/rosin-flux-tin-kolophonium-loeten-photo.jpg'

<Image src={rosin_flux_tin_kolophonium_loeten_photo} width="350">A tin of rosin-based flux. Image from https://en.wikipedia.org.</Image>
...
import rosin_core_solder_firepower_60_40_photo from './_assets/rosin-core-solder-firepower-60-40-photo.jpg'

<Image src={rosin_core_solder_firepower_60_40_photo} width="300">A brand of solder which has a rosin-based flux core.</Image>
...
import solder_flux_pen_no_clean from './_assets/solder-flux-pen-no-clean.jpg'

<Image src={solder_flux_pen_no_clean} width="700">A no-clean solder flux pen from ChemTools (part number CT-NC-DP).</Image>
