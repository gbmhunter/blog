...
<tr>
<td colspan="5" style={{ textAlign: 'center' }}>MECHANICAL KEY</td>
</tr>
<tr>
<td>12</td>
<td>RSVD</td>
...
import pcie_edge_connector_schematic_symbol_and_example_design from './pcie-edge-connector-schematic-symbol-and-example-design.png'

<Image src={pcie_edge_connector_schematic_symbol_and_example_design} width="997">A PCIe card-edge connector schematic symbol and associated components.</Image>
