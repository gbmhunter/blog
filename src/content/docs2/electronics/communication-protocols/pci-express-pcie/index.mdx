...
import pci_type_0_non_bridge_config_space_diagram_v2 from './pci-type-0-non-bridge-config-space-diagram-v2.png'

<Image src={pci_type_0_non_bridge_config_space_diagram_v2} width="624">The standardised registers that belong to the PCI/PCIe Type 0 (non-bridge) configuration space. Image from https://en.wikipedia.org.</Image>
...
import screenshot_of_custom_pcie_card_in_device_manager from './screenshot-of-custom-pcie-card-in-device-manager.png'

<Image src={screenshot_of_custom_pcie_card_in_device_manager} width="341">A screenshot of Windows Device Manager showing the presence of a custom PCIe card.</Image>
...
import screenshot_of_custom_pcie_card_in_rw_everything from './screenshot-of-custom-pcie-card-in-rw-everything.png'

<Image src={screenshot_of_custom_pcie_card_in_rw_everything} width="883">A screenshot of the RWEverything software while exploring the memory of a custom PCIe card inserted into a Windows PC.</Image>
