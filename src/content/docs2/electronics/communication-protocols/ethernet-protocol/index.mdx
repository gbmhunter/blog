...
<Image src={import('./ltc4267-poe-regulator-typical-application.png')} width="600">Typical application schematic for the Analog Devices LTC4267 PoE regulator IC. Image retrieved 2021-08-26 from https://www.analog.com/media/en/technical-documentation/data-sheets/4267fc.pdf.</Image>
