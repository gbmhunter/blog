...
import ltc4267_poe_regulator_typical_application from './ltc4267-poe-regulator-typical-application.png'

<Image src={ltc4267_poe_regulator_typical_application} width="600">Typical application schematic for the Analog Devices LTC4267 PoE regulator IC. Image retrieved 2021-08-26 from https://www.analog.com/media/en/technical-documentation/data-sheets/4267fc.pdf.</Image>
...
import wiznet_w5500_ic_photo from './wiznet-w5500-ic-photo.jpg'

    <Image src={wiznet_w5500_ic_photo} width="200">Image of the WIZnet W5500 serial-to-ethernet IC. Image from https://www.wiznet.io/product-item/w5500/.</Image>
