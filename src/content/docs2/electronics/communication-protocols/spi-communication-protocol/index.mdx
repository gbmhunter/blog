...
import spi_basic_master_slave_diagram from './_assets/spi-basic-master-slave-diagram.webp'

<Image src={spi_basic_master_slave_diagram} width="600">The basic connections needed between an SPI master and a single SPI slave.</Image>
...
import cpol_and_cpha_diagram from './_assets/cpol-and-cpha-diagram.webp'

<Image src={cpol_and_cpha_diagram} width="800">Diagram showing the different behaviours for different CPOL and CPHA settings.</Image>
...
import example_transmission_cpol0_cpha0 from './_assets/example-transmission-cpol0-cpha0.webp'

<Image src={example_transmission_cpol0_cpha0} width="800">Example single-byte transfer with CPOL=0 and CPHA=0 (Mode 0). Master sends 0xA1, slave sends 0x75. Data is sampled at the dotted red vertical lines.</Image>
...
import example_transmission_cpol1_cpha1 from './_assets/example-transmission-cpol1-cpha1.webp'

<Image src={example_transmission_cpol1_cpha1} width="800">Example single-byte transfer with CPOL=1 and CPHA=1 (Mode 3). Master sends 0xA1, slave sends 0x75. Data is sampled at the dotted red vertical lines.</Image>
...
import microchip_sam_d21_spi_transfer_modes_table from './_assets/microchip-sam-d21-spi-transfer-modes-table.png'

<Image src={microchip_sam_d21_spi_transfer_modes_table} width="800">Screenshot of the SPI modes table from the Microchip SAM D21 datasheet[^bib-microchip-samd21-datasheet].</Image>
...
import fxos8700cq_freescale_magnetometer_note_supports_only_point_to_point_spi_protocol from './_assets/fxos8700cq-freescale-magnetometer-note-supports-only-point-to-point-spi-protocol.png'

<Image src={fxos8700cq_freescale_magnetometer_note_supports_only_point_to_point_spi_protocol} width="745">The note from the Freescale FXOS8700CQ magnetometer stating that it only supports the 'point-to-point' SPI protocol[^bib-nxp-fxos8700cq-ds].</Image>
...
import microchip_mcp41x1_dpot_spi_connections from './_assets/microchip-mcp41x1-dpot-spi-connections.png'

<Image src={microchip_mcp41x1_dpot_spi_connections} width="600">Schematics from the MCP4XXX DPOT datasheet showing to connect the shared MOSI/MISO pin (called SDI/SDO) to a SPI bus and SPI host[^bib-microchip-mcp4xxxx-dpot-ds].</Image>
...
import dual_spi_diagram from './_assets/dual-spi-diagram.webp'

<Image src={dual_spi_diagram} width="500">A Dual SPI bus, where MOSI and MISO have been replaced with bi-directional IO0 and IO1.</Image>
...
import quad_spi_diagram from './_assets/quad-spi-diagram.webp'

<Image src={quad_spi_diagram} width="500">A Quad SPI (QSPI) bus, which is like a Dual SPI bus but with two additional data lines, IO2 and IO3.</Image>
...
import infineon_s25fs128s_qspi_flash_connection_diagram from './_assets/infineon-s25fs128s-qspi-flash-connection-diagram.png'

<Image src={infineon_s25fs128s_qspi_flash_connection_diagram} width="500">Wiring diagram for the Infineon S25FS128S QSPI flash IC[^bib-infineon-s25fs128s-ds].</Image>
...
import ws2812b_comms_protocol_info from './_assets/ws2812b-comms-protocol-info.webp'

<Image src={ws2812b_comms_protocol_info} width="900">Data showing how the WS2812 RGB LED communication protocol relies of the timings of HIGH and LOW parts of a bit to determine a 0 or 1[^worldsemi-ws2812b-rgb-led-ds].</Image>
