...
import i2c_logo from './_assets/i2c-logo.gif'

<Image src={i2c_logo} width="200">The I2C logo.</Image>
...
import i2c_pull_up_resistors from './_assets/i2c-pull-up-resistors.png'

<Image src={i2c_pull_up_resistors} width="488">I2C pull-up resistors.</Image>
...
import typical_application_schematic_for_i2c_io_expander from './_assets/typical-application-schematic-for-i2c-io-expander.png'

<Image src={typical_application_schematic_for_i2c_io_expander} width="400">A typical application schematic for an I2C I/O expander.</Image>
...
import i2c_slave_address_pins_logic_table_with_scl_sda_ability_ti_ina226 from './_assets/i2c-slave-address-pins-logic-table-with-scl-sda-ability-ti-ina226.png'

<Image src={i2c_slave_address_pins_logic_table_with_scl_sda_ability_ti_ina226} width="800">The logic table (truth table) of the I2C address pins on the TI INA226 IC. Notice how you can connect the address pins up to SCL or SDA as well as the standard VS and GND, to give a total of 16 possible I2C addresses[^bib-ti-ina226-power-mon].</Image>
...
import i2c_10_bit_addressing_scheme_bit_pattern_of_address_bytes from './_assets/i2c-10-bit-addressing-scheme-bit-pattern-of-address-bytes.gif'

<Image src={i2c_10_bit_addressing_scheme_bit_pattern_of_address_bytes} width="1000">The bit pattern of the two address bytes in the I2C 10-bit addressing scheme. Image from [i2c-bus.org](http://www.i2c-bus.org/).</Image>
...
import i2c_buffer_ic_example from './_assets/i2c-buffer-ic-example.jpg'

<Image src={i2c_buffer_ic_example} width="800">An example from a NXP application note showing how their P82B96 I2C-bus buffering IC can utilise buffering and twisted pairs to increase the I2C communication distance.</Image>
...
import i2c_noise_from_long_cable from './_assets/i2c-noise-from-long-cable.jpg'

<Image src={i2c_noise_from_long_cable} width="387">The cross-talk noise that occurs on long I2C transmission lines. This shows SCL (yellow) and SDA (blue) over an 8m ethernet cable.</Image>
...
<Image src={c232hm_ddhsl_0_ftdi_usb_to_mpsse_cable} width="265">The C232HM-DDHSL-0 FTDI USB-to-MPSSE cable. Creates a bridge between your computer and a number of serial comm protocols such as SPI, I2C and UART.</Image>
...
<Image src={typical_i2c_waveform} width="483">A typical I2C waveform. The top waveform is the clock (SCK), and the bottom waveform is the data (SDA). This shows a master trying to communicate with the slave, but the slave does not acknowledge (the ninth bit is high).</Image>
...
import i2c_waveform_example_saleae_logic_analyser from './_assets/i2c-waveform-example-saleae-logic-analyser.png'

<Image src={i2c_waveform_example_saleae_logic_analyser} width="800">i2c-waveform-example-saleae-logic-analyser</Image>
...
import i2c_waveform_with_nak_saleae_logic_analyser from './_assets/i2c-waveform-with-nak-saleae-logic-analyser.png'

<Image src={i2c_waveform_with_nak_saleae_logic_analyser} width="800">An I2C slave that doesn't respond, no ACK on the 9th clock pulse.</Image>
