...
<Image src={can_bus_logo_bosch} width="270">The CAN bus logo. Image from www.bosch.com.</Image>
...
import oh_look_its_a_can_bus from './_assets/oh-look-its-a-can-bus.png'

<Image src={oh_look_its_a_can_bus} width="500">Oh look, it's a CAN bus!</Image>
...
import can_bus_bit_rate_vs_bus_length from './_assets/can-bus-bit-rate-vs-bus-length.png'

<Image src={can_bus_bit_rate_vs_bus_length} width="500">Graph showing the relationship between the CAN bus transmission rate and maximum bus length.</Image>
...
import can_bus_cia_ds_102_9_pin_sub_d_connector_pin_assignment from './_assets/can-bus-cia-ds-102-9-pin-sub-d-connector-pin-assignment.png'

<Image src={can_bus_cia_ds_102_9_pin_sub_d_connector_pin_assignment} width="500">CAN bus pin assignments for the DE-9 serial connector from the CiA DS-102 standard.</Image>
...
import arbitration_waveform_waveform_zoomed_in_annotated from './_assets/arbitration-waveform/waveform-zoomed-in-annotated.png'

<Image src={arbitration_waveform_waveform_zoomed_in_annotated} width="600">Zoomed in view of the above scope capture, showing the width of the arbitration "events" aligns with the bit period of 8us (CAN bus was running at 125kHz).</Image>
...
import can_bit_timing from './_assets/can-bit-timing.webp'

<Image src={can_bit_timing} width="900">Timing diagram of a single CAN bit.</Image>
...
import can_bit_timing_prop_delay_between_two_nodes from './_assets/can-bit-timing-prop-delay-between-two-nodes.webp'

<Image src={can_bit_timing_prop_delay_between_two_nodes} width="800">Diagram showing why the two-way propagation of the bit must occur between any two nodes before the end of the `PROP_SEG`.</Image>
...
import can_standard_base_frame_format_data_remote from './_assets/can-standard-base-frame-format-data-remote.png'

<Image src={can_standard_base_frame_format_data_remote} width="883">The standard (base) CAN frame format for both data and remote frames.</Image>
...
import st_can_frame_incorrect_acronym_ide from './_assets/st-can-frame-incorrect-acronym-ide.png'

<Image src={st_can_frame_incorrect_acronym_ide} width="500">Don't always believe what you see in datasheets. There is definitely no 'Integrated Development Environment' bit in a CAN frame. Image from https://www.st.com/resource/en/application_note/dm00625700-fdcan-peripheral-on-stm32-devices-stmicroelectronics.pdf, accessed 2021-04-19.</Image>
...
import can_extended_frame_format_data_remote from './_assets/can-extended-frame-format-data-remote.png'

<Image src={can_extended_frame_format_data_remote} width="800">The extended CAN frame format for both data and remote frames.</Image>
...
import can_open_logo from './_assets/can-open-logo.jpg'

<Image src={can_open_logo} width="500">The CANopen logo.</Image>
...
import can_bus_licensing_fee_highlighted_bosch from './_assets/can-bus-licensing-fee-highlighted-bosch.png'

<Image src={can_bus_licensing_fee_highlighted_bosch} width="506">A screenshot of the CAN bus licensing fee details from Bosch. Image from http://www.bosch-semiconductors.de/media/automotive_electronics/pdf_2/ipmodules_3/can_protocol_license_1/Bosch_CAN_Protocol_License_Conditions.pdf.</Image>
...
import omzlo_white from './_assets/omzlo-white.png'

<Image src={omzlo_white} width="200">The Omzlo logo.</Image>
...
import nxp_tja115x_secure_can_application_principle from './_assets/nxp-tja115x-secure-can-application-principle.png'

<Image src={nxp_tja115x_secure_can_application_principle} width="500">The basic principle of the TJA115x Secure CAN range of CAN transceivers from NXP[^nxp-tja115x-secure-can].</Image>
...
import pca82c200_can_controller_block_diagram from './_assets/pca82c200-can-controller-block-diagram.png'

<Image src={pca82c200_can_controller_block_diagram} width="800">Block diagram of the PCA82C200 CAN controller IC[^philips-pca82c200-ds].</Image>
...
import iso_11898_2_can_bus_repeater from './_assets/iso-11898-2-can-bus-repeater.png'

<Image src={iso_11898_2_can_bus_repeater} width="600">A CAN bus repeater topology from the CiA ISO 118989-2 standard.</Image>
...
import amis_42770_on_semiconductor_can_bus_repeater_ic from './_assets/amis-42770-on-semiconductor-can-bus-repeater-ic.png'

<Image src={amis_42770_on_semiconductor_can_bus_repeater_ic} width="600">Application diagram from the AMIS-42770 IC's datasheet which shows how it can be configured to act as a CAN bus repeater.</Image>
...
import ems_crep_s4_can_bus_repeater from './_assets/ems-crep-s4-can-bus-repeater.png'

<Image src={ems_crep_s4_can_bus_repeater} width="500">The CRep S4 CAN Bus repeater by EMD Wuensche.</Image>
...
import reference_ti_can_repeater_design_tida_01487 from './_assets/reference-ti-can-repeater-design-tida-01487.png'

<Image src={reference_ti_can_repeater_design_tida_01487} width="700">The block-level architecture of the CAN bus repeater design by Texas Instruments. Image from http://www.ti.com/lit/ug/tidudb5a/tidudb5a.pdf?ts=1591658758534.</Image>
...
import can_bus_tvs_diodes_littelfuse_sm24canb_block_diagram_and_application_example from './_assets/can-bus-tvs-diodes-littelfuse-sm24canb-block-diagram-and-application-example.png'

<Image src={can_bus_tvs_diodes_littelfuse_sm24canb_block_diagram_and_application_example} width="600">Block diagram and application example for the CAN bus AQ24CANFD TVS diode from LittelFuse. Image from https://www.littelfuse.com/~/media/electronics/datasheets/tvs_diode_arrays/littelfuse_tvs_diode_array_aq24canfd_datasheet.pdf.pdf, acquired 2021-04-27.</Image>
...
import peak_pcan_usb_photo from './_assets/peak-pcan-usb-photo.jpg'

<Image src={peak_pcan_usb_photo} width="400">Product photo of the PEAK PCAN-USB USB to CAN bus dongle[^peak-pcan-usb].</Image>
...
import can_fd_frame_structure_feff_arbitration_and_control_fields from './_assets/can-fd-frame-structure-feff-arbitration-and-control-fields.webp'

<Image src={can_fd_frame_structure_feff_arbitration_and_control_fields} width="1000">The CAN FD FEFF frame structure showing the arbitration and control fields.</Image>
