...
import battery_charging_spec_rev_1_2_different_types_of_ports from './battery-charging-spec-rev-1.2-different-types-of-ports.webp'

<Image src={battery_charging_spec_rev_1_2_different_types_of_ports} width="800">Diagram showing the basic electrical wiring for the various ports specified by BC 1.2.</Image>
...
import battery_charging_spec_rev_1_2_charging_downstream_port from './battery-charging-spec-rev-1.2-charging-downstream-port.webp'

<Image src={battery_charging_spec_rev_1_2_charging_downstream_port} width="800">The internal circuitry connected to the D+ and D- lines in a Charging Downstream Port (CDP). Numerical values are nominal values, the USB standard instead specifies ranges[^usb-org-battery-charging-v1.2-spec].</Image>
...
import usb_type_c_plug_photo from './usb-type-c-plug-photo.jpg'

<Image src={usb_type_c_plug_photo} width="600">Photo of a USB Type-C plug on the end of a cable.</Image>

The below image shows the pinout for both the USB Type-C plug and the receptacle.

import usb_type_c_connector_pinout from './usb-type-c-connector-pinout.webp'

<Image src={usb_type_c_connector_pinout} width="800">Pinout for both the USB Type-C plug and receptacle[^wikipedia-usb-c].</Image>
...
import usb2_0_without_pd from './usb2.0-without-pd.webp'

<Image src={usb2_0_without_pd} width="800">Basic connection scheme for USB 2.0 without PD over a Type-C connector.</Image>
...
import max14747_typical_application_circuit from './max14747-typical-application-circuit.png'

<Image src={max14747_typical_application_circuit} width="800">Typical application circuit for the Analog Devices MAX14747 IC[^analog-devices-max14747-usb-charging-ic].</Image>
...
import stmicroelectronics_stusb4500_3d_render_wlcsp_25 from './stmicroelectronics-stusb4500-3d-render-wlcsp-25.png'

<Image src={stmicroelectronics_stusb4500_3d_render_wlcsp_25} width="200">The STUSB4500 in the WLCSP-25 package[^st-microelectronics-stusb4500-standalone-pd-sink].</Image>

Below is a minimal application schematic using the IC act as a USB PD power sink without any connected MCU:

import stmicroelectronics_stusb4500_minimal_application_schematic from './stmicroelectronics-stusb4500-minimal-application-schematic.png'

<Image src={stmicroelectronics_stusb4500_minimal_application_schematic} width="900">Minimal application circuit for the STMicroelectronics STUSB4500 IC. Note that it is operated as a standalone controller and there is no MCU present[^st-microelectronics-stusb4500-standalone-pd-sink].</Image>
...
import molex_2171750001_type_c_6_lead_connector_photo_and_diagram from './molex-2171750001-type-c-6-lead-connector-photo-and-diagram.webp'

<Image src={molex_2171750001_type_c_6_lead_connector_photo_and_diagram} width="600">Photo and diagram of the Molex 2171750001 USB Type-C (6+18 Dummy) connector[^molex-2171750001-type-c-6-plus-18-dummy-connector-ds].</Image>
