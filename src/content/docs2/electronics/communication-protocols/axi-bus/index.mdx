...
import axi_bus_channel_architecture_of_reads_and_writes_diagram from './_assets/axi-bus-channel-architecture-of-reads-and-writes-diagram.png'

<Image src={axi_bus_channel_architecture_of_reads_and_writes_diagram} width="422">The AXI bus channel architecture. Image from http://www.xilinx.com/support/documentation/ip_documentation/axi_ref_guide/v13_4/ug761_axi_reference_guide.pdf.</Image>
