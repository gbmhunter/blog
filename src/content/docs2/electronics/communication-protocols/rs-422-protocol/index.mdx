...
<Image src={import('./dsub-db-9-female-male-photo-pin-numbers.png')} width="500">Pin numbering for the D-sub DE-9 (a.k.a. DB-9) female and male connectors.</Image>
...
<Image src={import('./dsub-db-25-pin-numbers.png')} width="500">Pin numbers for the male DB-25 connector, looking at the \"front\" of the connector which mates with the female part.</Image>
