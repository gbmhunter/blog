...
import dsub_db_9_female_male_photo_pin_numbers from './dsub-db-9-female-male-photo-pin-numbers.png'
...
import dsub_db_25_pin_numbers from './dsub-db-25-pin-numbers.png'
