...
<Image src={power_profiler_kit_2_photo} width="800">A photo of the Nordic Power Profiler Kit 2 which is great for measuring the power consumption of low power circuits!</Image>
...
import ble_current_conn_interval_30ms_latency_0 from './_assets/ble-current-conn-interval-30ms-latency-0.webp'

<Image src={ble_current_conn_interval_30ms_latency_0} width="1000">The current consumption of a BLE device with a connection interval of 30ms and a peripheral latency of 0.</Image>
...
import ble_current_conn_interval_1000ms_latency_0 from './_assets/ble-current-conn-interval-1000ms-latency-0.webp'

<Image src={ble_current_conn_interval_1000ms_latency_0} width="1000">The current consumption of a BLE device with a connection interval of 1000ms and a peripheral latency of 0.</Image>
...
import ble_current_conn_interval_30ms_latency_30 from './_assets/ble-current-conn-interval-30ms-latency-30.webp'

<Image src={ble_current_conn_interval_30ms_latency_30} width="1000">The current consumption of a BLE device with a connection interval of 30ms and a peripheral latency of 30.</Image>
...
import apple_accessory_design_guidelines_ble_connection_parameters from './_assets/apple-accessory-design-guidelines-ble-connection-parameters.png'

<Image src={apple_accessory_design_guidelines_ble_connection_parameters} width="600">The recommended BLE connection parameters from Apple's "Accessory Design Guidelines for Apple Devices".</Image>
...
import silicon_labs_spreadsheet_for_verifying_ble_params_for_apple from './_assets/silicon-labs-spreadsheet-for-verifying-ble-params-for-apple.webp'

<Image src={silicon_labs_spreadsheet_for_verifying_ble_params_for_apple} width="700">A screenshot of Silicon Labs' Excel spreadsheet for verifying BLE connection parameters for Apple devices.</Image>
