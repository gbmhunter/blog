...
<Image src={import('./easyscale-bit-coding-diagram-ti.png')} width="700">A bit coding diagram of the EasyScale communication protocol. Image from https://www.ti.com/lit/ds/symlink/lm3404.pdf.</Image>
