...
import easyscale_bit_coding_diagram_ti from './easyscale-bit-coding-diagram-ti.png'

<Image src={easyscale_bit_coding_diagram_ti} width="700">A bit coding diagram of the EasyScale communication protocol. Image from https://www.ti.com/lit/ds/symlink/lm3404.pdf.</Image>
