...
import pdf_normal from './pdf-normal.png'

<Image src={pdf_normal} width="500px">The PDF of the normal distribution, with $\mu=0$ and $\sigma=1$. The x-axis has been cut-off at the 1% and 99% percentiles, in reality the function continues from negative infinity to positive infinity. </Image>
...
import cdf_normal from './cdf-normal.png'

<Image src={cdf_normal} width="500px">The CDF of the normal distribution, with $\mu=0$ and $\sigma=1$. The x-axis has been cut-off at the 1% and 99% percentiles, in reality the function continues from negative infinity to positive infinity. The PDF of this distribution is shown in [^pdf-normal].</Image>
...
import quantile_normal from './quantile-normal.png'

<Image src={quantile_normal} width="500px">The quantile function of the normal distribution, with $\mu=0$ and $\sigma=1$. The x-axis has been cut-off at the 1% and 99% percentiles, in reality the function continues from negative infinity to positive infinity. The PDF of this distribution is shown in [^pdf-normal].</Image>
...
import generating_rvs_starting_pdf from './generating-rvs-starting-pdf.png'

<Image src={generating_rvs_starting_pdf} width="600px">A plot of the \"custom\" PDF we are going to use to define the distribution to generate random numbers from. In this example I just used `sin(x)` in the range of `0` to `pi`.</Image>
...
import generating_rvs_hist_of_rvs from './generating-rvs-hist-of-rvs.png'

<Image src={generating_rvs_hist_of_rvs} width="600px">A histogram of 10,000 generated random numbers that follow the distribution defined by our PDF. Notice how it closely follows the PDF defined in [^generating-rvs-starting-pdf], but with random \"jitter\" as you would expect if generating numbers randomly.</Image>
