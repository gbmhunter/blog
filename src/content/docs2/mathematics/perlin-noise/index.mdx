...
import perlin_noise_cloud_example from './perlin-noise-cloud-example.png'

<Image src={perlin_noise_cloud_example} width="331px">Rendered Perlin noise that has been configured to make realistic looking clouds.</Image>
