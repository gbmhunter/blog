...
import linear_curve_fitting_graph_of_points_and_line from './linear_curve_fitting_graph_of_points_and_line.png'

<Image src={linear_curve_fitting_graph_of_points_and_line} width="600px">The linear curve fitting (using the least squares approach) to four data points.</Image>
...
<Image src={linear_curve_fitting_graph_of_points_and_line} width="587px">The linear curve fitting (using the least squares approach) to four data points.</Image>
