...
import keep_calm_and_be_welcome_back from './keep-calm-and-be-welcome-back.png'

<Image src={keep_calm_and_be_welcome_back} width="400px">Image from http://www.keepcalm-o-matic.co.uk/p/keep-calm-and-be-welcome-back/.</Image>
