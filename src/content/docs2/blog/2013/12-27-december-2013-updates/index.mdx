...
import two_mosfet_gate_drives_with_deadtime_graph_screenshot from './two-mosfet-gate-drives-with-deadtime-graph-screenshot.png'

<Image src={two_mosfet_gate_drives_with_deadtime_graph_screenshot} width="500px">Screenshot of the MOSFET gate drive graph on the MOSFETs page.</Image>
