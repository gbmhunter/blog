...
import old_and_new_code_display_plugin_comparison from './old-and-new-code-display-plugin-comparison.jpg'

<Image src={old_and_new_code_display_plugin_comparison} width="600px">A comparison between the old and new syntax highlighter plugin used on CladLabs.</Image>
