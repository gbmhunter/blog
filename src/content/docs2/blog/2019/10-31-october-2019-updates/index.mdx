...
import n_3d_rotation_visualizer_screenshot from './3d-rotation-visualizer-screenshot.png'

<Image src={n_3d_rotation_visualizer_screenshot} width="500px">A screenshot of the 3D rotation visualizer and converter.</Image>