...
import colorful_happy_new_year_2019_vector from './colorful-happy-new-year-2019-vector.jpg'

<Image src={colorful_happy_new_year_2019_vector} width="800px">Happy new year! Image from www.vecteezy.com.</Image>

## Statistics for 2018

This is the first year I have used Google Analytics to gather these statistics. Even though I have been using Google Analytics for many years, in previous years I just relied on the statistics presented in the Wordpress admin dashboard. This is no longer possible as I am now [using Hugo to power this site](/updates/2018/12/15/site-migration-to-hugo-complete/). This also means that the reported numbers are different, in fact, Wordpress seemed to always report higher numbers than Google Analytics. The stats for 2017 on this page are also from Google Analytics so that a fair comparison can be made. See the [Happy New Year 2018 post](/updates/2018/01/01/happy-new-year-2018/) for the Wordpress sourced 2017 stats.
...
import google_analytics_2018_mbedded_ninja_users from './google-analytics-2018-mbedded-ninja-users.png'

<Image src={google_analytics_2018_mbedded_ninja_users} width="800px">Number of users per week for the 2018 year. Image from Google Analytics.</Image>
