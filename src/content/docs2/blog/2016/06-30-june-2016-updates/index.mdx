...
import javafx_logo from './_assets/javafx-logo.png'

<Image src={javafx_logo} width="366px">The JavaFX logo.</Image>  
...
<Image src={sm712_02htg_rs485_tvs_diode_pinout_and_functional_block_diagram} width="511px">The pintout and functional block diagram of the SM712-02HTG TVS diode, designed specifically for protecting RS-485 bus lines. Image from http://www.littelfuse.com/~/media/electronics/datasheets/tvs_diode_arrays/littelfuse_tvs_diode_array_sm712_datasheet.pdf.pdf.</Image>  
...
<Image src={beehive_electronics_non_contact_em_probes_100_a_b_c_d} width="1379px">The four non-contact EM probes made by Beehive Electronics. Three are for magnetic field measurement and one is for electric field measurement.</Image>  
...
import offline_switcher_complete_isolated_flyback_switching_supply_schematic_ti from './_assets/offline-switcher-complete-isolated-flyback-switching-supply-schematic-ti.png'
