...
<Image src={pcie_edge_connector_schematic_symbol_and_example_design} width="498px">A PCIe card-edge connector schematic symbol and associated components.</Image>  
