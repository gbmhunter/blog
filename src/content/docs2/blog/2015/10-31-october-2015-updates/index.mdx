...
import atmel_avr_at32_3d_render_of_ic_www_teckhat_com from './_assets/atmel-avr-at32-3d-render-of-ic-www-teckhat-com.gif'

<Image src={atmel_avr_at32_3d_render_of_ic_www_teckhat_com} width="259px">A 3D render of the AT32UC3L, an Atmel AVR AT32 microcontroller. Image from http://teckhat.com/.</Image>  
...
import pcb_surface_finish_immersion_silver from './_assets/pcb-surface-finish-immersion-silver.jpg'

<Image src={pcb_surface_finish_immersion_silver} width="355px">Example of an immersion silver (IAg) PCB finish. Image from http://www.rlcinnovation.com/.</Image>  
...
import sot_346_sc_59a_component_package_3d_render from './_assets/sot-346-sc-59a-component-package-3d-render.jpg'

<Image src={sot_346_sc_59a_component_package_3d_render} width="354px">A 3D render of the SOT-346 (SC-59A) component package.</Image>  
...
import keystone_minature_smd_testpoint from './_assets/keystone-minature-smd-testpoint.jpg'

<Image src={keystone_minature_smd_testpoint} width="275px">A miniature SMD testpoint made by Keystone.</Image>  
...
import to_5_6_component_package_photo from './_assets/to-5-6-component-package-photo.jpg'

<Image src={to_5_6_component_package_photo} width="275px">A photo of the TO-5 6-lead component package.</Image>  
