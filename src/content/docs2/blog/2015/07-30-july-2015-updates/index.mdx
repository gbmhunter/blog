...
import op_amp_schematic_differential_amplifier from './_assets/op-amp-schematic-differential-amplifier.png'

<Image src={op_amp_schematic_differential_amplifier} width="436px">An op-amp configured as a differential amplifier.</Image>
...
import aspect_ratio_page_screenshot from './_assets/aspect-ratio-page-screenshot.png'

<Image src={aspect_ratio_page_screenshot} width="312px">A screenshot of the aspect ratio information added the 'Pads, Vias And Holes' page as part of the PCB design section.</Image>  
...
import fpga_schematic_just_the_ic_no_routing from './_assets/fpga-schematic-just-the-ic-no-routing.png'

<Image src={fpga_schematic_just_the_ic_no_routing} width="590px">An A3 schematic sheet with just one 236-pin FPGA IC added to it (no routing).</Image>  
