...
import arm_programming_header_pinout_screenshot from './arm-programming-header-pinout-screenshot.png'

<Image src={arm_programming_header_pinout_screenshot} width="500px"></Image>
...
import to_39_ball_lens_screenshot from './to-39-ball-lens-screenshot.png'

<Image src={to_39_ball_lens_screenshot} width="500px"></Image>
...
import sma_connector_screenshot from './sma-connector-screenshot.png'

<Image src={sma_connector_screenshot} width="500px"></Image>
