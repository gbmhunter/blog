...
import bluetooth_4_0_icon from './bluetooth-4-0-icon.jpg'

<Image src={bluetooth_4_0_icon} width="379px">The Bluetooth icon/logo.</Image>
...
import screenshot_playing_around_with_rthostimugl from './screenshot-playing-around-with-rthostimugl.png'

<Image src={screenshot_playing_around_with_rthostimugl} width="657px">Playing around with RTHostIMUGL and a connected IMU through an Arduino.</Image>
