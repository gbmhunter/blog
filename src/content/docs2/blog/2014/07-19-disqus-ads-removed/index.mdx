...
<Image src={import('./screenshot-with-disqus-ads-present.png')} width="700px">Screenshot with disqus ads present.</Image>
...
<Image src={import('./disabling-disqus-ads-promoted-discovery-annotated.png')} width="600px">Disabling disqus ads.</Image>

Now we are back to normal!

<Image src={import('./screenshot-with-disqus-ads-removed.png')} width="700px">Screenshot with disqus ads removed.</Image>
