...
import img_serial_in_serial_out_shift_register from './_assets/serial-in-serial-out-shift-register.svg'

<Image src={img_serial_in_serial_out_shift_register} width="500px">Schematic for building a 4-bit SISO shift register from flip flops.</Image>
...
import img_typical_flyback_schematic from './_assets/typical-flyback-schematic.png'

<Image src={img_typical_flyback_schematic} width="600px"></Image>
