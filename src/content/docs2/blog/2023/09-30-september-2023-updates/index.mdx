...
import ninjaterm_homepage_old_new_comparison from './ninjaterm-homepage-old-new-comparison.webp'

<Image src={ninjaterm_homepage_old_new_comparison} width="900px"></Image>
...
import stuck_i2c_buses_screenshot from './stuck-i2c-buses-screenshot.png'

<Image src={stuck_i2c_buses_screenshot} width="600px"></Image>
...
import i2c_protocol_format_screenshot from './i2c-protocol-format-screenshot.png'

<Image src={i2c_protocol_format_screenshot} width="600px"></Image>
