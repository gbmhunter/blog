...
<Image src={import('./graphing.gif')} width="600px"></Image>
...
<Image src={import('./fake-ports-screenshot.png')} width="600px"></Image>

* Ability to change terminal font size.

<Image src={import('./change-font-size-screenshot.png')} width="400px"></Image>

* Added initial Playwright e2e (end-to-end) tests.

<Image src={import('./playwright-test-ui-screenshot.png')} width="600px"></Image>
...
<Image src={import('./vite-build-screenshot.png')} width="400px"></Image>
...
<Image src={import('./new-version-available-screenshot.png')} width="700px"></Image>

* Added settings to be able to configure behaviour on receipt of carriage return and line feed characters.

<Image src={import('./new-line-and-carriage-return-settings-screenshot.png')} width="600px"></Image>
