...
import raster_io_example_image from './raster-io-example-image.png'

<Image src={raster_io_example_image} width="400px">A GeoTIF file which has been reprojected and displayed using rasterio.</Image>
