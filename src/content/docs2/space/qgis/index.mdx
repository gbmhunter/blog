...
import qgis_logo from './qgis-logo.png'

<Image src={qgis_logo} width="200px">The QGIS logo.</Image>
...
import qgis_xyz_tiles_new_connection from './qgis-xyz-tiles-new-connection.png'

<Image src={qgis_xyz_tiles_new_connection} width="500px">Right-click on 'XYZ tiles' and then click on 'New Connection'.</Image>

Then add your desired XYZ tile server information:

import qgis_xyz_tiles_google_tile_server from './qgis-xyz-tiles-google-tile-server.png'

<Image src={qgis_xyz_tiles_google_tile_server} width="500px">Adding the Google tile map service to QGIS.</Image>

To use this tile server, click on the newly added tile server and drag in down into the _Layers_ pane:

import qgis_xyz_tiles_dragging_server_into_layers from './qgis-xyz-tiles-dragging-server-into-layers.png'

<Image src={qgis_xyz_tiles_dragging_server_into_layers} width="500px">Dragging the tile server into the Layers pane to display the basemap imagery.</Image>
