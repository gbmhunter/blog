...
import logistic_function_changing_b1 from './logistic-function-changing-b1.gif'

<Image src={logistic_function_changing_b1} width="800px"></Image>
...
import logistic_function_changing_b0 from './logistic-function-changing-b0.gif'

<Image src={logistic_function_changing_b0} width="800px"></Image>
...
import data_head_iris from './data-head-iris.png'

<Image src={data_head_iris} width="500px">The first 5 rows of the Iris dataset.</Image>
...
import logistic_regression_iris_predictions from './logistic-regression-iris-predictions.png'

<Image src={logistic_regression_iris_predictions} width="600px">The predictions of the type of Iris for the test data.</Image>
...
import logistic_regression_iris_classification_report from './logistic-regression-iris-classification-report.png'

<Image src={logistic_regression_iris_classification_report} width="500px">The classification report for our logistic regression model.</Image>
