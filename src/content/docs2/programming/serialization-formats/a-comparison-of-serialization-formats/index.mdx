...
draft: false
image: /images/page-images/a-comparison-of-serialization-formats.png
...
import file_icon_csv from './_assets/file-icon-csv.png'

<Image src={file_icon_csv} width="100px"></Image>
...
import file_icon_json from './_assets/file-icon-json.png'

<Image src={file_icon_json} width="100px"></Image>
...
import protobuf_icon from './_assets/protobuf-icon.png'

<Image src={protobuf_icon} width="200px"></Image>
...
import toml_icon from './_assets/toml-icon.png'

<Image src={toml_icon} width="200px"></Image>
...
import xml_file_icon from './_assets/xml-file-icon.png'

<Image src={xml_file_icon} width="150px"></Image>
...
import yaml_file_icon from './_assets/yaml-file-icon.png'

<Image src={yaml_file_icon} width="150px"></Image>
...
import serialization_formats_conversion_times_10k_cpp from './_assets/serialization-formats-conversion-times-10k-cpp.png'

<Image src={serialization_formats_conversion_times_10k_cpp} width="600px">C++ conversion times for 10k objects in popular serialization formats.</Image>

import serialization_formats_conversion_times_10k_python from './_assets/serialization-formats-conversion-times-10k-python.png'

<Image src={serialization_formats_conversion_times_10k_python} width="600px">Python conversion times for 10k objects in popular serialization formats.</Image>
...
import serialization_formats_conversion_times_100k_cpp from './_assets/serialization-formats-conversion-times-100k-cpp.png'

<Image src={serialization_formats_conversion_times_100k_cpp} width="600px">C++ conversion times for 100k objects in popular serialization formats.</Image>

import serialization_formats_conversion_times_100k_python from './_assets/serialization-formats-conversion-times-100k-python.png'

<Image src={serialization_formats_conversion_times_100k_python} width="600px">Python conversion times for 100k objects in popular serialization formats.</Image>
...
import serialization_formats_file_sizes from './_assets/serialization-formats-file-sizes.png'

<Image src={serialization_formats_file_sizes} width="600px">Comparative file sizes for popular serialization formats.</Image>
