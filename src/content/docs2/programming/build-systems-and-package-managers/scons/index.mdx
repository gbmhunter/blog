...
import scons_build_system_logo from './scons-build-system-logo.png'

<Image src={scons_build_system_logo} width="310px">The logo for the SCons build system.</Image>
