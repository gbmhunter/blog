...
<Image src={import('./bazel-build-system-logo.png')} width="150px"></Image>
...
<Image src={import('./buck-build-system-logo.png')} width="150px"></Image>
...
<Image src={import('./buckaroo-package-manager-logo.png')} width="150px"></Image>
...
<Image src={import('./cmake-build-system-logo.png')} width="150px"></Image>
...
<Image src={import('./conan-c-cpp-package-manager-logo.png')} width="150px"></Image>
...
<Image src={import('./gnu-logo.png')} width="150px"></Image>
...
<Image src={import('./scons-build-system.png')} width="200px"></Image>
