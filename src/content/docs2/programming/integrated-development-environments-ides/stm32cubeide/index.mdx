...
import stm32_cube_ide_logo from './stm32-cube-ide-logo.png'

<Image src={stm32_cube_ide_logo} width="600px">The STM32CubeIDE logo.</Image>
...
import stm32cubeide_ioc_file_micro_pinout from './stm32cubeide-ioc-file-micro-pinout.png'

<Image src={stm32cubeide_ioc_file_micro_pinout} width="700px">A screenshot of the 'Pinout & Configuration' view of the .ioc file in STM32CubeIDE.</Image>
...
import stm32_cube_monitor_screenshot from './stm32-cube-monitor-screenshot.png'

<Image src={stm32_cube_monitor_screenshot} width="800px">A screenshot of the STM32CubeMonitor application running on Windows.</Image>