...
import cortex_m3_memory_regions from './cortex-m3-memory-regions.png'

<Image src={cortex_m3_memory_regions} width="500px">The ARM Cortex-M3 memory regions.</Image>
