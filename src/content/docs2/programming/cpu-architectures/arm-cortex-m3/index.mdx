...
import arm_cortex_m3_complete_fixed_memory_map from './_assets/arm-cortex-m3-complete-fixed-memory-map.png'

<Image src={arm_cortex_m3_complete_fixed_memory_map} width="700px">The ARM Cortex-M3 CPU fixed memory map. Image from http://infocenter.arm.com/help/topic/com.arm.doc.ddi0337e/DDI0337E_cortex_m3_r1p1_trm.pdf.</Image>
