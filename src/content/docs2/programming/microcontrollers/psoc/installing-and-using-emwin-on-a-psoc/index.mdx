...
import linker_build_settings_emwin_psoc_5 from './_assets/linker-build-settings-emwin-psoc-5.png'

<Image src={linker_build_settings_emwin_psoc_5} width="650px">The linker build settings for using emWin with GCC.</Image>
