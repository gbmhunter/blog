...
<Image src={import('./_assets/psoc-programmer-screenshot-01.png')} width="600px">Screenshot of the PSoC programmer application in Windows.</Image>
...
<Image src={import('./_assets/psoc-programmer-chip-lock-enabled.png')} width="600px">The 'Chip Lock Enabled' option in PSoC programmer.</Image>
