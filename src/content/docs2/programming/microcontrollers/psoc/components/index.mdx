...
import custom_user_c_code_in_psoc_api_files from './custom-user-c-code-in-psoc-api-files.png'

<Image src={custom_user_c_code_in_psoc_api_files} width="688px">The correct place to enter custom user code in automatically generated Cypress component API files.</Image>
...
import psoc_component_analogue_multiplexor_mux from './psoc-component-analogue-multiplexor-mux.jpg'

<Image src={psoc_component_analogue_multiplexor_mux} width="550px">The analogue multiplexor (mux) component in PSoC Creator.</Image>
...
import psoc_creator_schematic_cap_sense_component from './psoc-creator-schematic-cap-sense-component.jpg'

<Image src={psoc_creator_schematic_cap_sense_component} width="670px">The cap sense configure window in PSoC Creator.</Image>
...
import psoc_component_schematic_counter_16bit from './psoc-component-schematic-counter-16bit.png'

<Image src={psoc_component_schematic_counter_16bit} width="820px">The PSoC counter component, set to be 16-bit (this is configurable).</Image>
...
import psoc_debounce_component_with_pin_and_interrupt from './psoc-debounce-component-with-pin-and-interrupt.png'

<Image src={psoc_debounce_component_with_pin_and_interrupt} width="590px">The PSoC Debouncer. In the case, the switch pulled-up, and input goes low on press, which fires interrupt.</Image>
...
import psoc_filter_component_config_dialog_box from './psoc-filter-component-config-dialog-box.png'

<Image src={psoc_filter_component_config_dialog_box} width="1118px">The filter component configuration tab in PSoC Creator.</Image>
...
import cypress_psoc_i2c_api_while_loops_in_master_functions_annotated from './cypress-psoc-i2c-api-while-loops-in-master-functions-annotated.png'

<Image src={cypress_psoc_i2c_api_while_loops_in_master_functions_annotated} width="538px">An example of the dangerous, un-bounded while() loops in the PSoC I2C API.</Image>
...
import psoc_i2c_api_with_upper_bounds_on_while_loops_annotated from './psoc-i2c-api-with-upper-bounds-on-while-loops-annotated.png'

<Image src={psoc_i2c_api_with_upper_bounds_on_while_loops_annotated} width="857px">An screenshot of an edited version of the PSoC I2C API with added upper-bounds on the number of while() loop iterations.</Image>
...
import psoc_top_design_isr_component_connected_to_push_button from './psoc-top-design-isr-component-connected-to-push-button.jpg'

<Image src={psoc_top_design_isr_component_connected_to_push_button} width="472px">The ISR component, connected to a push button (digital input pin).</Image>
...
import hall_effect_interrupts_from_bldc_motor_for_both_rise_and_fall from './hall-effect-interrupts-from-bldc-motor-for-both-rise-and-fall.png'

<Image src={hall_effect_interrupts_from_bldc_motor_for_both_rise_and_fall} width="1054px">6 PSoC interrupts to service the three hall-effect inputs from a BLDC motor. Six interrupts are required because the PSoC interrupt component only supports rising-edge triggering, and so a inverting gate and second interrupt per sensor is required to trigger on falling-edge.</Image>
...
import psoc_module_character_lcd from './psoc-module-character-lcd.jpg'

<Image src={psoc_module_character_lcd} width="154px">The PSoC Character LCD component. Not much to it right?</Image>

Pin description:

import psoc_module_character_lcd_pin_description from './psoc-module-character-lcd-pin-description.jpg'

<Image src={psoc_module_character_lcd_pin_description} width="800px">The pin descriptions for the PSoC LCD component.</Image>
...
import ganging_port_pins_together_to_provide_more_output_current from './ganging-port-pins-together-to-provide-more-output-current.png'

<Image src={ganging_port_pins_together_to_provide_more_output_current} width="620px">Ganging port pins together on a PSoC microcontroller to provide more output current. Be careful not to exceed to total allowed current per port.</Image>
...
import psoc_component_pulse_converter_trigger_in_out from './psoc-component-pulse-converter-trigger-in-out.png'

<Image src={psoc_component_pulse_converter_trigger_in_out} width="388px">The PSoC Pulse Converter component, being used here to output constant-width pulses.</Image>
...
import psoc_component_quadrature_decoder from './psoc-component-quadrature-decoder.png'

<Image src={psoc_component_quadrature_decoder} width="1034px">The PSoC quadrature decoder component. Takes the A, B and N inputs from an incremental encoder and converts it into a count.</Image>
...
import psoc_creator_scb_component_as_uart_example_topdesign from './psoc-creator-scb-component-as-uart-example-topdesign.png'

<Image src={psoc_creator_scb_component_as_uart_example_topdesign} width="307px">A screenshot of a SCB block in the `TopDesign.cysch` file in PSoC Creator. This SCB block is configured as a UART.</Image>
...
import vdac_component_routed_to_debug_pin_on_schematic from './vdac-component-routed-to-debug-pin-on-schematic.png'

<Image src={vdac_component_routed_to_debug_pin_on_schematic} width="210px">The PSoC VDAC component.</Image>
...
import using_psoc_vdac_component_to_inspect_code_execution from './using-psoc-vdac-component-to-inspect-code-execution.jpg'

<Image src={using_psoc_vdac_component_to_inspect_code_execution} width="579px">The oscilloscope on the PSoC VDAC component output allows you to inspect code execution. Each different voltage level corresponds to a different section of code. This was taken while running a complex FreeRTOS-based program.</Image>
...
import care_with_psoc_watchdog_and_eeprom_flash_20ms_write_time from './care-with-psoc-watchdog-and-eeprom-flash-20ms-write-time.png'

<Image src={care_with_psoc_watchdog_and_eeprom_flash_20ms_write_time} width="357px">A screenshot taken from the PSoC 5 LP datasheet, stating care must be taken when using the watchdog in an application that also performs EEPROM or flash writes.</Image>
