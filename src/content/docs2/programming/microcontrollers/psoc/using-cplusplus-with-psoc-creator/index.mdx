...
import psoc_creator_build_settings_command_line_custom_flags from './_assets/psoc-creator-build-settings-command-line-custom-flags.png'

<Image src={psoc_creator_build_settings_command_line_custom_flags} width="800px">Adding custom command line flags in PSoC Creator to force GCC to use the C++ compiler.</Image>
...
import cplusplus_linker_error_undefined_reference_to_gxx_personality from './_assets/cplusplus-linker-error-undefined-reference-to-gxx-personality.png'
...
import c_linker_error_undefined_reference_to_cxa_end_cleanup from './_assets/c-linker-error-undefined-reference-to-cxa-end-cleanup.png'

<Image src={c_linker_error_undefined_reference_to_cxa_end_cleanup} width="600px">Add the custom compile flag '-fno-exceptions' to every .cpp file you want to compile in PSoC Creator to prevent the 'undefined reference to __cxa_end_cleanup' linker error.</Image>
...
import psoc_creator_build_settings_to_use_new_delete_fno_exceptions from './_assets/psoc-creator-build-settings-to-use-new-delete-fno-exceptions.png'

<Image src={psoc_creator_build_settings_to_use_new_delete_fno_exceptions} width="800px">Add the custom compile flag '-fno-exceptions' flag via the 'Build Settings' menu in PSoC Creator.</Image>
...
import psoc_creator_io_function_gcc_build_warnings_cpp from './_assets/psoc-creator-io-function-gcc-build-warnings-cpp.png'

<Image src={psoc_creator_io_function_gcc_build_warnings_cpp} width="700px">The PSoC Creator build warnings that pop up if you compile C++ code. You can safely ignore these.</Image>
...
import psoc_creator_build_settings_compiler_optimisation_none from './_assets/psoc-creator-build-settings-compiler-optimisation-none.png'

<Image src={psoc_creator_build_settings_compiler_optimisation_none} width="600px">Setting the compiler optimisation to none in the PSoC Creator project build settings so that C++ code can be debugged just like normal C code.</Image>
