...
<Image src={import('./_assets/atmel-sam3u-development-kit-annotated-diagram.jpg')} width="700px">Annotated hardware diagram of the Atmel SAM3U development kit. Image from www.digikey.com.</Image>
...
<Image src={import('./_assets/atmel-ice-swd-pin-mapping.png')} width="600px">The pin mapping for the Atmel-ICE programmer when using the SWD programming interface. Image from http://ww1.microchip.com/downloads/en/DeviceDoc/Atmel-42330-Atmel-ICE_UserGuide.pdf.</Image>
