...
<Image src={import('./mplab-xc-compiler-microchip-logo.png')} width="282px">The logo for the range of MPLAB XC compilers. Image from http://www.microchip.com/.</Image>
...
<Image src={import('./mplab-xc-compiler-build-status-output-memory-summary-licensing.png')} width="540px">Build status output from the free version of the MPLAB XC compiler.</Image>
...
<Image src={import('./built-in-pic-microcontroller-delay-functions.png')} width="719px">A screenshot of the built-in delay functions provided in the PIC microcontroller libraries. This screenshot was taken from pic18.h.</Image>
