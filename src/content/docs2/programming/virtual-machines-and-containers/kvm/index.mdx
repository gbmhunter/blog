...
import kvm_unable_to_connect_to_libvirt from './kvm-unable-to-connect-to-libvirt.png'

<Image src={kvm_unable_to_connect_to_libvirt} width="500px">Screenshot of the 'Unable to connect to libvirt' error in KVM.</Image>
