...
import futures_and_promises_cpp_icon from './_assets/futures-and-promises-cpp-icon.png'

<Image src={futures_and_promises_cpp_icon} width="200px">Icon for futures and promises.</Image>
