...
<Image src={import('./_assets/terminal-output-start-of-zynq-zc702-linux-boot-using-yocty.png')} width="1656px">The terminal output during the start of a Linux boot built using Yocty, and running on the Xilinx ZC702 dev. board.</Image>
