...
import zephyr_project_logo from './_assets/zephyr-project-logo.png'

<Image src={zephyr_project_logo} width="500px">The Zephyr Project logo.</Image>
...
import timers_basic_example_output from './_assets/timers-basic-example-output.png'

<Image src={timers_basic_example_output} width="400px">Running the timer example code above and observing the expiry function run every second.</Image>
...
import watchdog_example from './_assets/watchdog-example.png'

<Image src={watchdog_example} width="800px">Running the watchdog example code and seeing it timeout.</Image>
...
import semaphore_working_example_stdout from './_assets/semaphore-working-example-stdout.png'

<Image src={semaphore_working_example_stdout} width="800px">The output from the full working Polling API example above, showing how a thread blocks on two separate semaphores.</Image>
...
import zephyr_shell_x_messages_dropped_screenshot from './_assets/zephyr-shell-x-messages-dropped-screenshot.png'

<Image src={zephyr_shell_x_messages_dropped_screenshot} width="700px">A screenshot of the \"x messages dropped\" error that can occur with Zephyr logging.</Image>
...
import zephyr_ram_report_output_screenshot from './_assets/zephyr-ram-report-output-screenshot.png'

<Image src={zephyr_ram_report_output_screenshot} width="500px">A screenshot of the output produce by the `west build -t ram_report` command.</Image>
...
import puncover_build_error from './_assets/puncover-build-error.png'

<Image src={puncover_build_error} width="500px">A screenshot of the build error you can get if you don't clean build after installing puncover.</Image>
...
import spaces_in_path_not_supported_zephyr_documentation_warning from './_assets/spaces-in-path-not-supported-zephyr-documentation-warning.png'

<Image src={spaces_in_path_not_supported_zephyr_documentation_warning} width="900px">A warning on Zephyr's documentation about using spaces in paths.</Image>
...
import selecting_use_build_system_default_in_nrf_connect from './_assets/selecting-use-build-system-default-in-nrf-connect.png'

<Image src={selecting_use_build_system_default_in_nrf_connect} width="600px">Selecting \"Use build system default\" can sometimes fix device tree errors.</Image>
...
import by_not_providing_find_zephyr_cmake from './_assets/by-not-providing-find-zephyr-cmake.png'

<Image src={by_not_providing_find_zephyr_cmake} width="700px">Screenshot of the error \"By not providing \"FindZephyr.cmake\" in CMAKE_MODULE_PATH ...\".</Image>
...
import error_no_module_named_elftools from './_assets/error-no-module-named-elftools.png'

<Image src={error_no_module_named_elftools} width="700px">Screenshot of the error \"No module named 'elftools'\".</Image>
