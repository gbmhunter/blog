...
draft: false
image: /images/page-images/linux-serial-ports-using-c-cpp.png
...
import linux_dev_dir_ttyacm0_arduino_serial from './_assets/linux-dev-dir-ttyacm0-arduino-serial.png'

<Image src={linux_dev_dir_ttyacm0_arduino_serial} width="600px">A listing of the /dev/ directory in Linux with a connected Arduino. The Arduino serial port is present as /dev/ttyACM0.</Image>
