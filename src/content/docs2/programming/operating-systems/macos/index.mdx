...
import iterm2_enabling_natural_text_editing from './iterm2-enabling-natural-text-editing.png'

<Image src={iterm2_enabling_natural_text_editing} width="500px">Enabling the 'Natural Text Editing' key mapping reset in iTerm2.</Image>
