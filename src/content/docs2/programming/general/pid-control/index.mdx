...
import pid_controller_diagram_process_error_setpoint_measured_value from './pid-controller-diagram-process-error-setpoint-measured-value.webp'

<Image src={pid_controller_diagram_process_error_setpoint_measured_value} width="900px">A block diagram of a PID controller.</Image>
...
import standard_form_pid_controller_diagram from './standard-form-pid-controller-diagram.webp'

<Image src={standard_form_pid_controller_diagram} width="800px">Diagram of a PID controller in standard form.</Image>
...
import msd_simulation_manual_tuning_01_p0_i0_d0 from './msd-simulation/manual-tuning-01-p0-i0-d0.png'

<Image src={msd_simulation_manual_tuning_01_p0_i0_d0} width="600px">1st step of tuning, set all gains to 0.</Image>

Now let's increase $K_p$ until the system starts to oscillate continuously (increasing $K_p$ from left to right in the figure):

import msd_simulation_manual_tuning_02_increasing_kp_round_1 from './msd-simulation/manual-tuning-02-increasing-kp-round-1.png'

<Image src={msd_simulation_manual_tuning_02_increasing_kp_round_1} width="900px">2st step of tuning, increasing $K_p$ until system continuously oscillates.</Image>

At $K_p=100$, we get continuous oscillation. Now increase $K_d$ until the oscillations are critically dampened:

import msd_simulation_manual_tuning_03_increasing_kd_round_1 from './msd-simulation/manual-tuning-03-increasing-kd-round-1.png'

<Image src={msd_simulation_manual_tuning_03_increasing_kd_round_1} width="900px">3rd step of tuning, increasing $K_d$ until oscillations are dampened.</Image>
...
import msd_simulation_manual_tuning_04_increasing_kp_round_2 from './msd-simulation/manual-tuning-04-increasing-kp-round-2.png'

<Image src={msd_simulation_manual_tuning_04_increasing_kp_round_2} width="900px">4th step of tuning, increasing $K_p$ again.</Image>

At around $K_p=1800$ we start to get continuous oscillation. Can we dampen this by increasing $K_d$ again?

import msd_simulation_manual_tuning_05_increasing_kd_round_2 from './msd-simulation/manual-tuning-05-increasing-kd-round-2.png'

<Image src={msd_simulation_manual_tuning_05_increasing_kd_round_2} width="900px">5th step of tuning, increasing $K_d$ to see if we can critically dampen the oscillations.</Image>
...
import msd_simulation_manual_tuning_06_increasing_ki from './msd-simulation/manual-tuning-06-increasing-ki.png'

<Image src={msd_simulation_manual_tuning_06_increasing_ki} width="900px">6th step of tuning, increasing $K_i$ until steady-state error is eliminated in a suitable amount of time.</Image>
...
import pid_controller_with_feedforward_diagram from './pid-controller-with-feedforward-diagram.webp'

<Image src={pid_controller_with_feedforward_diagram} width="800px">A PID controller with feedforward added.</Image>
...
import mass_spring_damper_system_diagram_pid from './mass-spring-damper-system-diagram-pid.png'

<Image src={mass_spring_damper_system_diagram_pid} width="600px">A mass-spring-damper system, which is commonly used to demonstrate PID control and appropriate tuning.</Image>
...
import msd_simulation_msd_response_plot_p10_i0_d0 from './msd-simulation/msd-response-plot-p10-i0-d0.png'

<Image src={msd_simulation_msd_response_plot_p10_i0_d0} width="800px">The response of the mass-spring-damper system with just proportional gain.</Image>
...
import msd_simulation_msd_response_plot_p300_i0_d0 from './msd-simulation/msd-response-plot-p300-i0-d0.png'

<Image src={msd_simulation_msd_response_plot_p300_i0_d0} width="800px">The response of the mass-spring-damper system with more proportional gain.</Image>
...
import msd_simulation_msd_response_plot_p300_i300_d0 from './msd-simulation/msd-response-plot-p300-i300-d0.png'

<Image src={msd_simulation_msd_response_plot_p300_i300_d0} width="800px">The response of the mass-spring-damper system with more proportional gain.</Image>
...
import msd_simulation_msd_response_plot_p300_i300_d20 from './msd-simulation/msd-response-plot-p300-i300-d20.png'

<Image src={msd_simulation_msd_response_plot_p300_i300_d20} width="800px">The response of the mass-spring-damper system with derivative control added.</Image>
...
If you are interested in the Python code that was used to perform this simulation, see [here](./msd-simulation/main.py).
...
import pid_tuner_screenshot from './pid-tuner-screenshot.png'

<Image src={pid_tuner_screenshot} width="900px">Screenshot of the PID tuning app at pidtuner.com[^pid-tuner-dot-com-homepage].</Image>
