...
import basic_bootloader_memory_map from './_assets/basic-bootloader-memory-map.webp'

<Image src={basic_bootloader_memory_map} width="700px">A basic example showing the layout of a microcontrollers memory when a bootloader is used.</Image>
...
import swap_move_algorithm_mcuboot from './_assets/swap-move-algorithm-mcuboot.webp'

<Image src={swap_move_algorithm_mcuboot} width="900px">Illustration of the swap-move algorithm to swap two firmware images using just a single extra erase sector in slot 0.</Image>
...
import mcuboot_homepage_screenshot from './_assets/mcuboot-homepage-screenshot.png'

<Image src={mcuboot_homepage_screenshot} width="700px">A screenshot of MCUboot's homepage as of Jan 2024.</Image>
...
import zephyr_mcuboot_shell_output_during_swap from './_assets/zephyr-mcuboot-shell-output-during-swap.png'

<Image src={zephyr_mcuboot_shell_output_during_swap} width="700px">The output to the Zephyr shell just after a new image has been downloaded, the MCU reboots and MCUboot performs a swap of the images.</Image>
