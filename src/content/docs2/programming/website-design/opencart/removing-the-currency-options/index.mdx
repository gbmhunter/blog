...
import open_cart_currency_options_gone from './_assets/open-cart-currency-options-gone.jpg'

<Image src={open_cart_currency_options_gone} width="800px">Removing the currency options in OpenCart only takes a little CSS.</Image>
