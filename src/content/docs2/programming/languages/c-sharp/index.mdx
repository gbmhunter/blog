...
import screenshot_of_nuget_plugin_for_visual_studio from './_assets/screenshot-of-nuget-plugin-for-visual-studio.jpg'

<Image src={screenshot_of_nuget_plugin_for_visual_studio} width="700px">A screenshot of the NuGet plugin for Visual Studio.</Image>
