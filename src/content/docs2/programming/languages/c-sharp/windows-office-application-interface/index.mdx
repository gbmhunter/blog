...
import add_microsoft_word_object_library_reference from './_assets/add-microsoft-word-object-library-reference.png'

<Image src={add_microsoft_word_object_library_reference} width="320px">Adding the Microsoft Word x.x (14.0 in this case) Object Library to a C# project.</Image>
