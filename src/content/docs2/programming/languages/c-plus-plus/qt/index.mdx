...
import qt_creator_you_need_to_install_xcode_command_line_tools from './qt-creator-you-need-to-install-xcode-command-line-tools.png'

<Image src={qt_creator_you_need_to_install_xcode_command_line_tools} width="200px">The Qt installer warning you that you need Xcode and the Xcode command-line tools installed. Note that you can make do with just the command-line tools.</Image>
...
import qt_creator_menu_tools_options from './qt-creator-menu-tools-options.png'

<Image src={qt_creator_menu_tools_options} width="300px"></Image>

1. Uncheck the _Lower case file names_ checkbox.

import qt_creator_uncheck_lower_case_filenames from './qt-creator-uncheck-lower-case-filenames.png'

<Image src={qt_creator_uncheck_lower_case_filenames} width="700px"></Image>
...
import macdeployqt_cli_screenshot from './macdeployqt-cli-screenshot.png'

<Image src={macdeployqt_cli_screenshot} width="500px">Screenshot of the Qt macdeployqt CLI tool.</Image>
