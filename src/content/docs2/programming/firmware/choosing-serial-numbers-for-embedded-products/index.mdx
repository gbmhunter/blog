...
draft: false
image: /images/page-images/choosing-serial-numbers-for-embedded-products.png
...
import tank_with_serial_number from './_assets/tank-with-serial-number.png'

<Image src={tank_with_serial_number} width="400px"></Image>
...
import probability_of_collision_32_bit from './_assets/probability-of-collision-32-bit.png'

<Image src={probability_of_collision_32_bit} width="600px">The probability of a collision when generating 32-bit random serial numbers for different numbers of devices.</Image>
...
import probability_of_collision_32_bit_approx_vs_exact from './_assets/probability-of-collision-32-bit-approx-vs-exact.png'

<Image src={probability_of_collision_32_bit_approx_vs_exact} width="600px">Comparing the approximate and exact equations for calculating the collision probability for 32-bit serial numbers and a varying number of devices.</Image>
...
import probability_of_collision_64_bit from './_assets/probability-of-collision-64-bit.png'

<Image src={probability_of_collision_64_bit} width="600px">The probability of a collision when generating 64-bit random serial numbers for different numbers of devices from 1 to up to 1 billion.</Image>
