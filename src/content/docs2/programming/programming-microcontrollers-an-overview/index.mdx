...
import arm_cortex_10pin_debug_connector_pinout from './arm-cortex-10pin-debug-connector-pinout.svg'

<Image src={arm_cortex_10pin_debug_connector_pinout} width="800px">Standard pinout for the ARM Cortex 10-pin programming connector configured for (A) JTAG and (B) SWD. NC pins are **N**ot **C**onnected (i.e. not used)[^bib-keil-coresight-conn].</Image>
...
import samtec_ftsh_105_01_l_dv_k_2x5_1_27mm_header from './samtec-ftsh-105-01-l-dv-k-2x5-1.27mm-header.png'

<Image src={samtec_ftsh_105_01_l_dv_k_2x5_1_27mm_header} width="200px">3D model of the Samtec FTSH-105-01 10-pin 2x5 1.27mm pitch SMD header[^bib-samtec-ftsh-105-01].</Image>
...
import n_14pin_ti_jtag_connector_pinout from './14pin-ti-jtag-connector-pinout.svg'

<Image src={n_14pin_ti_jtag_connector_pinout} width="500px">Pinout for the TI 14-pin JTAG connector[^bib-segger-ti-14pin][^bib-ti-jtag-conns].</Image>
...
import beagleboard_photo_jtag_14pin_ti_debug_conn_highlighted from './beagleboard-photo-jtag-14pin-ti-debug-conn-highlighted.png'

<Image src={beagleboard_photo_jtag_14pin_ti_debug_conn_highlighted} width="600px">Photo highlighting the 14-pin TI style JTAG connector on the BeagleBoard-xM[^bib-beagleboard-xm].</Image>

### 20-pin ARM "Standard" Debug Connector Pinout

This is the most common 20-pin debug connector pinout for an ARM device.

import arm_cortex_20pin_arm_standard_debug_connector_pinout from './arm-cortex-20pin-arm-standard-debug-connector-pinout.svg'

<Image src={arm_cortex_20pin_arm_standard_debug_connector_pinout} width="500px">Pinout for the 20-pin \"standard\" ARM debug connector[^bib-keil-coresight-conn].</Image>
...
import arm_cortex_20pin_coresight_debug_connector_pinout from './arm-cortex-20pin-coresight-debug-connector-pinout.svg'

<Image src={arm_cortex_20pin_coresight_debug_connector_pinout} width="500px">Pinout for the \"Cortex Debug + ETM Connector\" 20-pin debug connector[^bib-keil-coresight-conn].</Image>
