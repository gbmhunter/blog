...
<Image src={import('./fpga-fgg-485-capacitors-around-outside-pcb-routing-screenshot.png')} width="670px">If your not allowed to place components on the bottom-side of the PCB, placing decoupling caps around the perimeter of a large BGA packaged FPGA is the best you can do.</Image>
