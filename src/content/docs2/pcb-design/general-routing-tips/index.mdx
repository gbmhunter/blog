...
import screenshot_during_routing_a_track_on_pcb_in_altium from './screenshot-during-routing-a-track-on-pcb-in-altium.png'

<Image src={screenshot_during_routing_a_track_on_pcb_in_altium} width="321px">Screenshot during the routing of a track on a PCB in Altium.</Image>
...
import routed_accelrometer_footprint_showing_thermal_relief_on_not_connects_for_stress_relief from './routed-accelrometer-footprint-showing-thermal-relief-on-not-connects-for-stress-relief.png'

<Image src={routed_accelrometer_footprint_showing_thermal_relief_on_not_connects_for_stress_relief} width="800px">Routing un-used pins on a accelerometer component package a minimum distance away from the IC to reduce stress when infrared/reflow soldering.</Image>
...
import pcb_damaged_by_screw_head from './pcb-damaged-by-screw-head.jpg'

<Image src={pcb_damaged_by_screw_head} width="500px">Ouch. This is what can happen if you don't provide clearance on a PCB for screw heads.</Image>
