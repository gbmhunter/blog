...
import pcb_untented_vias_as_test_points from './pcb-untented-vias-as-test-points.jpg'

<Image src={pcb_untented_vias_as_test_points} width="500px">Notice the untented vias on a PCB. These can be used as test-points in space-constrained designs.</Image>
...
import keystone_minature_smd_testpoint from './keystone-minature-smd-testpoint.jpg'

<Image src={keystone_minature_smd_testpoint} width="200px">A minature SMD testpoint made by Keystone.</Image>
</td>
...
import harwin_smt_test_point from './harwin-smt-test-point.jpg'

<Image src={harwin_smt_test_point} width="160px">Harwin SMT Test Point</Image>
</td>
