...
import hole_size_versus_pad_size from './hole-size-versus-pad-size.png'

<Image src={hole_size_versus_pad_size} width="767px">Diagram showing different ratios between hole and pad size.</Image>
...
import ninja_calc_via_current_ipc_2221a_calculator_screenshot from './ninja-calc-via-current-ipc-2221a-calculator-screenshot.png'

<Image src={ninja_calc_via_current_ipc_2221a_calculator_screenshot} width="890px">A screenshot of the via current calculator (based of the IPC-2221A standard) in NinjaCalc.</Image>
...
import drilled_out_via_on_pcb_next_to_resistor from './drilled-out-via-on-pcb-next-to-resistor.jpg'

<Image src={drilled_out_via_on_pcb_next_to_resistor} width="1600px">A drilled-out via (to break the connection) between a 0603 resistor and SOT-23-3 MOSFET.</Image>
...
import minimum_annular_ring from './minimum-annular-ring.gif'

<Image src={minimum_annular_ring} width="124px">The definition of an annular ring in PCB design.</Image>
...
import pads_with_direct_connect_and_thermal_relief from './pads-with-direct-connect-and-thermal-relief.png'

<Image src={pads_with_direct_connect_and_thermal_relief} width="440px">The pad on the left has a direct-connect style to the surrounded polygon pour, while the pad on the right has a thermal-relief connection style.</Image>
