...
import sod_323_sc_76_component_package_3d_render from './_assets/sod-323-sc-76-component-package-3d-render.jpg'

<Image src={sod_323_sc_76_component_package_3d_render} width="200px"></Image>
...
<Image src={sod_323_sc_76_component_package_3d_render} width="200px">3D model of the `SOD-323` component package.</Image>
...
import sod_323_package_dimensions_nxp from './_assets/sod-323-package-dimensions-nxp.png'

<Image src={sod_323_package_dimensions_nxp} width="700px">Dimensions for the `SOD-323` component package[^bib-nxp-sod323-ds].</Image>
...
import sod_323f_3d_render_nexperia from './_assets/sod-323f-3d-render-nexperia.png'

<Image src={sod_323f_3d_render_nexperia} width="300px">3D render of the `SOD-323F` component package[^bib-nexperia-sod-323f].</Image>

import sod_323f_package_dimensions_diodes_inc from './_assets/sod-323f-package-dimensions-diodes-inc.png'

<Image src={sod_323f_package_dimensions_diodes_inc} width="700px">Package dimensions of the `SOD-323F` component package[^bib-diodes-inc-sod-323f].</Image>
...
import sod_323fl_component_package_dimensions_central_semiconductor from './_assets/sod-323fl-component-package-dimensions-central-semiconductor.png'

<Image src={sod_323fl_component_package_dimensions_central_semiconductor} width="700px">Package dimensions of the Central Semiconductor `SOD-323FL` component package[^bib-central-semi-sod-323fl].</Image>

import sod_323fl_land_pattern_central_semiconductor from './_assets/sod-323fl-land-pattern-central-semiconductor.png'

<Image src={sod_323fl_land_pattern_central_semiconductor} width="700px">Recommended land pattern for the Central Semiconductor `SOD-323FL` component package[^bib-central-semi-sod-323fl].</Image>
...
import sod_323he_3d_model_rohm from './_assets/sod-323he-3d-model-rohm.png'

<Image src={sod_323he_3d_model_rohm} width="300px">3D model of the SOD-323HE component package[^bib-rohm-rb558vam150-ds].</Image>

import sod_323he_package_dimensions_rohm from './_assets/sod-323he-package-dimensions-rohm.png'

<Image src={sod_323he_package_dimensions_rohm} width="600px">Package dimensions of the SOD-323HE component package[^bib-rohm-rb558vam150-ds].</Image>
