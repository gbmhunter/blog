...
import sc_79_sod_523_component_package_3d_render from './sc-79-sod-523-component-package-3d-render.png'

<Image src={sc_79_sod_523_component_package_3d_render} width="200px"></Image>
...
import sod_523_package_dimensions from './sod-523-package-dimensions.png'

<Image src={sod_523_package_dimensions} width="600px">Package dimensions for the SOD-523 package[^bib-nxp-sod523-package-info].</Image>

import sod_523_land_pattern from './sod-523-land-pattern.png'

<Image src={sod_523_land_pattern} width="600px">Recommended land pattern for the SOD-523 package[^bib-nxp-sod523-package-info].</Image>
