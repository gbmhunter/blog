...
import qip_component_package_photo from './_assets/qip-component-package-photo.jpg'

<Image src={qip_component_package_photo} width="600px">A photo of the QIP component package.</Image>
