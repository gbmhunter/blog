...
import hc_49us_component_package_photo from './_assets/hc-49us-component-package-photo.jpg'

<Image src={hc_49us_component_package_photo} width="200px">A photo of the HC-49/US component package.</Image>
...
import hc49us_component_package_dimensions_land_pattern from './_assets/hc49us-component-package-dimensions-land-pattern.png'

<Image src={hc49us_component_package_dimensions_land_pattern} width="800px">The dimensions and recommended land pattern for the HC-49/U-S component package.</Image>

## Further Reading

For info on un-named SMD crystal packages (which are more common than the HC-49/U-S due to their smaller size), see the [SMD Crystal Packages page](/docs/pcb-design/component-packages/crystal-packages/index.mdx).
