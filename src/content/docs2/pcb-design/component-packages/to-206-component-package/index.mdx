...
import to_206aa_to_18_3_photo_digikey from './_assets/to-206aa-to-18-3-photo-digikey.png'

<Image src={to_206aa_to_18_3_photo_digikey} width="300px">A photo of the TO-206AA (TO-18-3) from DigiKey[^digikey-2n2222a].</Image>

The dimensions of the `TO-206AA` are shown below:

import to_206_aa_to_18_3_lead_ti_h03c_dimensions from './_assets/to-206-aa-to-18-3-lead-ti-h03c-dimensions.png'

<Image src={to_206_aa_to_18_3_lead_ti_h03c_dimensions} width="700px">Dimensions for the TO-206AA (TO-18) component package from National Semiconductor (now Texas Instruments)[^ti-metal-can-packages].</Image>
