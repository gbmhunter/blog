...
import pg_sct595_3d_render from './_assets/pg-sct595-3d-render.png'

<Image src={pg_sct595_3d_render} width="300px">A 3D render of the PG-SCT595 package[^digikey-tls105b0mbhtsa1-product-page].</Image>
...
import pg_sct595_package_dimensions from './_assets/pg-sct595-package-dimensions.png'

<Image src={pg_sct595_package_dimensions} width="800px">The dimensions for the PG-SCT595 package[^infineon-bts3800sl-gate-driver-ds].</Image>

## Recommended Land Pattern

The below image shows the recommended land pattern and solder paste apertures:

import pg_sct595_recommended_land_pattern from './_assets/pg-sct595-recommended-land-pattern.png'

<Image src={pg_sct595_recommended_land_pattern} width="700px">The recommended land pattern and solder paste apertures for the PG-SCT595 package[^infineon-pg-sct595-5-1].</Image>
