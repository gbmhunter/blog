...
import tssop_38_component_package_3d_render from './_assets/tssop-38-component-package-3d-render.jpg'

<Image src={tssop_38_component_package_3d_render} width="300px">A 3D render of the TSSOP-38 component package.</Image>
...
import htssop_28_component_package_3d_render_with_thermal_pad from './_assets/htssop-28-component-package-3d-render-with-thermal-pad.jpg'

<Image src={htssop_28_component_package_3d_render_with_thermal_pad} width="320px">A 3D render of the 28-pin TSSOP component package that has a thermal pad (HTSSOP-28).</Image>
