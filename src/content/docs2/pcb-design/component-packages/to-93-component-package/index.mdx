...
<Image src={import('./_assets/to-93-component-package-photo.jpg')} width="160px">A photo of the TO-93 component package.</Image>
...
<Image src={import('./_assets/two-scrs-on-heatsinks.jpg')} width="600px">Two high-power SCRs in TO-93 packages that are mounted to heatsinks (the International Rectifier 151RB60 and an unknown SCR).</Image>
