...
import sot_363_component_package_3d_render from './_assets/sot-363-component-package-3d-render.jpg'

<Image src={sot_363_component_package_3d_render} width="200px">A 3D render of the SOT-363 component package.</Image>
...
import sot_363_component_package_dimensions_diodes_inc from './_assets/sot-363-component-package-dimensions-diodes-inc.png'

<Image src={sot_363_component_package_dimensions_diodes_inc} width="917px">The dimensions of the SOT-363 component package. Image from http://www.diodes.com/.</Image>

## Footprint (Land Pattern)

import sot_363_component_package_recommended_footprint_land_pattern_diodes_inc from './_assets/sot-363-component-package-recommended-footprint-land-pattern-diodes-inc.png'

<Image src={sot_363_component_package_recommended_footprint_land_pattern_diodes_inc} width="885px">A recommended footprint (land pattern) for the SOT-363 component package. Image from http://www.diodes.com/.</Image>
...
import dmn63d8ldw_dual_device_mosfet_in_sot_363_component_package_internal_schematic from './_assets/dmn63d8ldw-dual-device-mosfet-in-sot-363-component-package-internal-schematic.png'

<Image src={dmn63d8ldw_dual_device_mosfet_in_sot_363_component_package_internal_schematic} width="322px">Internal schematic of a dual-MOSFET component in a SOT-363 package. Notice it is not polarity sensitive. Image from http://www.diodes.com/.</Image>
