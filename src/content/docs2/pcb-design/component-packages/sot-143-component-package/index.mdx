...
import sot_143_3d_model_digikey from './_assets/sot-143-3d-model-digikey.png'

<Image src={sot_143_3d_model_digikey} width="150px"></Image>
...
<Image src={sot_143_3d_model_digikey} width="300px">A 3D model of the SOT-143 component package[^bib-digikey-stm6315rbw13f]. On the upside down render, you can clearly see the 1 wider lead.</Image>
