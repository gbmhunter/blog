...
import sot_416_3d_render_rohm from './_assets/sot-416-3d-render-rohm.png'

<Image src={sot_416_3d_render_rohm} width="300px">A 3D render of the SOT-416 component package by Rohm Semiconductor[^rs-dtd523ye3tl-npn-transistor].</Image>
...
import sot_416_dimensions_toshiba from './_assets/sot-416-dimensions-toshiba.png'

<Image src={sot_416_dimensions_toshiba} width="500px">Dimensions from Toshiba for the SOT-416 component package[^toshiba-sot-416].</Image>

### Recommended Land Pattern

The image below shows the recommended land pattern from Toshiba for the `SOT-416`.

import sot_416_recommended_land_pattern_toshiba from './_assets/sot-416-recommended-land-pattern-toshiba.png'

<Image src={sot_416_recommended_land_pattern_toshiba} width="300px">The recommended land pattern from Toshiba for the SOT-416 package[^toshiba-sot-416].</Image>
...
import sot_416fl_3d_render_snapeda from './_assets/sot-416fl-3d-render-snapeda.jpg'

<Image src={sot_416fl_3d_render_snapeda} width="250px">A 3D render of the SOT-416FL from SnapEDA[^snapeda-dtc143zebtl-bjt].</Image>
...
import sot_416fl_dimensions_rohm from './_assets/sot-416fl-dimensions-rohm.png'

<Image src={sot_416fl_dimensions_rohm} width="600px">Dimensions of the SOT-416FL package from Rohm Semiconductor[^rohm-rb715wm-schottky-barrier-diode-ds].</Image>

### Recommended Land Pattern

The image below shows the recommended land pattern from Rohm Semiconductor for their `SOT-416FL` package.

import sot_416fl_recommended_land_pattern_rohm from './_assets/sot-416fl-recommended-land-pattern-rohm.png'

<Image src={sot_416fl_recommended_land_pattern_rohm} width="400px">The recommended land pattern from Rohm for the SOT-416FL package[^rohm-rb715wm-schottky-barrier-diode-ds].</Image>
