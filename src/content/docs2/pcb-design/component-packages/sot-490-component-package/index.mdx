...
import sc_89_3_3d_model_digikey from './_assets/sc-89-3-3d-model-digikey.png'

<Image src={sc_89_3_3d_model_digikey} width="250px">3D model of the SOD-490 (SC-89-3) component package. Retrieved 2021-09-02, from https://www.digikey.co.nz/en/products/detail/onsemi/NTE4153NT1G/687079.</Image>
...
import sot_490_dimensions_vishay from './_assets/sot-490-dimensions-vishay.png'

<Image src={sot_490_dimensions_vishay} width="600px">Dimensions of the SOT-490 package from Vishay[^vishay-sot-490].</Image>
