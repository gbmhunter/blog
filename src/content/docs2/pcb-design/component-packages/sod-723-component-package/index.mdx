...
import sod_723_component_package_3d_render from './sod-723-component-package-3d-render.jpg'

<Image src={sod_723_component_package_3d_render} width="200px"></Image>
...
<Image src={sod_723_component_package_3d_render} width="300px">A 3D render of the SOD-723 component package.</Image>

## Dimensions

import package_sod_723_2d_dimensions from './package-sod-723-2d-dimensions.png'

<Image src={package_sod_723_2d_dimensions} width="500px">2D dimensions drawing of the SOD-723 package. Taken from the NXP SOD-723 datasheet (http://www.nxp.com/documents/outline_drawing/sod723_po.pdf).</Image>

## Land Pattern

import package_sod_723_recommended_land_pattern from './package-sod-723-recommended-land-pattern.png'

<Image src={package_sod_723_recommended_land_pattern} width="500px">The recommended PCB land pattern for the SOD-723 component package.</Image>
