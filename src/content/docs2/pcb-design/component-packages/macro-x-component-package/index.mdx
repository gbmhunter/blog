...
import mrf581 from './_assets/mrf581.png'

<Image src={mrf581} width="200px"></Image>
...
<Image src={mrf581} width="350px">Photo of the MRF581 RF NPN transistor in the Macro X component package.</Image>
