...
import melf_package_dimensions_diodes_inc from './_assets/melf-package-dimensions-diodes-inc.png'

<Image src={melf_package_dimensions_diodes_inc} width="800px">The dimensions of the MELF component package from Diodes Incorporated[^diodes-inc-melf].</Image>

## Recommended Land Pattern

Below is the recommended land pattern for the MELF package from Diodes Inc:

import melf_recommended_land_pattern_diodes_inc from './_assets/melf-recommended-land-pattern-diodes-inc.png'

<Image src={melf_recommended_land_pattern_diodes_inc} width="800px">The recommended land pattern for the MELF component package from Diodes Incorporated[^diodes-inc-melf].</Image>
