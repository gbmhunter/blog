...
import smc_do_214ab_component_package_3d_render from './_assets/smc-do-214ab-component-package-3d-render.jpg'

<Image src={smc_do_214ab_component_package_3d_render} width="200px">A 3D render of the SMC (DO-214AB) component package.</Image>
...
import component_package_smc_do_214ab_dimensions_and_land_pattern from './_assets/component-package-smc-do-214ab-dimensions-and-land-pattern.png'

<Image src={component_package_smc_do_214ab_dimensions_and_land_pattern} width="800px">Dimensions and recommended land pattern for the DO-214AB (SMC) component package. Image from Vishay Outline Dimensions: SMC (http://www.vishay.com/docs/95023/smc.pdf).</Image>
