...
import to_252_component_package_3d_render from './_assets/to-252-component-package-3d-render.jpg'

<Image src={to_252_component_package_3d_render} width="150px">A 3D render of the TO-252-3 (DPACK) component package.</Image>
...
<Image src={to_252_component_package_3d_render} width="300px">A 3D render of the TO-252-3 (DPACK) component package.</Image>
...
import to_252_5_p1_3d_model_diodes_inc from './_assets/to-252-5-p1-3d-model-diodes-inc.png'

<Image src={to_252_5_p1_3d_model_diodes_inc} width="400px">3D model of the TO-252-5-P1 package[^diodes-inc-to-252-5-p1].</Image>
...
import to_252_p1_package_dimensions_diode_inc from './_assets/to-252-p1-package-dimensions-diode-inc.png'

<Image src={to_252_p1_package_dimensions_diode_inc} width="600px">Dimensions of the TO-252-5-P1 package from Diodes Inc[^diodes-inc-to-252-5-p2-ds].</Image>

**Recommended Land Pattern**

The image below shows the recommended land pattern of the `TO-252-5-P1` package from Diodes Inc.

import to_252_p1_recommended_land_pattern_diode_inc from './_assets/to-252-p1-recommended-land-pattern-diode-inc.png'

<Image src={to_252_p1_recommended_land_pattern_diode_inc} width="600px">The recommended land pattern for the TO-252-5-P1 package from Diodes Inc[^diodes-inc-to-252-5-p2-ds].</Image>
...
import to_252_5_p2_3d_render_nisshinbo from './_assets/to-252-5-p2-3d-render-nisshinbo.png'

<Image src={to_252_5_p2_3d_render_nisshinbo} width="300px">A 3D render of the TO-252-5-P2 component package.[^nisshinbo-to-252-5-p2]</Image>

**Recommended Land Pattern**

The image below shows a recommended land pattern from Ricoh for the `TO-252-5-P2`.

import component_package_to_252_5_recommended_land_pattern from './_assets/component-package-to-252-5-recommended-land-pattern.png'

<Image src={component_package_to_252_5_recommended_land_pattern} width="500px">The recommended PCB land pattern for the TO-252-5 component package. Image from Ricoh TO-252 Package Information (http://www.ricoh.com/LSI/product_power/pkg/to-252-5-p2.pdf).</Image>
