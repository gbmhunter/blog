...
import confused_man_holding_ic_in_hand from './confused-man-holding-ic-in-hand.webp'

<Image src={confused_man_holding_ic_in_hand} width="250px"></Image>
...
import package_size_comparison_chart from './package-size-comparison-chart.svg'

<Image src={package_size_comparison_chart} width="900px">A package size comparison chart. When printed on A4 paper is has a 1:1 scale.</Image>
...
import sparkfun_break_out_board from './sparkfun-break-out-board.jpg'

<Image src={sparkfun_break_out_board} width="160px">A SOIC-8 to DIP break-out board made by SparkFun.</Image>
...
import aries_correct_a_chip_sot_23_6 from './aries-correct-a-chip-sot-23-6.png'

<Image src={aries_correct_a_chip_sot_23_6} width="250px">SOT-23-6 to DIP.</Image>

import aries_correct_a_chip_soic_16 from './aries-correct-a-chip-soic-16.png'

<Image src={aries_correct_a_chip_soic_16} width="250px">SOIC-16 to DIP. </Image>

import aries_correct_a_chip_qfp_64 from './aries-correct-a-chip-qfp-64.png'

<Image src={aries_correct_a_chip_qfp_64} width="250px">QFP-64 to PGA (dual-rowed DIP). </Image>
</div>
