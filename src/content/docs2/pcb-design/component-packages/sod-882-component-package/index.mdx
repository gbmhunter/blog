...
import sod_882_component_package_photo_nexperia from './sod-882-component-package-photo-nexperia.png'

<Image src={sod_882_component_package_photo_nexperia} width="300px"></Image>
