...
import do_41_component_package_photo from './_assets/do-41-component-package-photo.jpg'

<Image src={do_41_component_package_photo} width="300px">A photo of the DO-41 component package.</Image>
...
import do_41_package_dimensions_vishay from './_assets/do-41-package-dimensions-vishay.png'

<Image src={do_41_package_dimensions_vishay} width="500px">The dimensions for the DO-204AL (DO-41) component package from Vishay[^vishay-1n4001-ds].</Image>
