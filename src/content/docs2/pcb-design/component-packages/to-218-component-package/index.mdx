...
import to_218_package_dimensions_on_semi from './_assets/to-218-package-dimensions-on-semi.png'

<Image src={to_218_package_dimensions_on_semi} width="600px">Package dimensions of the TO-218 component package[^bib-on-semi-sot-93].</Image>
...
import to_218_single_lead_dimensions_fairchild_semiconductor from './_assets/to-218-single-lead-dimensions-fairchild-semiconductor.png'

<Image src={to_218_single_lead_dimensions_fairchild_semiconductor} width="800px">Dimensions for a single-lead TO-218 component package[^bib-fairchild-to-218-single-lead].</Image>
