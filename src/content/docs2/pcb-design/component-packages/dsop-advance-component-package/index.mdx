...
import dsop_advance_photo_top_and_bottom_business_wire from './_assets/dsop-advance-photo-top-and-bottom-business-wire.png'

<Image src={dsop_advance_photo_top_and_bottom_business_wire} width="300px">A photo of the top and bottom of the DSOP Advance component package. Image from Business Wire[^business-wire-dsop-advance].</Image>
...
import dsop_advance_component_package_dimensions from './_assets/dsop-advance-component-package-dimensions.png'

<Image src={dsop_advance_component_package_dimensions} width="900px">The dimensions for the DSOP Advance component package.</Image>

## Recommended Land Pattern

import dsop_advance_component_package_recommended_land_pattern from './_assets/dsop-advance-component-package-recommended-land-pattern.png'

<Image src={dsop_advance_component_package_recommended_land_pattern} width="350px">The recommended land pattern for the DSOP Advance component package.</Image>
