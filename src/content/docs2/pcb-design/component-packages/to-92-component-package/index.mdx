...
import to_92_3_component_package_3d_render from './_assets/to-92-3-component-package-3d-render.jpg'

<Image src={to_92_3_component_package_3d_render} width="292px">A 3D render of the TO-92-3 component package.</Image>
...
import to_226_component_package_3d_render from './_assets/to-226-component-package-3d-render.jpg'

<Image src={to_226_component_package_3d_render} width="407px">A 3D render of the TO-92/18 (TO-226AB) component package.</Image>
...
import package_to_92_3d_render_with_pin_numbering_v2 from './_assets/package-to-92-3d-render-with-pin-numbering-v2.png'

<Image src={package_to_92_3d_render_with_pin_numbering_v2} width="516px">A 3D render of the TO-92 component package with pin numbering.</Image>
...
import to_92_clip_on_heatsink_aavid_thermalloy_575200B00000G from './_assets/to-92-clip-on-heatsink-aavid-thermalloy-575200B00000G.png'

<Image src={to_92_clip_on_heatsink_aavid_thermalloy_575200B00000G} width="295px">The TO-92 clip-on heatsink by Aavid Thermalloy (part num. 575200B00000G).</Image>
