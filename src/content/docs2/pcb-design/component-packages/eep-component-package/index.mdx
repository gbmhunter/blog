...
import eep_component_package_photo from './_assets/eep-component-package-photo.png'

<Image src={eep_component_package_photo} width="384px">Photo of a DC/DC converter by Texas Instruments in an EEP package.</Image>

## Dimensions

import eep_dimensions from './_assets/eep-dimensions.png'

<Image src={eep_dimensions} width="500px">Dimensions of the EEP package.</Image>
