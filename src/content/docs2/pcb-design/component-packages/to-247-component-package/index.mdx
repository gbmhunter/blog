...
import irfp460_to_247 from './_assets/irfp460-to-247.jpg'

<Image src={irfp460_to_247} width="200px">Photo of the International Rectifier (now Vishay) IRFP460 N-channel power MOSFET in the TO-247AC component package.</Image>

import to_247ac_component_package_3d_render_infineon from './_assets/to-247ac-component-package-3d-render-infineon.jpg'

<Image src={to_247ac_component_package_3d_render_infineon} width="500px">3D render of the TO-247AC component package. Image from https://www.powerelectronictips.com/igbts-come-fully-isolated-247-package/, retrieved 2021-03-16.</Image>

import to_247ac_sod_429_component_package_dimensions from './_assets/to-247ac-sod-429-component-package-dimensions.png'

<Image src={to_247ac_sod_429_component_package_dimensions} width="800px">The dimensions for the TO-247AC (SOD-429) component package. Image from https://assets.nexperia.com/documents/package-information/SOT429.pdf, accessed 2021-03-16.</Image>
...
import to_247vs_to_247_plus_component_packages_infineon from './_assets/to-247vs-to-247-plus-component-packages-infineon.png'

<Image src={to_247vs_to_247_plus_component_packages_infineon} width="500px">Comparisons of the TO-247-3 and -4 to the TO-247PLUS variants[^bib-infineon-to247plus].</Image>
