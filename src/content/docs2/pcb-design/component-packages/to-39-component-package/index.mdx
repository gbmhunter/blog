...
import to_39_component_package_photo from './to-39-component-package-photo.jpg'

<Image src={to_39_component_package_photo} width="300px">A photo of the TO-39-3 component package.</Image>
...
import component_package_to_39_2_photo_with_window from './component-package-to-39-2-photo-with-window.jpg'

<Image src={component_package_to_39_2_photo_with_window} width="400px">A photo of the TO-39-2 component package.</Image>

## TO-39-3

import component_package_to_39_3_dimensions from './component-package-to-39-3-dimensions.png'

<Image src={component_package_to_39_3_dimensions} width="400px">Dimensions for the TO-39-3 component package.</Image>

import component_package_to_39_3_photo_with_window from './component-package-to-39-3-photo-with-window.jpg'

<Image src={component_package_to_39_3_photo_with_window} width="400px">A photo of a windowed component in the TO-39-3 component package.</Image>

import component_package_to_39_pcb_land_pattern from './component-package-to-39-pcb-land-pattern.png'

<Image src={component_package_to_39_pcb_land_pattern} width="400px">An example of a PCB land pattern for the TO-39-3 component package.</Image>

## TO-39-4

import component_package_to_39_4_dimensions from './component-package-to-39-4-dimensions.png'

<Image src={component_package_to_39_4_dimensions} width="400px">Dimensions for the TO-39-4 component package.</Image>

import component_package_to_39_4_photo_with_window from './component-package-to-39-4-photo-with-window.jpg'

<Image src={component_package_to_39_4_photo_with_window} width="400px">A photo of a TO-39-4 component package with window.</Image>

import component_package_to_39_mlx90614xci_dimensions from './component-package-to-39-mlx90614xci-dimensions.png'

<Image src={component_package_to_39_mlx90614xci_dimensions} width="400px">Package dimensions for the MLX90614XCI infrared thermometer. Image from melexis.com.</Image>

## TO-39 Ball Lens

Optan produces components which come in a TO-39 "Ball Lens" package.

import to_39_ball_lens_component_package_optan_3d_render from './to-39-ball-lens-component-package-optan-3d-render.png'

<Image src={to_39_ball_lens_component_package_optan_3d_render} width="400px">A 3D render of the TO-39 \"Ball Lens\" package by Optan[^bib-optan-products]. Image © 2021, Crystal IS, Inc.</Image>
