...
import msop_8_component_package_3d_model_with_exposed_pad from './_assets/msop-8-component-package-3d-model-with-exposed-pad.jpg'

<Image src={msop_8_component_package_3d_model_with_exposed_pad} width="200px">3D model of the MSOP-8 component package (with exposed pad).</Image>
...
import msop_8_component_package_dimensions from './_assets/msop-8-component-package-dimensions.png'

<Image src={msop_8_component_package_dimensions} width="800px">Package dimensions of the MSOP-8 component package (with exposed pad).</Image>
...
import msop_10_component_package_dimensions from './_assets/msop-10-component-package-dimensions.png'

<Image src={msop_10_component_package_dimensions} width="500px">Package dimensions of the MSOP-10 component package (with exposed pad).</Image>

### Footprint

import msop_10_component_package_recommend_land_pattern from './_assets/msop-10-component-package-recommend-land-pattern.gif'

<Image src={msop_10_component_package_recommend_land_pattern} width="500px">The footprint for the MSOP-10 component package.</Image>
