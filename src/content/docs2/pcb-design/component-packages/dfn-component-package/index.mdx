...
import son_6_component_package_3d_model from './_assets/son-6-component-package-3d-model.jpg'

<Image src={son_6_component_package_3d_model} width="150px">The 3D model of the DFN-6 component package.</Image>
...
import ap63356_dfn_pin_assignments from './_assets/ap63356-dfn-pin-assignments.png'

<Image src={ap63356_dfn_pin_assignments} width="300px">Outline of the V-DFN3020-13 package by Diodes Inc[^bib-diodes-inc-ap63356]. Notice the very un-standard pin geometries, which you'll see in some DFN packages.</Image>
...
import component_package_vdfpn8_mlp8_outline_dimensions from './_assets/component-package-vdfpn8-mlp8-outline-dimensions.png'

<Image src={component_package_vdfpn8_mlp8_outline_dimensions} width="500px">Outline and dimensions for the VDFPN8 (SON-8) component package of a Numonyx flash IC.Image from http://www.micron.com/~/media/Documents/Products/Data%20Sheet/NOR%20Flash/Serial%20NOR/M25P/M25P128.pdf.</Image>
...
<Image src={son_6_component_package_3d_model} width="300px">The 3D model of the DFN-6 component package.</Image>

import son_6_component_package_with_two_thermal_pads from './_assets/son-6-component-package-with-two-thermal-pads.jpg'

<Image src={son_6_component_package_with_two_thermal_pads} width="300px">The 3D model of the DFN-6 component package which has two thermal pads instead of one.</Image>

## DFN-8, 3x3mm

The DFN-8 3x3mm package is used for components such as linear regulators[^bib-st-ldk715-ds].

import son_8_component_package_3d_model from './_assets/son-8-component-package-3d-model.jpg'

<Image src={son_8_component_package_3d_model} width="400px">The 3D model of the DFN-8 component package.</Image>

import son_8_component_package_dimensions from './_assets/son-8-component-package-dimensions.png'

<Image src={son_8_component_package_dimensions} width="400px">The package dimensions of the DFN-8 component package.</Image>

import son_8_component_package_exposed_thermal_pad from './_assets/son-8-component-package-exposed-thermal-pad.png'

<Image src={son_8_component_package_exposed_thermal_pad} width="400px">The package dimensions of the DFN-8 component package with exposed thermal pad.</Image>

import son_8_component_package_land_pattern_and_thermal_properties from './_assets/son-8-component-package-land-pattern-and-thermal-properties.png'

<Image src={son_8_component_package_land_pattern_and_thermal_properties} width="400px">The recommended land pattern and thermal properties of the DFN-8 component package.</Image>

import son_8_component_package_ti_land_pattern from './_assets/son-8-component-package-ti-land-pattern.png'

<Image src={son_8_component_package_ti_land_pattern} width="400px">The recommended land pattern (from TI) of the DFN-8 component package.</Image>
...
import wson_component_package_height from './_assets/wson-component-package-height.png'

<Image src={wson_component_package_height} width="450px">An outline of the WSON component package showing it's height.</Image>

The VSON variant has a height of 1.00mm (max.)

import vson_component_package_height from './_assets/vson-component-package-height.png'

<Image src={vson_component_package_height} width="470px">An outline of the VSON component package showing it's height.</Image>
