...
import soic_8_component_package_dimensions from './_assets/soic-8-component-package-dimensions.png'

<Image src={soic_8_component_package_dimensions} width="555px">The dimensions for the SOIC-8N component package.</Image>

The dimensions for the `SOIC-16N` component package are shown below:

import soic_16_component_package_dimensions from './_assets/soic-16-component-package-dimensions.jpg'

<Image src={soic_16_component_package_dimensions} width="575px">The dimensions for the SOIC-16N component package.</Image>
...
import soic_8_component_package_sparkfun_breakout_board from './_assets/soic-8-component-package-sparkfun-breakout-board.jpg'

<Image src={soic_8_component_package_sparkfun_breakout_board} width="272px">A SOIC-8 to DIP-8-300 adapter PCB by SparkFun.</Image>
...
import maximum_power_dissapation_graphs_so_8 from './_assets/maximum-power-dissapation-graphs-so-8.png'

<Image src={maximum_power_dissapation_graphs_so_8} width="701px">Maximum power dissipation graphs for the SOIC-8N component package.</Image>
...
import soic_8_component_package_standard_mosfet_pinout from './_assets/soic-8-component-package-standard-mosfet-pinout.png'

<Image src={soic_8_component_package_standard_mosfet_pinout} width="334px">The standard pinout for a single MOSFET (N or P-channel) in a SOIC-8 package.</Image>
