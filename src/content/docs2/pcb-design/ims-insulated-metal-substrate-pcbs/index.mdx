...
<Image src={ims_pcb_aluminium_side_on_photo} width="346px">A side on photo of a IMS PCB with an aluminium base.</Image>
...
import ims_pcb_copper_clad_top_down_photo from './ims-pcb-copper-clad-top-down-photo.png'

<Image src={ims_pcb_copper_clad_top_down_photo} width="281px">Top-down photo of a IMS PCB for high-power LEDs.</Image>
...
import example_stack_up_of_single_sided_single_layered_ims_pcb from './example-stack-up-of-single-sided-single-layered-ims-pcb.png'

<Image src={example_stack_up_of_single_sided_single_layered_ims_pcb} width="407px">An example stack-up of a single-sided, single-layered IMS PCB.</Image>
...
import example_stack_up_of_single_sided_double_layered_ims_pcb from './example-stack-up-of-single-sided-double-layered-ims-pcb.png'

<Image src={example_stack_up_of_single_sided_double_layered_ims_pcb} width="388px">An example stack-up of a single-sided, double-layered IMS PCB.</Image>
