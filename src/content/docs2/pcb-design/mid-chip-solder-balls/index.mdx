...
import mid_chip_solder_ball_3d_render_henkel_electronics from './mid-chip-solder-ball-3d-render-henkel-electronics.png'

<Image src={mid_chip_solder_ball_3d_render_henkel_electronics} width="500px">A 3D render of a mid-chip solder ball.[^henkel-eliminating-mid-chip-solder-balls]</Image>
...
import solder_paste_aperture_designs from './solder-paste-aperture-designs.webp'

<Image src={solder_paste_aperture_designs} width="800px">Diagram showing the common aperture designs used to fix mid-chip solder balls. Diagram not to scale.</Image>
