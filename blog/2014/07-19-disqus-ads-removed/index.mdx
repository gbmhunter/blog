...
<Image src={require('./screenshot-with-disqus-ads-present.png').default} width="700px">Screenshot with disqus ads present.</Image>
...
<Image src={require('./disabling-disqus-ads-promoted-discovery-annotated.png').default} width="600px">Disabling disqus ads.</Image>

Now we are back to normal!

<Image src={require('./screenshot-with-disqus-ads-removed.png').default} width="700px">Screenshot with disqus ads removed.</Image>
