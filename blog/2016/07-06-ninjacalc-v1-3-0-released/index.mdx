...
<Image src={require('/images/2016/07/ninja-calc-crc-calculator-example.gif').default} width="1094px">Example usage of the CRC Calculator within NinjaCalc (http://gbmhunter.github.io/NinjaCalc/).</Image>
...
<Image src={require('/images/2016/04/ninja-calc-logo-v2-no-transparency.png').default} width="308px">The NinjaCalc logo (with no transparency).</Image>
