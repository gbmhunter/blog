...
<Image src={require('./_assets/ninja-calc-crc-calculator-example.gif').default} width="1094px">Example usage of the CRC Calculator within NinjaCalc (http://gbmhunter.github.io/NinjaCalc/).</Image>
