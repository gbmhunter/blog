...
* New [Humidity Sensors page.](/electronics/components/sensors/humidity-sensors)
    ...
    <Image src={require('/images/2016/03/magnus-equation-humidity-temperature-and-dew-point.png').default} width="637px">A screenshot of the Magnus equation, which calculates the dew point from the relative humidity and temperature.</Image>
...
* New [Bit Masking page](/programming/languages/c/bit-fields-and-bit-manipulation-masking) under Programming->Languages->C.  
    ...
    <Image src={require('/images/2016/03/binary-sparse-matrix-style.jpg').default} width="500px"></Image>
