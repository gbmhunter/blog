...
* Added information about [multiple-collector and multiple-emitter BJTs](/electronics/components/transistors/bipolar-junction-transistors-bjts#multiple-collector-and-multiple-emitter-bjts).
    ...
    <Image src={require('/images/2015/08/basic-two-input-tll-nand-gate-schematic.png').default} width="499px">The schematic of a basic two-input TTL NAND gate.</Image>
...
* Added new info on [NTC thermistor temperature sensing](/electronics/components/sensors/temperature-sensors/) with information on PTC and NTC thermistors, including how to connect them up to a microcontroller for temperature measurements.
    ...
    <Image src={require('/images/2016/05/screenshot-of-ntc-thermistor-page.png').default} width="529px">A screenshot of the NTC thermistor page.</Image>
...
* New information about the common-collector BJT amplifier.
    ...
    <Image src={require('/images/2015/08/basic-common-collector-bjt-amplifier-schematic.png').default} width="517px">The basic schematic of a common-collector BJT amplifier.</Image>including simulation results...

    <Image src={require('/images/2015/08/vout-vs-vin-basic-common-collector-bjt-amplifier-v2.png').default} width="1418px">Vout vs. Vin for a basic common-collector BJT amplifier.</Image>
...
* Information added about making [constant-current LED drivers using BJTs](/electronics/components/transistors/bipolar-junction-transistors-bjts#constant-current-sink).
      ...
      <Image src={require('/images/2015/08/constant-current-bjt-based-led-driver.png').default} width="465px">The simulation schematic for a constant-current BJT-based LED driver.</Image>