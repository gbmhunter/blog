...
* Fixed three issues preventing me from upgrading from Hugo `v0.54.0` to `v0.60.1`, and then upgraded! The two issues were:
    ...
    * Hugo would timeout with the following error:
        ...
        <Image src={require('./screenshot-columbus-radio-directory.png').default} width="500px">A screenshot showing the number of image resources in the `columbus-radio` page.</Image>
