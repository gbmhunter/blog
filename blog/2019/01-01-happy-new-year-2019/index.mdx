...
<Image src={require('./colorful-happy-new-year-2019-vector.jpg').default} width="800px">Happy new year! Image from www.vecteezy.com.</Image>
...
<Image src={require('./google-analytics-2018-mbedded-ninja-users.png').default} width="800px">Number of users per week for the 2018 year. Image from Google Analytics.</Image>
