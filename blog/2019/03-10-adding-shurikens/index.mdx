...
<Image src={require('./shuriken-icon.png').default} width="100px">+1's, likes, thumb's up and claps have been done before, this blog uses shurikens!</Image>
...
<Image src={require('./shuriken.gif').default} width="700px">Demo of the shurikens.</Image>
...
<Image src={require('./travis-ci-secret-environment-variables.png').default} width="700px">The settings page for the CICD setup on TravisCI.</Image>
...
<Image src={require('./removing-disqus-reactions.png').default} width="700px">Saying goodbye to the Disqus reactions.</Image>
