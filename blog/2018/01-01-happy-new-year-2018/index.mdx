...
<Image src={require('/images/2018/01/happy-new-year-2018.jpg').default} width="700px"></Image>
...
<Image src={require('/images/2018/01/mbedded-ninja-2017-statistics-visitors-by-country.png').default} width="250px">The number of visitors to blog.mbedded.ninja in the year 2017, sorted by country.</Image>
...
<Image src={require('/images/2018/01/mbedded-ninja-visitor-stats-2017-screenshot-annotated.png').default} width="800px">Visitor stats for mbedded.ninja in 2017, highlighting the drop in visits when the blog was moved from www.mbedded.ninja to blog.mbedded.ninja in March 2017.</Image>
