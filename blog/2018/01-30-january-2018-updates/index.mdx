...
* New [apt page](/programming/operating-systems/linux/programs/apt) under Programming->Operating Systems->Linux->Programs.  
    ...
    <Image src={require('/images/2018/02/sudo-apt-install-icon.png').default} width="400px"></Image>

* New [Anaconda page](/programming/languages/python/anaconda) under Programming->Languages->Python.

    <Image src={require('/images/2018/02/anaconda-python-logo.png').default} width="400px">The logo for Anaconda (Python distribution/environment).</Image>
