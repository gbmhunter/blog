...
* New [apt page](/programming/operating-systems/linux/programs/apt) under Programming->Operating Systems->Linux->Programs.  
    ...
    <Image src={require('./_assets/sudo-apt-install-icon.png').default} width="400px"></Image>

* New [Anaconda page](/programming/languages/python/anaconda) under Programming->Languages->Python.

    <Image src={require('./_assets/anaconda-python-logo.png').default} width="400px">The logo for Anaconda (Python distribution/environment).</Image>
