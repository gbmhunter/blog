...
<Image src={require('/images/2018/02/ninja-calc-two-coordinate-geodesics-calculator-screenshot.png').default} width="450px">A screenshot of the 'Two Coordinate Geodesics' calculator in NinjaCalc.</Image>
