...
<Image src={require('./_assets/ninja-calc-two-coordinate-geodesics-calculator-screenshot.png').default} width="450px">A screenshot of the 'Two Coordinate Geodesics' calculator in NinjaCalc.</Image>
