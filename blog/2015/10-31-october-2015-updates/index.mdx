...
* Moved all of the Atmel microcontroller pages under a new [Atmel parent page](/programming/microcontrollers/atmel).  
    ...
    <Image src={require('./_assets/atmel-avr-at32-3d-render-of-ic-www-teckhat-com.gif').default} width="259px">A 3D render of the AT32UC3L, an Atmel AVR AT32 microcontroller. Image from http://teckhat.com/.</Image>  
...
* New [PCB Surface Finishes page](/pcb-design/pcb-surface-finishes) under PCB Design.  
    ...
    <Image src={require('./_assets/pcb-surface-finish-immersion-silver.jpg').default} width="355px">Example of an immersion silver (IAg) PCB finish. Image from http://www.rlcinnovation.com/.</Image>  
...
* New [SOT-346 Component Package page](/pcb-design/component-packages/sot-346-component-package).  
    ...
    <Image src={require('./_assets/sot-346-sc-59a-component-package-3d-render.jpg').default} width="354px">A 3D render of the SOT-346 (SC-59A) component package.</Image>  
...
* New [Testpoints page](/pcb-design/testpoints) under [PCB Design](/pcb-design).  
    ...
    <Image src={require('./_assets/keystone-minature-smd-testpoint.jpg').default} width="275px">A miniature SMD testpoint made by Keystone.</Image>  
