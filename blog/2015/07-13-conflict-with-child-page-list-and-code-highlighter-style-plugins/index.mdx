...
<Image src={require('./_assets/sb-child-list-plugin-bug-code-displaying-correctly.png').default} width="508px">Code displaying correctly.</Image>

I was left with Crayon shortcodes in the form

<Image src={require('./_assets/sb-child-list-plugin-bug-code-displaying-incorrectly.png').default} width="379px">Code displaying incorrectly because of a bug with the SB Child List plugin.</Image>
