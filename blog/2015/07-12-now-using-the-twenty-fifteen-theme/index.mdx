...
<Image src={require('./_assets/screenshot-of-mbedded-ninja-home-page-with-twenty-fifteen-theme.png').default} width="1000px">A screenshot of mbedded-ninja's home page with the new twentyfifteen theme.</Image>

<Image src={require('./_assets/just-some-of-avadas-menu-structure.png').default} width="182px">Just some of Avada's complex, deeply-nested and non-intuitive menu structure.</Image>
