...
* Information on [Aspect Ratios added to the Pads, Vias and Holes page](/pcb-design/pads-vias-holes#aspect-ratios).  
    ...
    <Image src={require('./_assets/aspect-ratio-page-screenshot.png').default} width="312px">A screenshot of the aspect ratio information added the 'Pads, Vias And Holes' page as part of the PCB design section.</Image>  
...
* New [FPGAs sub-section](/electronics/components/fpgas) under Electronics->Components.  
    ...
    <Image src={require('./_assets/fpga-schematic-just-the-ic-no-routing.png').default} width="590px">An A3 schematic sheet with just one 236-pin FPGA IC added to it (no routing).</Image>  
