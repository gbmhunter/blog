...
* New [GCC Bugs page](/programming/compilers/gcc/gcc-bugs) under Programming->Compilers->GCC.  
    ...
    <Image src={require('./_assets/gcc-compiler-logo.png').default} width="151px">The GCC logo.</Image>
...
* Updates to the [Assembly page](/programming/languages/assembly).  
    ...
    <Image src={require('./_assets/assembly-programming-language-icon.png').default} width="500px"></Image>

* New [Perlin Noise page](/mathematics/perlin-noise) under Mathematics.  

    <Image src={require('./_assets/perlin-noise-cloud-example.png').default} width="374px">Rendered Perlin noise that has been configured to make realistic looking clouds.</Image>