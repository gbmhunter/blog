...
* New [LVDS (Low-Voltage Differential Signalling) page](/electronics/communication-protocols/lvds-low-voltage-differential-signalling) under Electronics->Communication Protocols.  
    ...
    <Image src={require('/images/2017/08/lvds-multipoint-configuration-example-schematic-ti.png').default} width="558px">Example schematics showing LVDS devices in a multipoint configuration. Image from www.ti.com.</Image>
...
* Added a "Posted" and "Last modified" metric to every post/page. This should help readers determine the age and relevance of the information on a particular page.  
    ...
    <Image src={require('/images/2017/09/posted-and-last-updated-time-dates-on-pages.png').default} width="471px">Screenshot of the 'Posted' and 'Last Updated' date times now shown on all pages and posts.</Image>

* Added the lightbox effect to all single images on posts/pages.  

    <Image src={require('/images/2017/09/screenshot-of-the-lightbox-effect-added-to-images.png').default} width="251px">Screenshot of the lightbox effect added to images on blog.mbedded.ninja.</Image>

* New [Magic Statics page](/programming/languages/c-plus-plus/magic-statics) under Programming->Programming Languages->C++.  

    <Image src={require('/images/2017/08/magic-statics-icon-bunny-hat-code.png').default} width="400px"></Image>
