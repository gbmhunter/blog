...
<Image src={require('./_assets/ninja-calc-v2.2.0-screenshot-calc-selection-page.png').default} width="1920px">NinjaCalc is now a web app! A screenshot while selecting a calculator using the new web app at https://ninjacalc.mbedded.ninja/calculators/electronics/cabling/wire-gauge-calculator.</Image>
