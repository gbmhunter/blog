...
<Image src={require('./psoc-building-block-image.jpg').default} width="320px">Image from the PSoC website.</Image>

<Image src={require('./mercurial-logo.png').default} width="320px">Mercurials logo.</Image>
