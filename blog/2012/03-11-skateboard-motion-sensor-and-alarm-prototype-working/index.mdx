...
<Image src={require('./2012-03-04-21-17-27.jpg').default} width="250px">The MS24 motion sensor (works in any direction, unlike most tilt sensors).</Image>
...
<Image src={require('./2012-03-08-21-36-21.jpg').default} width="250px"></Image>
...
<Image src={require('./2012-03-08-21-37-14.jpg').default} width="250px">The BJT full-bridge used to drive the alarm speaker.</Image>
