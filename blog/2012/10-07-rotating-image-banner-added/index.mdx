...
<Image src={require('./screenshot-of-banner-added-to-cladlabs.jpg').default} width="600px">Screenshot of the rotating banner added to the CladLabs website.</Image>
