...
<Image src={require('./calculator.jpg').default} width="320px">A calculator?!?. Yes.</Image>
...
<Image src={require('./ohms-law-calculator-screenshot.png').default} width="500px">A screen-shot of the Ohm's law calculator on the Resistors page.</Image>
