...
<Image src={require('./_assets/03-anchor-holes-and-disk.jpg').default} width="400px"></Image>

<Image src={require('./_assets/15-knsu-propellant-in-mould.jpg').default} width="400px"></Image>

<Image src={require('./_assets/27-end-of-rocket-with-ignitor.jpg').default} width="400px"></Image>
