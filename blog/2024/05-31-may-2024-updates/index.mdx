...
<Image src={require('./_assets/ninjaterm-number-types-screenshot.jpg').default} width="600px"></Image>
...
<Image src={require('./_assets/ninjaterm-macros-screenshot.png').default} width="900px"></Image>

You now have the ability to select the flow-control method (none or hardware) when opening a serial port:

<Image src={require('./_assets/ninjaterm-flow-control-screenshot.png').default} width="700px"></Image>

NinjaTerm has a new profiles feature which lets you save and load different serial port configurations.

<Image src={require('./_assets/ninjaterm-profiles-screenshot.jpg').default} width="900px"></Image>
