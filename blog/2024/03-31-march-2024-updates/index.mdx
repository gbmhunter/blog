...
<Image src={require('./_assets/ninjaterm-v4.13.0-release-notes.png').default} width="600px"></Image>
...
<Image src={require('./_assets/umami-dashboard-showing-analytics-for-blog.png').default} width="600px"></Image>
...
<Image src={require('./_assets/running-umami-on-lightsail-screenshot.png').default} width="600px"></Image>

Added info on [C compile-time asserts()](/programming/languages/c/assertions-assert/).

<Image src={require('./_assets/compile-time-asserts-screenshot.png').default} width="600px"></Image>
