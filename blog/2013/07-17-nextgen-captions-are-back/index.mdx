...
<Image src={require('./keep-calm-and-be-welcome-back.png').default} width="400px">Image from http://www.keepcalm-o-matic.co.uk/p/keep-calm-and-be-welcome-back/.</Image>
