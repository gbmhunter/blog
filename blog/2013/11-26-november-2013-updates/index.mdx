...
* [candy-calc firmware project](https://github.com/gbmhunter/candy-calc) has been started on GitHub. I am hoping to eventually convert all calculators on this site to use this framework.  
  	...
  	<Image src={require('./candy-calc-readme-screenshot.jpg').default} width="500px">A screenshot of the candy-calc repo on GitHub.</Image>
...
* LT3745 Design Guide page (**as of Dec 2017, URL not available**) and calculator using the [candy-calc](https://github.com/gbmhunter/candy-calc) framework  
  	...
  	<Image src={require('./lt3745-calculator-screenshot.jpg').default} width="500px">A screenshot of the calculator on the LT3745 Design Guide page.</Image>
...
* Info on ~LED lens types~.
    ...
    <Image src={require('./led-lens-shapes-screenshot.jpg').default} width="400px">A screenshot of the calculator on the LT3745 Design Guide page.</Image>
...
* New page on [Antenna Design](/electronics/circuit-design/antenna-design), incorporating the use of [Google Charts](https://developers.google.com/chart/)
  	...
  	<Image src={require('./antenna-page-screenshot.jpg').default} width="500px">A screenshot of the Antenna page.</Image>
