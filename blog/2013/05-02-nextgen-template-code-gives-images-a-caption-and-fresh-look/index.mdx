...
<Image src={require('./cladlab-nextgen-custom-template-image-code-working.png').default} width="500px">When the NextGEN custom template code works!</Image>
...
<Image src={require('./image-before-nextgen-caption-and-border-template-for-singlepic-added.png').default} width="500px">What images used to look like before the NextGEN caption and border template was added.</Image>

But...it's not perfect...yet. As you can see below, in certain situations the images to go crazy.

<Image src={require('./cladlab-nextgen-custom-template-image-code-not-fully-working.png').default} width="650px">When the NextGEN custom template code isn't working correctly, this happens.</Image>
