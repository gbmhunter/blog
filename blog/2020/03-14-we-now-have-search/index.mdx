...
<Image src={require('./example-of-search-in-blog.gif').default} width="800px">A demo of the new search functionality added for blog.mbedded.ninja.</Image>
...
<Image src={require('./search-dictionary-download-speed.png').default} width="700px">The Network panel of the Chrome Developer Tools showing the time it takes to download the site's search dictionary (index.json) to the clients browser.</Image>
