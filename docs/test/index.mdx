...
<Image src={require('./_assets/cartoon-ninja.jpg').default} width="300px">This should be an clickable image of the logo. **Bold text**. An equation: $x^2$. There should be a footnote number at the end of this sentence[^foot-1].</Image>
...
<Image src={require('./_assets/test-image-1000px.webp').default} width="2000">A larger test image. Make the screen width small and make sure this image does not exceed 100% page width.</Image>
