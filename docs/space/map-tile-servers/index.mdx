...
<Image src={require('./map-tile-s2-2018-epsg3857-1-1-1.png').default} width="400px">The tile returned from a Web Map Tile Service (WMTS) at the URL https://tiles.maps.eox.at/wmts/1.0.0/s2cloudless-2017_3857/default/g/1/1/1.jpg</Image>
