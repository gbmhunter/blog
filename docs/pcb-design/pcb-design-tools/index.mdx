...
<Image src={require('./saturn-pcb-toolkit-screenshot.gif').default} width="500px">A screen-shot of the Saturn PCB toolkit.</Image>
...
<Image src={require('./resistor-calculator-screenshot.jpg').default} width="500px">Screenshot of the resistor calculator.</Image>
