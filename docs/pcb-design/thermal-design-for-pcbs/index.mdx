...
<Image src={require('./basic-thermal-resistance-principle.svg').default} width="300px">The basic principle behind thermal resistance. Note the similarity to Ohm's law.</Image>
...
<Image src={require('./ic-temperature-diagram-with-junction-case-ambient.svg').default} width="800px">A diagram of the different temperature points used when defining thermal resistances for ICs mounted on PCBs.</Image>
...
<Image src={require('./thermal-resistance-vs-pressure-tim-t-global-tg-a1250.png').default} width="600px">The relationship between pressure and thermal resistance for a silicon TIM from T-Global Technology (TG-A1250). Image acquired 2020-08-14 from http://www.tglobaltechnology.com/uploads/files/tds/TG-A1250.pdf.</Image>
