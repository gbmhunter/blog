...
<Image src={require('./soldermask-example-stainless-steel-soldermask-dot-com.jpg').default} width="300px">An example of a stainless steel soldermask stencil. Image from http://www.soldermask.com/.</Image>
...
<Image src={require('./pcb-stencil-aspect-and-area-ratio-illustration.png').default} width="800px">Diagram explaining the aspect and area ratios of PCB stencils. Image from http://www.ti.com/lit/an/slua271a/slua271a.pdf.</Image>
