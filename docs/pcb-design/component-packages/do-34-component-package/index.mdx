...
<Image src={require('./_assets/sod-27-do-34-package-photo.png').default} width="300px">A photo of a SOD-27 (DO-34) package from a Nexperia product page on Farnell[^farnell-nexperia-nzx20b133].</Image>
...
<Image src={require('./_assets/nxp-sod-27-do-34-package-dimensions.png').default} width="900px">The dimensions for the NXP SOD-27 (DO-34) package[^nxp-sod-27-package-info].</Image>
