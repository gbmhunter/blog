...
<Image src={require('./_assets/son-6-component-package-3d-model.jpg').default} width="150px">The 3D model of the DFN-6 component package.</Image>
...
<Image src={require('./_assets/ap63356-dfn-pin-assignments.png').default} width="300px">Outline of the V-DFN3020-13 package by Diodes Inc[^bib-diodes-inc-ap63356]. Notice the very un-standard pin geometries, which you'll see in some DFN packages.</Image>
...
<Image src={require('./_assets/component-package-vdfpn8-mlp8-outline-dimensions.png').default} width="500px">Outline and dimensions for the VDFPN8 (SON-8) component package of a Numonyx flash IC.Image from http://www.micron.com/~/media/Documents/Products/Data%20Sheet/NOR%20Flash/Serial%20NOR/M25P/M25P128.pdf.</Image>
...
<Image src={require('./_assets/son-6-component-package-3d-model.jpg').default} width="300px">The 3D model of the DFN-6 component package.</Image>

<Image src={require('./_assets/son-6-component-package-with-two-thermal-pads.jpg').default} width="300px">The 3D model of the DFN-6 component package which has two thermal pads instead of one.</Image>

## DFN-8, 3x3mm

The DFN-8 3x3mm package is used for components such as linear regulators[^bib-st-ldk715-ds].

<Image src={require('./_assets/son-8-component-package-3d-model.jpg').default} width="400px">The 3D model of the DFN-8 component package.</Image>

<Image src={require('./_assets/son-8-component-package-dimensions.png').default} width="400px">The package dimensions of the DFN-8 component package.</Image>

<Image src={require('./_assets/son-8-component-package-exposed-thermal-pad.png').default} width="400px">The package dimensions of the DFN-8 component package with exposed thermal pad.</Image>

<Image src={require('./_assets/son-8-component-package-land-pattern-and-thermal-properties.png').default} width="400px">The recommended land pattern and thermal properties of the DFN-8 component package.</Image>

<Image src={require('./_assets/son-8-component-package-ti-land-pattern.png').default} width="400px">The recommended land pattern (from TI) of the DFN-8 component package.</Image>
...
<Image src={require('./_assets/wson-component-package-height.png').default} width="450px">An outline of the WSON component package showing it's height.</Image>

The VSON variant has a height of 1.00mm (max.)

<Image src={require('./_assets/vson-component-package-height.png').default} width="470px">An outline of the VSON component package showing it's height.</Image>
