...
<Image src={require('./snaphat-component-package-photo.png').default} width="340px">A photo of the SNAPHAT component package.</Image>

## Dimensions

<Image src={require('./component-package-snaphat-dimensions.png').default} width="600px">The dimensions for the SnapHat component package.</Image>

## Typical Pin Connections

<Image src={require('./component-package-snaphat-schematic.png').default} width="400px">The schematic for the SnapHat component package.</Image>