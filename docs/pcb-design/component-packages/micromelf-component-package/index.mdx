...
<Image src={require('./_assets/micro-melf-component-package-photo.jpg').default} width="300px">A photo of the Micro-MELF component package.</Image>
...
<Image src={require('./_assets/component-package-micro-melf-dimensions-and-land-pattern.png').default} width="800px">The dimensions and recommended land pattern for the Vishay MicroMELF component package[^vishay-smm0102-thin-film-micromelf-resistors].</Image>
