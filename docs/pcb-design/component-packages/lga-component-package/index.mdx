...
<Image src={require('./_assets/lga-component-package-3d-render.jpg').default} width="350px">A 3D render of an LGA component package.</Image>
...
<Image src={require('./_assets/lga-775-component-package-socket.jpg').default} width="500px">Socket for the LGA-775 component package.</Image>
