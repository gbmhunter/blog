...
<Image src={require('./_assets/sot-723-component-package-3d-render.jpg').default} width="200px">A 3D render of the SOT-723 component package.</Image>
...
<Image src={require('./_assets/sot-723-component-package-dimensions-and-footprint.png').default} width="686px">Dimensions and a recommended footprint for the SOT-723 component package. Image from http://www.onsemi.com/pub_link/Collateral/ESD7C3.3D-D.PDF.</Image>
...
<Image src={require('./_assets/sot-723-recommended-land-pattern-onsemi.png').default} width="800px">The recommended land pattern for the SOT-723 component package from onsemi[^onsemi-esd7c-szesd7c-series-esd-diode].</Image>
