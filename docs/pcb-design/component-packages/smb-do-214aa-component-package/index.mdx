...
<Image src={require('./_assets/component-package-do214aa-smb-back-and-front-image.jpg').default} width="700px">A front and back photo of the DO-214AA (SMB) diode component package.</Image>
...
<Image src={require('./_assets/smb-do-214aa-component-package-3d-render.jpg').default} width="366px">A 3D render of the SMB (DO-214AA) component package.</Image>

## Images

<Image src={require('./_assets/component-package-do214aa-smb-dimensions-and-land-pattern.gif').default} width="700px">The dimensions and recommended land pattern for the DO-214AA (SMB) diode component package.</Image>
