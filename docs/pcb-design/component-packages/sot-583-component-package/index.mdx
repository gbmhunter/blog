...
<Image src={require('./_assets/sot-583-component-package-3d-render-ti.png').default} width="200px">A 3D render of the SOT-583 component package from Texas Instruments[^ti-tps628512-product-page].</Image>
...
<Image src={require('./_assets/sot-583-component-package-dimensions-ti.png').default} width="500px">The dimensions of the SOT-583 component package from TI. Image from https://www.ti.com/lit/ml/mpcs002/mpcs002.pdf.</Image>

## Recommended Footprint

<Image src={require('./_assets/sot-583-component-package-recommended-footprint.png').default} width="500px">The recommended footprint for the SOT-583 component package by TI. Image from https://www.ti.com/lit/ml/mpcs002/mpcs002.pdf.</Image>
