...
<Image src={require('./_assets/sot-416-3d-render-rohm.png').default} width="300px">A 3D render of the SOT-416 component package by Rohm Semiconductor[^rs-dtd523ye3tl-npn-transistor].</Image>
...
<Image src={require('./_assets/sot-416-dimensions-toshiba.png').default} width="500px">Dimensions from Toshiba for the SOT-416 component package[^toshiba-sot-416].</Image>

### Recommended Land Pattern

The image below shows the recommended land pattern from Toshiba for the `SOT-416`.

<Image src={require('./_assets/sot-416-recommended-land-pattern-toshiba.png').default} width="300px">The recommended land pattern from Toshiba for the SOT-416 package[^toshiba-sot-416].</Image>
...
<Image src={require('./_assets/sot-416fl-3d-render-snapeda.jpg').default} width="250px">A 3D render of the SOT-416FL from SnapEDA[^snapeda-dtc143zebtl-bjt].</Image>
...
<Image src={require('./_assets/sot-416fl-dimensions-rohm.png').default} width="600px">Dimensions of the SOT-416FL package from Rohm Semiconductor[^rohm-rb715wm-schottky-barrier-diode-ds].</Image>

### Recommended Land Pattern

The image below shows the recommended land pattern from Rohm Semiconductor for their `SOT-416FL` package.

<Image src={require('./_assets/sot-416fl-recommended-land-pattern-rohm.png').default} width="400px">The recommended land pattern from Rohm for the SOT-416FL package[^rohm-rb715wm-schottky-barrier-diode-ds].</Image>
