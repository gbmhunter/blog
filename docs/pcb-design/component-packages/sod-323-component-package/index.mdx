...
<Image src={require('./_assets/sod-323-sc-76-component-package-3d-render.jpg').default} width="200px"></Image>
...
<Image src={require('./_assets/sod-323-sc-76-component-package-3d-render.jpg').default} width="200px">3D model of the `SOD-323` component package.</Image>
...
<Image src={require('./_assets/sod-323-package-dimensions-nxp.png').default} width="700px">Dimensions for the `SOD-323` component package[^bib-nxp-sod323-ds].</Image>
...
<Image src={require('./_assets/sod-323f-3d-render-nexperia.png').default} width="300px">3D render of the `SOD-323F` component package[^bib-nexperia-sod-323f].</Image>

<Image src={require('./_assets/sod-323f-package-dimensions-diodes-inc.png').default} width="700px">Package dimensions of the `SOD-323F` component package[^bib-diodes-inc-sod-323f].</Image>
...
<Image src={require('./_assets/sod-323fl-component-package-dimensions-central-semiconductor.png').default} width="700px">Package dimensions of the Central Semiconductor `SOD-323FL` component package[^bib-central-semi-sod-323fl].</Image>

<Image src={require('./_assets/sod-323fl-land-pattern-central-semiconductor.png').default} width="700px">Recommended land pattern for the Central Semiconductor `SOD-323FL` component package[^bib-central-semi-sod-323fl].</Image>
...
<Image src={require('./_assets/sod-323he-3d-model-rohm.png').default} width="300px">3D model of the SOD-323HE component package[^bib-rohm-rb558vam150-ds].</Image>

<Image src={require('./_assets/sod-323he-package-dimensions-rohm.png').default} width="600px">Package dimensions of the SOD-323HE component package[^bib-rohm-rb558vam150-ds].</Image>
