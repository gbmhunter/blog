...
<Image src={require('./_assets/sit1532ai-j4-dcc-32.768e-1.5x0.8mm-4-bga-package-3d-render.png').default} width="300px">3D render of the SiTIME SIT1532AI-J4-DCC-32.768E in the 1.5x0.8mm CSP BGA package[^element14-sit1532ai-j4-dcc-32.768e].</Image>
...
<Image src={require('./_assets/abm3b-8.000mhz-10-1-u-t-crystal-3.2x2.5mm-package-render.png').default} width="300px">3D render of the Abracon ABM3B-8.000MHZ-10-1-U-T in the 3.2x2.5mm SMD crystal package[^element14-abm3b-8.000mhz-10-1-u-t].</Image>
...
<Image src={require('./_assets/abracon-ax3dbf1-125.0000t-crystal-package-dimensions.png').default} width="600px">Package dimensions of the Abracon AX3DBF1-125.0000T SMD crystal, in a 3.2x2.5x1.0mm form factor. Image retrieved 2021-09-07, from https://nz.mouser.com/datasheet/2/3/AX3-1578477.pdf.</Image> 
...
<Image src={require('./_assets/7x5mm-4lead-euroquartz-smd-crystal-smd-package-photo.png').default} width="400px">Photo of the EUROQUARTZ 10.000MHZ MQ/30/30/40/12PF crystal in a 7x5mm SMD package[^element14-10.000mhz-mq-30-30-40-12pf].</Image>

This is a common larger SMD package for crystals. There is also a 2-Lead package with the same outer dimensions.

<Image src={require('./_assets/7x5mm-4lead-euroquartz-smd-crystal-smd-package-dimensions.png').default} width="400px">Package dimensions of the EUROQUARTZ 10.000MHZ MQ/30/30/40/12PF crystal in a 7x5mm SMD package[^element14-10.000mhz-mq-30-30-40-12pf].</Image>

## Through-Hole Crystal Packages

Radial 6.2x2.1mm

<Image src={require('./_assets/raltron-r26-32.768-6-crystal-package-6.2x2.1mm-photo.png').default} width="300px">Photo of a Raltron R26-32.768-6 32.678kHz crystal in a 6.2x2.1mm radial package. Image retrieved 2021-09-11, from https://nz.element14.com/raltron/r26-32-768-6/crystal-32-768khz-6pf-6-2-x-2/dp/2982324.</Image>
