...
<Image src={require('./_assets/tssop-38-component-package-3d-render.jpg').default} width="300px">A 3D render of the TSSOP-38 component package.</Image>
...
<Image src={require('./_assets/htssop-28-component-package-3d-render-with-thermal-pad.jpg').default} width="320px">A 3D render of the 28-pin TSSOP component package that has a thermal pad (HTSSOP-28).</Image>
