...
<Image src={require('./_assets/mrf581.png').default} width="200px"></Image>
...
<Image src={require('./_assets/mrf581.png').default} width="350px">Photo of the MRF581 RF NPN transistor in the Macro X component package.</Image>
