...
<Image src={require('./confused-man-holding-ic-in-hand.webp').default} width="250px"></Image>
...
<Image src={require('./package-size-comparison-chart.svg').default} width="900px">A package size comparison chart. When printed on A4 paper is has a 1:1 scale.</Image>
...
<Image src={require('./sparkfun-break-out-board.jpg').default} width="160px">A SOIC-8 to DIP break-out board made by SparkFun.</Image>
...
<Image src={require('./aries-correct-a-chip-sot-23-6.png').default} width="250px">SOT-23-6 to DIP.</Image>

<Image src={require('./aries-correct-a-chip-soic-16.png').default} width="250px">SOIC-16 to DIP. </Image>

<Image src={require('./aries-correct-a-chip-qfp-64.png').default} width="250px">QFP-64 to PGA (dual-rowed DIP). </Image>
</div>
