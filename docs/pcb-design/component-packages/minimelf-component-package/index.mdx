...
<Image src={require('./_assets/mini-melf-sod-80-do-213aa-component-package-photo.jpg').default} width="100px">Mini-MELF (SOD-80, DO-213AA).</Image>

<Image src={require('./_assets/mini-melf-sod-80-do-213aa-component-package-photo.jpg').default} width="300px">A photo of the Mini-MELF (SOD-80, DO-213AA) component package.</Image>
...
<Image src={require('./_assets/component-package-sod-80-dimensions-and-land-pattern.gif').default} width="500px">Image from http://www.topline.tv/drawings/images/MELF_Diodes/SOD80.gif.</Image>
