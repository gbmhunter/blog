...
<Image src={require('./_assets/sod-128-component-package-3d-render.jpg').default} width="150px"></Image>
...
<Image src={require('./_assets/sod-128-component-package-3d-render.jpg').default} width="300">A 3D render of the SOD-128 component package.</Image>
...
<Image src={require('./_assets/sod128-package-outline.jpg').default} width="900">The package outline for the SOD-128 component package.</Image>

## Recommended Land Pattern

<Image src={require('./_assets/sod128-recommended-land-pattern.jpg').default} width="900">The recommended land pattern for the SOD-128 component package.</Image>
