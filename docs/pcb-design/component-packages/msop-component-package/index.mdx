...
<Image src={require('./_assets/msop-8-component-package-3d-model-with-exposed-pad.jpg').default} width="200px">3D model of the MSOP-8 component package (with exposed pad).</Image>
...
<Image src={require('./_assets/msop-8-component-package-dimensions.png').default} width="800px">Package dimensions of the MSOP-8 component package (with exposed pad).</Image>
...
<Image src={require('./_assets/msop-10-component-package-dimensions.png').default} width="500px">Package dimensions of the MSOP-10 component package (with exposed pad).</Image>

### Footprint

<Image src={require('./_assets/msop-10-component-package-recommend-land-pattern.gif').default} width="500px">The footprint for the MSOP-10 component package.</Image>
