...
<Image src={require('./_assets/sot-902-2-3d-render-nxp.png').default} width="150px">A 3D render of the SOT-902-2 component package from NXP[^nxp-sot-902-2].</Image>
...
<Image src={require('./_assets/sot-902-2-package-dimensions-nxp.png').default} width="800px">The dimensions of the SOT-902-2 component package from NXP[^nxp-sot-902-2].</Image>

### Recommended Land Pattern

<Image src={require('./_assets/sot-902-2-recommended-land-pattern-nxp.png').default} width="800px">The land pattern for the SOT-902-2 component package from NXP[^nxp-sot-902-2].</Image>

## SOT-902-3

### Dimensions

<Image src={require('./_assets/component-package-sot-902-3-nxp-xqfn8-dimensions.png').default} width="800px">The dimensions for the SOT-902-3 component package. Image from http://www.nxp.com/documents/outline_drawing/sot902-3_po.pdf.</Image>

### Recommended Land Pattern

<Image src={require('./_assets/component-package-sot-902-3-nxp-xqfn8-land-pattern.png').default} width="800px">The land pattern for the SOT-902-3 component package. Image from http://www.nxp.com/documents/reflow_soldering/sot902-3_fr.pdf.</Image>
