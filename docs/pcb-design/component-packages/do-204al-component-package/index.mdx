...
<Image src={require('./_assets/do-41-component-package-photo.jpg').default} width="300px">A photo of the DO-41 component package.</Image>
...
<Image src={require('./_assets/do-41-package-dimensions-vishay.png').default} width="500px">The dimensions for the DO-204AL (DO-41) component package from Vishay[^vishay-1n4001-ds].</Image>
