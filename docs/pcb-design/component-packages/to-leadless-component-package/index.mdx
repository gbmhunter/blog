...
<Image src={require('./_assets/to-leadless-component-package-3d-render.jpg').default} width="200px">A 3D render of the TO-Leadless component package.</Image>
...
<Image src={require('./_assets/to-leadless-component-package-size-comparison-with-d2pak.png').default} width="500px">Size comparison between the TO-Leadless and DPAK component packages.</Image>
...
<Image src={require('./_assets/to-leadless-component-package-dimensions.png').default} width="800px">The dimensions of the TO-Leadless component package.</Image>

## Footprint

<Image src={require('./_assets/to-leadless-component-package-recommended-land-pattern.png').default} width="800px">The recommended land pattern for the TO-Leadless component package.</Image>

<Image src={require('./_assets/to-leadless-component-package-recommended-stencil.png').default} width="600px">The recommended stencil pattern for the TO-Leadless component package.</Image>
