...
<Image src={require('./_assets/smc-do-214ab-component-package-3d-render.jpg').default} width="200px">A 3D render of the SMC (DO-214AB) component package.</Image>
...
<Image src={require('./_assets/component-package-smc-do-214ab-dimensions-and-land-pattern.png').default} width="800px">Dimensions and recommended land pattern for the DO-214AB (SMC) component package. Image from Vishay Outline Dimensions: SMC (http://www.vishay.com/docs/95023/smc.pdf).</Image>
