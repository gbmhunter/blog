...
<Image src={require('./_assets/do-35-do-204ah-component-package-photo.jpg').default} width="350px">A photo of the DO-35 (DO-204AH) component package.</Image>
...
<Image src={require('./_assets/do-35-do-204ah-package-dimensions-vishay.png').default} width="800px">The dimensions for the DO-35 (DO-204AH) package from Vishay[^vishay-package-information].</Image>
