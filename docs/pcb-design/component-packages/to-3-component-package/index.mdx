...
<Image src={require('./_assets/component-package-to-3-2l-dimensions.png').default} width="600px">Dimensions for the TO-3-2 component package</Image>

## TO-3-8

<Image src={require('./_assets/to-3-8-component-package-photo-top-bottom.jpg').default} width="400px">A photo of the TO-3-8 component package.</Image>

<Image src={require('./_assets/component-package-to-3-8l-dimensions.jpg').default} width="300px">Dimensions for the TO-3-8 component package.</Image>
...
<Image src={require('./_assets/to-3-15-component-package-national-semiconductor-dimensions.png').default} width="600px">Dimensions of the TO-3-15 (TO-3 15 lead) component package[^bib-ti-metal-can-packages]. Image © 2011, Texas Instruments.</Image>
