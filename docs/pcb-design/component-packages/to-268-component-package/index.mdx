...
<Image src={require('./_assets/d3pak-to-268-component-package-photo.jpg').default} width="150px">Photo of the D3PAK (TO-268) component package.</Image>
...
<Image src={require('./_assets/to-268-3-component-package-dimensions.png').default} width="800px">Dimensions for the D3PAK (TO-268) component package.</Image>
...
<Image src={require('./_assets/to-268-component-package-land-pattern.png').default} width="500px">Recommended land pattern for the D3PAK (TO-268) component package.</Image>

## Recommended Stencil

Shown below is the recommended stencil pattern.

<Image src={require('./_assets/to-268-component-package-recommended-stencil-pattern.png').default} width="500px">Recommended stencil pattern for the D3PAK (TO-268) component package.</Image>
