...
<Image src={require('./_assets/hu3pak-3d-render-st-microelectronics.png').default} width="200px">3D render of the HU3PAK component package[^bib-st-micro-sthu32n65dm6ag-ds].</Image>
