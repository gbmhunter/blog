...
<Image src={require('./_assets/sot-89-sc62-to-243-component-package-3d-render.jpg').default} width="200px"></Image>
...
<Image src={require('./_assets/sot-89-3-package-dimensions-diodes-inc.png').default} width="300px">Dimensions of the SOT-89-3 component package[^bib-diodes-sot89].</Image>
...
<Image src={require('./_assets/sot-89-sc62-to-243-component-package-3d-render.jpg').default} width="296px">A 3D render of the SOT-89 (SC-62, TO-243) component package. Image from http://www.digikey.com/.</Image>

### Dimensions

<Image src={require('./_assets/sot-89-sc62-to-243-component-package-dimensions.jpg.png').default} width="937px">The dimensions for the SOT-89-5 (SC-62, TO-243) component package.</Image>
