...
<Image src={require('./sc-79-sod-523-component-package-3d-render.png').default} width="200px"></Image>
...
<Image src={require('./sod-523-package-dimensions.png').default} width="600px">Package dimensions for the SOD-523 package[^bib-nxp-sod523-package-info].</Image>

<Image src={require('./sod-523-land-pattern.png').default} width="600px">Recommended land pattern for the SOD-523 package[^bib-nxp-sod523-package-info].</Image>
