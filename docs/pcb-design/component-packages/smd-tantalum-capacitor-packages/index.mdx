...
<Image src={require('./smd-tantalum-capacitor-package-photo.jpg').default} width="262px">A photo of a SMD tantalum capacitor package.</Image>
...
<Image src={require('./tantalum-smd-capacitors-component-package-kemet-land-dimensions-and-courtyard-info.pdf.png').default} width="1139px">The land dimensions and courtyard for various SMD tantalum capacitor sizes. Image from www.kemet.com.</Image>
