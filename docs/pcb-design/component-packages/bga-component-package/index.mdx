...
<Image src={require('./bga-144-component-package-3d-render.jpg').default} width="150px">A 3D render of the BGA-144 component package.</Image>
...
<Image src={require('./example-of-nsmd-pcb-pad-solder-joint-xilinx.png').default} width="507px">Example of a NSMD (non-soldermask defined) solder joint on a BGA package. Image from http://www.xilinx.com/.</Image>
...
<Image src={require('./dsbga-component-package-4-25-bump-size-comparison-ti.png').default} width="282px">A size comparison of the 4 to 25 bump DSBGA component packages. Image from http://www.ti.com/.</Image>
...
<Image src={require('./dsbga-8-component-package-2d-pcb-footprint-birds-eye.png').default} width="236px">A 2D birds-eye view of the CAD model for the DSBGA-8 component package.</Image>
