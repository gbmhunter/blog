...
<Image src={require('./_assets/sot-665-component-package-3d-render.jpg').default} width="200px">A 3D render of the SOT-665 component package. Image from http://www.digikey.com/.</Image>
...
<Image src={require('./_assets/sot-665-component-package-dimensions.png').default} width="836px">The dimensions for the SOT-665 component package from NXP[^nxp-sot-665].</Image>
...
<Image src={require('./_assets/sot-665-component-package-footprint-land-pattern.png').default} width="736px">A recommended footprint (land pattern) for the SOT-665 component package. Image from http://www.st.com/.</Image>
...
<Image src={require('./_assets/sot-665-recommended-land-pattern.png').default} width="800px">The recommended land pattern for the SOT-665 component package from NXP[^nxp-sot-665].</Image>
