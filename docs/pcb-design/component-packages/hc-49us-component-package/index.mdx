...
<Image src={require('./_assets/hc-49us-component-package-photo.jpg').default} width="200px">A photo of the HC-49/US component package.</Image>
...
<Image src={require('./_assets/hc49us-component-package-dimensions-land-pattern.png').default} width="800px">The dimensions and recommended land pattern for the HC-49/U-S component package.</Image>
