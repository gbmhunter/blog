...
<Image src={require('./_assets/sot-1226-component-package-3d-render-top-bottom.gif').default} width="500px">A 3D render of the SOD-1226 component package. Image from http://www.nxp.com/packages/sot1226.html.</Image>

## Dimensions

Dimensions are 0.80x0.80x0.35mm.

<Image src={require('./_assets/sot-1226-component-package-dimensions.png').default} width="481px">The dimensions of the SOT-1226 component package. Image from http://www.nxp.com/documents/outline_drawing/sot1226_po.pdf.</Image>

## Recommended Land Pattern/Footprint

<Image src={require('./_assets/sot-1226-component-package-recommended-footprint.png').default} width="443px">The recommended footprint (land pattern) for the SOT-1226 component package.</Image>
