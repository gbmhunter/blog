...
<Image src={require('./_assets/sc-89-3-3d-model-digikey.png').default} width="250px">3D model of the SOD-490 (SC-89-3) component package. Retrieved 2021-09-02, from https://www.digikey.co.nz/en/products/detail/onsemi/NTE4153NT1G/687079.</Image>
...
<Image src={require('./_assets/sot-490-dimensions-vishay.png').default} width="600px">Dimensions of the SOT-490 package from Vishay[^vishay-sot-490].</Image>
