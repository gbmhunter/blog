...
<Image src={require('./vishay-sc-89-6-component-drawing.png').default} width="700px">Drawing of the SOD-563 (SC-89-6) component package. Retrieved 2021-09-02, from https://www.vishay.com/docs/71612/sc89_6leads.pdf.</Image>

<Image src={require('./vishay-sc-89-6-component-drawing-dimensions.png').default} width="500px">Dimension table of the SOD-563 (SC-89-6) component package. Retrieved 2021-09-02, from https://www.vishay.com/docs/71612/sc89_6leads.pdf.</Image>
