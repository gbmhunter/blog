...
<Image src={require('./_assets/to-206aa-to-18-3-photo-digikey.png').default} width="300px">A photo of the TO-206AA (TO-18-3) from DigiKey[^digikey-2n2222a].</Image>

The dimensions of the `TO-206AA` are shown below:

<Image src={require('./_assets/to-206-aa-to-18-3-lead-ti-h03c-dimensions.png').default} width="700px">Dimensions for the TO-206AA (TO-18) component package from National Semiconductor (now Texas Instruments)[^ti-metal-can-packages].</Image>
