...
<Image src={require('./_assets/soic-8-component-package-dimensions.png').default} width="555px">The dimensions for the SOIC-8N component package.</Image>

The dimensions for the `SOIC-16N` component package are shown below:

<Image src={require('./_assets/soic-16-component-package-dimensions.jpg').default} width="575px">The dimensions for the SOIC-16N component package.</Image>
...
<Image src={require('./_assets/soic-8-component-package-sparkfun-breakout-board.jpg').default} width="272px">A SOIC-8 to DIP-8-300 adapter PCB by SparkFun.</Image>
...
<Image src={require('./_assets/maximum-power-dissapation-graphs-so-8.png').default} width="701px">Maximum power dissipation graphs for the SOIC-8N component package.</Image>
...
<Image src={require('./_assets/soic-8-component-package-standard-mosfet-pinout.png').default} width="334px">The standard pinout for a single MOSFET (N or P-channel) in a SOIC-8 package.</Image>
