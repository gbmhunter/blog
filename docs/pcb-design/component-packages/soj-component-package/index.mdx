...
<Image src={require('./_assets/soj-component-package-3d-render.jpg').default} width="200px">A 3D render of the SOJ component package.</Image>
...
<Image src={require('./_assets/ic-package-soj-28.jpg').default} width="500px">Photo of a SOJ-28 package, a variant of the SOIC package with J-type leads.</Image>
...
<Image src={require('./_assets/soj-32-package-dimensions-infineon.png').default} width="700px">The dimensions of Infineon's SOJ-32 component package[^infineon-soj-32].</Image>

## Recommended Land Pattern

Below is the recommended land pattern for Infineon's SOJ-32 package[^infineon-soj-32]:

<Image src={require('./_assets/soj-recommended-land-pattern-infineon.png').default} width="700px">The recommended land pattern for Infineon's SOJ-32 component package[^infineon-soj-32].</Image>
...
<Image src={require('./_assets/soj-40-socket-ebay.webp').default} width="500px">A 40-pin SOJ socket from Foxconn listed on eBay by West Florida Components[^soj-40-socket-ebay].</Image>
