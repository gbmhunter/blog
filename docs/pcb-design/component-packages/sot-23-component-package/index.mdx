...
<Image src={require('./_assets/sot-23-3-3d-render-nisshinbo.png').default} width="300px">A 3D render of the SOT-23-3 component package by Nisshinbo[^nisshinbo-sot-23-3].</Image>
...
<Image src={require('./_assets/package-dimensions-sot23-3.gif').default} width="500px">The dimensions of the SOT-23-3 component package.</Image>

### Recommended Land Pattern

The image below shows the recommended land pattern by NXP for the `SOT-23-3` package.

<Image src={require('./_assets/sot-23-3-recommend-land-pattern-nxp.png').default} width="600px">The recommended land pattern for the SOT-23-3 package by NXP[^nxp-sot-23-package-info].</Image>
...
<Image src={require('./_assets/sot-23-5-3d-render-direnc.png').default} width="300px">A 3D render of the SOT-23-5 package from Direnc[^direnc-tps70950dbvr].</Image>
...
<Image src={require('./_assets/sot-23-5-dimensions-bourns.png').default} width="700px">The dimensions of the SOT-23-5 package from Bourns[^bourns-sot23-5-package-info].</Image>

### Recommended Land Pattern

The image below shows a recommended land pattern from Bourns for the `SOT-23-5` package.

<Image src={require('./_assets/sot-23-5-recommended-land-pattern-bourns.png').default} width="600px">A recommended land pattern from Bourns for the SOT-23-5 package.</Image>
...
<Image src={require('./_assets/component-package-sot-23-6-sc-74a-sot-457-3d-render.jpg').default} width="200px">A 3D render of the SOT-23-6 (SOT-457) component package.</Image>
...
<Image src={require('./_assets/rohm-sot-457-imt4-sot-23-6-component-package-non-standard-clockwise-pin-numbering-annotated.png').default} width="645px">The Rohm SOT-23-6 component package (a.k.a. SOT-457, IMT4) with non-standard pin numbering.</Image>
...
<Image src={require('./_assets/sot-23-8-component-package-dimensions-diodes-incorporated.png').default} width="800px">Dimensions for the SOT-23-8 component package. Image from http://www.diodes.com/.</Image>
...
<Image src={require('./_assets/sot-23-8-component-package-recommended-footprint-diodes-incorporated.png').default} width="1000px">A recommended footprint for the SOT-23-8 component package. Image from http://www.diodes.com/.</Image>
