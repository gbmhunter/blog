...
<Image src={require('./_assets/to-pmod-7-component-package-3d-render.jpg').default} width="200px">A 3D render of the TO-PMOD-7 component package.</Image>
...
<Image src={require('./_assets/to-pmod-7-component-package-dimensions-and-land-pattern.png').default} width="800px">The dimensions and recommended land pattern for the TO-PMOD-7 component package. Image from http://www.ti.com/.</Image>
