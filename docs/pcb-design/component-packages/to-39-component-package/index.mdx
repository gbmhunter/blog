...
<Image src={require('./to-39-component-package-photo.jpg').default} width="300px">A photo of the TO-39-3 component package.</Image>
...
<Image src={require('./component-package-to-39-2-photo-with-window.jpg').default} width="400px">A photo of the TO-39-2 component package.</Image>

## TO-39-3

<Image src={require('./component-package-to-39-3-dimensions.png').default} width="400px">Dimensions for the TO-39-3 component package.</Image>

<Image src={require('./component-package-to-39-3-photo-with-window.jpg').default} width="400px">A photo of a windowed component in the TO-39-3 component package.</Image>

<Image src={require('./component-package-to-39-pcb-land-pattern.png').default} width="400px">An example of a PCB land pattern for the TO-39-3 component package.</Image>

## TO-39-4

<Image src={require('./component-package-to-39-4-dimensions.png').default} width="400px">Dimensions for the TO-39-4 component package.</Image>

<Image src={require('./component-package-to-39-4-photo-with-window.jpg').default} width="400px">A photo of a TO-39-4 component package with window.</Image>

<Image src={require('./component-package-to-39-mlx90614xci-dimensions.png').default} width="400px">Package dimensions for the MLX90614XCI infrared thermometer. Image from melexis.com.</Image>

## TO-39 Ball Lens

Optan produces components which come in a TO-39 "Ball Lens" package.

<Image src={require('./to-39-ball-lens-component-package-optan-3d-render.png').default} width="400px">A 3D render of the TO-39 \"Ball Lens\" package by Optan[^bib-optan-products]. Image © 2021, Crystal IS, Inc.</Image>
