...
<Image src={require('./_assets/sop-4-component-package-3d-model.jpg').default} width="200px">A 3D model of the SOP-4 component package. Image from www.digikey.com.</Image>
...
<Image src={require('./_assets/sop-4-component-package-photo.jpg').default} width="356px">A photo of the SOP-4 component package.</Image>

### Dimensions

<Image src={require('./_assets/sop-4-component-package-dimensions-and-land-pattern.png').default} width="500px">The dimensions and recommended land pattern for the SOP-4 component package. Image from http://www.everlight.com/datasheets/EL452-G.pdf.</Image>
...
<Image src={require('./_assets/sop-8-package-dimensions-ti.png').default} width="600px">The package dimensions for the SOP-8 component package from TI[^ti-iso1050-ds].</Image>
