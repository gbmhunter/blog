...
<Image src={require('./_assets/sot-23f-3d-render-toshiba-rs.png').default} width="400px">A 3D render of the SOT-23F component package[^bib-rs-toshiba-hall-effect-sensor-tcs40dprlf].</Image>
...
<Image src={require('./_assets/sot-23f-package-outline-and-dimensions-diodes-inc.png').default} width="600px">The package outline and dimensions of the SOT-23F package from Diodes Inc[^bib-diodes-inc-sot-23f-package-info].</Image>

## Recommended Footprint

<Image src={require('./_assets/sot-23f-suggested-footprint-diodes-inc.png').default} width="600px">The recommended PCB footprint for the SOT-23F package by Diodes Inc[^bib-diodes-inc-sot-23f-package-info].</Image>
