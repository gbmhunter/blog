...
<Image src={require('./_assets/dip-16-component-package-3d-render.jpg').default} width="300px">A 3D render of the DIP-16 component package.</Image>
...
<Image src={require('./_assets/making-antistatic-packaging-for-dip-ic-with-aluminium-foil.jpg').default} width="500px">Anti-static packaging can easily be made for DIP packages with foam and aluminium foil.</Image>
...
<Image src={require('./_assets/motorola-mc68000-dip-package-640x314.jpg').default} width="500px">The iconic 1979 Motorola 68000 CPU in a DIP-600-64 package.</Image>
...
<Image src={require('./_assets/m5l2764k-eeprrom.jpg').default} width="400px">Photo of the Mitsubishi M5L2764K EPROM (note, one \"E\" not two, it's \"erasable\" but not \"electronically erasable\") with a transparent lid in a \"DIL\" (DIP) package.</Image>
