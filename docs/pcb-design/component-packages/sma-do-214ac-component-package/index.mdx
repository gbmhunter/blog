...
<Image src={require('./_assets/sma-do-214ac-component-package-3d-render.jpg').default} width="200px">A 3D render of the SMA (DO-214AC) component package.</Image>
...
<Image src={require('./_assets/package-do-214ac-2d-dimensions.png').default} width="500px">The dimensions for the DO-214AC component package.</Image>

Pitch is 6.8mm from pad center to pad center.

## Recommended Land Pattern

<Image src={require('./_assets/package-do-214ac-recommended-land-pattern.png').default} width="500px">The recommended PCB land pattern for the DO-214AC component package.</Image>
