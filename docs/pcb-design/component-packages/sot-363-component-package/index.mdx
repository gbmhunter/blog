...
<Image src={require('./_assets/sot-363-component-package-3d-render.jpg').default} width="200px">A 3D render of the SOT-363 component package.</Image>
...
<Image src={require('./_assets/sot-363-component-package-dimensions-diodes-inc.png').default} width="917px">The dimensions of the SOT-363 component package. Image from http://www.diodes.com/.</Image>

## Footprint (Land Pattern)

<Image src={require('./_assets/sot-363-component-package-recommended-footprint-land-pattern-diodes-inc.png').default} width="885px">A recommended footprint (land pattern) for the SOT-363 component package. Image from http://www.diodes.com/.</Image>
...
<Image src={require('./_assets/dmn63d8ldw-dual-device-mosfet-in-sot-363-component-package-internal-schematic.png').default} width="322px">Internal schematic of a dual-MOSFET component in a SOT-363 package. Notice it is not polarity sensitive. Image from http://www.diodes.com/.</Image>
