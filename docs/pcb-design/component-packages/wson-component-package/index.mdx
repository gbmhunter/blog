...
<Image src={require('./_assets/pg-wson-8-1-3d-render-infineon.png').default} width="200px">A 3D render of the WSON-8 (PG-WSON-8-1) component package from Infineon[^bib-infineon-pg-wson-8-1].</Image>
...
<Image src={require('./_assets/dqd-texas-instruments-tpd8f003-wson-component-package.png').default} width="500px">The pin diagram for three different TPD8F003 family components which come in the WSON style package[^bib-ti-tpdxf003-ds].</Image>
