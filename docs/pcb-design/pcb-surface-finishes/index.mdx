...
<Image src={require('./hasl-pcb-surface-finish-example.jpg').default} width="463px">An example of a PCB with a HASL surface finish. Image from http://www.pcbsourcing.com/.</Image>
...
<Image src={require('./example-of-immersion-tin-surface-finish-on-pcb.jpg').default} width="890px">Example of an immersion tin (ISn) PCB surface finish. Image from http://www.standardpcb.com/.</Image>
...
<Image src={require('./pcb-surface-finish-immersion-silver.jpg').default} width="600px">Example of an immersion silver (IAg) PCB finish. Image from http://www.rlcinnovation.com/.</Image>
...
<Image src={require('./example-of-immersion-gold-pcb-surface-finish.jpg').default} width="1557px">Example of an immersion gold PCB surface finish. Image from http://www.standardpcb.com/.</Image>
