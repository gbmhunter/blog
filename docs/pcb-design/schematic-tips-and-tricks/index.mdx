...
<Image src={require('./schematic-note-and-arrow-obvious-not-wire-annotated.png').default} width="544px">By changing the colour and making it non-orthogonal, it is obvious this note arrow is not a schematic wire/net.</Image>
