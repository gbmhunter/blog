...
<table>
  <tbody>
    <tr>
      <td><Image src={require('./etchback-none.png').default} width="200px">Cross-section of a via hole with no etchback (hole has not been plated yet).</Image></td>
      <td><Image src={require('./etchback-before-plating.png').default} width="220px">Cross-section of a via hole that has positive etchback (hole has not been plated yet).</Image></td>
      <td><Image src={require('./etchback-after-plating.png').default} width="200px">Cross-section of a via which has been plated after positive etchback was done, notice the 'three-point connection'.</Image></td>
    </tr>
  </tbody>
</table>
...
<Image src={require('./etchback-negative.png').default} width="314px">The cross-section of a via with negative etchback. Notice how the copper plane recedes from the edge of the via hole.</Image>
