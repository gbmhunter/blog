...
1. Firstly, use the _Universal Chart_ to calculate an unadjusted cross-sectional area.  
    ...
    <Image src={require('./ipc-2152-universal-chart.png').default} width="641px">The Universal Chart in IPC-2152 which gives an un-adjusted track cross-sectional area based upon the desired current and temperature rise.</Image>  
...
[Jack Olsen - How To 2152 (pdf)](./JackOlson-HowTo2152.pdf)

[Jack Olsen - How To 2152 (Excel based calculator)](./JackOlson-HowTo2152.xls)
