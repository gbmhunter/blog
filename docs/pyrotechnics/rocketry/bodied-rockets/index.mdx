...
<Image src={require('./_assets/5min_rocket.jpg').default} width="320px">The 5min rocket. Visual appearance came second to construction speed.</Image>
...
<Image src={require('./_assets/tiger_rocket_01.jpg').default} width="320px">The 'Tiger' rocket. Painted with fluro colours so it was easy to find in a paddock.</Image>

<Image src={require('./_assets/tiger_rocket_02.jpg').default} width="320px">The rocket motors that went in the 'Tiger' rocket.</Image>