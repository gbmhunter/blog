...
<Image src={require('./_assets/03-anchor-holes-and-disk.jpg').default} width="320px"></Image>
...
<Image src={require('./_assets/27-end-of-rocket-with-ignitor.jpg').default} width="320px"></Image>
...
<Image src={require('./_assets/15-knsu-propellant-in-mould.jpg').default} width="320px"></Image>
...
<Image src={require('./_assets/19-kndx-propellant-grain-unwrapped.jpg').default} width="500px"></Image>
...
<Image src={require('./_assets/21-putting-thermal-backing-in-motor.jpg').default} width="500px"></Image>
...
<Image src={require('./_assets/38-afterburn-03.jpg').default} width="320px"></Image>
...
<Image src={require('./_assets/33-rocketboard-02.jpg').default} width="600px"></Image>
