...
<Image src={require('./bazel-build-system-logo.png').default} width="150px"></Image>
...
<Image src={require('./buck-build-system-logo.png').default} width="150px"></Image>
...
<Image src={require('./buckaroo-package-manager-logo.png').default} width="150px"></Image>
...
<Image src={require('./cmake-build-system-logo.png').default} width="150px"></Image>
...
<Image src={require('./conan-c-cpp-package-manager-logo.png').default} width="150px"></Image>
...
<Image src={require('./gnu-logo.png').default} width="150px"></Image>
...
<Image src={require('./scons-build-system.png').default} width="200px"></Image>
