...
<Image src={require('/images/programming-misc/mercurial-error-msg-abandoned-transaction-found.png').default} width="300px">The 'abandoned transaction found' Mercurial error message.</Image>
