...
<Image src={require('./_assets/umami-logo.png').default} width="300px">The Umami logo.</Image>
...
<Image src={require('./_assets/umami-dashboard-showing-analytics-for-blog.png').default} width="900px">The Umami dashboard showing the page views and visitor count for this blog.</Image>
...
<Image src={require('./_assets/aws-lightsail-create-instance.png').default} width="900px">The Amazon Lightsail homepage with the \"Create instance\" button.</Image>
...
<Image src={require('./_assets/picking-ubuntu-22-04-in-lightsail.png').default} width="800px">Picking Ubuntu 22.04 LTS as the OS in Lightsail.</Image>
...
<Image src={require('./_assets/choosing-dual-stack-and-size-lightsail.png').default} width="700px">Choosing the networking type and size of the Lightsail instance.</Image>
...
<Image src={require('./_assets/ipv4-https-firewall-rule-in-lightsail.png').default} width="700px">Adding a IPv4 firewall to allow https traffic in Lightsail.</Image>
...
<Image src={require('./_assets/adding-dns-a-record-in-cloudflare.png').default} width="900px">Adding a DNS A record to point to the IP address of the Lightsail instance.</Image>
...
<Image src={require('./_assets/umami-docker-up-command-worked.png').default} width="500px">Running \"sudo docker compose up -d\" and watching Docker pull the layers and start the database and application.</Image>
...
<Image src={require('./_assets/umami-login-screen.png').default} width="900px">If you make it to this Umami login screen, your http setup is working.</Image>
...
<Image src={require('./_assets/change-ssl-settings-in-cloudflare-from-flexible-to-full-strict.png').default} width="900px">Screenshot of me changing the SSL settings in CloudFlar from Flexible to Full (strict) so that https will work without getting the \"too many redirects\" error.</Image>
...
<Image src={require('./_assets/create-snapshot-in-lightsail.png').default} width="700px">Creating a snapshot of the Umami instance in preparation for moving to IPv6 only.</Image>
...
<Image src={require('./_assets/localhost-being-the-top-referrer-in-umami.png').default} width="600px">Oh oh! Umami is running when developing, and clocking up many page visits.</Image>
