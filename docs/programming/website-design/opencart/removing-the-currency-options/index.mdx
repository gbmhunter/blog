...
<Image src={require('./_assets/open-cart-currency-options-gone.jpg').default} width="800px">Removing the currency options in OpenCart only takes a little CSS.</Image>
