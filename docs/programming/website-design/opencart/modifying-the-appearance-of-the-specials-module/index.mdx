...
<Image src={require('/images/programming-opencart/open-cart-unmodified-specials-module-appearance.jpg').default} width="800px">The default appearance of the specials module.</Image>
...
<Image src={require('/images/programming-opencart/open-cart-adding-box-specials-css-class.jpg').default} width="800px">Modifying the CSS to change the appearance of the OpenCart specials module.</Image>
...
<Image src={require('/images/programming-opencart/open-cart-creating-title-background-with-gimp.jpg').default} width="600px">Creating a title background for the OpenCart specials module with GIMP.</Image>
