...
<Image src={require('./_assets/wordpress-plugin-broken-link-checker-sends-you-email.png').default} width="650px">The 'Broken Link Checker' plugin sends you an email when it detects a NEW broken link.</Image>
...
<Image src={require('./_assets/wordpress-plugin-broken-link-checker-edit-url.png').default} width="650px">You only have to edit a broken hyperlink once for all ocurrances of it on your site.</Image>
