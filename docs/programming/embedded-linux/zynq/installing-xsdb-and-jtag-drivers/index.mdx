...
<Image src={require('./_assets/xilinx-zc702-usb-to-jtag-module-highlighted.png').default} width="548px">The Xilinx Zynq-7000 ZC702 development board with the USB-to-JTAG module highlighted.</Image>
...
<Image src={require('./_assets/installing-xilinx-digilent-jtag-drivers-ubuntu-snapshot.png').default} width="587px">A snapshot of the terminal output while installing the Xilinx 'Digilent' JTAG drivers on Ubuntu.</Image>
