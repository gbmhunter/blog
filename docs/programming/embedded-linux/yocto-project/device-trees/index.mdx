...
<Image src={require('./yocto-device-tree-conversion-from-blob-to-source.png').default} width="1159px">A comparison between the Yocto generated binary Device Tree Blob (.dtb) file and the human-readable Device Tree Source (.dts) file that can be created from the .dtb file using the program dtc.</Image>
