...
<Image src={require('./the-yocto-project-logo.png').default} width="404px">The logo for the Yocto project.</Image>
...
<Image src={require('./yocto-linux-build-in-progress-showing-cpu-usage.png').default} width="1491px">An embedded Linux build in progress (using Yocto), note the CPU usage!</Image>
...
<Image src={require('./yocto-running-qemu-after-building-default-linux-image.png').default} width="1327px">Running the finished Yocto build in QEMU (an emulator).</Image>
