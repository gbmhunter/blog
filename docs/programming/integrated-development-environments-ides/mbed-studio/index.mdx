...
<Image src={require('./arm-mbed-studio-getting-started.png').default} width="600px">A screenshot of the 'Getting Started' welcome screen in Mbed Studio.</Image>

Mbed Studio uses ARM Compiler 6 (as of June 2020).

<Image src={require('./mbed-studio-os-blinky-example.png').default} width="600px">A screenshot of the 'OS blinky' example project in Mbed Studio.</Image>
