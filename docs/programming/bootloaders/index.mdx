...
<Image src={require('./_assets/basic-bootloader-memory-map.webp').default} width="700px">A basic example showing the layout of a microcontrollers memory when a bootloader is used.</Image>
...
<Image src={require('./_assets/swap-move-algorithm-mcuboot.webp').default} width="900px">Illustration of the swap-move algorithm to swap two firmware images using just a single extra erase sector in slot 0.</Image>
...
<Image src={require('./_assets/mcuboot-homepage-screenshot.png').default} width="700px">A screenshot of MCUboot's homepage as of Jan 2024.</Image>
...
<Image src={require('./_assets/zephyr-mcuboot-shell-output-during-swap.png').default} width="700px">The output to the Zephyr shell just after a new image has been downloaded, the MCU reboots and MCUboot performs a swap of the images.</Image>
