...
<Image src={require('./logistic-function-changing-b1.gif').default} width="800px"></Image>
...
<Image src={require('./logistic-function-changing-b0.gif').default} width="800px"></Image>
...
<Image src={require('./data-head-iris.png').default} width="500px">The first 5 rows of the Iris dataset.</Image>
...
<Image src={require('./logistic-regression-iris-predictions.png').default} width="600px">The predictions of the type of Iris for the test data.</Image>
...
<Image src={require('./logistic-regression-iris-classification-report.png').default} width="500px">The classification report for our logistic regression model.</Image>
