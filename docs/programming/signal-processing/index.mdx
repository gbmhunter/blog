...
<Image src={require('./_assets/graph-of-maxima-minima-detection-on-six-waveforms.png').default} width="800px">A graph of maxima and minima detection on six noisy sine-like waveforms.</Image>

A graph on noisy, but stable data showing problems with maxima and minima detection without thresholding (false detections).

<Image src={require('./_assets/noisy-data-graph-with-no-threshold-on-maxima-minima-detection.png').default} width="800px">A graph on noisy, but stable data showing problems with maxima and minima detection without thresholding (false detections).</Image>
