...
<Image src={require('./box-car-functions-ft-gt.png').default} width="700px"></Image>

We need to "flip" $g(\tau)$ to give $g(-\tau)$:

<Image src={require('./g-tau-flipped.png').default} width="700px"></Image>

Then we need to shift $g(-\tau)$ by $t$ to give $g(t - \tau)$:

<Image src={require('./g-tau-offset.png').default} width="700px"></Image>
...
<Image src={require('./when-t-less-than-0.png').default} width="400px"></Image>
...
<Image src={require('./when-0-lte-t-lt-1.png').default} width="400px"></Image>
...
<Image src={require('./when-1-lte-t-lt-2.png').default} width="400px"></Image>
...
<Image src={require('./when-2-lte-t-lt-inf.png').default} width="400px"></Image>
...
<Image src={require('./convolution-two-box-car-functions.gif').default} width="700px">An animated .gif showing the convolution of two box-car functions. The value of the convolution function at any time t (bottom line in red) is the amount area shown in red in the middle plot, which is the area under the curve of f(t)g(t) (the two waveforms multiplied together).</Image>
