...
<Image src={require('./gedit-save-to-shared-virtual-box-folder-text-file-busy-error.png').default} width="800px">The workaround, to enable the 'Save Backup Copy' option in the preferences, and hit the save button twice.</Image>
...
<Image src={require('./gedit-preferences-enabling-save-backup-copy-to-stop-file-busy-error.png').default} width="500px">The 'File Busy' error that you get when trying to save a file across a mounted, shared folder from within Linux system running Gedit.</Image>
