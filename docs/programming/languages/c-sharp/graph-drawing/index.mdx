...
<Image src={require('./_assets/nplot-screenshot.png').default} width="300px">Screenshot of the NPlot charting library for .NET. Features a 2D candleplot, filled region, line plot and datetime axis.</Image>
...
<Image src={require('./_assets/telerik-radchart-screenshot.png').default} width="300px">Screenshot of the Telerik charting library for .NET applications. Comes with some very nice skins and tutorials.</Image>
...
<Image src={require('./_assets/zedgraph-screenshot.png').default} width="300px">Screenshot of the ZedGraph charting library for .NET. One of the most powerful and widely used free charting libraries.</Image>
