...
<Image src={require('/images/programming-misc/add-microsoft-word-object-library-reference.png').default} width="320px">Adding the Microsoft Word x.x (14.0 in this case) Object Library to a C# project.</Image>
