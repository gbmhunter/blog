...
There is a great cheat sheet by John Sheehan which explains string manipulation in the .NET language. Unfortunately, it can no longer be found on his site, but you can still download this [locally cached version](/images/filebase/programming/languages/c-sharp/john-sheehan-msnet-formatting-strings-cheat-sheet.pdf).
...
<Image src={require('/images/programming-misc/screenshot-of-nuget-plugin-for-visual-studio.jpg').default} width="700px">A screenshot of the NuGet plugin for Visual Studio.</Image>
