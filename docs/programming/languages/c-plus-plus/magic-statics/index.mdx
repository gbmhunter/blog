...
<Image src={require('./_assets/magic-statics-icon-bunny-hat-code.png').default} width="300px"></Image>
...
<Image src={require('./_assets/visual-studio-support-for-cpp-magic-statics.png').default} width="622px">Table showing Visual Studio's support for magic statics. Image from https://msdn.microsoft.com/en-us/library/hh567368.aspx.</Image>
