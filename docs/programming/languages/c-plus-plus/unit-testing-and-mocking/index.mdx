...
<Image src={require('./_assets/example-output-from-unittestpp-when-test-fail.png').default} width="961px">Example output from UnitTest++ when one of the tests fails.</Image>
