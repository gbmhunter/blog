...
<Image src={require('/images/2013/06/assembly-code-example.png').default} width="481px">An example of assembly code from the glibc library (an optimised memcpy() function).</Image>
