...
<Image src={require('/images/2016/07/screenshot-java-serial-rxtx-website-front-page.png').default} width="1313px">A screenshot of RXTX's (a Java comm port library) front page on their website. Dear god.</Image>
