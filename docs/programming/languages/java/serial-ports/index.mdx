...
<Image src={require('./_assets/screenshot-java-serial-rxtx-website-front-page.png').default} width="1313px">A screenshot of RXTX's (a Java comm port library) front page on their website. Dear god.</Image>
