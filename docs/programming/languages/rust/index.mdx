...
<Image src={require('/images/2015/05/rust-programming-language-logo-white-background.png').default} width="300px">The logo of the Rust programming language. Image from http://www.rust-lang.org/.</Image>
