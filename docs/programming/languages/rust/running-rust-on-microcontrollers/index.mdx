...
<Image src={require('./ewg-logo-blue-white-on-transparent.png').default} width="200px">The logo of Rust's Embedded Devices Working Group[^bib-rust-embedded-working-group-repo].</Image>
...
<Image src={require('./compiler-warning-about-unused-result.png').default} width="700px">The Rust compiler warning when compiling the above code.</Image>
...
<Image src={require('./crate-structure-for-embedded-rust.png').default} width="1000px">The hierarchical crate structure for an embedded Rust firmware project.</Image>
...
<Image src={require('./file-macro-in-rust-compiler-built-in.png').default} width="600px">Screenshot of the file! macro source code inside the Rust standard library.</Image>
...
<Image src={require('./cargo-cortex-m-quickstart-project-files.png').default} width="800px">The resulting Cortex-M quickstart project creating by running the above cargo command.</Image>
...
<Image src={require('./riscv-rt-crate-docs-screenshot.png').default} width="700px">Screenshot of the docs for the riscv_rt (RISC-V runtime) crate.</Image>
...
<Image src={require('./stm32-rs-repo-readme-screenshot.png').default} width="600px">A screenshot of the stm32-rs repo's README.</Image>
...
<Image src={require('./using-cargo-generate-for-arduino-uno.png').default} width="700px">cargo generate with the Rahix/avr-hal-template GitHub repo provides a really quick way of setting up a Rust project for an Arduino board.</Image>
...
<Image src={require('./screenshot-of-basic-arduino-app-in-rust.png').default} width="700px">Screenshot of a bare-bones Arduino app written in Rust (flashing an LED and printing \"Hello\" to the console.</Image>
...
<Image src={require('./atsamd-rs-atsamd-repo-screenshot.png').default} width="600px">Screenshot of the README of the atsamd-rs/atsamd repository.</Image>
...
<Image src={require('./rp-hal-rust-support-for-the-rp2040-readme-screenshot.png').default} width="400px">Screenshot of the rp-rs/rp-hal repo README.</Image>
...
<Image src={require('./stm32-discovery-blinky-debugging-in-vs-code.png').default} width="800px">Step-by-step debugging a STM32F303 Discovery Kit blinky Rust application in VS Code. I started with the repo at https://github.com/rubberduck203/stm32f3-discovery, and after a few tweaks, this was up and running!</Image>
...
<Image src={require('./rtic-documentation-screenshot.png').default} width="400px">A screenshot of the homepage for RTIC's documentation.</Image>
...
<Image src={require('./tock-os-logo.png').default} width="700px">The Tock logo. Image from the Tock GitHub organization page.</Image>
...
<Image src={require('./tock-architecture-diagram.png').default} width="700px">Architecture block diagram for the Tock RTOS. Image from the Tock documentation[^bib-tock-tock-design].</Image>
...
<Image src={require('./comparison-of-the-square-function-in-cpp-and-rust.png').default} width="1000px">Screenshot of the Compiler Explorer showing the difference in square() assembly output for C++ and Rust.</Image>
