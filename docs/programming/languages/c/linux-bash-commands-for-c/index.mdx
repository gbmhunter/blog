...
<Image src={require('./_assets/essential-bash-commands-for-c-screenshot.png').default} width="450px">Screenshot of essential bash commands for C being used in a terminal on Ubuntu.</Image>
