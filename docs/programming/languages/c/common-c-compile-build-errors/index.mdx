...
<Image src={require('/images/programming-c-builderrors/elf-section-bss-will-not-fit-in-region-ram.png').default} width="700px">C build error 'elf section '.bss' will not fit in region 'ram'</Image>
...
<Image src={require('/images/programming-misc/c-warning-suggesed-parentheses-around-assignment-used-as-truth-value.png').default} width="500px">A warning message from the C compiler.</Image>
...
<Image src={require('/images/programming-misc/c-build-error-subscripted-value-is-neither-array-nor-pointer.png').default} width="500px">The C build error 'subscripted value is neither array nor pointer'.</Image>
...
<Image src={require('/images/programming-misc/c-build-warning-pragma-once-in-main-file.png').default} width="500px">The C compiler warning '#pragma once in main file' which occurs when the directive '#pragma once' is incorrectly placed in a .c file.</Image>
...
<Image src={require('/images/programming-misc/c-build-error-variable-or-field-declared-void.png').default} width="500px">The C build error 'Variable or field declared void'.</Image>
...
<Image src={require('/images/programming-psoc/keil-c51-build-error-not-in-formal-parameter-list.png').default} width="500px">The 'not in formal parameter list' build error is most likely to occur when you have forgotten to add the semi-colon at the end of a function declaration.</Image>
