...
<Image src={require('./valgrind-logo.jpg').default} width="316px">The Valgrind logo.</Image>
...
<Image src={require('./callgrind-profiling-output-displayed-in-kcachegrind.png').default} width="1310px">The callgrind profiling output data being displayed in kcachegrind for a simple test application (with Fibonacci calculation and looping).</Image>
