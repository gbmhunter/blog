...
<Image src={require('./linux-dev-dir-ttyacm0-arduino-serial.png').default} width="600px">A listing of the /dev/ directory in Linux with a connected Arduino. The Arduino serial port is present as /dev/ttyACM0.</Image>
