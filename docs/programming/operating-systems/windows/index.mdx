...
<Image src={require('./_assets/rich-copy-crashed-on-long-file-names.png').default} width="600px">RichCopy has crashed for me when encountering a large number of files with filenames 'too long' for windows to deal with.</Image>
