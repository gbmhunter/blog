...
<Image src={require('/images/project-autoelectricblanket/raspberry-pi-with-lots-of-cables-filtered.jpg').default} width="800px">The RaspberryPi while testing.</Image>
...
<Image src={require('/images/project-autoelectricblanket/simple-led-connected-to-raspberry-pi-gpio.jpg').default} width="800px">I used a single LED connected up to one of the RaspberryPi's GPIO pins for basic testing.</Image>
