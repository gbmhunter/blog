...
<Image src={require('./rp2040-package-photo.png').default} width="400px">Photo of the RP2040 IC in it's 56-pin 7x7mm QFN package[^bib-rpi-rp2040-product-page].</Image>
...
<Image src={require('./rp2040-qfn-56-pinout.png').default} width="600px">Pinout for the RP2040 microcontroller, which is in a QFN-56-7x7 package[^bib-rpi-rp2040-ds].</Image>
...
<Image src={require('./rp2040-system-overview.png').default} width="700px">A system overview (functional block diagram) of the RP2040 microcontroller[^bib-rpi-rp2040-hardware-design].</Image>
