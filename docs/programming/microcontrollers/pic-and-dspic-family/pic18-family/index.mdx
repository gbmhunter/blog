...
<Image src={require('/images/2016/06/marketing-image-microchip-pic18-microcontroller-family.pdf.png').default} width="571px">Marketing render of a range of microcontrollers from the Microchip PIC18 family. Image from http://ww1.microchip.com/.</Image>
