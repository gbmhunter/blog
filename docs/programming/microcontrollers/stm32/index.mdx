...
<Image src={require('./stlink-v3set-st-microelectronics-programmer-photo.png').default} width="500">A photo of the STLINK-V3SET programmer. Image from https://www.digikey.co.nz/product-detail/en/stmicroelectronics/STLINK-V3SET/497-18216-ND.</Image>
