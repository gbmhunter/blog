...
<Image src={require('./arduino-uno-r3-photo.jpg').default} width="425px">A photo of the Arduino Uno (revision r3). Image from https://www.wikimedia.org/.</Image>
...
<Image src={require('./arduino-logo.svg').default} width="300px">The Arduino logo.</Image>
...
<Image src={require('./windows-8-start-screen.jpg').default} width="272px">The Windows 8 start screen.</Image>

## NetDuino

An embedded platform that runs the .NET Micro framework.

<Image src={require('./netduino-plus-photo.jpg').default} width="470px">The Netduino, an embedded platform that runs the .NET Micro framework. Image from http://netduino.com/.</Image>
...
<Image src={require('./mariamole-screenshot-from-website.jpg').default} width="402px">Screenshot of the MariaMole IDE. Image from http://dalpix.com/mariamole.</Image>
