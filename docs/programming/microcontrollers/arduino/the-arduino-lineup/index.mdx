...
<Image src={require('./arduino-uno-pcb.jpg').default} width="200px">The Arduino UNO, the first ever Arduino PCB.</Image>
...
<Image src={require('./arduino-yun-pcb.jpg').default} width="200px">The Arduino Yun, a PCB with both a real-time Arduino microcontroller and Linux-based microprocessor.</Image>
