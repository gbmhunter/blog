...
<Image src={require('./_assets/arduino-infrared-sensors.jpg').default} width="400px">Arduino-compatible infrared sensors.</Image>
...
<Image src={require('./_assets/arduino-4wd-robot-motor-controller.jpg').default} width="400px">The controller for a Arduino 4WD robot.</Image>

## Sensor Shield

<Image src={require('./_assets/arduino-sensor-shield.jpg').default} width="400px">An Arduino sensor shield.</Image>
...
<Image src={require('./_assets/arduino-ultrasound-module.jpg').default} width="600px">An Arduino compatible ultrasound module.</Image>

## The DealExtreme Robotic Platform

<Image src={require('./_assets/bottom-side-of-arduino-4wd-robot.jpg').default} width="200px">The bottom side of the 4WD Arduino robot.</Image>
...
<Image src={require('./_assets/arduino-4wd-robot-base-wheels-motor-driver.jpg').default} width="600px">A Arduino robot base.</Image>
