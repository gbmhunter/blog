...
<Image src={require('/images/2011/09/atmel-avr-at32-3d-render-of-ic-www-teckhat-com.gif').default} width="259px">A 3D render of the AT32UC3L, an Atmel AVR AT32 microcontroller. Image from http://teckhat.com/.</Image>
