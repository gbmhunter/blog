...
<Image src={require('./_assets/atmel-avr-mk2-programmer-photo-www-robotics-org-zajpg.jpg').default} width="293px">A photo of the Atmel AVR MkII programmer, suitable for ISP programming of a range of Atmel microcontrollers.</Image>
