...
<Image src={require('./_assets/atmel-avr-atmega168-ic-photo-www-wolfpaulus-com.jpeg').default} width="426px">A photo of the Atmel AVR ATmega168 microcontroller. Image from https://wolfpaulus.com.</Image>
