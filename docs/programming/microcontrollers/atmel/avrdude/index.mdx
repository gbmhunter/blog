...
<Image src={require('/images/2015/10/avr-dude-windows-command-line-default-usage-info.png').default} width="486px">The default information printed by avrdude from the Windows command line.</Image>

It supports a wide-range of programmers and microcontrollers.

<Image src={require('/images/2015/10/example-cmd-screenshot-of-avrdude-programming-atmega-microcontroller.png').default} width="452px">A Windows command-line screenshot of AVRDUDE programming an Atmel ATmega microcontroller.</Image>
