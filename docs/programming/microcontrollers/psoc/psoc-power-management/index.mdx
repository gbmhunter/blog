...
<Image src={require('/images/programming-psoc/psoc-5-power-consumption-ma-vs-mhz-graph.png').default} width="400px">A graph of the PSoC 5 power consumption expressed as mA per MHz.</Image>
