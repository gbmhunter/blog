...
<Image src={require('./custom-user-c-code-in-psoc-api-files.png').default} width="688px">The correct place to enter custom user code in automatically generated Cypress component API files.</Image>
...
<Image src={require('./psoc-component-analogue-multiplexor-mux.jpg').default} width="550px">The analogue multiplexor (mux) component in PSoC Creator.</Image>
...
<Image src={require('./psoc-creator-schematic-cap-sense-component.jpg').default} width="670px">The cap sense configure window in PSoC Creator.</Image>
...
<Image src={require('./psoc-component-schematic-counter-16bit.png').default} width="820px">The PSoC counter component, set to be 16-bit (this is configurable).</Image>
...
<Image src={require('./psoc-debounce-component-with-pin-and-interrupt.png').default} width="590px">The PSoC Debouncer. In the case, the switch pulled-up, and input goes low on press, which fires interrupt.</Image>
...
<Image src={require('./psoc-filter-component-config-dialog-box.png').default} width="1118px">The filter component configuration tab in PSoC Creator.</Image>
...
<Image src={require('./cypress-psoc-i2c-api-while-loops-in-master-functions-annotated.png').default} width="538px">An example of the dangerous, un-bounded while() loops in the PSoC I2C API.</Image>
...
<Image src={require('./psoc-i2c-api-with-upper-bounds-on-while-loops-annotated.png').default} width="857px">An screenshot of an edited version of the PSoC I2C API with added upper-bounds on the number of while() loop iterations.</Image>
...
<Image src={require('./psoc-top-design-isr-component-connected-to-push-button.jpg').default} width="472px">The ISR component, connected to a push button (digital input pin).</Image>
...
<Image src={require('./hall-effect-interrupts-from-bldc-motor-for-both-rise-and-fall.png').default} width="1054px">6 PSoC interrupts to service the three hall-effect inputs from a BLDC motor. Six interrupts are required because the PSoC interrupt component only supports rising-edge triggering, and so a inverting gate and second interrupt per sensor is required to trigger on falling-edge.</Image>
...
<Image src={require('./psoc-module-character-lcd.jpg').default} width="154px">The PSoC Character LCD component. Not much to it right?</Image>

Pin description:

<Image src={require('./psoc-module-character-lcd-pin-description.jpg').default} width="800px">The pin descriptions for the PSoC LCD component.</Image>
...
<Image src={require('./ganging-port-pins-together-to-provide-more-output-current.png').default} width="620px">Ganging port pins together on a PSoC microcontroller to provide more output current. Be careful not to exceed to total allowed current per port.</Image>
...
<Image src={require('./psoc-component-pulse-converter-trigger-in-out.png').default} width="388px">The PSoC Pulse Converter component, being used here to output constant-width pulses.</Image>
...
<Image src={require('./psoc-component-quadrature-decoder.png').default} width="1034px">The PSoC quadrature decoder component. Takes the A, B and N inputs from an incremental encoder and converts it into a count.</Image>
...
<Image src={require('./psoc-creator-scb-component-as-uart-example-topdesign.png').default} width="307px">A screenshot of a SCB block in the `TopDesign.cysch` file in PSoC Creator. This SCB block is configured as a UART.</Image>
...
<Image src={require('./vdac-component-routed-to-debug-pin-on-schematic.png').default} width="210px">The PSoC VDAC component.</Image>
...
<Image src={require('./using-psoc-vdac-component-to-inspect-code-execution.jpg').default} width="579px">The oscilloscope on the PSoC VDAC component output allows you to inspect code execution. Each different voltage level corresponds to a different section of code. This was taken while running a complex FreeRTOS-based program.</Image>
...
<Image src={require('./care-with-psoc-watchdog-and-eeprom-flash-20ms-write-time.png').default} width="357px">A screenshot taken from the PSoC 5 LP datasheet, stating care must be taken when using the watchdog in an application that also performs EEPROM or flash writes.</Image>
