...
<Image src={require('/images/programming-psoc/linker-build-settings-emwin-psoc-5.png').default} width="650px">The linker build settings for using emWin with GCC.</Image>
