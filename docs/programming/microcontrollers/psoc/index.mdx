...
<Image src={require('/images/programming-misc/freertos-logo-large.jpg').default} width="320px">The FreeRTOS logo. Image from http://www.arm.com/community/partners/display_product/rw/ProductId/4028/.</Image>
