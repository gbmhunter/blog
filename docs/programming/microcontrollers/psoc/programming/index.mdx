...
<Image src={require('/images/programming-misc/swd-programming-interface-for-psoc-5.png').default} width="250px">The pinout for the PSoC programming interface.</Image>
...
<Image src={require('/images/electronics-misc/mini-prog-3-insides-top.jpg').default} width="400px">The top view of the MiniProg3 PCB with the cover removed.</Image>

<Image src={require('/images/electronics-misc/mini-prog-3-insides-bottom_0.jpg').default} width="400px">The bottom view of the MiniProg3 PCB with the cover removed.</Image>
