...
<Image src={require('./_assets/additional-features-only-provided-on-sio-pins.png').default} width="631px">Information on the SIO pins from a PSoC datasheet.</Image>
