...
<Image src={require('./pid-controller-diagram-process-error-setpoint-measured-value.webp').default} width="900px">A block diagram of a PID controller.</Image>
...
<Image src={require('./standard-form-pid-controller-diagram.webp').default} width="800px">Diagram of a PID controller in standard form.</Image>
...
<Image src={require('./msd-simulation/manual-tuning-01-p0-i0-d0.png').default} width="600px">1st step of tuning, set all gains to 0.</Image>

Now let's increase $K_p$ until the system starts to oscillate continuously (increasing $K_p$ from left to right in the figure):

<Image src={require('./msd-simulation/manual-tuning-02-increasing-kp-round-1.png').default} width="900px">2st step of tuning, increasing $K_p$ until system continuously oscillates.</Image>

At $K_p=100$, we get continuous oscillation. Now increase $K_d$ until the oscillations are critically dampened:

<Image src={require('./msd-simulation/manual-tuning-03-increasing-kd-round-1.png').default} width="900px">3rd step of tuning, increasing $K_d$ until oscillations are dampened.</Image>
...
<Image src={require('./msd-simulation/manual-tuning-04-increasing-kp-round-2.png').default} width="900px">4th step of tuning, increasing $K_p$ again.</Image>

At around $K_p=1800$ we start to get continuous oscillation. Can we dampen this by increasing $K_d$ again?

<Image src={require('./msd-simulation/manual-tuning-05-increasing-kd-round-2.png').default} width="900px">5th step of tuning, increasing $K_d$ to see if we can critically dampen the oscillations.</Image>
...
<Image src={require('./msd-simulation/manual-tuning-06-increasing-ki.png').default} width="900px">6th step of tuning, increasing $K_i$ until steady-state error is eliminated in a suitable amount of time.</Image>
...
<Image src={require('./pid-controller-with-feedforward-diagram.webp').default} width="800px">A PID controller with feedforward added.</Image>
...
<Image src={require('./mass-spring-damper-system-diagram-pid.png').default} width="600px">A mass-spring-damper system, which is commonly used to demonstrate PID control and appropriate tuning.</Image>
...
<Image src={require('./msd-simulation/msd-response-plot-p10-i0-d0.png').default} width="800px">The response of the mass-spring-damper system with just proportional gain.</Image>
...
<Image src={require('./msd-simulation/msd-response-plot-p300-i0-d0.png').default} width="800px">The response of the mass-spring-damper system with more proportional gain.</Image>
...
<Image src={require('./msd-simulation/msd-response-plot-p300-i300-d0.png').default} width="800px">The response of the mass-spring-damper system with more proportional gain.</Image>
...
<Image src={require('./msd-simulation/msd-response-plot-p300-i300-d20.png').default} width="800px">The response of the mass-spring-damper system with derivative control added.</Image>
...
<Image src={require('./pid-tuner-screenshot.png').default} width="900px">Screenshot of the PID tuning app at pidtuner.com[^pid-tuner-dot-com-homepage].</Image>
