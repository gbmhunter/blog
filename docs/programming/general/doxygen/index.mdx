...
<Image src={require('./doxygen-logo.png').default} width="300px"></Image>
...
<Image src={require('./doxygen-html-documentation-screenshot.png').default} width="1900px">Screenshot of the html documentation that Doxygen generates with properly commented code.</Image>
...
<Image src={require('./doxygen-gui-extract-private-and-static-selected.png').default} width="829px">Selecting 'EXTRACT_PRIVATE' and 'EXTRACT STATIC' in the Doxygen GUI.</Image>
