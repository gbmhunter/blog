...
<Image src={require('/images/programming-misc/bit-bucket-logo.png').default} width="320px">The BitBucket logo. Image from https://bitbucket.org/.</Image>
...
<Image src={require('/images/electronics-electricskateboard/electric-skateboard-c-code-screenshot.png').default} width="600px">Screenshot of the electric skateboard firmware, showing main.c.</Image>
