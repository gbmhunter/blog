...
<Image src={require('/images/electronics-electricskateboard/skateboard-pcb-routing-almost-complete.jpg').default} width="500px">Screenshot of the nearly finished skateboard PCB routing (1 of 2 boards...).</Image>
...
<Image src={require('/images/electronics-misc/psoc-5-cy8c5246ax1-054-microcontroller.png').default} width="320px">A schematic drawing of the PSoC 5 CY8C5246AX1-054 microcontroller.</Image>
...
<tbody >
<tr >
<td ><Image src={require('/images/electronics-electricskateboard-firstprototype/img_6210.jpg').default} width="160px">A supposedly '3kW' BLDC motor I got from Hobby King.</Image></td>
<td ><Image src={require('/images/electronics-electricskateboard-firstprototype/img_6216.jpg').default} width="160px">The BLDC motor mount, that attaches to only one end of the motor, since it is an outrunner.</Image></td>
<td ><Image src={require('/images/electronics-electricskateboard-firstprototype/img_6221.jpg').default} width="160px">A lithium-ion polymer battery from Hobby King.</Image></td>
</tr>
</tbody>
</table>
...
<Image src={require('/images/electronics-electricskateboard-firstprototype/sam_0125.jpg').default} width="320px">I made two Xbee breakout boards for prototyping, since they use the non-prototype friendly 2mm pitch connectors.</Image>
