...
<Image src={require('./cap_01.jpg').default} width="600px">Disposable cameras from a Kodak processing store.</Image>

<Image src={require('./cap_02.jpg').default} width="600px">The circuits inside the disposable cameras.</Image>

<Image src={require('./cap_03.jpg').default} width="600px">330V 80uF caps from the cameras.</Image>

<Image src={require('./cap_04.jpg').default} width="600px">Assembled 1920uF 330V capacitor bank.</Image>

<Image src={require('./cap_05.jpg').default} width="600px">I don't want to touch it.</Image>

<Image src={require('./cap_06.jpg').default} width="600px">The finished cap bank.</Image>
...
<Image src={require('./coil_01.jpg').default} width="600px">The cardboard core and two slotted side washers. The slots prevent eddy currents from forming and wasting power.</Image>

<Image src={require('./coil_02.jpg').default} width="600px">The coil former assembled.</Image>

<Image src={require('./coil_03.jpg').default} width="600px">The coil completed, ready to slide on the barrel.</Image>
