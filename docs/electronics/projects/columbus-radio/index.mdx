...
<Image src={require('./columbus-radio-010-original-front.jpg').default} width="535px">The original front-panel of the Columbus radio.</Image>
...
<Image src={require('./columbus-radio-020-original-radio-from-back.jpg').default} width="589px">The original rear of the cabinet. Valves, air capacitors and pulley systems!</Image>

 The original electronics!

<Image src={require('./columbus-radio-250-the-original-electronics-woah.jpg').default} width="763px">The original electronics of the Columbus radio, housed in the underside of the metal case which sat in the radio cabinet.</Image>
...
<Image src={require('./columbus-radio-040-original-speaker.jpg').default} width="706px">The original Columbus radio speaker.</Image>
...
<tbody>
<tr>
<td><Image src={require('./columbus-radio-050-maxistrip-paint-stripper.jpg').default} width="253px">The Maxistrip paint stripper.</Image></td>
<td><Image src={require('./columbus-radio-060-easy-spray-paint-stripper.jpg').default} width="171px">The 'Dad's Easy Spray' paint stripper.</Image></td>
<td><Image src={require('./columbus-radio-070-coopers-paint-stripper.jpg').default} width="176px">The Cooper's stripper.</Image></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td><Image src={require('./columbus-radio-075-trying-the-maxistrip.jpg').default} width="232px">Testing out the Maxistrip stripper.</Image></td>
<td><Image src={require('./columbus-radio-080-coating-radio-with-stripper.jpg').default} width="421px">Applying the stripper.</Image></td>
</tr>
</tbody>
</table>
...
<Image src={require('./columbus-radio-090-scraping-the-varnish-off.jpg').default} width="722px">Removing the stripper goop after about 20mins of soaking.</Image>

Yay, it works! You can see the bare wood (on the side) coming up nicely in the photo below:

<Image src={require('./columbus-radio-120-difference-between-stripped-and-original.jpg').default} width="585px">Comparison between the stripped and non-stripped wooden surfaces of the cabinet.</Image>
...
<table>
  <tbody>
    <tr>
      <td><Image src={require('./columbus-radio-124-comparison-maxistrip.jpg').default} width="346px">A wooden surface stripped using Maxistrip.</Image></td>
      <td><Image src={require('./columbus-radio-125-comparison-coopers.jpg').default} width="347px">A wooden surface stripped using Cooper's.</Image></td>
    </tr>
  </tbody>
</table>
...
<Image src={require('./columbus-radio-130-removing-the-columbus-logo.jpg').default} width="647px">Sadly removing the 'Columbus' logo.</Image>

I had to mask of the speaker port while stripping the front panel.

<Image src={require('./columbus-radio-135-masking-speaker-port-while-stripping.jpg').default} width="428px">Masking of the speaker port while stripping the front face of the cabinet.</Image>

Don't forget the strip the dials! These had intricate carvings of the Columbus ship on them.

<Image src={require('./columbus-radio-140-stripping-the-knobs.jpg').default} width="544px">Stripping back the intricate dials of the Columbus radio.</Image>
...
<Image src={require('./columbus-radio-145-cabinent-all-stripped-ready-for-moisturising.jpg').default} width="538px">All stripped and already looking better than the before!</Image>
...
<Image src={require('./columbus-radio-155-moisturising-the-cabinent.jpg').default} width="492px">Moisturising the cabinet.</Image>
...
<Image src={require('./columbus-radio-190-finished-the-cabinent.jpg').default} width="656px">The cabinet looking swag after moisturising!</Image>
...
<Image src={require('./columbus-radio-160-coating-the-inside-with-no-borer.jpg').default} width="533px">Giving the inside of the cabinet a good coat of 'no borer'.</Image>
...
<Image src={require('./columbus-radio-300-raspberry-pi-b-plus.jpg').default} width="444px">The RaspberryPi B+ I used as for the smarts inside Columbus radio.</Image>
...
<Image src={require('./columbus-radio-200-removing-the-original-speaker.jpg').default} width="371px">Removing the existing Columbus radio speaker.</Image>
...
<table><tbody ><tr>
<td ><Image src={require('./columbus-radio-210-installing-6x9-mount.jpg').default} width="268px">Installing the 6x9 mount for the front speaker.</Image></td>
<td ><Image src={require('./columbus-radio-220-installing-6x9-speaker.jpg').default} width="268px">Installing the front 6x9 speaker.</Image></td>
</tr></tbody></table>

 Installing the rear speaker:

<Image src={require('./columbus-radio-241-rear-facing-speaker.jpg').default} width="564px">Installing the rear 6x9 speaker.</Image>
...
<Image src={require('./columbus-radio-230-making-room-for-psu.jpg').default} width="417px">Chiseling away some small bits of wood in the cabinet to make room for the PSU.</Image>
...
<tbody>
<tr>
<td><Image src={require('./columbus-radio-345-removing-old-indicator.jpg').default} width="250px">Removing the existing valve-based indicator.</Image></td>
<td><Image src={require('./columbus-radio-350-place-for-indicator.jpg').default} width="257px">I now had to find something to fit into the gap...</Image></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td><Image src={require('./columbus-radio-353-new-indicator.jpg').default} width="300px">Making up a mount for a 12V, 100mA bulb to replace the valve-based indicator.</Image></td>
<td><Image src={require('./columbus-radio-356-gluing-new-indicator-into-place.jpg').default} width="300px">Hot-gluing the bulb into the front glass face from the back.</Image></td>
</tr>
</tbody>
</table>
...
<Image src={require('./columbus-radio-360-wiring-up-a-pot.jpg').default} width="600px">Wiring up from the RaspberryPi daughter board to an existing potentiometer on the Columbus radio. This one was used for volume control.</Image>
...
<tbody>
<tr>
<td><Image src={require('./columbus-radio-310-cutting-out-daughter-board.jpg').default} width="378px">Cutting out a RaspberryPi daughter board from strip-board prototyping PCB.</Image></td>
<td><Image src={require('./columbus-radio-320-fitting-daughter-board.jpg').default} width="285px">Fitting the daughter board directly onto the RaspberryPi's GPIO header. This was designed so the entire thing could still fit inside a standard Pi B+ enclosure.</Image></td>
</tr>
</tbody>
</table>
...
<Image src={require('./raspberry-pi-gpio-layout-model-b-plus-800.jpg').default} width="300px">The GPIO header layout of the RaspberryPi B+. Image from http://www.raspberrypi-spy.co.uk/2014/07/raspberry-pi-b-gpio-header-details-and-pinout/.</Image>
...
<Image src={require('./columbus-radio-330-populated-daughter-board.jpg').default} width="600px">The completed daughter board.</Image>
...
<Image src={require('./volumio-sudo-upgrade-screenshot.png').default} width="568px">Part-way through the sudo -y upgrade process on the volumio.</Image>
...
<Image src={require('./potentiometer-not-moving-but-adc-values-changing.png').default} width="654px">Screenshot a python script reading back the ADC value from the old potentiometer and converting it into the volume. Even though the potentiometer was not moving, the volume value was varying wildly.</Image>
...
<Image src={require('./columbus-radio-440-volumio-ssh-and-rsync-screenshot.png').default} width="965px">Copying the repository to the RaspberryPi using rsync, and then loading the code through SSH.</Image>
...
<Image src={require('./columbus-radio-430-screenshot-of-python-hardware-ui-code.png').default} width="630px">Screenshot of part of the Python 'hardware UI' script.</Image>
...
<Image src={require('./columbus-radio-420-closeup-on-stand-with-effect.jpg').default} width="904px">The finished Columbus radio, streaming music from the internet using Volumio and Spotify!</Image>
...
<Image src={require('./columbus-radio-600-time-logs.png').default} width="922px">The time logs for the Columbus Radio project.</Image>

The time spent (in hours) by date:

<Image src={require('./columbus-radio-610-graph-time-worked-by-date.png').default} width="635px">The time spend on the Columbus Radio project by date.</Image>

The time spent on the Columbus Radio project (as a percentage) by category:

<Image src={require('./columbus-radio-620-graph-time-worked-by-category.png').default} width="699px">Time spent by category on the Columbus Radio project.</Image>

## Material Cost Statistics

The individual material costs of each item used to build the Columbus Radio.

<Image src={require('./columbus-radio-630-table-material-cost.png').default} width="864px">The material costs of each component used to build the Columbus Radio.</Image>

 And now as a pretty pie chart (as a percentage of the total cost):

<Image src={require('./columbus-radio-640-graph-material-cost-by-component.png').default} width="818px">The material costs (as a percentage) of the components used to build the Columbus Radio.</Image>
