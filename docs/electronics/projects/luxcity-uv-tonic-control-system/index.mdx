...
<Image src={require('./arduino-8-ch-relay-channel-02.jpg').default} width="250px">The Freetronics 8-channel relay driver shield for the Arduino.</Image>
...
<Image src={require('./freetronics-relay-driver-schematic-snapshot-of-1-channel.png').default} width="500px">Part of the schematics for the Freetronics 8-channel relay driver shield showing one channel.</Image>

## 64x SPDT 12V Relays

<Image src={require('./64-12v-relays.jpg').default} width="500px">64 12V relays.</Image>
...
<Image src={require('./12v-solenoid-valve-02.jpg').default} width="320px">A 12V solenoid valve. 62 of these were used to control the flow of UV-reactive tonic water or air through the pipes.</Image>
...
<Image src={require('./solenoid-minimum-operating-pressure.png').default} width="500px"></Image>
...
<Image src={require('./twin-power-supplies.jpg').default} width="320px">Twin 500W power supplies to turn on up to half of the relays and solenoids all at once.</Image>
...
<Image src={require('./arduino-lcd-shield-02.jpg').default} width="320px">The Freetronics LCD shield for the Arduino. This was used to display running information to the user.</Image>
...
<Image src={require('./vixen-software-logo.jpg').default} width="300px">The Vixen software logo. Image from http://www.vixenlights.com.</Image>
...
<Image src={require('./vixen-screenshot-tonic-test-sequence.png').default} width="600px"></Image>
...
<Image src={require('./arduino-and-relay-shield-stack-vertical.jpg').default} width="600px">A Ardunio stack with the Uno (at bottom), 8 relay shields, and an LCD shield on-top.</Image>

Wiring up the relay boards.

<Image src={require('./relay-shiled-wiring-02.jpg').default} width="600px">More wires!</Image>

Placement of the relays onto strip board (they JUST managed to fit all on one board).

<Image src={require('./relay-shield-wiring-and-relays-01.jpg').default} width="600px">Wiring up the relay shields, with the relays next door.</Image>

A quick way of breaking tracks on prototype board.

<Image src={require('./quick-way-of-breaking-tracks-on-prototype-board.jpg').default} width="600px">The quick way to break tracks on a prototype board.</Image>

Soldering the relays, relay coil inputs, and power connectors to the board.

<Image src={require('./soldering-prototype-board.jpg').default} width="600px">Soldering up the prototype board.</Image>

The 62 solenoid valves.

<Image src={require('./solenoids-in-a-box.jpg').default} width="600px">All of the 62 solenoids, in a box.</Image>
...
<Image src={require('./string-of-diodes.jpg').default} width="600px">String of diodes for quenching the inductive kick of the solenoids.</Image>

The Arduino, relay control boards, and the relay board, semi-assembled.

<Image src={require('./arduino-and-relays-semi-assembled.jpg').default} width="600px">The Arduino and relays semi-assembled.</Image>
...
<Image src={require('./finished-soldering-the-prototype-board.jpg').default} width="600px">The bottom-side of the prototype board, fully soldered. Notice the heavy duty rails that deliver the power to the relays/solenoids. Even with these thick lines of solder, when half (31) of the solenoids where turned on, the board got considerably warm around the PSU entry point.</Image>

Wiring up the solenoids, as they need to have a 2m cable reach. I'm going through 100m cable rolls like it's Christmas.

<Image src={require('./lots-of-twisted-wire.jpg').default} width="600px">Lots of twisted wire for the solenoids.</Image>

The pile of wired solenoids. It took a good 8+ hours to wire these up!

<Image src={require('./pile-of-wired-solenoids.jpg').default} width="600px">The pile of wired solenoids. It took a good 8+ hours to wire these up!</Image>

Shorting out the green wire to ground on the PSU to get it to turn on.

<Image src={require('./grounding-the-green-wire-on-psu.jpg').default} width="600px">Grounding the green wire on the PSU to get it to turn on.</Image>

Adding small-valued power resistors in series with the PSU outputs to make them share the current equally.

<Image src={require('./current-sharing-power-resistors.jpg').default} width="600px">Adding small-valued power resistors in series with the PSU outputs to make them share the current equally.</Image>
...
<Image src={require('./heavy-duty-fuses.jpg').default} width="600px">The heavy duty fuses used to protect the +12V rails of the power supply. The two in use are 30A 5AG fuses, and the two spares are 40A.</Image>
...
<Image src={require('./lcd-screen-tonic-active.jpg').default} width="600px">The LCD screen working. This part was a breeze, it was an Arduino capable LCD shield, and there was a pre-written library for the firmware. It literally took less than 5 minutes to get working.</Image>

The solenoids were numbered so sequencing would become confusing when out in the field.

<Image src={require('./solenoid-number-3.jpg').default} width="600px">Numbering the solenoids...</Image>

Testing the complete system the night before it's due to be used.

<Image src={require('./circle-of-solenoids.jpg').default} width="600px">Testing the system in my living room the night before it's to be used.</Image>
...
<Image src={require('./vixen-tonic-generic-serial-output-plugin-settings.png').default} width="600px"></Image>

## Onsite

The manifold with the solenoids in place, being assembled on-site.

<Image src={require('./manifold-with-solenoids-in-place.jpg').default} width="600px">The manifold with the solenoids in place, being assembled on-site.</Image>

Carrying the water tank for the gin and tonic drinks down the road to the the construction site.


<Image src={require('./carrying-tank-down-road.jpg').default} width="600px">Carrying the water tank for the gin and tonic drinks down the road to the the construction site.</Image>

The tensioned cable structure being hoisted into the air by the crane.

<Image src={require('./structure-half-up-in-air.jpg').default} width="600px">The tensioned cable structure being hoisted into the air by the crane.</Image>

The annoying street-light which dampened the fluorescent effect.

<Image src={require('./bright-light-in-the-way.jpg').default} width="600px">A bright light that we couldn't turn off. This reduced the fluorescent effect of the tonic.</Image>

The pipes with tonic inside them, glowing with UV.

<Image src={require('./pipes-with-tonic-and-uv.jpg').default} width="600px">The central structure and the tonic-filled pipes glowing under UV light.</Image>

Gin and tonic!

<Image src={require('./gin-and-tonic-uv.jpg').default} width="600px">Gin and tonic glowing under UV light!</Image>

Some of the other structures at the Luxcity event.

<Image src={require('./altitude-02.jpg').default} width="600px">A view of Altitude from the centre.</Image>

<Image src={require('./scary-tree.jpg').default} width="600px"></Image>
