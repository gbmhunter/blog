...
<Image src={require('./basic-switched-capacitor-circuit.png').default} width="400">A basic switched-capacitor circuit.</Image>
...
<Image src={require('./phase-graph.png').default} width="600">Plot showing the on/off sequencing for the switches in the above schematic.</Image>
