...
<Image src={require('./antenna-symbol-open-top.svg').default} width="100">A schematic symbol for an antenna with an open top.</Image>
{/* {{% figure src="antenna-symbol-closed-top.svg" width="100px" caption="A schematic symbol for an antenna with an closed top." %}} */}
<Image src={require('./antenna-symbol-closed-top.svg').default} width="100">A schematic symbol for an antenna with an closed top.</Image>
</div>
...
<Image src={require('./battery-symbol.svg').default} width="200">The schematic symbol for a battery.</Image>
...
<Image src={require('./capacitor-symbol-unpolarized.svg').default} width="200">The schematic symbol for a non-polarised capacitor.</Image>
{/* {{% figure src="capacitor-symbol-polarized.svg" width="200px" caption="The schematic symbol for a polarised capacitor." %}} */}
<Image src={require('./capacitor-symbol-polarized.svg').default} width="200">The schematic symbol for a polarised capacitor.</Image>
{/* {{% figure src="capacitor-symbol-variable.svg" width="200px" caption="The schematic symbol for a variable capacitor." %}} */}
<Image src={require('./capacitor-symbol-variable.svg').default} width="200">The schematic symbol for a variable capacitor.</Image>
</div>
...
<Image src={require('./diode-symbol-general-purpose.svg').default} width="200">The recommended schematic symbol for an general purpose diode.</Image>
{/* {{% figure src="diode-symbol-schottky.svg" width="200px" caption="The recommended schematic symbol for an Schottky diode." %}} */}
<Image src={require('./diode-symbol-zener.svg').default} width="200">The recommended schematic symbol for an Zener diode.</Image>
...
<Image src={require('./diode-symbol-tvs-avalanche.svg').default} width="200">The recommended schematic symbol for a unidirectional avalanche diode (including TVS diodes).</Image>
{/* {{% figure src="diode-symbol-led.svg" width="200px" caption="The recommended schematic symbol for an LED." %}} */}
<Image src={require('./diode-symbol-led.svg').default} width="200">The recommended schematic symbol for an LED.</Image>
</div>
...
<Image src={require('./fuse-symbol.svg').default} width="200">Schematic symbol for a fuse.</Image>
...
<Image src={require('./ferrite-bead-symbol.svg').default} width="200">The schematic symbol for a ferrite bead.</Image>
...
<Image src={require('./fiducial-symbol.svg').default} width="200">The schematic symbol for a fiducial.</Image>
...
<Image src={require('./gdt-schematic-symbol-2-electrode.svg').default} width="250">Schematic symbol and designator for a 2-electrode gas discharge tube (GDT).</Image>
<Image src={require('./gdt-schematic-symbol-3-electrode.svg').default} width="250">Schematic symbol and designator for a 3-electrode gas discharge tube (GDT).</Image>
</div>
...
<Image src={require('./ground-symbol-signal.svg').default} width="250">The schematic symbol for a signal (general) ground.</Image>
<Image src={require('./ground-symbol-earth.svg').default} width="250">The schematic symbol for a earth ground.</Image>
<Image src={require('./ground-symbol-chassis.svg').default} width="250">The schematic symbol for a chassis ground.</Image>
</div>
...
<Image src={require('./integrated-circuit-schematic-symbol-u1.png').default} width="200">Recommended schematic symbol for an integrated circuit (IC).</Image>
...
<Image src={require('./resistor-schematic-symbol-r1.png').default} width="250">The schematic symbol for a standard resistor.</Image>
<Image src={require('./variable-resistor-potentiometer-schematic-symbol.png').default} width="250">The schematic symbol for a variable resistor (potentiometer).</Image>
</div>
...
<Image src={require('./spark-gap-schematic-symbol-triangular-200um-no-bom.png').default} width="200">A schematic symbol for a spark gap. This spark gap is created with two triangles of copper on the PCB, with a gap of 200um between them. As this is made purely from the PCB, there is no BOM component needed.</Image>
...
<Image src={require('./transistor-symbols.svg').default} width="700">Schematic symbols for a variety of different transistor types. Showing the circle around the BJT or the body diode of the MOSFET is personal choice, however I do recommend showing the MOSFET body diode so you don't forget it's there when designing a circuit!</Image>
...
<Image src={require('./crystal-schematic-symbol.png').default} width="200">The schematic symbol for a crystal.</Image>
...
<Image src={require('./varistor-symbol-mov.svg').default} width="200">Schematic symbol for a varistor (e.g. MOV) (recommended).</Image>
