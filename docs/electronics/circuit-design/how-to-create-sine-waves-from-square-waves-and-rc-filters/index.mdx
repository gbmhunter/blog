...
<Image src={require('./four-rc-filter-sine-wave-generator-schematic.png').default} width="900">Schematic of a sine wave generator circuit using a square wave input and 4 RC filter stages.</Image>
...
<Image src={require('./sim-four-stage-rc-filter-fft-of-input-plot.png').default} width="600">The time domain voltage signal of a 10kHz 3.3V square wave (top) and the FFT of this signal (bottom).</Image>
...
<Image src={require('./sim-four-stage-rc-filter-schematic.png').default} width="700">Schematic for our 10kHz sine wave generator.</Image>
...
<Image src={require('./sim-four-stage-rc-filter-output-plot.png').default} width="700">Simulation results for the four-stage RC filter based sine wave generator circuit.</Image>
...
<Image src={require('./sim-four-stage-rc-filter-bode-plot.png').default} width="700">Bode plots for the four-stage RC filter based sine wave generator circuit.</Image>
...
<Image src={require('./sim-four-stage-rc-filter-thd.png').default} width="700">Plots showing the reduction in harmonic distortion through each successive RC filter stage.</Image>
...
<Image src={require('./sim-four-stage-rc-filter-thd-bar-plot.png').default} width="600">Plot showing the THD at each stage in the sine wave generator circuit.</Image>
