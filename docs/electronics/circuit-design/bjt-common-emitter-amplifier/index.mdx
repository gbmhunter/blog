...
<Image src={require('./common-emitter-amplifier-schematic.png').default} width="600">Schematic for a common emitter amplifier with DC bias and AC coupling.</Image>
...
<Image src={require('./common-emitter-amplifier-gain-equation-diagram.png').default} width="300" float="right">Diagram showing how the gain equation for a common emitter amplifier is found.</Image>
...
<Image src={require('./common-emitter-amplifier-design-process-schematic.png').default} width="800">The finished schematic of our common emitter amplifier, ready for simulation.</Image>
...
<Image src={require('./common-emitter-amplifier-simulation-vin-vout-plot.png').default} width="600">Simulation results showing $V_{OUT}$ vs. $V_{IN}$.</Image>
...
<Image src={require('./common-emitter-amplifier-simulation-freq-response-plot.png').default} width="600">The simulated frequency response of our common emitter amplifier.</Image>
