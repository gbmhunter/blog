...
<Image src={require('./_assets/basic-rc-schematic.webp').default} width="500">A basic RC charging circuit.</Image>
...
<Image src={require('./_assets/rc-charging-plot.png').default} width="700">A basic RC charging circuit.</Image>
