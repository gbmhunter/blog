...
<Image src={require('./_assets/basic-schematic-of-wheatstone-bridge.png').default} width="400">The basic schematic of a Wheatstone bridge (resistance bridge).</Image>
