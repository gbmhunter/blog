...
<Image src={require('./diagram-of-hs-in-complex-plane.png').default} width="600">Graphical representation of $H(s)$ on the complex plane and how the magnitude and phase are encoded into this.</Image>
...
<Image src={require('./poles-graph.png').default} width="900">Argand diagram showing how the location of poles (no zeroes shown) on a pole zero plots shows how components of the system respond to transients (i.e. impulses).</Image>
...
<Image src={require('./tuning-comparison-group-delay.png').default} width="600">Group delay plotted for a number of different 4-order filter tunings.</Image>
...
<Image src={require('./low-pass-rc-filter-mag.png').default} width="600">The magnitude response of the the low-pass RC filter, found by plotting $Eq.\ \ref{eq:mag-response-lp-rc-filter}$. Note that the magnitude has been converted into decibels with $dB = 20log10(mag)$.</Image>
...
<Image src={require('./low-pass-rc-filter-phase.png').default} width="600">The phase response of the the low-pass RC filter, found by plotting $Eq.\ \ref{eq:phase-response-lp-rc-filter}$</Image>
...
<Image src={require('./wolfram-alpha-transfer-function-analysis-screenshot.png').default} width="600">Screenshot of Wolfram Alpha's results when you provide it a transfer function[^bib-wolfram-alpha-transfer-function-2nd-order-bessel].</Image>
