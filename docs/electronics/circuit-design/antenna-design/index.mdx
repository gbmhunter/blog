...
<Image src={require('./_assets/rf-antenna-with-sma-connection.jpg').default} width="300">A standard 1-3GHz RF antenna with an SMA connection.</Image>
...
<Image src={require('./_assets/typical-minimum-component-clearances-from-pcb-antenna.png').default} width="800">The minimum recommended clearances between a PCB antenna and other components. Image from http://www.antenova-m2m.com/resources/literature.</Image>
