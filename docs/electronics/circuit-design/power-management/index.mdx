...
<Image src={require('./circuit-schematic-suicide-switch-with-usb-powered-lipo-charger.png').default} width="700">A circuit schematic of a 'suicide switch' powered from a USB port.</Image>
...
<Image src={require('./power-mgmt-ic-switching-on-48v-scope-trace.png').default} width="700">A scope trace of a power management IC switching on the output once the UVLO threshold is exceeded.</Image>
...
<Image src={require('./ina226-power-monitor-ic-internal-diagram-with-external-filtering.png').default} width="878">The internal diagram (with some external filtering circuitry) of the INA226 voltage/current/power monitoring IC. Image from http://www.ti.com/.</Image>
