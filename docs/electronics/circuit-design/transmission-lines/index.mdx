...
<Image src={require('./_assets/transmission-line-schematic-symbol.png').default} width="500">Schematic symbol for a transmission line, which represents a piece of coax cable. Because this usually isn't a component to appear on the BOM (if it's a PCB track), it's not normally given a designator.</Image>
...
<Image src={require('./_assets/microstrip-track-example-in-isometric-view-microchip.gif').default} width="300">An isometric diagram of a microstrip. Image from www.maximintegrated.com.</Image>
...
<Image src={require('./_assets/coplanaer-waveguide-for-gsm-antenna.png').default} width="490">A co-planer waveguide for a GSM antenna feed-line. The co-planar waveguide is the curved track that starts at E1. The three 0402 components are for a impedance matching circuit.</Image>
