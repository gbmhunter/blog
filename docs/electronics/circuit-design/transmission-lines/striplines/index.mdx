...
<Image src={require('./_assets/edge-coupled-stripline-impedance-controlled-routing-diagram-with-dimensions.png').default} width="827">A cross-sectional diagram of a edge-coupled stripline, showing the common names for the dimensions.</Image>
