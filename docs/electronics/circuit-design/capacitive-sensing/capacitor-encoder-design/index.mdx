...
<table>
  <tbody>
    <tr>
      ...
      <td><Image src={require('./linear-nm1-cap-encoder-passive-pcb-image.png').default} width="400">A linear capacitive encoder passive PCB.</Image></td>
      {/* <td>{{% figure src="linear-nm1-cap-encoder-active-pcb-image.png" caption="A linear capacitive encoder active PCB."  width="400px" %}}</td> */}
      <td><Image src={require('./linear-nm1-cap-encoder-active-pcb-image.png').default} width="400">A linear capacitive encoder active PCB.</Image></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td><Image src={require('./rotational-nm1-capacitive-encoder-passive-pcb-image.png').default} width="400">A rotational capacitive encoder passive PCB.</Image></td>
      ...
      <td><Image src={require('./rotational-nm1-capacitive-encoder-active-pcb-image.png').default} width="400">A rotational capacitive encoder active PCB.</Image></td>
    </tr>
  </tbody>
</table>
...
<Image src={require('./165um-dielectric-3m-467mp-half-peeled-off-backing.jpg').default} width="400">165um plastic dielectric (3M 467MP).</Image>
...
<Image src={require('./cap-encoder-individual-cdc-waveform-graphs-for-both-tracks.jpg').default} width="800">The individual waveforms for each CDC channel on both the N and N-1 tracks (for use with an absolute algorithm).</Image>
...
<Image src={require('./cap-encoder-grouped-cdc-waveform-graphs-for-both-tracks.jpg').default} width="800">The grouped waveforms (all 6 channels) for both the N and N-1 tracks (for use with an absolute algorithm).</Image>
...
<Image src={require('./cdc-vs-time-graph-showing-different-offsets-of-each-channel.jpg').default} width="800">CDC values vs. time graph showing the different offsets each channel can have.</Image>
...
<Image src={require('./cdc-phase-difference-graph-showing-noisy-stepwise-increments.jpg').default} width="800">Graph showing the stepwise incrementing of the phase difference between the two calculated positions of the CDC tracks.</Image>
