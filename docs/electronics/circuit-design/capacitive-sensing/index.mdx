...
<Image src={require('./capacitive-encoder-photo-cui-amt.jpg').default} width="300">The CUI AMT100 series capacitive encoders with up to 2048 counts per revolution. Image from http://www.engineerlive.com/Asia-Pacific-Engineer/Time_Compression/Capacitive_encoder_offers_versatility/22119/.</Image>
...
<table>
    <tbody>
        <tr>
            ...
            <td><Image src={require('./digital-calliper-capacitive-encoder-strip-up-close-photo.jpg').default} width="284">A zoomed in photo of the capacitive linear encoder pads on a digital calliper. Image from http://www.iceinspace.com.au/forum/showthread.php?t=80356.</Image></td>
            ...
            <td><Image src={require('./capacitance-strip-dimensions-for-linear-encoder.jpg').default} width="321">The dimensions for a capacitive linear encoder commonly found in digital callipers. Image from http://www.iceinspace.com.au/forum/showthread.php?t=80356.</Image></td>
        </tr>
    </tbody>
</table>
</div>
...
Section 3.1 of the "Basic Linear Design" book by Analog Devices. Freely available from <a href="http://www.analog.com/library/analogDialogue/archives/43-09/linear_circuit_design_handbook.html">http://www.analog.com/library/analogDialogue/archives/43-09/linear_circuit_design_handbook.html</a>.

{/* {{% figure src="toc-section-3-1-analog-devices-basic-linear-design-book-capactivie-sensings-highlighted.png" width="800px" %}} */}
<Image src={require('./toc-section-3-1-analog-devices-basic-linear-design-book-capactivie-sensings-highlighted.png').default} width="800">Section 3.1 of the "Basic Linear Design" book by Analog Devices. Freely available from <a href="http://www.analog.com/library/analogDialogue/archives/43-09/linear_circuit_design_handbook.html">http://www.analog.com/library/analogDialogue/archives/43-09/linear_circuit_design_handbook.html</a>.</Image>
