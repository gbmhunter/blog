...
<Image src={require('./dev-kit-featuring-sim900-gprs-module-and-sma-antenna.jpg').default} width="398">Development kit featuring the SIM900 GPRS module and a SMA antenna.</Image>
