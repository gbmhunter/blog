...
<Image src={require('./pmsm-motor-control-architecture-with-psoc-micro.png').default} width="1372">The FOC control architecture for a PMSM motor with a PSoC microcontroller.</Image>
