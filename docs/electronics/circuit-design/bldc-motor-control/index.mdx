...
draft: false
images: [/electronics/circuit-design/bldc-motor-control/rp17-bldc-motor-nema-17.jpg]
lastmod: 2020-05-12
...
<Image src={require('./rp17-bldc-motor-nema-17.jpg').default} width="258">A standard-looking BLDC motor in a NEMA-17 enclosure.</Image>
...
<Image src={require('./psoc-bldc-schematic-luts-and-multiplexors-for-phase-drive.png').default} width="1000">A PSoC schematic containing LUTs and multiplexors for trapezoidal-control of a BLDC motor.</Image>
...
<Image src={require('./16-bit-500-count-sine-wave-lut-data-graph-1.png').default} width="1069">Data extracted from a 16-bit sine wave LUT designed for use with sinusoidal BLDC motor control.</Image>
...
<Image src={require('./clark-transformation-alpha-beta-geometric-interpretation.gif').default} width="516">A geometric interpretation of the Clark (alpha-beta) transformation. Image from http://en.wikipedia.org/wiki/%CE%91%CE%B2%CE%B3_transform.</Image>
...
<Image src={require('./park-transformation-d-q-geometric-interpretation.jpg').default} width="976">A geometric interpretation of the Park (dq) transformation. Image from http://en.wikipedia.org/wiki/Dqo_transformation.</Image>
...
<Image src={require('./pmsm-motor-control-architecture-with-psoc-micro.png').default} width="1000">The FOC control architecture for a PMSM motor with a PSoC microcontroller.</Image>
...
<Image src={require('./nema-17-motor-mounting-dimensions.jpg').default} width="497">The NEMA17 mounting hole dimensions .The dimensions are in millimeters. Image from http://www.xylotex.com/FAQ.htm.</Image>

The NEMA23 mounting hole dimensions are shown below. The dimensions are in inches.

<Image src={require('./nema-23-motor-mounting-dimensions.jpg').default} width="595">The NEMA23 mounting hole dimensions .The dimensions are in inches. Image from http://www.xylotex.com/FAQ.htm.</Image>
