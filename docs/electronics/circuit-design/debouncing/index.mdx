...
<Image src={require('./example-switch-waveform-needs-debouncing.webp').default} width="600">An example output from a button press, which needs debouncing.</Image>
...
<Image src={require('./rc-debouncing-circuit.webp').default} width="600">A simple RC debouncing circuit.</Image>
...
<Image src={require('./rc-debouncing-waveforms.webp').default} width="900">RC debouncing waveforms.</Image>
