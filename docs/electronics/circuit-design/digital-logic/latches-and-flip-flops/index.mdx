...
<Image src={require('./cover-image.png').default} width="600"></Image>
...
<Image src={require('./what-type-of-flipflop.png').default} width="700">We're talking about the flip-flops on the right, not the left. If you're not following along, don't worry, this is a New Zealand thing :-D.</Image>
...
<Image src={require('./sr-latch-from-nor-gates.svg').default} width="500">A SR latch made from NOR gates.</Image>
...
<Image src={require('./sr-latch-from-nand-gates.png').default} width="500">A SR latch made from two NAND gates.</Image>
...
<Image src={require('./sr-latch-nand-sim/schematic.png').default} width="500"></Image>
...
<Image src={require('./sr-latch-nand-sim/transient-analysis.png').default} width="900"></Image>
...
<Image src={require('./sr-latch-from-nor-gates-states-red-black.svg').default} width="800">(A): A SR latch in the reset state. (B): A SR latch in the set state. Red represents logical "1", black logical "0".</Image>
...
<Image src={require('./d-latch-from-nand-gates.png').default} width="700">A D latch made from NAND gates and an inverter.</Image>
...
<Image src={require('./d-latch-from-nand-gates-simplified.png').default} width="700">A simplified D latch without an inverter.</Image>
...
<Image src={require('./d-latch-from-transmission-gates.png').default} width="500">A D latch made from transmission gates.</Image>
...
<Image src={require('./jk-flipflop-symbol.png').default} width="400">The schematic symbol for a JK latch.</Image>
...
<Image src={require('./jk-flipflop-from-nand-gates.png').default} width="700">Circuit showing how to build a JK latch from NAND gates.</Image>

:::example

Let's simulate a NAND-based JK latch in Micro-Cap. The schematic is:

<Image src={require('./jk-flipflop-nand-sim/schematic.png').default} width="600">The simulation schematic for the JK latch.</Image>
...
<Image src={require('./jk-flipflop-nand-sim/schematic-sim-text.png').default} width="300">The supported simulation "text" that goes with the schematic. This defines the waveforms of the 3x digital stimulus and the initial conditions.</Image>
...
<Image src={require('./jk-flipflop-nand-sim/transient-analysis.png').default} width="1000">Annotated transient analysis of the JK flip-flop.</Image>
...
<Image src={require('./edge-detection-using-and-inverter.png').default} width="500">Simple edge detection circuit made with an inverter and AND gate.</Image>

And this is what the timing looks like:

<Image src={require('./edge-detection-using-and-inverter-timing-diagram.png').default} width="700">Positive edge-detecting circuit made from an inverter and an AND gate. This circuit exploits the non-zero propagation delay through the inverter.</Image>
...
<Image src={require('./edge-detection-using-and-inverter-sim/schematic.png').default} width="700"></Image>
...
<Image src={require('./edge-detection-using-and-inverter-sim/1-bit-digital-stimulus-config.png').default} width="500px"></Image>

The resulting transient analysis is:

<Image src={require('./edge-detection-using-and-inverter-sim/transient-analysis.png').default} width="900px"></Image>
...
<Image src={require('./d-flipflop-symbol.png').default} width="700">The schematic symbols for a D-type flipflop. On the left is one WITH NO asynchronous set or reset, and the right is one WITH asynchronous set or reset.</Image>
...
<Image src={require('./d-flipflop-with-and-inverter.png').default} width="800">A D flip-flop made from a D NAND-based latch and additional edge-trigger circuit made with an AND gate and inverter.</Image>
...
<Image src={require('./master-slave-d-flip-flop-logic-diagram.png').default} width="800">How a master-slave D flip-flop can be built from two D latches and a bit of additional logic.</Image>
...
<Image src={require('./d-flipflop-with-more-nand-gates.png').default} width="600">A D-type flip-flop made solely from NAND gates. This version has no asynchronous set and clear inputs.</Image>
...
<Image src={require('./d-flipflop-nand-with-set-reset-sim/schematic.png').default} width="600px">The Micro-Cap schematic for simulating a edge-triggered D-type flip-flop with async. set and reset.</Image>

The resulting transient analysis looks as expected! (explanation below graph):

<Image src={require('./d-flipflop-nand-with-set-reset-sim/transient-analysis.png').default} width="900px">The transient analysis of the above circuit.</Image>
...
<Image src={require('./nexperia-74hc74-d-flip-flop-logic-diagram.png').default} width="700px">Logic diagram for 1 of the positive-edge triggered D-type flip-flops in the Nexperia 74HC74 IC. Note the complexity![^bib-nexperia-74hc74-ds]</Image>
...
<Image src={require('./ti-ls374-octal-edge-triggered-d-flip-flop-ic-logic-diagram.png').default} width="300px">Logic diagram of the Texas Instruments 74LS373 Edge-Triggered D-type Flip-flop IC[^bib-ti-ls374-ds].</Image>
...
<Image src={require('./jk-master-slave-flipflop-logic-diagram.png').default} width="900px">The construction of a master-slave JK flip-flop.</Image>
...
<Image src={require('./setup-and-hold-time-diagram.png').default} width="500px">Diagram showing how the setup and hold time are defined.</Image>
...
<Image src={require('./setup-and-hold-time-diagram-with-violation-examples.png').default} width="800px">Diagram illustrating the concept of setup and hold times, and showing 3 different data signals, one which is just ok, one which violates the setup time requirement and one which violates the hold time requirement.</Image>
...
<Image src={require('./toggle-flipflop-made-from-edge-triggered-d-type.png').default} width="800px">A toggle flip-flop made from an edge-triggered D-type flip-flop with it's nQ output connected to it's D input. The input signal is fed to it's CLK.</Image>
...
<Image src={require('./four-clock-cycle-delay-element-from-flipflops.png').default} width="800px">A simple four clock-cycle delay element made from four DQ flip-flops. This can be used as a simple timer.</Image>
