...
<Image src={require('./not-gate-symbol.svg').default} width="800">The symbols for a NOT gate (inverter).</Image>
...
<Image src={require('./and-gate-symbol.svg').default} width="800">The symbols for an AND gate.</Image>
...
<Image src={require('./and-gate-from-diodes-and-resistors.svg').default} width="300">An AND gate made from basic diode logic.</Image>
...
<Image src={require('./nand-gate-symbol.svg').default} width="800">The symbol for an NAND gate.</Image>
...
<Image src={require('./or-gate-symbol.svg').default} width="800">The symbol for an OR gate.</Image>
...
<Image src={require('./how-to-draw-the-or-gate.png').default} width="600">Diagram showing how to draw an OR gate from the segments of three equal diameter circles placed on a grid[^bib-spin-num-logic-gates].</Image>
...
<Image src={require('./nor-gate-symbol.svg').default} width="800">The symbols for a NOR gate.</Image>
...
<Image src={require('./xor-gate-symbol.svg').default} width="800">The symbols for a 2-input XOR (exclusive-or) gate.</Image>
...
<Image src={require('./xor-gate-made-from-ands-and-or.png').default} width="500">A XOR gate made from AND and OR gates, with some of the inputs inverted into the front-end of the AND gates.</Image>
...
<Image src={require('./xor-gate-made-from-and-nand-or.svg').default} width="500">A XOR gate made from 1 AND, NAND and OR gate.</Image>
...
<Image src={require('./xor-gate-made-from-nands.svg').default} width="600">A XOR gate made exclusively from NAND gates.</Image>
...
<Image src={require('./xor-gate-made-from-nors.svg').default} width="600">A XOR gate made exclusively from NOR gates.</Image>
...
<Image src={require('./xnor-gate-symbol.svg').default} width="800">The symbols for a XNOR gate.</Image>
...
<Image src={require('./rtl-logic-inverter.svg').default} width="400">A very basic logic "inverter" made from RTL.</Image>
...
<Image src={require('./rtl-logic-nor-gate.svg').default} width="400">Schematic of a RTL NOR gate. When both inputs are `LOW`, neither transistor is on and the output is pulled `HIGH` by $R_C$. Any `HIGH` input will turn on a transistor, which will drive the output `LOW`.</Image>
...
<Image src={require('./nmos-inverter-gate.png').default} width="200">The simple inverter made using NMOS technology.</Image>
...
<Image src={require('./nmos-nor-gate.png').default} width="300">A NOR gate made using NMOS technology.</Image>
...
<Image src={require('./cmos-inverter-gate.png').default} width="200">A CMOS inverter gate.</Image>
...
<Image src={require('./cmos-nand-gate.png').default} width="400">A 2-input CMOS NAND gate, built from two P-channel and two N-channel MOSFETs.</Image>
...
<Image src={require('./cmos-nand-gate-3-input.png').default} width="500">A schematic for a 3-input CMOS NAND gate.</Image>
...
<Image src={require('./cmos-nor-gate.png').default} width="400">A CMOS NOR gate.</Image>
...
<Image src={require('./cmos-and-gate.png').default} width="400">The schematic for building a 2-input CMOS AND gate. Notice how it's just a NAND gate with an inverter attached to the output.</Image>
...
<Image src={require('./cmos-or-gate.png').default} width="400">The schematic for building a 2-input CMOS OR gate. Notice how it's just a NOR gate with an inverter attached to the output.</Image>
...
<Image src={require('./cmos-xor-gate.png').default} width="600">A XOR gate built from CMOS logic.</Image>
...
<Image src={require('./tristate-inverter.png').default} width="000">Diagram showing how a tri-state converter can be made by combining the MOSFETs from a inverter and transmission gate into a single \"totem pole\" arrangement.</Image>
...
<Image src={require('./ptl-and-gate.png').default} width="500">An AND gate made from PTL logic.</Image>
...
<Image src={require('./ptl-xor-gate-8-tran.png').default} width="400">A XOR gate made from PTL logic. This XOR circuit uses a total of 8 transistors, less than the CMOS implementation that uses 12. But we can still do better!</Image>
...
<Image src={require('./ptl-xor-gate-6-tran.png').default} width="600">A XOR gate made in PTL logic with only 6 transistors[^bib-uni-waterloo-ptl].</Image>
...
<Image src={require('./digital-logic-counter-six-state-binary.png').default} width="700">Schematic of a six state binary counter.</Image>
...
<Image src={require('./digital-logic-counter-three-bit-grey-encoded-binary.png').default} width="700">Schematic of a three-bit Grey encoded binary counter.</Image>
