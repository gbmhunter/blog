...
<Image src={require('./1-bit-digital-stimulus-sim/1-bit-digital-stimulus-config.png').default} width="800px">Screenshot showing how to configure a 1-bit digital stimulus.</Image>

The above settings gives the following waveform if we perform a transient analysis:

<Image src={require('./1-bit-digital-stimulus-sim/transient-analysis.png').default} width="900px">Transient analysis for the 1-bit digital stimulus.</Image>
...
<Image src={require('./jk-flipflop-nand-sim/schematic.png').default} width="600px">The simulation schematic for the JK flip-flop.</Image>
...
<Image src={require('./jk-flipflop-nand-sim/transient-analysis-without-initial-conditions.png').default} width="900px">Simulation results without specifying initial conditions. The outputs get stuck in an indeterminate state forever.</Image>
...
<Image src={require('./jk-flipflop-nand-sim/initial-conditions.png').default} width="400px">The initial conditions specified for the JK flip-flop simulation.</Image>

Now the outputs start in a determinate state, and the simulation works as expected:

<Image src={require('./jk-flipflop-nand-sim/transient-analysis-with-initial-conditions.png').default} width="900px">Simulation with initial conditions.</Image>
