...
<Image src={require('./ngspice-main-window-windows-screenshot.png').default} width="600px">Screenshot of the main window of ngspice v34.0 when running on Windows.</Image>
