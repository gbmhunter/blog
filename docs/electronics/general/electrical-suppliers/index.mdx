...
<Image src={require('./avnet-logo.gif').default} width="100px"></Image>
...
<Image src={require('./digi-key-logo.jpg').default} width="100">The Digi-Key logo.</Image>
...
<Image src={require('./digi-key-automatic-bom-uploading-please-wait.png').default} width="320px"></Image>

<Image src={require('./digi-key-automatic-bom-uploading-selecting-excel-columns.png').default} width="700px"></Image>
...
<Image src={require('./element-14-logo.jpg').default} width="100px"></Image>
...
<Image src={require('./lcsc-logo.png').default} width="200px">The LCSC logo.</Image>
...
<Image src={require('./mouser-logo.jpg').default} width="100">The Mouser logo.</Image>
...
<Image src={require('./rs-components-logo.jpg').default} width="100">The RS Components logo.</Image>
...
<Image src={require('./alibaba-logo.jpg').default} width="100px">The Alibaba logo.</Image>
...
<Image src={require('./aliexpress-logo.jpg').default} width="100px">The AliExpress logo.</Image>
...
<Image src={require('./st-estore-free-samples.png').default} width="500">The ST eStore provides free samples for some of their parts, for example, the A6986ITR isolated buck converter[^bib-st-estore-free-samples].</Image>
...
<Image src={require('./microchip-direct-logo.png').default} width="300px">Microchip Direct's logo.[^bib-microchip-direct-home-page]</Image>
...
<Image src={require('./pcb-cart-logo.jpg').default} width="100">The PCB Cart logo.</Image>
...
<Image src={require('./jlc-pcb-logo.png').default} width="400">The logo for JLC PCB. Image from https://www.crunchbase.com/organization/jlcpcb, retrieved 2021-03-03.</Image>
...
<Image src={require('./pcb-zone-logo.jpg').default} width="100">The PCB Zone logo.</Image>
...
<Image src={require('./imp-logo.gif').default} width="100">The IMP logo.</Image>
