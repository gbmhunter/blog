...
<Image src={require('./sigh-altium.png').default} width="487px">Sigh. Altium.</Image>
...
<Image src={require('./altium-information-please-wait-a-moment-bug.jpg').default} width="284px">The annoying 'Please Wait A Moment' dialogue box that appears sometime while using Altium.</Image>

The error you sometimes get after the "Please Wait A Moment" box.

<Image src={require('./altium-access-violation-error.jpg').default} width="475px">An access violation error message which can occur when using Altium.</Image>

UPDATE: As of Altium v14.0, running on a Windows 8 machine, I have noticed far fewer of these errors!

<Image src={require('./altium-crash-please-wait-a-moment-i-was-lucky-enough-to-get-two-at-once.png').default} width="493px">Ohhhh look, I was lucky enough to get two at once!</Image>
...
<Image src={require('./task-manager-quickly-closing-altium-end-task.png').default} width="445px">Quickly closing Altium when it crashes.</Image>
...
<Image src={require('./altium-bug-argument-out-of-range-error-while-pcb-routing.png').default} width="580px">The fatal 'Argument out of range' error that can occur while routing tracks in Altium.</Image>
...
<Image src={require('./altium-not-drawing-almost-complete-circle-arcs.jpg').default} width="1127px">Altium will make arcs disappear on certain zoom levels if the arc is almost fully circular.</Image>
...
<table>
    <tbody>
        <tr>
            <td><Image src={require('./altium-not-exporting-holes-properly-before.jpg').default} width="369px">Hole in PCB.</Image></td>
            <td><Image src={require('./altium-not-exporting-holes-properly-after.jpg').default} width="382px">Hole covered over in step file output.</Image></td>
        </tr>
    </tbody>
</table>
...
<Image src={require('./altium-removing-solder-and-paste-mask.jpg').default} width="1233px">How to remove a solder or paste mask completely from a pad/via.</Image>
...
<Image src={require('./altium-library-search-without-asterisk.jpg').default} width="800px">Searching an Altium component library without an asterisk.</Image> <Image src={require('./altium-library-search-with-asterisk.jpg').default} width="800px">Searching an Alitum component library with an asterisk.</Image>
...
<Image src={require('./altium-polygon-clearance-rule.jpg').default} width="970px">The 'Polygon Clearance' rule in Alitum. Make sure you use 'InPolygon' and not 'IsPolygon'.</Image>
...
<Image src={require('./altium-keepout-layer-track-size.jpg').default} width="1414px">Changing the keepout layer track size.</Image>
...
<Image src={require('./altium-selecting-scaled-print.jpg').default} width="570px">Selecting 'Scaled Print' to print a 1:1 drawing of the PCB. Good for component footprint checking!</Image>
...
<Image src={require('./altium-detecting-acute-angles-under-pads.jpg').default} width="1533px">Altium has a bug where it reports acute angle rule violations of tracks that are under pads.</Image>
...
<Image src={require('./altium-layer-stack-up-manager-giving-wrong-height.jpg').default} width="1055px">The stack-up manager in Altium reporting the wrong height.</Image>
...
<Image src={require('./altium-script-combobox-loses-items-on-restart.jpg').default} width="573px">Altium forgets any items you assigned to a combo box through GUI after saving and restarting.</Image>
...
<Image src={require('./altium-bug-screen-artifact.png').default} width="521px">A screen artifact/glitch in Altium.</Image>
...
<Image src={require('./altium-parameter-manager-clearing-cells-takes-a-long-time-bug.png').default} width="1196px">When clearing a large number of cells (>20) in the Parameter Manager , Altium can take plenty of time, stalling the program in the process (it looks as though Altium has locked up).</Image>
...
<Image src={require('./objects-going-outside-of-the-pcb-boundry-in-altium.png').default} width="807px">Accidentally pushing objects outside of the PCB editor boundary can be a hassle to remove when designing a PCB in Altium.</Image>
...
<Image src={require('./schematic-parameters-unremovable-annotated.png').default} width="728px">This schematic parameter is un-removable!</Image>
...
<Image src={require('./altium-multi-line-pcb-string-made-from-single-line-strings.png').default} width="1276px">In Altium, multi-line PCB strings have to be made from many single-line strings.</Image>
...
<Image src={require('./altium-schematic-symbol-pin-properties-highlighting-hidden-pin-connect-to.png').default} width="486px">The 'Pin Properties' window in the Altium schematic symbol library editor. The 'Hide' and 'Connect To' fields give the allusion you can hide a pin and connect it to another, visible pin.</Image>
...
<Image src={require('./altium-bug-bom-table-field-name-missing-error.png').default} width="1225px">A screenshot of the 'Table: Field name Missing' error in Altium.</Image>
...
<Image src={require('./altium-bug-bom-table-field-name-missing-parameter-manager-no-names-annotated.png').default} width="877px">Hunting down unnamed parameters in the parameter manager to fix the 'Table: Field name missing' bug in Altium.</Image>
...
<Image src={require('./altium-pcb-editor-cant-handle-unicode-chars-ohms-symbols.png').default} width="1146px">Altium's PCB editor can't handle Unicode characters such as the Ohm (Omega) and degree symbol. This image shows how Altium will continuously try and update components that contain these symbols.</Image>
