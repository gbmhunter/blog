...
<Image src={require('./altium-stopping-rooms-from-being-added-to-pcb.jpg').default} width="799px">A screenshot showing how to stop Altium from adding rooms to the PCB.</Image>
...
<Image src={require('./altium-pairing-the-mechanical-layers.jpg').default} width="498px">Pairing mechanical layers in Altium.</Image>
...
<Image src={require('./example-of-hot-and-cold-altium-pcb-layer-colours-annotated.png').default} width="1341px">An example showing the use of 'hot' and 'cold' PCB layer colours in Altium to help distinguish between top and bottom associated objects.</Image>
...
<Image src={require('./altium-library-search-cap-name-standards.png').default} width="350px">Searching through an Altium schematic library.</Image>
...
<Image src={require('./adding-special-component-links-to-a-component-in-altium.png').default} width="1139px">Adding a special component link to the components datasheet in Altium.</Image>
...
<Image src={require('./quickly-going-to-a-datasheet-using-a-component-link-in-the-right-click-menu-in-altium.png').default} width="418px">Quickly going to the component datasheet by using a component link parameter in Altium.</Image>
...
<Image src={require('./altium-use-transparent-layers.jpg').default} width="1217px">Turning on the transparent layer option in Altium. Very useful when routing complex multi-layer boards!</Image>

Here is an example showing layers when set to Transparent mode.

<Image src={require('./altium-transparent-layers-example.jpg').default} width="1839px">An example of the PCB view in Altium when using transparent layers.</Image>
...
<Image src={require('./pads-with-direct-connect-and-thermal-relief.png').default} width="440px">A terminal block pad with direct connections to a polygon (+24V-MOTOR) and a pad with thermal relief connections (GND).</Image>
...
<Image src={require('./altium-adding-pads-to-the-direct-connect-pad-class.png').default} width="720px">Adding pads to the new 'DirectConnect' pad class.</Image>
...
<Image src={require('./altium-making-new-direct-conect-rule-for-pad-class.png').default} width="772px">Making a new 'Direct Connect' rule for the pad class.</Image>
...
<Image src={require('./altium-settings-open-internet-links-in-external-web-browser-annotated.png').default} width="390px">Checking 'Open internet links in external web browser' will stop Altium from trying to open them.</Image>
...
<table>
  <tbody>
    <tr>
      <td><Image src={require('./altium-footprint-wizard-adds-vias-to-centre-pads-01.png').default} width="182px">The footprint wizard in Altium has automatically added three thermal vias to this QFN package.</Image></td>
      <td><Image src={require('./altium-footprint-wizard-adds-vias-to-centre-pads-02.png').default} width="198px">I recommend that you remove these vias and instead add them as needed at the PCB routing stage of the design process.</Image></td>
      <td><Image src={require('./altium-footprint-wizard-adds-vias-to-centre-pads-03.png').default} width="191px">Also, I prefer to rename the thermal pin to pin number '0'.</Image></td>
    </tr>
  </tbody>
</table>
