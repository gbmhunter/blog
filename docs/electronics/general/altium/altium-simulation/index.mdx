...
<Image src={require('./frequency_response_01.jpg').default} width="320px">A first-order high-pass filter with a cut-off frequency of 15.9kHz.</Image>
...
<Image src={require('./frequency_response_02.jpg').default} width="320px">Find the frequency response by using the AC Small Signal Analysis feature of SPICE.</Image>
...
<Image src={require('./frequency_response_03.jpg').default} width="320px">Instruct Altium/SPICE to draw a magnitude function</Image>
...
<Image src={require('./frequency_response_04.jpg').default} width="320px">The resulting plot of the high-pass filter.</Image>
