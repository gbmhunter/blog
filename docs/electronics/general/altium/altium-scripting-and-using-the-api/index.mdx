...
<Image src={require('./_assets/running-hello-world-script-in-altium.png').default} width="893px">Running the Hello, world script in Altium.</Image>
...
<Image src={require('./_assets/altium-script-visual-studio-just-in-time-debugger-unhandled-exception-crash.png').default} width="438px">What happens when an exception is thrown in an Altium script.</Image>
...
<Image src={require('./_assets/altium-script-radio-group-example-screenshot.png').default} width="890px">Adding a TRadioGroup control to an Altium script UI.</Image>
...
<Image src={require('./_assets/pcb-script-bug-a-command-is-currently-active-and-save-cannot-be-completed-at-this-time.png').default} width="800px">You might get this error in Altium when trying to save because you have run a script which hasn't called PSBServer.PostProcess an equal number of times as PCBServer.PostProcess.</Image>
