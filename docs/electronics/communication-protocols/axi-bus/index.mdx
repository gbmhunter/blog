...
<Image src={require('./_assets/axi-bus-channel-architecture-of-reads-and-writes-diagram.png').default} width="422">The AXI bus channel architecture. Image from http://www.xilinx.com/support/documentation/ip_documentation/axi_ref_guide/v13_4/ug761_axi_reference_guide.pdf.</Image>
