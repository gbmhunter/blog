...
<Image src={require('./usb-adp-architecture-vbus-and-current-sources.png').default} width="786px">The ADP architecture, showing Vbus, current sources, and the snesing logic. Image from On-The-Go and Embedded Host Supplement to the USB Revision 2.0 Specification: Revision 2.0 version 1.1a.</Image>
...
<Image src={require('./at32uc3-dynamic-usb-power-consumtpion-table.png').default} width="743px">Table showing the dynamic USB power consumption of a AT32UC3A3 microcontroller during various USB transmission modes. Image from page 976 of http://www.atmel.com/Images/doc32072.pdf.</Image>
...
<Image src={require('./usb-surge-curr-01-750mA-surge-causing-vbus-to-drop-annotated.png').default} width="800px">A invalid surge current on the USB VBUS line of 750mA caused by the capacitance on the +3.3V when the rail powers up.</Image>
...
<Image src={require('./usb-surge-curr-02-100mA-current-limiter-added-vbus-doesnt-drop-annotated.png').default} width="800px">USB VBUS surge currents limited to appropriate values.</Image>
...
<Image src={require('./molex-mini-usb-type-b-plug-assembly-photo.jpg').default} width="320px">A photo of the Molex mini USB type B plug. Image from http://nz.element14.com/molex/47014-0008/mini-usb-type-b-plug-assembly/dp/1355758.</Image>
