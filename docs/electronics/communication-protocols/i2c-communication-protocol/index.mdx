...
<Image src={require('./i2c-logo.gif').default} width="200">The I2C logo.</Image>
...
<Image src={require('./i2c-pull-up-resistors.png').default} width="488">I2C pull-up resistors.</Image>
...
<Image src={require('./typical-application-schematic-for-i2c-io-expander.png').default} width="400">A typical application schematic for an I2C I/O expander.</Image>
...
<Image src={require('./i2c-slave-address-pins-logic-table-with-scl-sda-ability-ti-ina226.png').default} width="800">The logic table (truth table) of the I2C address pins on the TI INA226 IC. Notice how you can connect the address pins up to SCL or SDA as well as the standard VS and GND, to give a total of 16 possible I2C addresses[^bib-ti-ina226-power-mon].</Image>
...
<Image src={require('./i2c-10-bit-addressing-scheme-bit-pattern-of-address-bytes.gif').default} width="1000">The bit pattern of the two address bytes in the I2C 10-bit addressing scheme. Image from [i2c-bus.org](http://www.i2c-bus.org/).</Image>
...
<Image src={require('./i2c-buffer-ic-example.jpg').default} width="800">An example from a NXP application note showing how their P82B96 I2C-bus buffering IC can utilise buffering and twisted pairs to increase the I2C communication distance.</Image>
...
<Image src={require('./i2c-noise-from-long-cable.jpg').default} width="387">The cross-talk noise that occurs on long I2C transmission lines. This shows SCL (yellow) and SDA (blue) over an 8m ethernet cable.</Image>
...
<Image src={require('./i2c-long-cable-ground-no-ground.jpg').default} width="364">The difference grounding the other wire in a pair makes when transmitting I2C over twisted pair cables. The yellow trace is SCK (for reference), the white trace is SDA with the second wire floating, and the blue trace is SDA when the second wire is either grounded or connected to VCC. Notice a great reduction in cross-coupling on the blue trace. This was over a 20m ethernet cable.</Image>
...
<Image src={require('./c232hm-ddhsl-0-ftdi-usb-to-mpsse-cable.jpg').default} width="265">The C232HM-DDHSL-0 FTDI USB-to-MPSSE cable. Creates a bridge between your computer and a number of serial comm protocols such as SPI, I2C and UART.</Image>
...
<Image src={require('./typical-i2c-waveform.jpg').default} width="483">A typical I2C waveform. The top waveform is the clock (SCK), and the bottom waveform is the data (SDA). This shows a master trying to communicate with the slave, but the slave does not acknowledge (the ninth bit is high).</Image>
...
<Image src={require('./i2c-waveform-example-saleae-logic-analyser.png').default} width="800">i2c-waveform-example-saleae-logic-analyser</Image>
...
<Image src={require('./i2c-waveform-with-nak-saleae-logic-analyser.png').default} width="800">An I2C slave that doesn't respond, no ACK on the 9th clock pulse.</Image>
