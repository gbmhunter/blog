...
<Image src={require('./lm1893-example-circuit-power-line-comms-texas-instruments.png').default} width="800">Example circuit from Texas Instruments for the LM1893. Image from http://www.ti.com/lit/ds/snas544a/snas544a.pdf.</Image>
