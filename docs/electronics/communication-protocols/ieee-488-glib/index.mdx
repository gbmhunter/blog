...
<Image src={require('./gpib-ieee-488-keithley-daq.jpg').default} width="400">Photo of the Keithley DAQ6510 Data Acquisition And Logging module which uses the IEEE-488 (GPIB) bus.</Image>
