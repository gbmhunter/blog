...
<Image src={require('./mipi-alliance-logo.jpg').default} width="700">The MIPI Alliance logo. I couldn't find a logo specifically for the I3C protocol so this is the best substitute. Image from https://www.fierceelectronics.com/components/mipi-alliance-releases-mipi-i3c-sensor-interface-specification.</Image>
...
<Image src={require('./i3c-vs-i2c-energy-consumption-and-raw-data-rate.png').default} width="800">Energy consumption and data rate comparisons between I3C and I2C. Image from the publicly available MIPI I3C Basic specification.</Image>
