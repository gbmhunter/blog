...
<Image src={require('./pci-type-0-non-bridge-config-space-diagram-v2.png').default} width="624">The standardised registers that belong to the PCI/PCIe Type 0 (non-bridge) configuration space. Image from https://en.wikipedia.org.</Image>
...
<Image src={require('./screenshot-of-custom-pcie-card-in-device-manager.png').default} width="341">A screenshot of Windows Device Manager showing the presence of a custom PCIe card.</Image>
...
<Image src={require('./screenshot-of-custom-pcie-card-in-rw-everything.png').default} width="883">A screenshot of the RWEverything software while exploring the memory of a custom PCIe card inserted into a Windows PC.</Image>
