...
<Image src={require('./pcie-edge-connector-schematic-symbol-and-example-design.png').default} width="997">A PCIe card-edge connector schematic symbol and associated components.</Image>
