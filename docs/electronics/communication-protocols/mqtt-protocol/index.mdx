...
<Image src={require('./mqtt-logo.png').default} width="500">The MQTT logo. Image from https://www.eclipse.org/paho/, acquired 2021-03-30.</Image>
...
<Image src={require('./mqtt-sn-architecture.png').default} width="600">High-level diagram of the MQTT-SN architecture[^bib-oasis-open-mqtt-protocol-spec-v1.2].</Image>
