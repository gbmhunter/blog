...
<Image src={require('./rs232-comm-protocol-male-connector-large-pinout.png').default} width="350">The pinout of a male RS-232 DE-9 connector. Image from http://www.ethernut.de/.</Image>
...
<Image src={require('./analog-devices-rs-232-transceiver-pin-layout.png').default} width="242">Pinout of a RS-232 transceiver by Analog Devices.</Image>
...
<Image src={require('./low-cost-discrete-part-rs-232-to-ttl-converter-schematic-atmel-avr910.png').default} width="600">The schematic of a cheap, discrete-part RS-232 to TTL logic-level converter. Image from Atmel AVR910 (http://www.atmel.com/).</Image>
...
<Image src={require('./tripplite-rj45-to-db9f-cisco-serial-console-port-rollover-cable-photo.png').default} width="300">Photo of the TrippLite RJ45 to DB9F Cisco Serial Console Port Rollover Cable, 6 ft. (1.83 m)[^bib-tripp-lite-rj45-to-db9f-cable-ds].</Image>
