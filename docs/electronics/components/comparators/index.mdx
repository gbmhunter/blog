...
<Image src={require('./basic-op-amp-schematic-symbol.png').default} width="350">The basic schematic symbol for a comparator (it is the same for an op-amp).</Image>
...
<Image src={require('./comparator-hystersis-graph.png').default} width="334">A graph showing how comparator hystersis works.</Image>
...
<Image src={require('./comparator-push-pull-out-non-inverting-configuration.png').default} width="535">A schematic of a comparator in the non-inverting configuration.</Image>
