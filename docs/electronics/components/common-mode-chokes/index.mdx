...
<Image src={require('./common-mode-choke-schematic-symbol.png').default} width="300">The schematic symbol for a common-mode choke.</Image>
...
<Image src={require('./common-mode-choke-how-it-works-diagram.svg').default} width="700">Diagram showing how a common-mode choke works.</Image>
...
<Image src={require('./differential-noise-diagram.svg').default} width="700">Diagram showing what differential noise is and how it is commonly suppressed.</Image>
