...
<Image src={require('./_assets/analog-switch-circuit-two-mosfets.svg').default} width="600">Circuit diagram of a basic CMOS analogue switch, using one P-channel MOSFET ($Q1$) and one N-channel MOSFET ($Q2$).</Image>
...
<Image src={require('./_assets/analogue-switch-resistance-graph.png').default} width="600">Graph of the individual MOSFETs on resistance versus the switch voltage, and the combined on resistance seen by the external circuit (which is both resistances in parallel).</Image>
...
<Image src={require('./_assets/transmission-gate-symbols.png').default} width="900">Various schematic symbols used for transmission gates (the same thing as an analogue switch but used for digital signals).</Image>
...
<Image src={require('./_assets/nexperia-74hc74-d-flip-flop-logic-diagram.png').default} width="700">Logic diagram for 1 of the positive-edge triggered D-type flip-flops in the Nexperia 74HC74 IC. Note the complexity![^bib-nexperia-74hc74-ds]</Image>
...
<Image src={require('./_assets/intersil-isl43l410-analogue-switch-functional-diagram.png').default} width="250">Functional diagram of the Intersil ISL43L410 analogue switch. Image from http://www.intersil.com/content/dam/Intersil/documents/isl4/isl43l410.pdf.</Image>
...
<Image src={require('./_assets/maxim-ds3690-26-channel-transmission-gate-functional-diagram.png').default} width="300">The functional diagram for the Maxim DS3690 26-channel transmission gate[^bib-maxim-ds3690-ds].</Image>
