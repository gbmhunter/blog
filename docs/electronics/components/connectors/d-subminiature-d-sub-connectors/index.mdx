...
<Image src={require('./de-9-female-pcb-mount-d-sub-connector-photo.jpg').default} width="300">One of the most commonly used D-sub connectors of this era, the 9-pin female PCB-mount DE-9 connector.</Image> 
...
<Image src={require('./connector-db25-schematic-symbol.png').default} width="200">An easy-to-identify schematic symbol style for representing D sub-miniature connectors.</Image>
...
<Image src={require('./dsub-de-9-pin-numbers.png').default} width="500">Pin numbers for the male DE-9 connector, looking at the 'front' of the connector which mates with the female part.</Image>
...
<Image src={require('./dsub-db-9-female-male-photo-pin-numbers.png').default} width="500">Pin numbering for the D-sub DE-9 (a.k.a. DB-9) female and male connectors.</Image>
...
<Image src={require('./dsub-db-25-pin-numbers.png').default} width="500">Pin numbers for the male DB-25 connector, looking at the 'front' of the connector which mates with the female part.</Image>
...
<Image src={require('./d-sub-connector-with-c-filter-conec-graph-of-insertion-loss-vs-freq.pdf.png').default} width="551">A graph of insertion loss vs. frequency for a Conec D-sub connector with integrated capacitance for filtering (a 'C' filter).</Image>
...
<Image src={require('./te-connectivity-5205817-1-d-sub-screw-kit.jpg').default} width="254">The TE Connectivity 5205817-1 D-Sub screw kit.</Image>
...
<Image src={require('./amphenol-ltw-waterproof-serial-de-9-receptacle-connector.jpg').default} width="450">A waterproof DE-9 receptacle by Amphenol LTW.</Image>
