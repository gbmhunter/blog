...
<Image src={require('./m8-m12-connector-codings-te-connectivity.png').default} width="700">Common codings for M8/M12 circular connectors. Image from https://www.te.com/content/dam/te-com/documents/industrial-automation-and-control/global/m8m12_product_presentation.pdf.</Image>
...
<Image src={require('./y-style-m12-splitter-phoenix-contact-1054338.jpg').default} width="300">A Y-style M12 splitter from Phoenix Contact. Image from https://nz.element14.com/phoenix-contact/1054338/sensor-splitter-8p-m12-plug-plug/dp/3223043.</Image>
