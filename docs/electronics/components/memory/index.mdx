...
<Image src={require('./_assets/example-eeprom-pinout-in-sot-23-6-package.png').default} width="361px">Example pinout of a EEPROM IC in a SOT-23-6 component package.</Image>
...
<Image src={require('./_assets/ds28e05-eeprom-ic-connected-to-micro-using-1-wire.pdf.png').default} width="390px">The DS28E05 EEPROM I2C, connected to a microcontroller via the 1-wire interface.</Image>

## Flash

Flash sometimes uses flip-flop style pin naming conventions. The M25P128 is one such example.

<Image src={require('./_assets/m25p128-flash-ic-that-uses-flip-flop-style-naming-for-spi-pins.png').default} width="420px">The M25P128 flash IC which uses flip-flop style pin naming conventions.</Image>
