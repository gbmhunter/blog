...
<Image src={require('./_assets/macronix-mx25v5126f-block-diagram.png').default} width="700px">The internal block diagram showing the architecture of the MX25V5126F NOR flash IC from Macronix[^macronix-mx25v5126f-nor-flash-ds].</Image>
