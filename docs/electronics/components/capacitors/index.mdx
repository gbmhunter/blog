...
<Image src={require('./_assets/capacitor-symbols.png').default} width="500">Schematic symbols used for various types of capacitors.</Image>
...
<Image src={require('./_assets/c0g-np0-capacitor-temp-coeff-grouping-digikey.png').default} width="500">DigiKey, like many other suppliers, groups together C0G and NP0 as one temperature coefficient. Screenshot from https://www.digikey.com/product-detail/en/tdk-corporation/CGA4C2C0G1H392J060AA/445-6942-1-ND/2672960.</Image>
...
<Image src={require('./_assets/murata-deformation-of-pcb-by-electrostrictive-phenomenon.jpg').default} width="450">The deformation of a PCB due to the electrostrictive phenomenon in ceramic chip capacitors. Image from http://www.murata.com/products/capacitor/solution/naki.html.</Image>
...
<Image src={require('./_assets/avx-flexiterm-test-for-ceramic-chip-caps.png').default} width="500">Diagram showing the test setup for measuring the maximum bending flex for AVX chip capacitors with "FLEXITERM" terminals[^bib-avx-auto-mlcc].</Image>
...
<Image src={require('./_assets/pcb-with-electrolyte-leakage-zoomed-out.jpg').default} width="1000">Photo of a PCB in a Dell sound system. Highlighted is leaking electrolytic capacitor, which also corroded right through the lead of a neighbouring resistor.</Image>
...
<Image src={require('./_assets/pcb-with-electrolyte-leakage-zoomed-in.jpg').default} width="800">A close-up of the faulty electrolytic capacitor.</Image>
...
<Image src={require('./_assets/container-of-th-tantalum-caps.jpg').default} width="700">Through-hole tantalum capacitors.</Image>
...
<Image src={require('./_assets/cross-section-of-tantalum-capacitor.png').default} width="500">Cross-section of a SMD tantalum capacitor.</Image>
...
<Image src={require('./_assets/yellow-potted-film-capacitor-alibaba.png').default} width="200">A yellow potted film capacitor. Image from alibaba.com.</Image>
<Image src={require('./_assets/blue-potted-film-capacitor-hitano.png').default} width="200">A blue potted film capacitor from Hitano.</Image>
</div>
...
<Image src={require('./_assets/red-radial-film-capacitor-photo-ecq-p1h822gz3-digikey.png').default} width="300">A red radial film capacitor (Panasonic ECQ-P1H822GZ3). Image from digikey.com.</Image>
...
<Image src={require('./_assets/20191227-capacitor-blown-in-circuit.jpg').default} width="800">A broken 1uF (marking 105K) 250VAC metallized film capacitor (red bulge with cracks in it) I found inside my mum's paper shredder.</Image>
...
<Image src={require('./_assets/door-knob-capacitors.jpg').default} width="600">Ceramic, high-voltage 'door-knob' capacitors. Image from www.trademe.co.nz.</Image>
...
<Image src={require('./_assets/capacitors-in-parallel.webp').default} width="600">Diagram showing the resulting capacitance from two capacitors in parallel.</Image>
...
<Image src={require('./_assets/capacitors-in-series.webp').default} width="800">Diagram showing the equivalent capacitance from two capacitors connected in series.</Image>
...
<Image src={require('./_assets/diagram-for-disc-capacitance-equation.svg').default} width="320">Diagram for the disc-to-infinity capacitance equation.</Image>
...
<Image src={require('./_assets/diagram-for-sphere-capacitance-equation.svg').default} width="320">Diagram for the sphere-to-infinity capacitance equation.</Image>
...
<Image src={require('./_assets/diagram-for-coaxial-cylinders-capacitance-equation.png').default} width="320">Diagram for the coaxial cylinder capacitance equation. Image from http://www.capsense.com/capsense-wp.pdf.</Image>
...
<Image src={require('./_assets/capacitor-with-parasitic-series-resistance-leakage-current.png').default} width="300">A capacitor showing the parasitic series resistance present in all real capacitors, which creates a leakage current.</Image>
...
<Image src={require('./_assets/graph-of-temperature-variation-of-ceramic-chip-4-7uf-capacitors.png').default} width="800">Graph of the capacitance variation (w.r.t. voltage) of a select group of 4.7uF ceramic chip capacitors, Image from http://www.maximintegrated.com/app-notes/index.mvp/id/5527.</Image>
...
<Image src={require('./_assets/dc-bias-capacitance-derating-graph-from-murata.webp').default} width="600">Graph showing how the package size changes the DC bias behaviour. All 4 capacitors have are from the same manufacturer, and have the same ratings (capacitance, voltage, dielectric) except for package size. Graph was generated by Murata's SimSurfing tool[^murata-sim-surfing-tool-mlcc].</Image>
...
<Image src={require('./_assets/decoupling-caps-schematic-example-on-r-pi-pcb.png').default} width="400">Example usage of decoupling capacitors for ICs. Schematic is from the Raspberry-Pi PCB. Image from http://www.raspberrypi.org/wp-content/uploads/2012/04/Raspberry-Pi-Schematics-R1.0.pdf.</Image>
...
<Image src={require('./_assets/charge-pump-based-negative-voltage-gen-schematic.png').default} width="800">This schematic shows a charge pump circuit used to generate -5V from a +5V PWM signal.</Image>
...
<Image src={require('./_assets/feedthrough-capacitor-3d-render-0603-1608-3-connections.jpg').default} width="350">A 3D render of an 0603-sized feedthrough capacitor with 3 connections. Image from www.digikey.com.</Image>
...
<Image src={require('./_assets/feedthrough-capacitor-schematic-symbol-3-connection.png').default} width="400">The schematic symbol for a 3-terminal feedthrough capacitor.</Image>
...
<Image src={require('./_assets/capacitance-multiplier-simple.svg').default} width="500">A simple capacitance multiplier consisting of a single resistor, capacitor and NPN BJT transistor. The effective capacitance is approximately the capacitance of C1 multiplied by the current gain B of the transistor.</Image>
...
<Image src={require('./_assets/capacitance-multiplier-resistor-divider.svg').default} width="500">A capacitance multiplier which has improved filtering performance compared to the single resistor version.</Image>
...
<Image src={require('./_assets/capacitance-multiplier-sim/schematic.png').default} width="800">Simulation-ready schematic of the capacitance multiplier we are designing.</Image>
...
<Image src={require('./_assets/capacitance-multiplier-sim/out.png').default} width="800">The simulated frequency response of the capacitance multiplier circuit above.</Image>
...
<Image src={require('./_assets/circuit-schematic-showing-how-to-repair-an-electrolytic-capacitor.png').default} width="300">Schematic showing how to repair/reform an old electrolytic capacitor. The voltage on the capacitor should slowly rise to the rated voltage.</Image>
...
<Image src={require('./_assets/capacitor-voltage-graph-while-charging-through-resistor-for-reforming.png').default} width="400">Graph of an electrolytic capacitor charging through a resistor to reform the aluminium oxide. The graph part of the image from http://www.antonine-education.co.uk/Pages/Electronics_2/Timing_Subsystems/RC_Networks/further_page_2.htm.</Image>
...
<Image src={require('./_assets/energy-loss-while-charging-a-capacitor-schematic.webp').default} width="600">A schematic showing the basic circuit while charging a capacitor, highlighting the energy lost in the series resistance.</Image>
