...
<Image src={require('./boost-converter-basic-schematic.svg').default} width="600">The basic schematic of a boost converter. SW1 is typically a MOSFET switched by control logic (not shown).</Image>
...
<Image src={require('./compensation-components-for-tps61087evm-boost-converter-annotated.png').default} width="870">The external loop compensation components for the TPS61087 boost regulator. Image from the Texas Instruments TPS61087EVM User's Guide with annotations.</Image>
...
<Image src={require('./schematic-of-boost-converter-with-down-conversion-capability.png').default} width="507">The internal schematic of a boost converter with in-built down conversion capability (the ability to drop the input voltage).</Image>
