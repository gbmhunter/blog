...
<Image src={require('./buck-converter-basic-schematic.svg').default} width="600">The basic schematic of a buck converter. SW1 is typically a MOSFET switched by control logic (not shown).</Image>
...
<Image src={require('./buck-converter-schematic-current-path-ton.svg').default} width="500">Current path when the switch is **closed** (during $t_{on}$ ).</Image>
...
<Image src={require('./buck-converter-schematic-current-path-toff.svg').default} width="500">Current path when the switch is **open** (during $t_{off}$).</Image>
...
<Image src={require('./voltage-mode-control-diagram.svg').default} width="800">The basic logical components used for voltage-mode control.</Image>
...
<Image src={require('./ninja-calc-buck-converter-calculator-screenshot.png').default} width="950">A screenshot of the buck converter calculator in NinjaCalc (as of v2.2.0).</Image>
...
<Image src={require('./photo-of-lmz20502-buck-converter.jpg').default} width="306">A photo of the LMZ20502 buck converter. Image from http://www.digikey.co.nz/product-detail/en/LMZ20502SILT/296-38656-1-ND/.</Image>
...
<Image src={require('./microsip-component-package-dimensions.png').default} width="500">The dimensions of the MicroSIP component package, used by the Texas Instruments 'Nano' buck converters. Image from http://www.ti.com/lit/ds/symlink/lmz20502.pdf.</Image>
