...
<Image src={require('./traco-power-tsp600-124-psu-photo.jpg').default} width="350px">Photo of the Traco TSP600-124 24V 600W DIN-mounted power supply, which runs of mains power. This is medium power isolated switch-mode power supply unit.</Image>
...
<Image src={require('./flyback-regulator-schematic-basic.svg').default} width="600px">Schematic of a basic flyback converter, with no feedback. Transformer T1 is usually called a \"mutually coupled inductor\".</Image>
