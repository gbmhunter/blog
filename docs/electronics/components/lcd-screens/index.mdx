...
<Image src={require('./lcd-schematic.jpg').default} width="500px">Schematic for a character LCD.</Image>
...
<Image src={require('./reverse-mounting-lcd-screen-onto-pcb-annotated.png').default} width="600px">This picture shows how to reverse-mount a standard LCD screen onto a PCB. Notice the SMD 2.54mm pitch header with long contacts (6.80mm).</Image>

The image below shows what a reverse-mounted LCD screen will look like from the front.

<Image src={require('./lcd-screen-reverse-mounted-on-pcb-front-view.jpg').default} width="600px">The front view of a reverse-mounted LCD screen.</Image>
