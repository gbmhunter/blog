...
<Image src={require('./zinc-air-battery-cut-away-annotated.jpg').default} width="450">A cut-away of a zinc-air button cell with annotations. Image from http://hear-better.com/.</Image>
