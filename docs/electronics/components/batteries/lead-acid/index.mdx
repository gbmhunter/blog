...
<Image src={require('./lead-acid-charging-showing-voltage-and-current.jpg').default} width="600">Monitoring the voltage and current is important while charging a lead-acid battery.</Image>
...
<Image src={require('./charging-a-lead-acid.jpg').default} width="800">Charging a 12V, 6Ah lead-acid battery with a variable-voltage power supply.</Image>
