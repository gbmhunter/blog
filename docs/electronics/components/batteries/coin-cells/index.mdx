...
<Image src={require('./_assets/duracell-cr2032-button-cell-with-bitter-coating.webp').default} width="800">A Duracell CR2032 button cell battery with a bitter coating to help prevent children swallowing them.</Image>
