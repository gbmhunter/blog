...
<Image src={require('./basic-bjt-current-mirror.png').default} width="400px">A basic BJT current mirror made from two NPN bipolar junction transistors.</Image>
...
<Image src={require('./buffered-bjt-current-mirror.png').default} width="400px">Schematic of a buffered BJT current mirror.</Image>
