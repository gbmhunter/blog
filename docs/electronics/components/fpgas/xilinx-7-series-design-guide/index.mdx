...
<Image src={require('./xilinx-7-series-decoupling-capacitor-parameter-value-recommendations.png').default} width="447px">The parameter value recommendations for decoupling caps used for a Xilinx 7 Series FPGA.</Image>
