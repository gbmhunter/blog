...
<Image src={require('./op-amp-basic-schematic-symbol.svg').default} width="500px">The basic schematic symbol for an op-amp.</Image>
...
<Image src={require('./op-amp-schematic-voltage-follower-buffer.svg').default} width="500px">An op-amp configured as a voltage follower (aka buffer).</Image>
...
<Image src={require('./simulation-schematic-for-op-amp-voltage-follower-buffer.png').default} width="400px">A simulation schematic for an op-amp configured as a voltage-follower (buffer).</Image>

The results of the simulation:

<Image src={require('./output-voltage-vs-input-voltage-op-amp-voltage-follower.png').default} width="600px">The simulation results for an op-amp configured as a voltage-follower (buffer). Note how the output voltage mirrors the input voltage exactly.</Image>
...
<Image src={require('./non-inverting-amplifier-schematic.svg').default} width="500px">An op-amp configured as a non-inverting amplifier.</Image>
...
<Image src={require('./non-inverting-op-amp-amplifier-simulation-schematic.png').default} width="450px">The simulation schematic for a non-inverting op-amp amplifier.</Image>
...
<Image src={require('./vout-vs-vin-non-inverting-op-amp-amplifier-gain-of-2.png').default} width="700px">A graph of $v_{out}$ vs. $v_{in}$ for a non-inverting op-amp amplifier circuit.</Image>
...
<Image src={require('./inverting-amplifier-schematic.svg').default} width="500px">An op-amp configured as an inverting amplifier.</Image>
...
<Image src={require('./inverting-op-amp-simulation-schematic.png').default} width="600px">A schematic for simulating the behaviour of an inverting op-amp.</Image>

And below are the simulation results for the above schematic:

<Image src={require('./vout-vs-vin-inverting-op-amp-gain-neg-1.png').default} width="700px">$v_{out}$ vs. $v_{in}$ for an inverting op-amp with a gain of -1.</Image>
...
<Image src={require('./differential-amplifier-schematic.svg').default} width="700px">An op-amp configured as a differential amplifier.</Image>
...
<Image src={require('./differential-op-amp-simulation-schematic.png').default} width="800px">A schematic for simulating the behaviour of a differential op-amp.</Image>

This schematic produces the following results:

<Image src={require('./differential-op-amp-simulation-graph-vin1-vin2-vout.png').default} width="700px">A graph Vout vs. Vin1 and Vin2 for a op-amp configured as a differential amplifier.</Image>
...
<Image src={require('./integration-amplifier-schematic-ideal.svg').default} width="500px">An op-amp configured as an ideal integrator.</Image>
...
<Image src={require('./integration-amplifier-schematic-non-ideal.svg').default} width="430px">An op-amp configured as a non-ideal (real world) integrator, with feedback resistor $R_f$ to slowly remove DC offset and $R_{bias}$ to compensate for input bias current.</Image>
...
<Image src={require('/docs/electronics/components/current-sources-and-sinks/current-sink/op-amp-current-sink-schematic.png').default} width="500px">Schematic of an op-amp based current sink. See [Current Sources And Sinks: Op-amp Current Sink](/docs/electronics/components/current-sources-and-sinks/index.mdx#op-amp-current-sink) for more info.</Image>
...
<Image src={require('./summing-amplifier-inverting.svg').default} width="500px">A summing amplifier with three inputs.</Image>
...
<Image src={require('./summing-amplifier-non-inverting.svg').default} width="500px">A non-inverting summing amplifier with three inputs.</Image>
...
<Image src={require('./ideal-diode-basic.svg').default} width="600px">A basic ideal diode circuit.</Image>

The below graph shows the response of the basic ideal diode circuit.

<Image src={require('./ideal-diode-basic-response.png').default} width="500px">The response of the basic ideal diode circuit.</Image>
...
<Image src={require('./ideal-diode-improved-inverting.svg').default} width="700px">An improved ideal diode/half-wave rectifier.</Image>
...
<Image src={require('./sample-and-hold.svg').default} width="600px">Basic op-amp based sample-and-hold circuit.</Image>
...
<Image src={require('./input-offset-voltage-model.svg').default} width="600px">The input offset voltage is modelled as a voltage source in series with one of the inputs of an ideal op-amp (it doesn't matter which input, as the input offset voltage can be positive or negative).</Image>
...
<Image src={require('./input-offset-voltage-trimming-inverting.svg').default} width="700px">A popular way of performing external input offset voltage trimming with a inverting op-amp.</Image>
...
<Image src={require('./slew-rate-distortion-diagram-square-wave.png').default} width="500px">Plot showing the effect an op-amps slew rate on a input square wave. Slew rate was chosen to be equal to the LM324's of 0.4V/us[^bib-ti-lm324-datasheet].</Image>
...
<Image src={require('./slew-rate-distortion-diagram-sine-wave.png').default} width="600px">Plots showing the distortion of a 10V (peak) 20kHz sine wave when subjected to different op-amp slew rates.</Image>
...
<Image src={require('./lm7705-low-noise-negative-bias-voltage-generator-for-op-amp-application-schematic.png').default} width="688px">The typical application schematic for the Texas Instruments LM7705, a 'Low-Noise Negative Bias Generator' for the negative supply of an op-amp. This allows the op-amp to output true 0V. Image from http://www.ti.com/.</Image>
...
<Image src={require('./open-loop-vs-closed-loop-op-amp-gain-bode-plot.svg').default} width="500px">How the open-loop and closed-loop gain of an op-amp changes with increasing frequency.</Image>

We can generalize the circuit of an op-amp with negative feedback to the block diagram shown below. 

<Image src={require('./generalized-negative-feedback-block-diagram.svg').default} width="700px">A block diagram showing a generalized op-amp configuration with negative feedback.</Image>
...
<Image src={require('./fully-differential-isolation-amplfier-ti-amc1200-simplified-schematic.pdf.png').default} width="700px">A simplified schematic of the Texas Instruments AMC1200, a fully-differential isolated amplifier. Image from http://www.ti.com/.</Image>
...
<Image src={require('./op-amp-input-pin-resistors.png').default} width="500px">Schematic showing a resistor on the positive input to a op-amp.</Image>
...
<Image src={require('./op07-op-amp-offset-nulling-circuit.png').default} width="500px">Image from https://www.analog.com/media/en/technical-documentation/data-sheets/OP07.pdf.</Image>
...
<Image src={require('./negative-impedance-converter-nic.svg').default} width="500px">Schematic of a negative impedance converter (NIC) created from an op-amp and a few passive components.</Image>
...
<Image src={require('./standard-8-pin-dual-op-amp-pinout.svg').default} width="400px">The standard pinout for two op-amps in an 8-pin package. This includes the DIP-8, TSSOP-8, SOIC-8 and MSOP-8 component packages.</Image>
