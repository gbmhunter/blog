...
<Image src={require('./vishay-thermawick-construction-thjp.png').default} width="400px">Basic construction of a thermal jumper chip from the Vishay ThermaWick family[^bib-vishay-thermawick-series-ds].</Image>
...
<Image src={require('./tjc-application-example-tt-electronics.png').default} width="300px">Typical application example for a thermal jumper chip.[^bib-tt-elec-tjc-series-ds]</Image>
