...
<Image src={require('./_assets/ti-it-looks-like-weve-encountered-some-resistance.png').default} width="600">One should always appreciate a good pun. Texas Instruments 404 page as of October 2020.</Image>
...
<Image src={require('./_assets/schematic-symbols-amer-euro-resistors.png').default} width="500">The \"American\" and \"European\" schematic symbols for a resistor. I prefer the American-style because it's easiest to distinguish from other box-like symbols.</Image>
...
<Image src={require('./_assets/resistors-in-parallel-equivalence-with-equation.webp').default} width="700px">Two resistors in parallel can be treated as one resistor using the shown equation.</Image>
...
<Image src={require('./_assets/resistors-in-series-equivalence-with-equation.webp').default} width="700px">Two resistors in series is the equivalent of one resistor with the resistance shown by the equation in this image.</Image>
...
<Image src={require('./_assets/resistor-divider-schematic.webp').default} width="350">A basic schematic of a simple resistor divider. You will see these used everywhere in circuits!</Image>
...
<Image src={require('./_assets/resistor-divider-thevenin-equivalent-diagram.webp').default} width="800">The Thevenin equivalent circuit for a resistor divider.</Image>
...
<Image src={require('./_assets/resistor-divider-charging-a-capacitor-example-1.webp').default} width="400">Schematic of a capacitor being charged through a resistor divider. How long will it take to charge?</Image>
...
<Image src={require('./_assets/resistor-divider-charging-a-capacitor-example-2.webp').default} width="400">The Thevenin equivalent circuit.</Image>
...
<Image src={require('./_assets/screenshot-of-ninjacalc-resistor-divider-calculator.png').default} width="604">A screenshot of the NinjaCalc's 'Resistor Divider' calculator, being used to find the top resistance.</Image>
...
<Image src={require('./_assets/yageo-rc-series-thick-film-general-purpose-resistors-summary-table.png').default} width="900px">Table showing the min. and max. resistances available in Yageo's RC family of general-purpose thick-film resistors[^bib-yageo-rc-family-product-page].</Image>
...
<Image src={require('./_assets/screenshot-ninjacalc-standard-resistance-finder-preferred-value-e6-e192-324.png').default} width="550">NinjaCalc's 'Standard Resistance Finder' calculator showing the closest E-series values to a desired resistance of 10.3kΩ (with closest highest and closest lowest resistance).</Image>
...
<Image src={require('./_assets/wire-wound-resistor-diagram-bourns.png').default} width="300">Cut-away diagram of a typical wire-wound resistor. Image by Bourns, retrieved on 2021-08-14 from https://www.bourns.com/products/resistors/wirewound-resistors.</Image>
...
<Image src={require('./_assets/tt-electronics-w22-2kji-2kr-wirewound-resistor.png').default} width="500">Close-up photo of the TT Electronics W22-2KJI 2kΩ 7W wirewound resistor[^bib-tt-electronics-w20-series-ds].</Image>
...
<Image src={require('./_assets/bunch-of-ceramic-power-resistors.jpg').default} width="600">A bunch of ceramic power resistors rated from 5 to 25W of power dissipation.</Image>
...
<Image src={require('./_assets/using-a-power-resistor-to-heat-oil.jpg').default} width="800">Power resistors can be used for heating. This photo shows a 5W resistor being used to heat a small container of oil, with a thermostat from a hot water cylinder to control the temperature.</Image>
...
<Image src={require('./_assets/current-sensing-resistor-large-four-lead.jpg').default} width="500">A large four-lead current sensing resistor.</Image>
...
<Image src={require('./_assets/parasitic-model-of-resistor-series-rl-parallel-c.svg').default} width="600">Parasitic model of a resistor modelling the resistance in parallel with an inductor which is then in series with a capacitor.</Image>
...
<Image src={require('./_assets/parasitic-model-of-resistor-parallel-rc-series-l.svg').default} width="600">Parasitic model of a resistor modelling the resistance in parallel with the end cap capacitance and that in series with the lead inductance.</Image>
...
<Image src={require('./_assets/500-0603-smd-resistors-on-tape.jpg').default} width="530">SMD resistors usually come on a tape like the one shown (which could be on a reel) which contains 500 0603 SMD resistors.</Image>

Once taken out of the tape, they don't look like much!

<Image src={require('./_assets/500-0603-smd-resistors-next-to-a-pin.jpg').default} width="517">500 0603 SMD resistors in a pile next to pin. This is too illustrate just how small they are! (and then can get smaller).</Image>
...
<Image src={require('./_assets/reel-0603-resistor-leftovers-best.jpg').default} width="900">This was me trying to be creative with the left-overs from putting about 30,000 reeled 0603 resistors into containers for prototyping with.</Image>
...
<Image src={require('./_assets/resistor-optimizer-janne-ahonen-screenshot.png').default} width="700px">Screenshot of the Resistor Optimizer tool[^bib-jahonen-kapsi-resistor-optimizer].</Image>
