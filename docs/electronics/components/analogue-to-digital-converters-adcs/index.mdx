...
<Image src={require('./_assets/adc-symbol-analogue-to-digital.png').default} width="350">A symbol representing a analogue-to-digital converter (ADC).</Image>
...
<Image src={require('./_assets/multiplexed-sample-and-hold-capacitor-adc.webp').default} width="400">Block diagram of the switched capacitor array architecture, used by many SAR ADCs.</Image>
...
<Image src={require('./_assets/switched-capacitor-adc-with-source-and-adc-input-resistance-modelled.webp').default} width="600">Model of a analogue input with source resistance $R_S$ connected to a ADC input with input resistance.</Image>
...
<Image src={require('./_assets/infineon-tc33xext-aa-mcu-adc-input-equivalent-circuit.png').default} width="600">Models of ADC input circuitry can get complex! This one is from the Infineon AURIX TriCore TC33xEXT AA family of MCUs[^infineon-aurix-tricore-tc33xext-aa-mcu-ds].</Image>
