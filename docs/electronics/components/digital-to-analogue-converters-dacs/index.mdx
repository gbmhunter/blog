...
<Image src={require('./dac-architecture-string.svg').default} width="600px">The internal architecture of a string DAC.</Image>
...
<Image src={require('./dac-architecture-r2r.svg').default} width="800px">The internal architecture of a R-2R DAC.</Image>
...
<Image src={require('./digital-input-analogue-output-graph.svg').default} width="500px">A graph showing how the DAC output voltage varies with the digital input code, and the various names given to parts of the behaviour.</Image>
...
<Image src={require('./dac-integral-non-linearity.svg').default} width="500px">The integral non-linearity for digital input code 010 is shown. Note how the 'ideal line' has been offset and gain compensated for, in this case by going through the DACs min and max. output voltages.</Image>
