...
<Image src={require('./_assets/battery-voltage-measurement-with-resistor-divider-caps-and-adc.webp').default} width="800px">.</Image>
...
<Image src={require('./_assets/power-profiler-kit-2-photo.webp').default} width="1000px">A photo of the Nordic Power Profiler Kit 2 when measuring the power to a low-power embedded circuit (off the bottom of screen, not visible).</Image>

<Image src={require('./_assets/nrf-power-profiler-screenshot-showing-typical-low-power-mcu-with-spikes.png').default} width="1000px">A screenshot of the nRF Power Profiler showing the current consumption of a typical low-power MCU circuit using Bluetooth LE. The idle current consumption is approx. 7uA, and current spikes up to approx. 10mA during Bluetooth transmissions, resulting in an average current of 120uA. Note the logarithmic Y-axis.</Image>
