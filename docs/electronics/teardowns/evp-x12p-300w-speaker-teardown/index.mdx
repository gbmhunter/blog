...
<Image src={require('./_assets/rear-panel-with-active-amp.jpg').default} width="800px">The rear panel of the speaker, which has all the circuitry bolted onto it.</Image>

It has thermal PTC  resettable fuses, so these couldn't of blown...

<Image src={require('./_assets/ptc-resettable-fuses.jpg').default} width="800px">PTC resettable fuses on the main PCB.</Image>
...
<Image src={require('./_assets/power-amp-circuitry.jpg').default} width="800px">The power amp circuitry, once the PSU and other pre-amp/filtering circuitry has been removed.</Image>
...
<Image src={require('./_assets/a1492-power-transistor.jpg').default} width="800px">The SCA1492 power transistor.</Image>
...
<Image src={require('./_assets/2012-07-23-20-28-21.jpg').default} width="800px">Hooray for nicely labelled test points!</Image>

After finding to difference between the broken and working circuits, I decided to remove the speakers from the enclosures.

<Image src={require('./_assets/2012-07-23-22-30-27.jpg').default} width="800px"></Image>

This is where I finally found the problem, the LF speaker coil had completely blown!

<Image src={require('./_assets/2012-07-23-22-44-31.jpg').default} width="800px"></Image>
...
<Image src={require('./_assets/2012-07-23-22-39-03.jpg').default} width="800px"></Image>
