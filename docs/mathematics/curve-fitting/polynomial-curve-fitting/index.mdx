...
<Image src={require('./many-polynomial-best-fits-on-graph.png').default} width="605px">A graph showing how different degree polynomials can be fitted to data.</Image>
...
<Image src={require('./2-degree-poly-best-fit-graph.png').default} width="600px">Four data points and a 2 degree polynomial of best fit (using the least squares method).</Image>
