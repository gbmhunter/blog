...
<Image src={require('./normal-distribution-pdf-examples.png').default} width="500px">A few example probability density functions (PDFs) for the normal distribution.</Image>
