...
<Image src={require('./linear-programming-example-2d-graph-feasible-region-wikipedia.png').default} width="203px">An example of linear programming with 2 variables. Image from www.wikipedia.com.</Image>
