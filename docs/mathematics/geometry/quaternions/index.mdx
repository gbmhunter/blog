...
A quaternion (pronounced _qwa-ter-ne-ion_) is a complex-number like system which contains three imaginary components and one real component. Arguably, the most useful quaternions is a subset of all quaternions called **unit quaternions** (or **versors**), which can be used to describe a rotation in 3D space. This page focuses primarily on these unit quaternions.
