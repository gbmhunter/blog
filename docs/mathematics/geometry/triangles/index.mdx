...
<Image src={require('./_assets/sin-cos-tan-diagram.webp').default} width="400px">Diagram illustrating the naming of the triangles sides w.r.t. to angle A when using trigonometric ratios.</Image>
...
:::example" title="Using The sin Ratio

Given the triangle in the image below, calculate the value of angle $A$.

<Image src={require('./_assets/sin-example.webp').default} width="400px">Diagram for the worked example using sin().</Image>
...
:::example" title="Using The tan Ratio

Given the triangle in image below, calculate the length of side $x$.

<Image src={require('./_assets/tan-example.webp').default} width="400px">Diagram for the worked example using tan().</Image>
...
<Image src={require('./_assets/tan-example-labelled.webp').default} width="400px">Triangle now has labelled edges and angles.</Image>
...
<Image src={require('./_assets/law-of-sines-diagram.webp').default} width="400px">Diagram illustrating the variables used in the Law of Sines.</Image>
...
:::example" title="Basic Law of Sines Calculation

Given the triangle shown below, calculate the length of side $a$.

<Image src={require('./_assets/law-of-sines-example-1-diagram.webp').default} width="400px">Diagram for Example 1.</Image>
...
<Image src={require('./_assets/law-of-sines-ambiguous-case-diagram.webp').default} width="1000px">Diagram showing the situations when you know two sides of the triangle and 1 opposite angle. c) is the ambiguous cases which has two possible solutions.</Image>
...
<Image src={require('./_assets/sine-law-sine-wave-graph.png').default} width="600px">Graph showing how inverse sine can result in two values between $[0, 180]$.</Image>
...
<Image src={require('./_assets/law-of-sines-ambiguous-case-a-not-acute-diagram.webp').default} width="600px">Diagram showing that when A is not acute, there is no ambiguous case for the Law of Sines.</Image>
...
:::example" title="Ambiguous Law of Sines
...
<Image src={require('./_assets/law-of-sines-ambiguous-example-diagram.webp').default} width="600px">Diagram for the ambiguous Law of Sines worked example.</Image>
...
<Image src={require('./_assets/law-of-cosines-diagram.webp').default} width="400px">Diagram showing the sides and angles involved in the Law of Cosines.</Image>
...
:::example" title="2 Sides and Their Included Angle Known

Given the triangle and known dimensions as shown below, calculate all unknown sides and angles.

<Image src={require('./_assets/law-of-cosines-two-sides-and-included-angle-known-example-diagram.webp').default} width="400px">Diagram for the worked example using the Law of Cosines on a triangle with 2 sides and their included angle known.</Image>
...
<Image src={require('./_assets/law-of-cosines-two-sides-and-included-angle-known-example-diagram-letters-added.webp').default} width="400px">Variable names have been added.</Image>
...
:::example" title="Multiple Solutions with the Law of Cosines

Given the triangle below, calculate the length of side $b$.

<Image src={require('./_assets/law-of-cosines-multiple-solutions-example.webp').default} width="600px">Diagram for the worked example for the Law of Cosines that has multiple solutions.</Image>
...
<Image src={require('./_assets/law-of-cosines-google-calculator.png').default} width="600px">Screenshot of the Law of Cosines calculator Google provides when you search \"law of cosines\"[^google-law-of-cosines-calc].</Image>
