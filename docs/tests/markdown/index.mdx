...
<Image src={require('./cartoon-ninja.jpg').default} width="300px">This should be an clickable image of the logo. **Bold text**. An equation: $x^2$. There should be a footnote number at the end of this sentence[^foot-1].</Image>
...
:::note" title="This Has a Custom Title!
