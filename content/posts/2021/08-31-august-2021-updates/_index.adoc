...
* Added info on link:/electronics/components/power-regulators/linear-regulators/#_foldback_current_limiting[how to design foldback current limiting with a linear regulator].
+
