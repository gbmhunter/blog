...
[.imagerow]
--
.The schematic symbol for a general or common ground. 
image::general-common-ground-schematic-symbol.png[width=250px, height=200px]

.The schematic symbol for analogue ground (AGND).
image::ground-analogue.png[width=250px, height=200px]

.The schematic symbol for digital ground (DGND).
image::digital-ground-schematic-symbol.png[width=250px, height=200px]
--
