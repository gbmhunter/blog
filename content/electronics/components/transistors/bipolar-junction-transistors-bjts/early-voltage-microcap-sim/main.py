...
def main():
    micro_cap_output_path = SCRIPT_DIR / 'early-voltage.DNO'
    ...
    for single_curve in data:
        ax.plot(single_curve['vce_V'], single_curve['ic_A'], label=f"$I_b={single_curve['ib_A']*1000.0:.0f}mA$")
    ...
    fig.tight_layout()
    plt.savefig(SCRIPT_DIR / 'vce_vs_ic.png')
