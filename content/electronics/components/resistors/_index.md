...
You call also get variable resistors which can be changed digitally (called DPOTs). They have their own page which can be found {{< link text="here" src="/electronics/components/dpots/_index.md" >}}.
...
More information and schematics on how to make current-sense circuits can be found on the {{< link text="Current-Sensing page" src="/electronics/circuit-design/current-sensing/_index.md" >}}.
