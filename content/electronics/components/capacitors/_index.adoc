...
[[avx-flexiterm-test-for-ceramic-chip-caps]]
.Diagram showing the test setup for measuring the maximum bending flex for AVX chip capacitors with "FLEXITERM" terminals<<bib-avx-auto-mlcc>>.
image::avx-flexiterm-test-for-ceramic-chip-caps.png[width=500px,link="{{< permalink >}}/avx-flexiterm-test-for-ceramic-chip-caps.png"]
...
.Diagram for the disc-to-infinity capacitance equation.
image::diagram-for-disc-capacitance-equation.svg[width=320]
...
.Diagram for the sphere-to-infinity capacitance equation.
image::diagram-for-sphere-capacitance-equation.svg[width=320]
...
[.text-center]
where: +
stem:[C] = capacitance, in stem:[F] +
stem:[\epsilon_0] is the permittivity of free space, approx. stem:[8.85 \times 10^{-12}Fm^{-1}] +
stem:[\epsilon_r] = relative dielectric constant (stem:[1] for a vacuum) +
stem:[r] = radius of sphere, in stem:[m]
...
The leakage current through a capacitor can be modelled with a resistor in parallel with the actual capacitance, as shown in <<capacitor-with-parasitic-series-resistance-leakage-current>>.

[[capacitor-with-parasitic-series-resistance-leakage-current]]
...
* [[[bib-capacitorguide.com, 1]]] http://www.capacitorguide.com/film-capacitor/.
* [[[bib-wikipedia-film-capacitor, 2]]] https://en.wikipedia.org/wiki/Film_capacitor
* [[[bib-ceramic-dielectric-types, 3]]] https://www.electronics-notes.com/articles/electronic_components/capacitors/ceramic-dielectric-types-c0g-x7r-z5u-y5v.php
* [[[bib-tdk-singing-capacitors, 4]]] https://product.tdk.com/en/contact/faq/31_singing_capacitors_piezoelectric_effect.pdf
* [[[bib-qs-study-capacitance-spherical, 5]]]: QS Study. _Capacitance of a Spherical Conductor_. Retrieved 2021-09-17, from https://qsstudy.com/physics/capacitance-spherical-conductor.
* [[[bib-avx-auto-mlcc, 6]]] AVX. _Automotive MLCC (datasheet)_. Retrieved 2022-02-01, from https://datasheets.avx.com/AutoMLCC.pdf.
