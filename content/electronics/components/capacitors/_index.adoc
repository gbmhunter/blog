...
Our cut-off frequency should then be -3dV ontop of that, i.e. at stem:[-1.58dB - 3dB = -4.58dB]. Plotting across and then down does indeed give us a cut-off frequency of approx. 10Hz.
