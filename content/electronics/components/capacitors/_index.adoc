...
WARNING: Even though the this is commonly called the effective capacitance, when calculating the cutoff frequency, you must use the real capacitance value, not the effective capacitance! (more on this below).
...
The equation for the cutoff frequency changes slightly:
...
The effective capacitance is exactly the same as in the single-resistor version in Eq \ref{eq:eff-cap}.
...
Arbitrarily choosing stem:[R2] to be stem:[10k\Omega], this means that stem:[R1] must be:
