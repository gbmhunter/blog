...
--
Let's design a constant-current diode using the ubiquitous 2N5457 JFET (we'll choose the one from On Semi) for a current of stem:[0.5mA]
...
Plugging these values into stem:[Eq.\ \ref{eq:jfet-vgs}] we can work out the required gate-source voltage:
