...
_Turnover temperature_ is a term used with 32.768kHz crystals to describe the temperature at which the crystal is at it's highest oscillation frequency. 32.768kHz crystals have a negative parabolic frequency response to temperature at the turnover temperature is at the maxima (at lower or higher temperatures, the frequency begins to drop). Most 32.678kHz crystals have a turnover temperature between 20 and 30°C<<bib-st-32khz-temp-comp>>.

.The common shape of a temperature vs. drift curve for a 32.768kHz crystal, highlighting the turnover point at the maxima. 
image::turnover-temp-graph.svg[width=500px]
