...
The _Segger Real-Time Terminal_ (RTT) provides a bi-directional data transfer mechanism between a host and target microcontroller. RTT emulates a telnet connection on the host machine<<bib-mcuoneclipse-segger-rtt>>.
