...
For more information on what designators are used for what components, see the {{% link text="Component Designators page." src="/electronics/circuit-design/component-designators/index.md" %}}.
