...
<td>
  <ul>
    <li>{{% link src="../sip-component-package/_index.md" text="SIP" %}}</li>
    <li>{{% link src="../qip-component-package/_index.md" text="QIP" %}}</li>
    <li>{{% link src="../soic-component-package/_index.md" text="SOIC" %}}</li>
  </ul>
</td>
</tr>
<tr>
