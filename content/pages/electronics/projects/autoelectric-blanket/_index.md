...
[singlepic id=1280 w=600 h=800 float=center template=caption]

The express extension serves up a web page.

[singlepic id=1283 w=800 h=1000 float=center template=caption]
...
[singlepic id=1278 w=800 h=600 float=center template=caption]
...
[singlepic id=1279 w=800 h=600 float=center template=caption]
