...
{{< figure src="a "C" filter" width="551" caption="](/images/2015/11/d-sub-connector-with-c-filter-conec-graph-of-insertion-loss-vs-freq.pdf.png) A graph of insertion loss vs. frequency for a Conec D-sub connector with integrated capacitance for filtering (a "C" filter)." caption-position="bottom" >}}
