...
{{< figure src="the female connector also has to support this" width="412" caption="](/images/2015/12/pcb-edge-connector-pci-hockey-stick.png) Male pcb-card edge connectors can have "hockey-stick" latches as indicated (the female connector also has to support this)." caption-position="bottom" >}}
