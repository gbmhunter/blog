...
{{< figure src="/images/2011/09/3n163-mosfet-drawing-with-substrate-connection.png" width="348" caption="A drawing of the 3N163 P-channel MOSFET, which has a fourth leg for the substrate connection (C). Image from http://pdf1.alldatasheet.com/datasheet-pdf/view/123459/CALOGIC/3N163.html." caption-position="bottom" >}}
