...
PIR sensors are pyroelectric infrared devices. They may not detect motion coming directly to, or directly away from the sensor. Lowest temperature difference for detection can be around [latex]4^\cdot C[/latex].
