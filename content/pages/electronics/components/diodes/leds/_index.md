...
{{< figure src="/images/2012/03/osram-ls-p47k-reverse-mount-led-photo.png" width="440" caption="An Osram reverse-mount LED (P47K series)." caption-position="bottom" >}}
...
{{< figure src="/images/2012/03/ws2811-rgb-led-front-and-back-photo.png" width="498" caption="The WS2811, a popular RGD LED, with integrated controller and drive circuitry (constant current supply). Communicates via a custom 800kHz protocol to a microcontroller." caption-position="bottom" >}}
...
{{< figure src="/images/2012/03/green-led-relative-intensity-vs-wavelength-ltst-c190kgkt.png" width="665" caption="A graph of the relative intensity vs. wavelength for a 0603 green LED (LTST-C190KGKT). It has a peak wavelength of 574nm and a dominant wavelength of 571nm." caption-position="bottom" >}}
...
{{< figure src="/images/2012/03/0603-led-up-close.jpg" width="1200" caption="A picture of a 0603 LED up close on a PCB. You can see the filament running into the middle of the pad (the part which emits the light)." caption-position="bottom" >}}
