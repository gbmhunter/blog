...
{{< figure src="/images/2012/04/sigh-altium.png" width="487" caption="Sigh. Altium." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-information-please-wait-a-moment-bug.jpg" width="284" caption="The annoying "Please Wait A Moment" dialogue box that appears sometime while using Altium." caption-position="bottom" >}}

The error you sometimes get after the "Please Wait A Moment" box.

{{< figure src="/images/2012/04/altium-access-violation-error.jpg" width="475" caption="An access violation error message which can occur when using Altium." caption-position="bottom" >}}

UPDATE: As of Altium v14.0, running on a Windows 8 machine, I have noticed far fewer of these errors!

{{< figure src="/images/2012/04/altium-crash-please-wait-a-moment-i-was-lucky-enough-to-get-two-at-once.png" width="493" caption="Ohhhh look, I was lucky enough to get two at once!" caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/task-manager-quickly-closing-altium-end-task.png" width="445" caption="Quickly closing Altium when it crashes." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-bug-argument-out-of-range-error-while-pcb-routing.png" width="580" caption="The fatal "Argument out of range" error that can occur while routing tracks in Altium." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-not-drawing-almost-complete-circle-arcs.jpg" width="1127" caption="Altium will make arcs disappear on certain zoom levels if the arc is almost fully circular." caption-position="bottom" >}}
...
<td >{{< figure src="/images/2012/04/altium-not-exporting-holes-properly-before.jpg" width="369" caption="Hole in PCB." caption-position="bottom" >}}
</td>
<td >{{< figure src="/images/2012/04/altium-not-exporting-holes-properly-after.jpg" width="382" caption="Hole covered over in step file output." caption-position="bottom" >}}
</td></tr></tbody></table>
...
{{< figure src="/images/2012/04/altium-removing-solder-and-paste-mask.jpg" width="1233" caption="How to remove a solder or paste mask completely from a pad/via." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-library-search-without-asterisk.jpg" width="800" caption="Searching an Altium component library without an asterisk." caption-position="bottom" >}} {{< figure src="/images/2012/04/altium-library-search-with-asterisk.jpg" width="800" caption="Searching an Alitum component library with an asterisk." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-polygon-clearance-rule.jpg" width="970" caption="The "Polygon Clearance" rule in Alitum. Make sure you use "InPolygon" and not "IsPolygon"." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-keepout-layer-track-size.jpg" width="1414" caption="Changing the keepout layer track size." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-selecting-scaled-print.jpg" width="570" caption="Selecting "Scaled Print" to print a 1:1 drawing of the PCB. Good for component footprint checking!" caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-detecting-acute-angles-under-pads.jpg" width="1533" caption="Altium has a bug where it reports acute angle rule violations of tracks that are under pads." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-layer-stack-up-manager-giving-wrong-height.jpg" width="1055" caption="The stack-up manager in Altium reporting the wrong height." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-script-combobox-loses-items-on-restart.jpg" width="573" caption="Altium forgets any items you assigned to a combo box through GUI after saving and restarting." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-bug-screen-artifact.png" width="521" caption="A screen artifact/glitch in Altium." caption-position="bottom" >}}
...
{{< figure src=">20" width="1196" caption="](/images/2012/04/altium-parameter-manager-clearing-cells-takes-a-long-time-bug.png)
](/images/2012/04/altium-parameter-manager-clearing-cells-takes-a-long-time-bug.png) When clearing a large number of cells (>20) in the Parameter Manager , Altium can take plenty of time, stalling the program in the process (it looks as though Altium has locked up)." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/objects-going-outside-of-the-pcb-boundry-in-altium.png" width="807" caption="Accidentally pushing objects outside of the PCB editor boundary can be a hassle to remove when designing a PCB in Altium." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/schematic-parameters-unremovable-annotated.png" width="728" caption="This schematic parameter is un-removable!" caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-multi-line-pcb-string-made-from-single-line-strings.png" width="1276" caption="In Altium, multi-line PCB strings have to be made from many single-line strings." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-schematic-symbol-pin-properties-highlighting-hidden-pin-connect-to.png" width="486" caption="The "Pin Properties" window in the Altium schematic symbol library editor. The "Hide" and "Connect To" fields give the allusion you can hide a pin and connect it to another, visible pin." caption-position="bottom" >}}
...
{{< figure src="8-pin" width="881" caption="](/images/2012/04/p-channel-mosfet-schematic-symbol-altium-soic-8-hidden-pins-annotated.png) The schematic symbol of a P-channel MOSFET in the Altium schematic symbol editor. The particualr MOSFET is in a SOIC-8N (8-pin) package, and I have attempted to hide the extra pins to keep the symbol looking clean." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-bug-bom-table-field-name-missing-error.png" width="1225" caption="A screenshot of the "Table: Field name Missing" error in Altium." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-bug-bom-table-field-name-missing-parameter-manager-no-names-annotated.png" width="877" caption="Hunting down unnamed parameters in the parameter manager to fix the "Table: Field name missing" bug in Altium." caption-position="bottom" >}}
...
{{< figure src="Omega" width="1146" caption="](/images/2012/04/altium-pcb-editor-cant-handle-unicode-chars-ohms-symbols.png) Altium's PCB editor can't handle Unicode characters such as the Ohm (Omega) and degree symbol. This image shows how Altium will continuously try and update components that contain these symbols." caption-position="bottom" >}}
