...
{{< figure src="/images/2012/04/altium-parameter-manager-clearing-cells-takes-a-long-time-bug.png" width="1196" caption="When clearing a large number of cells (>20) in the Parameter Manager , Altium can take plenty of time, stalling the program in the process (it looks as though Altium has locked up)." caption-position="bottom" >}}
...
{{< figure src="/images/2012/04/altium-pcb-editor-cant-handle-unicode-chars-ohms-symbols.png" width="1146" caption="Altium's PCB editor can't handle Unicode characters such as the Ohm (Omega) and degree symbol. This image shows how Altium will continuously try and update components that contain these symbols." caption-position="bottom" >}}
