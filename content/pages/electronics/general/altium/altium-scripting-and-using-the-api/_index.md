...
[caption id="attachment_9300" align="aligncenter" width="893"][![Running the Hello, world script in Altium.](http://blog.mbedded.ninja/wp-content/uploads/2012/02/running-hello-world-script-in-altium.png)
](http://blog.mbedded.ninja/wp-content/uploads/2012/02/running-hello-world-script-in-altium.png) Running the Hello, world script in Altium.[/caption]
...
[caption id="attachment_9380" align="aligncenter" width="438"][![What happens when an exception is thrown in an Altium script.](http://blog.mbedded.ninja/wp-content/uploads/2012/02/altium-script-visual-studio-just-in-time-debugger-unhandled-exception-crash.png)
](http://blog.mbedded.ninja/wp-content/uploads/2012/02/altium-script-visual-studio-just-in-time-debugger-unhandled-exception-crash.png) What happens when an exception is thrown in an Altium script.[/caption]
...
[caption id="attachment_9546" align="aligncenter" width="890"][![Adding a TRadioGroup control to an Altium script UI.](http://blog.mbedded.ninja/wp-content/uploads/2012/02/altium-script-radio-group-example-screenshot.png)
](http://blog.mbedded.ninja/wp-content/uploads/2012/02/altium-script-radio-group-example-screenshot.png) Adding a TRadioGroup control to an Altium script UI.R[/caption]
