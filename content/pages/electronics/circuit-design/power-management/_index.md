...
{{< figure src="with some external filtering circuitry" width="878" caption="](/images/2011/09/ina226-power-monitor-ic-internal-diagram-with-external-filtering.png) The internal diagram (with some external filtering circuitry) of the INA226 voltage/current/power monitoring IC. Image from http://www.ti.com/." caption-position="bottom" >}}
