...
{{< figure src="non-bridge" width="624" caption="](/images/2015/02/pci-type-0-non-bridge-config-space-diagram-v2.png) The standardised registers that belong to the PCI/PCIe Type 0 (non-bridge) configuration space. Image from https://en.wikipedia.org." caption-position="bottom" >}}
