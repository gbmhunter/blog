...
{{< figure src="/images/2015/02/ft-5000-smart-transceiver-cip-block-diagram.png" width="392px" caption="The block diagram for the FT5000 'Smart Transceiver' IC which can be used as part of a LON node."  >}}
...
{{< figure src="/images/2015/02/ft500-ft-x3-connection-diagram.png" width="518px" caption="A connection diagram between the FT5000 processor and the FT-X3 transformer."  >}}
...
{{< figure src="/images/2015/02/ft5000-typical-operating-conditions.png" width="325px" caption="The typical operating conditions of the FT5000 processor."  >}}
