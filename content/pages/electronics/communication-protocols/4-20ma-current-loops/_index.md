...
[caption id="attachment_13415" align="aligncenter" width="560"][![The current ranges allowed by the NAMUR NE 43 current-loop standard.](http://blog.mbedded.ninja/wp-content/uploads/2016/03/namur-ne-43-current-looop-current-ranges-diagram.png)
](http://blog.mbedded.ninja/wp-content/uploads/2016/03/namur-ne-43-current-looop-current-ranges-diagram.png) The current ranges allowed by the NAMUR NE 43 current-loop standard.[/caption]
...
[caption id="attachment_13040" align="aligncenter" width="807"][![Possibly the simplest 4-20mA current loop interface to an ADC on a microcontroller. No filtering, buffering or voltage scaling.](http://blog.mbedded.ninja/wp-content/uploads/2016/03/simple-4-20ma-current-loop-interface-to-micro-adc.png)
](http://blog.mbedded.ninja/wp-content/uploads/2016/03/simple-4-20ma-current-loop-interface-to-micro-adc.png) Possibly the simplest 4-20mA current loop interface to an ADC on a microcontroller. No filtering, buffering or voltage scaling.[/caption]
...
[caption id="attachment_13038" align="aligncenter" width="1021"][![An schematic showing how to interface a 4-20mA current loop signal to the ADC on a microcontroller. The circuit also has a low-pass filter and a buffer.](http://blog.mbedded.ninja/wp-content/uploads/2016/03/4-20ma-current-loop-interface-to-micro-schematic-with-filter-and-buffer.png)
](http://blog.mbedded.ninja/wp-content/uploads/2016/03/4-20ma-current-loop-interface-to-micro-schematic-with-filter-and-buffer.png) An schematic showing how to interface a 4-20mA current loop signal to the ADC on a microcontroller. The circuit also has a low-pass filter and a buffer.[/caption]
...
[caption id="attachment_13423" align="aligncenter" width="390"][![The logo for the HART communication protocol.](http://blog.mbedded.ninja/wp-content/uploads/2016/03/hart-communication-protocol-logo-4-20ma-current-loop.jpg)
](http://blog.mbedded.ninja/wp-content/uploads/2016/03/hart-communication-protocol-logo-4-20ma-current-loop.jpg) The logo for the HART communication protocol.[/caption]
