...
{{< figure src="/images/2011/09/i2c-slave-address-pins-logic-table-with-scl-sda-ability-ti-ina226.png" width="826" caption="The logic table (truth table) of the I2C address pins on the TI INA226 IC. Notice how you can connect the address pins up to SCL or SDA as well as the standard VS and GND, to give a total of 16 possible I2C addresses." caption-position="bottom" >}}
...
{{< figure src="/images/2011/09/i2c-noise-from-long-cable.jpg" width="387" caption="The cross-talk noise that occurs on long I2C transmission lines. This shows SCL (yellow) and SDA (blue) over a 20m ethernet cable." caption-position="bottom" >}}
...
{{< figure src="/images/2011/09/typical-i2c-waveform.jpg" width="483" caption="A typical I2C waveform. The top waveform is the clock (SCK), and the bottom waveform is the data (SDA). This shows a master trying to communicate with the slave, but the slave does not acknowledge (the ninth bit is high)." caption-position="bottom" >}}
...
{{< figure src="http://blog.mbedded.ninja/wp-content/gallery/electronics-misc/i2c-waveform-example-saleae-logic-analyser.png" caption="i2c-waveform-example-saleae-logic-analyser" caption-position="bottom" >}}
