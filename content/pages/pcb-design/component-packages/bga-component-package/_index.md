...
{{< figure src="non-soldermask defined" width="507" caption="](/images/2015/03/example-of-nsmd-pcb-pad-solder-joint-xilinx.png) Example of a NSMD (non-soldermask defined) solder joint on a BGA package. Image from http://www.xilinx.com/." caption-position="bottom" >}}
